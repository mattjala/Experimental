...
int_f h5pcreate_c(hid_t_f *cls, hid_t_f *prp_id)
/******/
{
  hid_t c_prp_id;
  int_f ret_value = 0;
...
int_f h5pclose_c(hid_t_f *prp_id)
/******/
{
  int_f ret_value = 0;
 ...
 * SOURCE
 */
int_f h5pcopy_c(hid_t_f *prp_id, hid_t_f *new_prp_id)
/******/
{
  hid_t c_new_prp_id;
  int_f ret_value = 0;
 ...
 * SOURCE
 */
int_f h5pequal_c(hid_t_f *plist1_id, hid_t_f *plist2_id, int_f *c_flag)
/******/
{
  htri_t c_c_flag;
  int_f ret_value = 0;
...
int_f h5pget_class_c(hid_t_f *prp_id, hid_t_f *classtype)
/******/
{
  hid_t c_classtype;
  int_f ret_value = 0;
...
int_f h5pset_preserve_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_preserve_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_deflate_c(hid_t_f *prp_id, int_f *level)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_chunk_c(hid_t_f *prp_id, int_f *rank, hsize_t_f *dims)
/******/
{
  int ret_value = -1;
...
int_f h5pget_chunk_c(hid_t_f *prp_id, int_f *max_rank, hsize_t_f *dims)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id = (hid_t)*prp_id;
 ...
 * SOURCE
 */
int_f h5pset_fill_value_c(hid_t_f *prp_id, hid_t_f *type_id, void *fillvalue)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_fill_value_c(hid_t_f *prp_id, hid_t_f *type_id, void *fillvalue)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pget_version_c(hid_t_f H5_ATTR_UNUSED *prp_id, int_f *boot,
                       int_f *freelist, int_f *stab, int_f *shhdr)
/******/
{
  /*
...
int_f h5pget_version_c(hid_t_f *prp_id, int_f *boot, int_f *freelist,
 ...
 * SOURCE
 */
int_f h5pget_userblock_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_userblock_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_sizes_c(hid_t_f *prp_id, size_t_f *sizeof_addr,
 ...
 * SOURCE
 */
int_f h5pset_sizes_c(hid_t_f *prp_id, size_t_f *sizeof_addr,
                     size_t_f *sizeof_size)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_sym_k_c(hid_t_f *prp_id, int_f *ik, int_f *lk)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_sym_k_c(hid_t_f *prp_id, int_f *ik, int_f *lk)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_istore_k_c(hid_t_f *prp_id, int_f *ik)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_istore_k_c(hid_t_f *prp_id, int_f *ik)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_driver_c(hid_t_f *prp_id, hid_t_f *driver)
/******/
{
  int ret_value = -1;
  hid_t c_driver;
 ...
 * SOURCE
 */
int_f h5pset_fapl_stdio_c(hid_t_f *prp_id)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_fapl_stdio_c(hid_t_f *prp_id, int_f *io)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_fapl_sec2_c(hid_t_f *prp_id)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_fapl_sec2_c(hid_t_f *prp_id, int_f *sec2)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_alignment_c(hid_t_f *prp_id, hsize_t_f *threshold,
                         hsize_t_f *alignment)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pget_alignment_c(hid_t_f *prp_id, hsize_t_f *threshold,
                         hsize_t_f *alignment)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_fapl_core_c(hid_t_f *prp_id, size_t_f *increment, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_fapl_core_c(hid_t_f *prp_id, size_t_f *increment, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_fapl_family_c(hid_t_f *prp_id, hsize_t_f *memb_size,
                           hid_t_f *memb_plist)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pget_fapl_family_c(hid_t_f *prp_id, hsize_t_f *memb_size,
                           hid_t_f *memb_plist)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_cache_c(hid_t_f *prp_id, int_f *mdc_nelmts, size_t_f *rdcc_nelmts,
...
/******/
{
  ...
  ret = H5Pset_cache(c_prp_id, c_mdc_nelmts, c_rdcc_nelmts, c_rdcc_nbytes,
                     c_rdcc_w0);
  if (ret < 0)
    return ret_value;
  ret_value = 0;
 ...
 * SOURCE
 */
int_f h5pget_cache_c(hid_t_f *prp_id, int_f *mdc_nelmts, size_t_f *rdcc_nelmts,
                     size_t_f *rdcc_nbytes, real_f *rdcc_w0)
/******/
{
  int ret_value = -1;
   ...
   */
  c_prp_id = (hid_t)*prp_id;
  ret = H5Pget_cache(c_prp_id, &c_mdc_nelmts, &c_rdcc_nelmts, &c_rdcc_nbytes,
                     &c_rdcc_w0);
  if (ret < 0)
    return ret_value;
 ...
 * SOURCE
 */
int_f h5pset_fapl_split_c(hid_t_f *prp_id, int_f *meta_len, _fcd meta_ext,
                          hid_t_f *meta_plist, int_f *raw_len, _fcd raw_ext,
                          hid_t_f *raw_plist)
/******/
{
  int ret_value = -1;
  ...
  ret = H5Pset_fapl_split(c_prp_id, c_meta_ext, c_meta_plist, c_raw_ext,
                          c_raw_plist);
 ...
 * SOURCE
 */
int_f h5pget_fapl_split_c(hid_t_f *prp_id, size_t_f *meta_ext_size,
 ...
 * SOURCE
 */
int_f h5pset_gc_references_c(hid_t_f *prp_id, int_f *gc_references)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_gc_references_c(hid_t_f *prp_id, int_f *gc_references)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_layout_c(hid_t_f *prp_id, int_f *layout)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_layout_c(hid_t_f *prp_id, int_f *layout)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_filter_c(hid_t_f *prp_id, int_f *filter, int_f *flags,
 ...
 * SOURCE
 */
int_f h5pget_nfilters_c(hid_t_f *prp_id, int_f *nfilters)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 *---------------------------------------------------------------------------*/
int_f h5pget_filter_c(hid_t_f *prp_id, int_f *filter_number, int_f *flags,
                      size_t_f *cd_nelmts, int_f *cd_values, size_t_f *namelen,
                      _fcd name, int_f *filter_id)
/******/
{
  ...
  if (NULL == (c_cd_values =
                   (unsigned int *)malloc(sizeof(unsigned int) * c_cd_nelmts)))
    goto DONE;

  /*
   * Call H5Pget_filter2 function.
   */
  if ((c_filter = H5Pget_filter2((hid_t)*prp_id, (unsigned)*filter_number,
                                 &c_flags, &c_cd_nelmts, c_cd_values,
 ...
 * SOURCE
 */
int_f h5pset_external_c(hid_t_f *prp_id, _fcd name, int_f *namelen,
 ...
 * SOURCE
 */
int_f h5pget_external_count_c(hid_t_f *prp_id, int_f *count)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_external_c(hid_t_f *prp_id, int_f *idx, size_t_f *name_size,
                        _fcd name, off_t_f *offset, hsize_t_f *bytes)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
  ...
  c_idx = (unsigned)*idx;
  status =
      H5Pget_external(c_prp_id, c_idx, c_namelen + 1, c_name, &c_offset, &size);
  ...
  *bytes = (hsize_t_f)size;
   ...
   *       from the function then we need to give HD5packFstring the fortran
   * buffer size so that it fills the remaining unused characters with blanks.
   * MSB
   */
 ...
 * PURPOSE
 *  Call H5Pset_btree_ratios to set B-tree split ratios for B-tree split ratios
 * for a dataset transfer property list. a dataset transfer property list.
 * INPUTS prp_id - property list identifier left - The B-tree split ratio for
 * left-most nodes. middle - The B-tree split ratio for all other nodes right -
 * The B-tree split ratio for right-most nodes and lone nodes. RETURNS 0 on
 * success, -1 on failure SOURCE
 */
int_f h5pset_btree_ratios_c(hid_t_f *prp_id, real_f *left, real_f *middle,
                            real_f *right)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pget_btree_ratios_c(hid_t_f *prp_id, real_f *left, real_f *middle,
                            real_f *right)
/******/
{
  int ret_value = -1;
...
int_f h5pget_fclose_degree_c(hid_t_f *fapl_id, int_f *degree)
/******/
{
  int ret_value = -1;
  hid_t c_fapl_id;
...
int_f h5pset_fclose_degree_c(hid_t_f *fapl_id, int_f *degree)
/******/
{
  int ret_value = -1;
  hid_t c_fapl_id;
...
int_f h5pset_buffer_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_buffer_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pfill_value_defined_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pget_alloc_time_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pset_alloc_time_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pget_fill_time_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pset_fill_time_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pset_meta_block_size_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_meta_block_size_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_sieve_buf_size_c(hid_t_f *prp_id, size_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_sieve_buf_size_c(hid_t_f *prp_id, size_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_small_data_block_size_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_small_data_block_size_c(hid_t_f *prp_id, hsize_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_hyper_vector_size_c(hid_t_f *prp_id, size_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_hyper_vector_size_c(hid_t_f *prp_id, size_t_f *size)
/******/
{
  int ret_value = 0;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pcreate_class_c(hid_t_f *parent, _fcd name, int_f *name_len,
...
/******/
{
   ...
   */
  c_class = H5Pcreate_class((hid_t)*parent, c_name, create, create_data, copy,
 ...
 * SOURCE
 */
int_f h5pregister_c(hid_t_f *cls, _fcd name, int_f *name_len, size_t_f *size,
                    void H5_ATTR_UNUSED *value)
/******/
{
  char *c_name = NULL;
  int_f ret_value = -1;
   ...
   */
  if (H5Pregister2((hid_t)*cls, c_name, (size_t)*size, value, NULL, NULL, NULL,
 ...
 * SOURCE
 */
int_f h5pinsert_c(hid_t_f *plist, _fcd name, int_f *name_len, size_t_f *size,
                  void H5_ATTR_UNUSED *value)
/******/
{
  char *c_name = NULL;
   ...
   */
  if (H5Pinsert2((hid_t)*plist, c_name, (size_t)*size, value, NULL, NULL, NULL,
                 NULL, NULL, NULL) < 0)
    goto DONE;
  ret_value = 0;
 ...
 * SOURCE
 */
int_f h5pexist_c(hid_t_f *cls, _fcd name, int_f *name_len)
/******/
{
  int_f ret_value = -1;
  hid_t c_class;
 ...
 * SOURCE
 */
int_f h5pisa_class_c(hid_t_f *plist, hid_t_f *cls)
/******/
{
  int_f ret_value = -1;
  hid_t c_class;
 ...
 * SOURCE
 */
int_f h5pget_size_c(hid_t_f *plist, _fcd name, int_f *name_len, size_t_f *size)
/******/
{
  int_f ret_value = -1;
  hid_t c_plist;
 ...
 * SOURCE
 */
int_f h5pget_nprops_c(hid_t_f *plist, size_t_f *nprops)
/******/
{
  int_f ret_value = -1;
  hid_t c_plist;
 ...
 * SOURCE
 */
int_f h5pget_class_parent_c(hid_t_f *prp_id, hid_t_f *parent_id)
/******/
{
  int_f ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pcopy_prop_c(hid_t_f *dst_id, hid_t_f *src_id, _fcd name,
                     int_f *name_len)
/******/
{
  int_f ret_value = -1;
 ...
 * SOURCE
 */
int_f h5premove_c(hid_t_f *plid, _fcd name, int_f *name_len)
/******/
{
  int_f ret_value = -1;
  hid_t c_plid;
 ...
 * SOURCE
 */
int_f h5punregister_c(hid_t_f *cls, _fcd name, int_f *name_len)
/******/
{
  int_f ret_value = -1;
  hid_t c_class;
 ...
 * SOURCE
 */
int_f h5pclose_class_c(hid_t_f *cls)
/******/
{
  int_f ret_value = -1;
  hid_t c_class;
 ...
 * SOURCE
 */
int_f h5pget_class_name_c(hid_t_f *cls, _fcd name, int_f *name_len)
/******/
{
  int_f ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_c(hid_t_f *plist, _fcd name, int_f *name_len, void *value)
/******/
{
  int_f ret_value = -1;
  char *c_name;
 ...
 * SOURCE
 */
int_f h5pget_c(hid_t_f *plist, _fcd name, int_f *name_len, void *value)
/******/
{
  int_f ret_value = -1;
  char *c_name;
...
int_f h5pset_shuffle_c(hid_t_f *prp_id)
/******/
{
  int_f ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_fletcher32_c(hid_t_f *prp_id)
/******/
{
  int_f ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_edc_check_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int_f ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pget_edc_check_c(hid_t_f *prp_id, int_f *flag)
/******/
{
  int_f ret_value = 0;
  hid_t c_prp_id;
...
int_f h5pset_family_offset_c(hid_t_f *prp_id, hsize_t_f *offset)
/******/
{
  int_f ret_value = 0;
  hid_t c_prp_id;
...
/******/
{
  ...
  status =
      H5Pset_fapl_multi(c_prp_id, c_memb_map, c_memb_fapl,
                        (const char *const *)c_memb_name, c_memb_addr, relax);
  if (status < 0)
    goto DONE;
  ret_value = 0;
...
int_f h5pset_fapl_multi_sc(hid_t_f *prp_id, int_f *flag)
/******/
{
  int_f ret_value = -1;
  hid_t c_prp_id;
...
int_f h5pget_fapl_multi_c(hid_t_f *prp_id, int_f *memb_map, hid_t_f *memb_fapl,
                          _fcd memb_name, int_f *len, int_f *lenmax,
                          real_f *memb_addr, int_f *flag, int_f *maxlen_out)
/******/
{
  int_f ret_value = -1;
  hid_t c_prp_id;
  ...
  status = H5Pget_fapl_multi(c_prp_id, c_memb_map, c_memb_fapl, c_memb_name,
                             c_memb_addr, &relax);
  if (status < 0)
    return ret_value;
  ...
  HD5packFstring(tmp, _fcdtocp(memb_name),
                 (size_t)(c_lenmax * H5FD_MEM_NTYPES));
...
int_f h5pset_szip_c(hid_t_f *prp_id, int_f *options_mask,
...
int_f h5pall_filters_avail_c(hid_t_f *prp_id, int_f *status)
/******/
{
  int_f ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_filter_by_id_c(hid_t_f *prp_id, int_f *filter_id, int_f *flags,
                            size_t_f *cd_nelmts, int_f *cd_values,
...
/******/
{
  ...
  if (NULL == (c_cd_values = (unsigned int *)malloc(sizeof(unsigned int) *
                                                    c_cd_nelmts_in)))
    goto DONE;
   ...
   */
  if (H5Pget_filter_by_id2((hid_t)*prp_id, (H5Z_filter_t)*filter_id, &c_flags,
                           &c_cd_nelmts, c_cd_values, (size_t)*namelen, c_name,
                           NULL) < 0)
    goto DONE;
 ...
 * SOURCE
 */
int_f h5pmodify_filter_c(hid_t_f *prp_id, int_f *filter, int_f *flags,
                         size_t_f *cd_nelmts, int_f *cd_values)
/******/
{
  int_f ret_value = -1;
 ...
 * SOURCE
 */
int_f h5premove_filter_c(hid_t_f *prp_id, int_f *filter)
/******/
{
  int_f ret_value = -1;
  hid_t c_prp_id;
 ...
 * OUTPUTS
 *  max_compact    - Maximum number of attributes to be stored in compact
 * storage min_dense      - Minimum number of attributes to be stored in dense
 * storage RETURNS 0 on success, -1 on failure SOURCE
 */
int_f h5pget_attr_phase_change_c(hid_t_f *ocpl_id, int_f *max_compact,
                                 int_f *min_dense)
/******/
{
  int ret_value = -1;
 ...
 *
 * INPUTS
 *  ocpl_id         - Object (dataset or group) creation property list
 * identifier OUTPUTS crt_order_flags - Flags specifying whether to track and
 * index attribute creation order RETURNS 0 on success, -1 on failure SOURCE
 */
int_f h5pset_attr_creation_order_c(hid_t_f *ocpl_id, int_f *crt_order_flags)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_shared_mesg_nindexes_c(hid_t_f *plist_id, int_f *nindexes)
/******/
{
  int ret_value = -1;
  hid_t c_plist_id;
 ...
 * SOURCE
 */
int_f h5pset_shared_mesg_index_c(hid_t_f *fcpl_id, int_f *index_num,
                                 int_f *mesg_type_flags, int_f *min_mesg_size)
/******/
{
  int ret_value = -1;
  herr_t ret;
   ...
   */
  ret = H5Pset_shared_mesg_index((hid_t)*fcpl_id, (unsigned)*index_num,
 ...
 * SOURCE
 */
int_f h5pget_attr_creation_order_c(hid_t_f *ocpl_id, int_f *crt_order_flags)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pset_link_creation_order_c(hid_t_f *gcpl_id, int_f *crt_order_flags)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pget_link_phase_change_c(hid_t_f *gcpl_id, int_f *max_compact,
                                 int_f *min_dense)
/******/
{
  int ret_value = -1;
...
int_f h5pget_obj_track_times_c(hid_t_f *plist_id, int_f *flag)
/******/
{
  int ret_value = -1;
...
int_f h5pset_obj_track_times_c(hid_t_f *plist_id, int_f *flag)
/******/
{
  int ret_value = -1;
  bool c_track_times;
...
int_f h5pset_create_inter_group_c(hid_t_f *lcpl_id, int_f *crt_intermed_group)
/******/
{
  int ret_value = -1;
  herr_t ret;
   ...
   */
  ret = H5Pset_create_intermediate_group((hid_t)*lcpl_id,
 ...
 * SOURCE
 */
int_f h5pget_link_creation_order_c(hid_t_f *gcpl_id, int_f *crt_order_flags)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pset_char_encoding_c(hid_t_f *plist_id, int_f *encoding)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pget_char_encoding_c(hid_t_f *plist_id, int_f *encoding)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_copy_object_c(hid_t_f *ocp_plist_id, int_f *copy_options)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pget_copy_object_c(hid_t_f *ocp_plist_id, int_f *copy_options)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pget_data_transform_c(hid_t_f *plist_id, _fcd expression,
 ...
 * SOURCE
 */
int_f h5pset_data_transform_c(hid_t_f *plist_id, _fcd expression,
...
/******/
{
   ...
   */
  if (NULL ==
      (c_expression = HD5f2cstring(expression, (size_t)*expression_len)))
    HGOTO_DONE(FAIL);
 ...
 * SOURCE
 */
int_f h5pget_local_heap_size_hint_c(hid_t_f *gcpl_id, size_t_f *size_hint)
/******/
{
 ...
 * SOURCE
 */
int_f h5pget_est_link_info_c(hid_t_f *gcpl_id, int_f *est_num_entries,
                             int_f *est_name_len)
/******/
{
  int_f ret_value = -1; /* Return value */
   ...
   */
  ret = H5Pget_est_link_info((hid_t)*gcpl_id, &c_est_num_entries,
                             &c_est_name_len);
  if (ret < 0)
    return ret_value;
 ...
 * SOURCE
 */
int_f h5pset_local_heap_size_hint_c(hid_t_f *gcpl_id, size_t_f *size_hint)
/******/
{
  int_f ret_value = -1; /* Return value */
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pset_est_link_info_c(hid_t_f *gcpl_id, int_f *est_num_entries,
                             int_f *est_name_len)
/******/
{
  int_f ret_value = -1; /* Return value */
   ...
   */
  ret = H5Pset_est_link_info((hid_t)*gcpl_id, (unsigned)*est_num_entries,
 ...
 * SOURCE
 */
int_f h5pset_link_phase_change_c(hid_t_f *gcpl_id, int_f *max_compact,
                                 int_f *min_dense)
/******/
{
  int ret_value = -1;
   ...
   */
  ret = H5Pset_link_phase_change((hid_t)*gcpl_id, (unsigned)*max_compact,
                                 (unsigned)*min_dense);
  if (ret < 0)
    return ret_value;
...
H5_ATTR_CONST
#endif
int_f h5pset_fapl_direct_c(hid_t_f H5_ATTR_UNUSED *fapl_id,
                           size_t_f H5_ATTR_UNUSED *alignment,
                           size_t_f H5_ATTR_UNUSED *block_size,
                           size_t_f H5_ATTR_UNUSED *cbuf_size)
/******/
{
  int ret_value = -1;
   ...
   * Call H5Pset_link_phase_change function.
   */
  ret = H5Pset_fapl_direct((hid_t)*fapl_id, (size_t)*alignment,
...
H5_ATTR_CONST
#endif
int_f h5pget_fapl_direct_c(hid_t_f H5_ATTR_UNUSED *fapl_id,
                           size_t_f H5_ATTR_UNUSED *alignment,
                           size_t_f H5_ATTR_UNUSED *block_size,
                           size_t_f H5_ATTR_UNUSED *cbuf_size)
/******/
{
   ...
   * Call H5Pget_link_phase_change function.
   */
  ret = H5Pget_fapl_direct((hid_t)*fapl_id, &c_alignment, &c_block_size,
                           &c_cbuf_size);
  if (ret < 0)
    return ret_value;
 ...
 * SOURCE
 */
int_f h5pset_attr_phase_change_c(hid_t_f *ocpl_id, int_f *max_compact,
                                 int_f *min_dense)
/******/
{
  int ret_value = -1;
   ...
   */
  ret = H5Pset_attr_phase_change((hid_t)*ocpl_id, (unsigned)*max_compact,
                                 (unsigned)*min_dense);
  if (ret < 0)
    return ret_value;
 ...
 * SOURCE
 */
int_f h5pset_nbit_c(hid_t_f *plist_id)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pset_scaleoffset_c(hid_t_f *plist_id, int_f *scale_type,
                           int_f *scale_factor)
/******/
{
  int ret_value = -1;
 ...
 * SOURCE
 */
int_f h5pset_nlinks_c(hid_t_f *lapl_id, size_t_f *nlinks)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pget_nlinks_c(hid_t_f *lapl_id, size_t_f *nlinks)
/******/
{
  int ret_value = -1;
  herr_t ret;
 ...
 * SOURCE
 */
int_f h5pget_create_inter_group_c(hid_t_f *lcpl_id, int_f *crt_intermed_group)
/******/
{
  int ret_value = -1;
  herr_t ret;
   ...
   */
  ret =
      H5Pget_create_intermediate_group((hid_t)*lcpl_id, &c_crt_intermed_group);
...
int_f h5pset_chunk_cache_c(hid_t_f *dapl_id, size_t_f *rdcc_nslots,
                           size_t_f *rdcc_nbytes, real_f *rdcc_w0) {
  int ret_value = -1;
   ...
   */
  if ((H5Pset_chunk_cache((hid_t)*dapl_id, (size_t)*rdcc_nslots,
...
int_f h5pget_chunk_cache_c(hid_t_f *dapl_id, size_t_f *rdcc_nslots,
                           size_t_f *rdcc_nbytes, real_f *rdcc_w0) {
  int ret_value = -1;
   ...
   */
  if ((H5Pget_chunk_cache((hid_t)*dapl_id, &c_rdcc_nslots, &c_rdcc_nbytes,
                          &c_rdcc_w0)) < 0)
    return ret_value; /* error occurred */
 ...
 *  buf_len - Size of the supplied buffer, or 0 (zero) if no initial image is
 *desired
 *
 *  Returns:     0 on success, -1 on failure
 *---------------------------------------------------------------------------*/

int_f h5pset_file_image_c(hid_t_f *fapl_id, void *buf_ptr, size_t_f *buf_len) {
  int ret_value = -1;
  /*
...
int_f h5pget_file_image_c(hid_t_f *fapl_id, void **buf_ptr,
                          size_t_f *buf_len_ptr) {
  int ret_value = -1;
   ...
   */
  if ((H5Pget_file_image((hid_t)*fapl_id, (void **)&c_buf_ptr,
                         &c_buf_len_ptr)) < 0)
    return ret_value; /* error occurred */
 ...
 * SOURCE
 */
int_f h5pset_fapl_mpio_c(hid_t_f *prp_id, int_f *comm, int_f *info)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_fapl_mpio_c(hid_t_f *prp_id, int_f *comm, int_f *info)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_mpi_params_c(hid_t_f *prp_id, int_f *comm, int_f *info)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_mpi_params_c(hid_t_f *prp_id, int_f *comm, int_f *info)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pset_dxpl_mpio_c(hid_t_f *prp_id, int_f *data_xfer_mode)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_dxpl_mpio_c(hid_t_f *prp_id, int_f *data_xfer_mode)
/******/
{
  int ret_value = -1;
  hid_t c_prp_id;
 ...
 * SOURCE
 */
int_f h5pget_mpio_actual_io_mode_c(hid_t_f *dxpl_id, int_f *actual_io_mode)
/******/
{
  int ret_value = -1;
