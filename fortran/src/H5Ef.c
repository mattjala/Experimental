 ...
 * SOURCE
 */
int_f h5eclear_c(hid_t_f *estack_id)
/******/
{
  int_f ret_value = 0;
 ...
 * SOURCE
 */
int_f h5eprint_c1(_fcd name, int_f *namelen)
/******/
{
  FILE *file = NULL;
  char *c_name = NULL;
 ...
 * SOURCE
 */
int_f h5eget_major_c(int_f *error_no, _fcd name, size_t_f *namelen)
/******/
{
  char *c_name = NULL;
 ...
 * SOURCE
 */
int_f h5eget_minor_c(int_f *error_no, _fcd name, size_t_f *namelen)
/******/
{
  char *c_name = NULL;
  size_t c_namelen = (size_t)*namelen;
...
int_f h5eset_auto2_c(int_f *printflag, hid_t_f *estack_id, H5E_auto2_t func,
                     void *client_data)
/******/
{
  int ret_val = -1;
