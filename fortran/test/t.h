...
H5_FCTESTDLL int_f nh5_fixname_c(_fcd base_name, size_t_f *base_namelen,
                                 hid_t_f *fapl, _fcd full_name,
                                 size_t_f *full_namelen);

H5_FCTESTDLL int_f nh5_cleanup_c(_fcd base_name, size_t_f *base_namelen,
                                 hid_t_f *fapl);
