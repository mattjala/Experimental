...
static herr_t attr_info(hid_t loc_id, const char *name, const H5A_info_t *ainfo,
                        void *opdata);
/* Operator function */
...
int main(void) {
   ...
   */
  dataset = H5Dcreate2(file, "Dataset", H5T_NATIVE_INT, fid, H5P_DEFAULT,
   ...
   */
  ret =
      H5Dwrite(dataset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, vector);
   ...
   */
  attr1 = H5Acreate2(dataset, ANAME, H5T_NATIVE_FLOAT, aid1, H5P_DEFAULT,
                     H5P_DEFAULT);
