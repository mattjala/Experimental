 ...
 * parameters.
 */
static const char *s_opts = "a:b:c:d:e:f:hi:j:k:l:m:no:q:s:t:u:v*z:E*G:LM:P:S:"
                            "T:VXWY:Z:1:2:3:4:5:6:7:8:9:0:";
...
static void usage(const char *prog) {
  ...
  PRINTVALSTREAM(rawoutstream, "   --enable-error-stack    Prints messages "
  ...
  PRINTVALSTREAM(rawoutstream, "   --src-vol-value         Value (ID) of the "
                               "VOL connector to use for opening the\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           input HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --src-vol-name          Name of the VOL "
                               "connector to use for opening the input\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --src-vol-info          VOL-specific info "
                               "to pass to the VOL connector used for\n");
  PRINTVALSTREAM(
      rawoutstream,
      "                           opening the input HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --dst-vol-value         Value (ID) of the "
                               "VOL connector to use for opening the\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           output HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --dst-vol-name          Name of the VOL "
                               "connector to use for opening the output\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --dst-vol-info          VOL-specific info "
                               "to pass to the VOL connector used for\n");
  PRINTVALSTREAM(
      rawoutstream,
      "                           opening the output HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --src-vfd-value         Value (ID) of the "
                               "VFL driver to use for opening the\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           input HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --src-vfd-name          Name of the VFL "
                               "driver to use for opening the input\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --src-vfd-info          VFD-specific info "
                               "to pass to the VFL driver used for\n");
  PRINTVALSTREAM(
      rawoutstream,
      "                           opening the input HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --dst-vfd-value         Value (ID) of the "
                               "VFL driver to use for opening the\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           output HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --dst-vfd-name          Name of the VFL "
                               "driver to use for opening the output\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           HDF5 file specified\n");
  PRINTVALSTREAM(rawoutstream, "   --dst-vfd-info          VFD-specific info "
                               "to pass to the VFL driver used for\n");
  PRINTVALSTREAM(
      rawoutstream,
      "                           opening the output HDF5 file specified\n");
  ...
  PRINTVALSTREAM(rawoutstream, "                           This option will "
                               "take precedence over the options\n");
  PRINTVALSTREAM(rawoutstream, "                           --low and --high\n");
  PRINTVALSTREAM(rawoutstream, "   --low=BOUND             The low bound for "
                               "library release versions to use\n");
  PRINTVALSTREAM(
      rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "   --high=BOUND            The high bound for "
                               "library release versions to use\n");
  PRINTVALSTREAM(
      rawoutstream,
      "                           when creating objects in the file\n");
  ...
  PRINTVALSTREAM(rawoutstream, "   --merge                 Follow external "
                               "soft link recursively and merge data\n");
  PRINTVALSTREAM(rawoutstream, "   --prune                 Do not follow "
                               "external soft links and remove link\n");
  PRINTVALSTREAM(rawoutstream, "   --merge --prune         Follow external "
                               "link, merge data and remove dangling link\n");
  PRINTVALSTREAM(rawoutstream, "   -c L1, --compact=L1     Maximum number of "
                               "links in header messages\n");
  PRINTVALSTREAM(rawoutstream, "   -d L2, --indexed=L2     Minimum number of "
                               "links in the indexed format\n");
  PRINTVALSTREAM(
      rawoutstream,
      "   -s S[:F], --ssize=S[:F] Shared object header message minimum size\n");
  PRINTVALSTREAM(rawoutstream, "   -m M, --minimum=M       Do not apply the "
                               "filter to datasets smaller than M\n");
  PRINTVALSTREAM(
      rawoutstream,
      "   -e E, --file=E          Name of file E with the -f and -l options\n");
  PRINTVALSTREAM(rawoutstream, "   -u U, --ublock=U        Name of file U with "
                               "user block data to be added\n");
  PRINTVALSTREAM(rawoutstream,
                 "   -b B, --block=B         Size of user block to be added\n");
  PRINTVALSTREAM(rawoutstream, "   -M A, --metadata_block_size=A  Metadata "
                               "block size for H5Pset_meta_block_size\n");
  PRINTVALSTREAM(
      rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "   -S FS_STRATEGY, --fs_strategy=FS_STRATEGY  "
                               "File space management strategy for\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           H5Pset_file_space_strategy\n");
  PRINTVALSTREAM(rawoutstream, "   -P FS_PERSIST, --fs_persist=FS_PERSIST  "
                               "Persisting or not persisting free-\n");
  PRINTVALSTREAM(
      rawoutstream,
      "                           space for H5Pset_file_space_strategy\n");
  PRINTVALSTREAM(rawoutstream,
                 "   -T FS_THRESHOLD, --fs_threshold=FS_THRESHOLD   Free-space "
                 "section threshold\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           for H5Pset_file_space_strategy\n");
  PRINTVALSTREAM(rawoutstream, "   -G FS_PAGESIZE, --fs_pagesize=FS_PAGESIZE   "
                               "File space page size for\n");
  PRINTVALSTREAM(rawoutstream,
                 "                           H5Pset_file_space_page_size\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "    M - is an integer greater than 1, size of "
                               "dataset in bytes (default is 0)\n");
  ...
  PRINTVALSTREAM(rawoutstream, "    Q - is the sort index type for the input "
                               "file. It can be \"name\" or\n");
  PRINTVALSTREAM(rawoutstream, "        \"creation_order\" (default)\n");
  PRINTVALSTREAM(rawoutstream, "    Z - is the sort order type for the input "
                               "file. It can be \"descending\" or\n");
  PRINTVALSTREAM(rawoutstream, "        \"ascending\" (default)\n");
  PRINTVALSTREAM(rawoutstream, "    B - is the user block size, any value that "
                               "is 512 or greater and is\n");
  PRINTVALSTREAM(rawoutstream, "        a power of 2 (1024 default)\n");
  PRINTVALSTREAM(rawoutstream, "    F - is the shared object header message "
                               "type, any of <dspace|dtype|fill|\n");
  PRINTVALSTREAM(rawoutstream, "        pline|attr>. If F is not specified, S "
                               "applies to all messages\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "    BOUND is an integer indicating the library "
                               "release versions to use when\n");
  PRINTVALSTREAM(
      rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "           (H5F_LIBVER_LATEST is aliased to "
                               "H5F_LIBVER_V114 for this release\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(
      rawoutstream,
      "    FS_STRATEGY is a string indicating the file space strategy used:\n");
  PRINTVALSTREAM(rawoutstream, "        FSM_AGGR:\n");
  PRINTVALSTREAM(rawoutstream, "               The mechanisms used in managing "
                               "file space are free-space\n");
  PRINTVALSTREAM(
      rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "               The mechanisms used in managing "
                               "file space are free-space\n");
  PRINTVALSTREAM(rawoutstream, "               managers with embedded paged "
                               "aggregation and virtual file driver.\n");
  PRINTVALSTREAM(rawoutstream, "        AGGR:\n");
  PRINTVALSTREAM(rawoutstream, "               The mechanisms used in managing "
                               "file space are aggregators and\n");
  PRINTVALSTREAM(rawoutstream, "               virtual file driver.\n");
  PRINTVALSTREAM(rawoutstream, "        NONE:\n");
  PRINTVALSTREAM(rawoutstream, "               The mechanisms used in managing "
                               "file space are virtual file\n");
  PRINTVALSTREAM(rawoutstream, "               driver.\n");
  PRINTVALSTREAM(rawoutstream, "        The default strategy when not set is "
                               "FSM_AGGR without persisting free-\n");
  PRINTVALSTREAM(rawoutstream, "        space.\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "    FS_PERSIST is 1 to persisting free-space "
                               "or 0 to not persisting free-space.\n");
  PRINTVALSTREAM(
      rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "    FS_THRESHOLD is the minimum size (in "
                               "bytes) of free-space sections to be\n");
  PRINTVALSTREAM(rawoutstream, "        tracked by the library.\n");
  PRINTVALSTREAM(rawoutstream, "      The default when not set is 1.\n");
  PRINTVALSTREAM(rawoutstream,
                 "      The value is ignored for AGGR and NONE strategies.\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "    FS_PAGESIZE is the size (in bytes) >=512 "
                               "that is used by the library when\n");
  PRINTVALSTREAM(rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "      <list of objects> is a comma separated "
                               "list of object names, meaning apply\n");
  PRINTVALSTREAM(rawoutstream, "        compression only to those objects. If "
                               "no names are specified, the filter\n");
  ...
  PRINTVALSTREAM(rawoutstream, "        SZIP=<pixels per block,coding> pixels "
                               "per block is a even number in\n");
  PRINTVALSTREAM(rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "        SOFF=<scale_factor,scale_type> "
                               "scale_factor is an integer and scale_type\n");
  PRINTVALSTREAM(rawoutstream, "            is either IN or DS\n");
  PRINTVALSTREAM(rawoutstream, "        "
                               "UD=<filter_number,filter_flag,cd_value_count,"
                               "value1[,value2,...,valueN]>\n");
  PRINTVALSTREAM(rawoutstream, "            Required values: filter_number, "
                               "filter_flag, cd_value_count, value1\n");
  PRINTVALSTREAM(rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "      <list of objects> is a comma separated "
                               "list of object names, meaning that\n");
  PRINTVALSTREAM(rawoutstream, "        layout information is supplied for "
                               "those objects. If no names are\n");
  PRINTVALSTREAM(
      rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "   SZIP compression with 8 pixels per block "
                               "and NN coding method to object dset1\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "3) h5repack -v -l dset1,dset2:CHUNK=20x10 -f "
                               "dset3,dset4,dset5:NONE file1 file2\n");
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "   Chunked layout, with a layout size of "
                               "20x10, to objects dset1 and dset2\n");
  PRINTVALSTREAM(rawoutstream,
  ...
  PRINTVALSTREAM(rawoutstream, "\n");
  PRINTVALSTREAM(rawoutstream, "   Using latest file format with maximum "
                               "compact group size of 10 and\n");
...
static int parse_command_line(int argc, const char *const *argv,
  ...
  if (custom_in_vol || custom_in_vfd) {
    if ((tmp_fapl = h5tools_get_fapl(
             options->fin_fapl, custom_in_vol ? &in_vol_info : NULL,
  ...
  if (custom_out_vol || custom_out_vfd) {
    if ((tmp_fapl = h5tools_get_fapl(
             options->fout_fapl, custom_out_vol ? &out_vol_info : NULL,
