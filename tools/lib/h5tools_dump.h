...
H5TOOLS_DLLVAR table_t
    *h5dump_type_table; /*type table reference for datatype dump  */
...
H5TOOLS_DLL int h5tools_dump_simple_data(FILE *stream,
                                         ...
                                         h5tools_context_t *ctx /*in,out*/,
                                         hid_t container, unsigned flags,
                                         hsize_t nelmts, hid_t type,
                                         void *_mem);
...
H5TOOLS_DLL void h5tools_dump_data(FILE *stream, const h5tool_format_t *info,
                                   ...
                                   int obj_data);
H5TOOLS_DLL void h5tools_dump_reference(FILE *stream,
                                        const h5tool_format_t *info,
...
H5TOOLS_DLL hbool_t h5tools_dump_region_attribute(
    ...
    h5tools_context_t *ctx /*in,out*/, h5tools_str_t *buffer, hsize_t *curr_pos,
    size_t ncols, hsize_t region_elmt_counter, hsize_t elmt_counter);
...
H5TOOLS_DLL void h5tools_print_fill_value(h5tools_str_t *buffer /*in,out*/,
                                          const h5tool_format_t *info,
                                          h5tools_context_t *ctx /*in,out*/,
                                          hid_t dcpl, hid_t type_id,
                                          hid_t obj_id);
H5TOOLS_DLL void h5tools_print_packed_bits(h5tools_str_t *buffer /*in,out*/,
                                           hid_t type);
