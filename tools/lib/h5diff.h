...
/* Enumeration value for keeping track of whether an error occurred or
...
typedef struct {
  ...
  diff_err_t
      err_stat; /* an error occurred (2, error, 1, differences, 0, no error) */
  ...
  h5tools_vol_info_t
      vol_info[2]; /* VOL information for input file, output file */
  h5tools_vfd_info_t
      vfd_info[2];       /* VFD information for input file, output file */
...
H5TOOLS_DLL hsize_t h5diff(const char *fname1, const char *fname2,
                           const char *objname1, const char *objname2,
                           diff_opt_t *opts);

H5TOOLS_DLL hsize_t diff(hid_t file1_id, const char *path1, hid_t file2_id,
...
hsize_t diff_datasetid(hid_t dset1_id, hid_t dset2_id, const char *obj1_name,
                       const char *obj2_name, diff_opt_t *opts);
...
herr_t match_up_memsize(hid_t f_tid1_id, hid_t f_tid2_id, hid_t *m_tid1,
                        hid_t *m_tid2, size_t *m_size1, size_t *m_size2);
/* in h5diff.c */
