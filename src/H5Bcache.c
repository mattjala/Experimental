 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5B__cache_get_initial_load_size(void *_udata,
                                               size_t *image_len) {
 ...
 *-------------------------------------------------------------------------
 */
static void *H5B__cache_deserialize(const void *_image, size_t len,
                                    void *_udata,
  ...
  H5B_shared_t *shared; /* Pointer to shared B-tree info */
  const uint8_t *image =
      (const uint8_t *)_image;            /* Pointer into image buffer */
  ...
  if (bt->nchildren > shared->two_k)
    HGOTO_ERROR(H5E_BTREE, H5E_BADVALUE, NULL,
                "number of children is greater than maximum");
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5B__cache_serialize(const H5F_t *f, void *_image,
