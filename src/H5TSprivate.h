...
H5_DLL BOOL CALLBACK H5TS_win32_process_enter(PINIT_ONCE InitOnce,
                                              PVOID Parameter, PVOID *lpContex);
...
#define H5TS_attr_setscope(attr_ptr, scope)                                    \
...
/* Testing routines */
H5_DLL H5TS_thread_t H5TS_create_thread(void *(*func)(void *),
                                        H5TS_attr_t *attr, void *udata);
