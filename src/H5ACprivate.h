...
#define H5AC_NOTIFY_ACTION_CHILD_UNSERIALIZED                                  \
...
H5_DLL herr_t H5AC_get_cache_auto_resize_config(
    const H5AC_t *cache_ptr, H5AC_cache_config_t *config_ptr);
H5_DLL herr_t H5AC_get_cache_size(const H5AC_t *cache_ptr, size_t *max_size_ptr,
...
H5_DLL herr_t H5AC_get_cache_hit_rate(const H5AC_t *cache_ptr,
                                      double *hit_rate_ptr);
H5_DLL herr_t H5AC_reset_cache_hit_rate_stats(H5AC_t *cache_ptr);
H5_DLL herr_t H5AC_set_cache_auto_resize_config(
    H5AC_t *cache_ptr, const H5AC_cache_config_t *config_ptr);
...
H5_DLL herr_t H5AC_get_mdc_image_info(const H5AC_t *cache_ptr,
...
H5_DLL herr_t H5AC_evict_tagged_metadata(H5F_t *f, haddr_t metadata_tag,
...
H5_DLL herr_t H5AC_cork(H5F_t *f, haddr_t obj_addr, unsigned action,
                        hbool_t *corked);
H5_DLL herr_t H5AC_get_entry_ring(const H5F_t *f, haddr_t addr,
                                  H5AC_ring_t *ring);
