...
/* Selection callbacks */
static herr_t H5S__none_copy(H5S_t *dst, const H5S_t *src,
...
static herr_t H5S__none_bounds(const H5S_t *space, hsize_t *start,
                               hsize_t *end);
...
static htri_t H5S__none_intersect_block(H5S_t *space, const hsize_t *start,
                                        const hsize_t *end);
...
static herr_t H5S__none_iter_coords(const H5S_sel_iter_t *iter,
                                    hsize_t *coords);
static herr_t H5S__none_iter_block(const H5S_sel_iter_t *iter, hsize_t *start,
                                   hsize_t *end);
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5S__none_iter_init(H5S_t H5_ATTR_UNUSED *space,
                                  H5S_sel_iter_t *iter) {
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5S__none_iter_coords(const H5S_sel_iter_t H5_ATTR_UNUSED *iter,
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5S__none_iter_block(const H5S_sel_iter_t H5_ATTR_UNUSED *iter,
                                   hsize_t H5_ATTR_UNUSED *start,
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static herr_t H5S__none_iter_next(H5S_sel_iter_t H5_ATTR_UNUSED *iter,
                                  size_t H5_ATTR_UNUSED nelem) {
  FUNC_ENTER_PACKAGE_NOERR
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static herr_t H5S__none_copy(H5S_t *dst, const H5S_t H5_ATTR_UNUSED *src,
...
static herr_t H5S__none_deserialize(H5S_t **space, const uint8_t **p,
  ...
  if (version < H5S_NONE_VERSION_1 || version > H5S_NONE_VERSION_LATEST)
    HGOTO_ERROR(H5E_DATASPACE, H5E_BADVALUE, FAIL,
                "bad version number for none selection");
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static herr_t H5S__none_bounds(const H5S_t H5_ATTR_UNUSED *space,
                               hsize_t H5_ATTR_UNUSED *start,
                               hsize_t H5_ATTR_UNUSED *end) {
  FUNC_ENTER_PACKAGE_NOERR
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static herr_t H5S__none_offset(const H5S_t H5_ATTR_UNUSED *space,
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static htri_t H5S__none_shape_same(H5S_t H5_ATTR_UNUSED *space1,
                                   H5S_t H5_ATTR_UNUSED *space2) {
  FUNC_ENTER_PACKAGE_NOERR
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
htri_t H5S__none_intersect_block(H5S_t H5_ATTR_UNUSED *space,
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static herr_t H5S__none_adjust_u(H5S_t H5_ATTR_UNUSED *space,
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
--------------------------------------------------------------------------*/
static herr_t H5S__none_adjust_s(H5S_t H5_ATTR_UNUSED *space,
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5S__none_project_scalar(const H5S_t H5_ATTR_UNUSED *space,
                                       hsize_t H5_ATTR_UNUSED *offset) {
  FUNC_ENTER_PACKAGE_NOERR
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5S__none_project_simple(const H5S_t H5_ATTR_UNUSED *base_space,
                                       H5S_t *new_space,
                                       hsize_t H5_ATTR_UNUSED *offset) {
  herr_t ret_value = SUCCEED; /* Return value */
