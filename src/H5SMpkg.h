...
#define H5SM_LIST_VERSION                                                      \
  0 /* Version of Shared Object Header Message List Indexes */
...
/* General routines */
H5_DLL ssize_t H5SM__get_index(const H5SM_master_table_t *table,
                               unsigned type_id);
...
/* Testing functions */
#ifdef H5SM_TESTING
H5_DLL herr_t H5SM__get_mesg_count_test(H5F_t *f, unsigned type_id,
                                        size_t *mesg_count);
#endif /* H5SM_TESTING */
