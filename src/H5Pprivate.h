...
#define H5P_STRCRT_CHAR_ENCODING_NAME                                          \
  "character_encoding" /* Character set encoding for string */
...
typedef struct H5P_libclass_t {
  ...
  H5P_genclass_t *
      *par_pclass; /* Pointer to global parent class property list class */
...
H5_DLLVAR const struct H5P_libclass_t
    H5P_CLS_TACC[1]; /* Named datatype access */
...
H5_DLL herr_t H5P_set(H5P_genplist_t *plist, const char *name,
                      const void *value);
...
H5_DLL herr_t H5P_poke(H5P_genplist_t *plist, const char *name,
                       const void *value);
H5_DLL herr_t
H5P_insert(H5P_genplist_t *plist, const char *name, size_t size, void *value,
...
H5_DLL herr_t H5P_get_fill_value(H5P_genplist_t *plist,
                                 const struct H5T_t *type, void *value);
