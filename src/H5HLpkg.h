...
struct H5HL_t {
  ...
  hbool_t single_cache_obj; /* Indicate if the heap is a single object in the
                               cache         */
...
struct H5HL_dblk_t {
  H5AC_info_t
      cache_info; /* Information for H5AC cache functions, _must_ be      */
...
/* Heap routines */
H5_DLL H5HL_t *H5HL__new(size_t sizeof_size, size_t sizeof_addr,
                         size_t prfx_size);
