...
/*---------------------------------------------------------------------------*/
int hg_thread_getaffinity(hg_thread_t thread, hg_cpu_set_t *cpu_mask) {
#if defined(_WIN32)
  return HG_UTIL_FAIL;
#elif defined(__APPLE__)
  (void)thread;
...
/*---------------------------------------------------------------------------*/
int hg_thread_setaffinity(hg_thread_t thread, const hg_cpu_set_t *cpu_mask) {
#if defined(_WIN32)
