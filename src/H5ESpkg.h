...
struct H5ES_t {
  ...
  H5ES_event_insert_func_t
      ins_func;  /* Callback to invoke for operation inserts */
  void *ins_ctx; /* Context for callback to invoke for operation inserts */
  H5ES_event_complete_func_t
      comp_func;  /* Callback to invoke for operation completions */
...
H5_DLL herr_t H5ES__wait(H5ES_t *es, uint64_t timeout, size_t *num_in_progress,
                         hbool_t *op_failed);
H5_DLL herr_t H5ES__get_requests(H5ES_t *es, H5_iter_order_t order,
                                 hid_t *connector_ids, void **requests,
                                 size_t array_len);
H5_DLL herr_t H5ES__cancel(H5ES_t *es, size_t *num_not_canceled,
                           hbool_t *op_failed);
H5_DLL herr_t H5ES__get_err_info(H5ES_t *es, size_t num_err_info,
...
H5_DLL int H5ES__list_iterate(H5ES_event_list_t *el, H5_iter_order_t order,
