...
static herr_t H5_trace_args_close_degree(H5RS_str_t *rs,
 ...
 *
 * Purpose:     This routine formats an H5F_close_degree_t and adds the output
 *to the refcounted string (RS) argument.
 *
 * Return:      SUCCEED / FAIL
 *
 *-------------------------------------------------------------------------
  ...
  for (argno = 0; *type; argno++, type += (isupper(*type) ? 2 : 1)) {
    ...
    /* A value */
      ...
      case 'D':
        ...
        {
          H5FD_mpio_collective_opt_t opt =
              (H5FD_mpio_collective_opt_t)va_arg(ap, int);
        ...
        {
          H5D_gather_func_t gop =
              (H5D_gather_func_t)va_arg(ap, H5D_gather_func_t);
        ...
        {
          H5FD_file_image_callbacks_t ficb =
              va_arg(ap, H5FD_file_image_callbacks_t);
        ...
        case 'n': /* H5D_mpio_no_collective_cause_t */
        {
          ...
          if (nocol_cause_mode & H5D_MPIO_NOT_CONTIGUOUS_OR_CHUNKED_DATASET) {
            H5RS_asprintf_cat(rs,
                              "%sH5D_MPIO_NOT_CONTIGUOUS_OR_CHUNKED_DATASET",
                              flag_already_displayed ? " | " : "");
            flag_already_displayed = TRUE;
          } /* end if */
        ...
        {
          H5D_scatter_func_t sop =
              (H5D_scatter_func_t)va_arg(ap, H5D_scatter_func_t);
      ...
      case 'E':
        ...
        {
          H5ES_event_complete_func_t cfunc = (H5ES_event_complete_func_t)va_arg(
              ap, H5ES_event_complete_func_t);
      ...
      case 'F':
        ...
        case 'C': /* H5FD_class_t */
        {
          ...
          H5RS_asprintf_cat(rs, "{'%s', %" PRIuHADDR ", ", cls.name,
                            cls.maxaddr);
        ...
        case 'f': /* H5F_fspace_strategy_t */
        {
          H5F_fspace_strategy_t fs_strategy =
              (H5F_fspace_strategy_t)va_arg(ap, int);
        ...
        case 'I': /* H5F_info2_t */
        {
          ...
          H5RS_asprintf_cat(rs, "{%u, %" PRIuHSIZE ", %" PRIuHSIZE "}, ",
                            fi2.free.version, fi2.free.meta_size,
                            fi2.free.tot_space);
          H5RS_asprintf_cat(
              rs, "{%u, %" PRIuHSIZE ", {%" PRIuHSIZE ", %" PRIuHSIZE "}}}",
        ...
        {
          H5F_file_space_type_t fspace_type =
              (H5F_file_space_type_t)va_arg(ap, int);
      ...
      case 'H':
        ...
        {
          H5_atclose_func_t cfunc =
              (H5_atclose_func_t)va_arg(ap, H5_atclose_func_t);
      ...
      case 'i': /* hid_t (and H5E_major_t / H5E_minor_t) */
      {
        ...
        if (H5P_DEFAULT == obj)
          ...
          switch (H5I_TYPE(
              obj)) { /* Use internal H5I macro instead of function call */
          case H5I_UNINIT:
            H5RS_asprintf_cat(rs, "0x%0llx (uninit - error)",
                              (unsigned long long)obj);
            break;

          case H5I_BADID:
            H5RS_asprintf_cat(rs, "0x%0llx (badid - error)",
                              (unsigned long long)obj);
            break;
          ...
          case H5I_VFL:
            H5RS_asprintf_cat(rs, "0x%0llx (file driver)",
                              (unsigned long long)obj);
            break;

          case H5I_VOL:
            H5RS_asprintf_cat(rs, "0x%0llx (VOL plugin)",
                              (unsigned long long)obj);
            break;

          case H5I_GENPROP_CLS:
            H5RS_asprintf_cat(rs, "0x%0llx (genprop class)",
                              (unsigned long long)obj);
            break;

          case H5I_GENPROP_LST:
            H5RS_asprintf_cat(rs, "0x%0llx (genprop list)",
                              (unsigned long long)obj);
            break;

          case H5I_ERROR_CLASS:
            H5RS_asprintf_cat(rs, "0x%0llx (err class)",
                              (unsigned long long)obj);
            break;
          ...
          case H5I_ERROR_STACK:
            H5RS_asprintf_cat(rs, "0x%0llx (err stack)",
                              (unsigned long long)obj);
            break;
          ...
          case H5I_EVENTSET:
            H5RS_asprintf_cat(rs, "0x%0llx (event set)",
                              (unsigned long long)obj);
            break;

          case H5I_NTYPES:
            H5RS_asprintf_cat(rs, "0x%0llx (ntypes - error)",
                              (unsigned long long)obj);
            break;

          default:
            H5RS_asprintf_cat(rs, "0x%0llx (unknown class)",
                              (unsigned long long)obj);
            break;
          } /* end switch */
        }   /* end else */
      ...
      case 'I':
        ...
        {
          H5I_iterate_func_t iiter =
              (H5I_iterate_func_t)va_arg(ap, H5I_iterate_func_t);
        ...
        {
          H5I_search_func_t isearch =
              (H5I_search_func_t)va_arg(ap, H5I_search_func_t);
      ...
      case 'P':
        ...
        case 'G': /* H5P_prp_get_func_t */
        {
          H5P_prp_get_func_t prp_get =
              (H5P_prp_get_func_t)va_arg(ap, H5P_prp_get_func_t);
        ...
        case 'S': /* H5P_prp_set_func_t */
        {
          H5P_prp_set_func_t prp_set =
              (H5P_prp_set_func_t)va_arg(ap, H5P_prp_set_func_t);
      ...
      case 'V':
        ...
        {
          H5VL_dataset_specific_t specific =
              (H5VL_dataset_specific_t)va_arg(ap, int);
        ...
        {
          H5VL_datatype_specific_t specific =
              (H5VL_datatype_specific_t)va_arg(ap, int);
        ...
        {
          H5VL_group_specific_t specific =
              (H5VL_group_specific_t)va_arg(ap, int);
        ...
        {
          H5VL_object_specific_t specific =
              (H5VL_object_specific_t)va_arg(ap, int);
        ...
        {
          H5VL_request_specific_t specific =
              (H5VL_request_specific_t)va_arg(ap, int);
        ...
        {
          H5VL_dataset_optional_t optional =
              (H5VL_dataset_optional_t)va_arg(ap, int);
        ...
        {
          H5VL_datatype_optional_t optional =
              (H5VL_datatype_optional_t)va_arg(ap, int);
        ...
        {
          H5VL_group_optional_t optional =
              (H5VL_group_optional_t)va_arg(ap, int);
        ...
        {
          H5VL_object_optional_t optional =
              (H5VL_object_optional_t)va_arg(ap, int);
        ...
        {
          H5VL_request_optional_t optional =
              (H5VL_request_optional_t)va_arg(ap, int);
      ...
      case 'Z':
        ...
        {
          H5Z_filter_func_t ffunc =
              (H5Z_filter_func_t)va_arg(ap, H5Z_filter_func_t);
  ...
  if (returning) {
    ...
    if (current_depth < last_call_depth) {
      ...
      if (H5_debug_g.ttimes) {
        ...
        HDsnprintf(tmp, sizeof(tmp), "%.6f",
                   (function_times.elapsed - running_times.elapsed));
