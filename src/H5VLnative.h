...
#define H5VL_NATIVE_DATASET_FORMAT_CONVERT 0 /* H5Dformat_convert (internal)   \
                                              */
#define H5VL_NATIVE_DATASET_GET_CHUNK_INDEX_TYPE                               \
  1 /* H5Dget_chunk_index_type      */
#define H5VL_NATIVE_DATASET_GET_CHUNK_STORAGE_SIZE                             \
  2                                          /* H5Dget_chunk_storage_size    */
#define H5VL_NATIVE_DATASET_GET_NUM_CHUNKS 3 /* H5Dget_num_chunks */
#define H5VL_NATIVE_DATASET_GET_CHUNK_INFO_BY_IDX                              \
  4 /* H5Dget_chunk_info            */
#define H5VL_NATIVE_DATASET_GET_CHUNK_INFO_BY_COORD                            \
  5                                       /* H5Dget_chunk_info_by_coord   */
#define H5VL_NATIVE_DATASET_CHUNK_READ 6  /* H5Dchunk_read                */
#define H5VL_NATIVE_DATASET_CHUNK_WRITE 7 /* H5Dchunk_write               */
#define H5VL_NATIVE_DATASET_GET_VLEN_BUF_SIZE                                  \
  8                                       /* H5Dvlen_get_buf_size         */
 ...
 *      routine must be updated.
 */
#define H5VL_NATIVE_FILE_CLEAR_ELINK_CACHE                                     \
  0 /* H5Fclear_elink_file_cache            */
#define H5VL_NATIVE_FILE_GET_FILE_IMAGE                                        \
  1 /* H5Fget_file_image                    */
#define H5VL_NATIVE_FILE_GET_FREE_SECTIONS                                     \
  2 /* H5Fget_free_sections                 */
#define H5VL_NATIVE_FILE_GET_FREE_SPACE                                        \
  3                                 /* H5Fget_freespace                     */
#define H5VL_NATIVE_FILE_GET_INFO 4 /* H5Fget_info1/2                       */
#define H5VL_NATIVE_FILE_GET_MDC_CONF                                          \
  5                                   /* H5Fget_mdc_config                    */
#define H5VL_NATIVE_FILE_GET_MDC_HR 6 /* H5Fget_mdc_hit_rate */
#define H5VL_NATIVE_FILE_GET_MDC_SIZE                                          \
  7                                 /* H5Fget_mdc_size                      */
#define H5VL_NATIVE_FILE_GET_SIZE 8 /* H5Fget_filesize                      */
#define H5VL_NATIVE_FILE_GET_VFD_HANDLE                                        \
  9 /* H5Fget_vfd_handle                    */
#define H5VL_NATIVE_FILE_RESET_MDC_HIT_RATE                                    \
  10 /* H5Freset_mdc_hit_rate_stats          */
#define H5VL_NATIVE_FILE_SET_MDC_CONFIG                                        \
  11 /* H5Fset_mdc_config                    */
#define H5VL_NATIVE_FILE_GET_METADATA_READ_RETRY_INFO                          \
  12 /* H5Fget_metadata_read_retry_info      */
#define H5VL_NATIVE_FILE_START_SWMR_WRITE                                      \
  13 /* H5Fstart_swmr_write                  */
#define H5VL_NATIVE_FILE_START_MDC_LOGGING                                     \
  14 /* H5Fstart_mdc_logging                 */
#define H5VL_NATIVE_FILE_STOP_MDC_LOGGING                                      \
  15 /* H5Fstop_mdc_logging                  */
#define H5VL_NATIVE_FILE_GET_MDC_LOGGING_STATUS                                \
  16 /* H5Fget_mdc_logging_status            */
#define H5VL_NATIVE_FILE_FORMAT_CONVERT                                        \
  17 /* H5Fformat_convert                    */
#define H5VL_NATIVE_FILE_RESET_PAGE_BUFFERING_STATS                            \
  18 /* H5Freset_page_buffering_stats        */
#define H5VL_NATIVE_FILE_GET_PAGE_BUFFERING_STATS                              \
  19 /* H5Fget_page_buffering_stats          */
#define H5VL_NATIVE_FILE_GET_MDC_IMAGE_INFO                                    \
  20                                /* H5Fget_mdc_image_info                */
#define H5VL_NATIVE_FILE_GET_EOA 21 /* H5Fget_eoa                           */
#define H5VL_NATIVE_FILE_INCR_FILESIZE                                         \
  22 /* H5Fincrement_filesize                */
#define H5VL_NATIVE_FILE_SET_LIBVER_BOUNDS                                     \
  23 /* H5Fset_latest_format/libver_bounds   */
#define H5VL_NATIVE_FILE_GET_MIN_DSET_OHDR_FLAG                                \
  24 /* H5Fget_dset_no_attrs_hint            */
#define H5VL_NATIVE_FILE_SET_MIN_DSET_OHDR_FLAG                                \
  25 /* H5Fset_dset_no_attrs_hint            */
#ifdef H5_HAVE_PARALLEL
#define H5VL_NATIVE_FILE_GET_MPI_ATOMICITY                                     \
  26 /* H5Fget_mpi_atomicity                 */
#define H5VL_NATIVE_FILE_SET_MPI_ATOMICITY                                     \
  27 /* H5Fset_mpi_atomicity                 */
#endif
#define H5VL_NATIVE_FILE_POST_OPEN                                             \
  28 /* Adjust file after open, with wrapping context */
/* NOTE: If values over 1023 are added, the H5VL_RESERVED_NATIVE_OPTIONAL macro
 *      must be updated.
 */
...
typedef struct H5VL_native_file_get_mdc_size_t {
  ...
  size_t
      *min_clean_size; /* Minimum amount of cached data to keep clean (OUT) */
...
typedef union H5VL_native_file_optional_args_t {
  ...
  struct {
    hbool_t
        *minimize; /* Flag whether dataset object headers are minimal (OUT) */
  } get_min_dset_ohdr_flag;

  /* H5VL_NATIVE_FILE_SET_MIN_DSET_OHDR_FLAG */
  struct {
    hbool_t
        minimize; /* Flag whether dataset object headers should be minimal */
...
#define H5VL_NATIVE_GROUP_GET_OBJINFO                                          \
  1    /* HG5Gget_objinfo (deprecated routine) */
#endif /* H5_NO_DEPRECATED_SYMBOLS */
/* NOTE: If values over 1023 are added, the H5VL_RESERVED_NATIVE_OPTIONAL macro
 *      must be updated.
 */
 ...
 *      routine must be updated.
 */
#define H5VL_NATIVE_OBJECT_GET_COMMENT                                         \
  0 /* H5G|H5Oget_comment, H5Oget_comment_by_name   */
#define H5VL_NATIVE_OBJECT_SET_COMMENT                                         \
  1 /* H5G|H5Oset_comment, H5Oset_comment_by_name   */
#define H5VL_NATIVE_OBJECT_DISABLE_MDC_FLUSHES                                 \
  2 /* H5Odisable_mdc_flushes                       */
#define H5VL_NATIVE_OBJECT_ENABLE_MDC_FLUSHES                                  \
  3 /* H5Oenable_mdc_flushes                        */
#define H5VL_NATIVE_OBJECT_ARE_MDC_FLUSHES_DISABLED                            \
  4 /* H5Oare_mdc_flushes_disabled                  */
#define H5VL_NATIVE_OBJECT_GET_NATIVE_INFO                                     \
  5 /* H5Oget_native_info(_by_idx, _by_name)        */
/* NOTE: If values over 1023 are added, the H5VL_RESERVED_NATIVE_OPTIONAL macro
 *      must be updated.
 */
...
typedef union H5VL_native_object_optional_args_t {
  ...
  struct {
    hbool_t *flag; /* Flag whether metadata cache flushes are disabled for this
                      object (OUT) */
 ...
 * \ingroup H5VLNAT
 */
H5_DLL herr_t H5VLnative_addr_to_token(hid_t loc_id, haddr_t addr,
                                       H5O_token_t *token);
/**
 * \ingroup H5VLNAT
 */
H5_DLL herr_t H5VLnative_token_to_addr(hid_t loc_id, H5O_token_t token,
                                       haddr_t *addr);
