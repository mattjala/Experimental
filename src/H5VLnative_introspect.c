...
/*
 * Purpose:     Connector/container introspection callbacks for the native VOL
 * connector
 *
 */
...
/* Note: H5VL__native_introspect_get_conn_cls and
 * H5VL__native_introspect_get_cap_flags are in src/H5VLnative.c so that they
 * can work with the statically declared class struct.
 */
 ...
 *---------------------------------------------------------------------------
 */
herr_t H5VL__native_introspect_opt_query(void H5_ATTR_UNUSED *obj,
  ...
  *flags = H5VL_OPT_QUERY_SUPPORTED;
  ...
  case H5VL_SUBCLS_NONE:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional 'none' operation");

  case H5VL_SUBCLS_INFO:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional info operation");

  case H5VL_SUBCLS_WRAP:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional wrapper operation");
  ...
  case H5VL_SUBCLS_ATTR:
    ...
    default:
      HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                  "unknown optional attribute operation");
      break;
    } /* end switch */
    break;
  ...
  case H5VL_SUBCLS_DATASET:
    ...
    default:
      HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                  "unknown optional dataset operation");
      break;
    } /* end switch */
    break;
  ...
  case H5VL_SUBCLS_DATATYPE:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional datatype operation");
  ...
  case H5VL_SUBCLS_FILE:
    ...
    default:
      HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                  "unknown optional file operation");
      break;
    } /* end switch */
    break;
  ...
  case H5VL_SUBCLS_GROUP:
    ...
    default:
      HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                  "unknown optional group operation");
      break;
    } /* end switch */
    break;
  ...
  case H5VL_SUBCLS_LINK:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional link operation");
  ...
  case H5VL_SUBCLS_OBJECT:
    ...
    default:
      HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                  "unknown optional object operation");
      break;
    } /* end switch */
    break;
  ...
  case H5VL_SUBCLS_REQUEST:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional request operation");

  case H5VL_SUBCLS_BLOB:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional blob operation");

  case H5VL_SUBCLS_TOKEN:
    HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL,
                "unknown optional token operation");
