...
typedef enum H5FA_cls_id_t {
  H5FA_CLS_CHUNK_ID =
      0, /* Fixed array is for indexing dataset chunks w/o filters   */
  H5FA_CLS_FILT_CHUNK_ID, /* Fixed array is for indexing dataset chunks
                             w/filters     */
...
typedef struct H5FA_create_t {
  ...
  uint8_t max_dblk_page_nelmts_bits; /* Log2(Max. # of elements in a data block
