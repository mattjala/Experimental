...
typedef enum H5VL_datatype_get_t {
  H5VL_DATATYPE_GET_BINARY_SIZE, /* Get size of serialized form of transient
                                    type */
...
/* Typedef and values for native VOL connector named datatype optional VOL
 * operations */
...
typedef struct H5VL_file_specific_args_t {
  ...
  union {
    ...
    struct {
      ...
      hbool_t
          *accessible; /* Whether file is accessible with FAPL settings (OUT) */
    } is_accessible;
...
typedef struct H5VL_link_create_args_t {
  ...
  union {
    ...
    struct {
      ...
      H5VL_loc_params_t
          curr_loc_params; /* Location parameters for current object */
    } hard;
...
typedef struct H5VL_object_visit_args_t {
  H5_index_t idx_type;   /* Type of index to iterate over */
  H5_iter_order_t order; /* Order of index iteration */
  unsigned fields;   /* Flags for fields to provide in 'info' object for 'op'
                        callback */
...
typedef enum H5VL_request_status_t {
  ...
  H5VL_REQUEST_STATUS_CANT_CANCEL, /* An attempt to cancel this operation was
                                      made, but it  */
...
typedef struct H5VL_info_class_t {
  ...
  void *(*copy)(
      const void *info); /* Callback to create a copy of the VOL info    */
  herr_t (*cmp)(int *cmp_value, const void *info1,
                const void *info2); /* Callback to compare VOL info */
  herr_t (*free)(void *info); /* Callback to release a VOL info               */
  herr_t (*to_str)(
      const void *info,
      char **str); /* Callback to serialize connector's info into a string */
  herr_t (*from_str)(
      const char *str,
...
typedef struct H5VL_wrap_class_t {
  void *(*get_object)(
      const void *obj); /* Callback to retrieve underlying object       */
  herr_t (*get_wrap_ctx)(
      const void *obj,
  ...
  herr_t (*free_wrap_ctx)(
      void *wrap_ctx); /* Callback to release the object wrapping context for
                          the connector */
} H5VL_wrap_class_t;

/* H5A routines */
typedef struct H5VL_attr_class_t {
  void *(*create)(void *obj, const H5VL_loc_params_t *loc_params,
  ...
  void *(*open)(void *obj, const H5VL_loc_params_t *loc_params,
                ...
                void **req);
  herr_t (*read)(void *attr, hid_t mem_type_id, void *buf, hid_t dxpl_id,
                 void **req);
  herr_t (*write)(void *attr, hid_t mem_type_id, const void *buf, hid_t dxpl_id,
                  void **req);
...
typedef struct H5VL_dataset_class_t {
  ...
  herr_t (*read)(size_t count, void *dset[], hid_t mem_type_id[],
                 hid_t mem_space_id[], hid_t file_space_id[], hid_t dxpl_id,
                 void *buf[], void **req);
  herr_t (*write)(size_t count, void *dset[], hid_t mem_type_id[],
                  hid_t mem_space_id[], hid_t file_space_id[], hid_t dxpl_id,
                  const void *buf[], void **req);
  herr_t (*get)(void *obj, H5VL_dataset_get_args_t *args, hid_t dxpl_id,
                void **req);
  herr_t (*specific)(void *obj, H5VL_dataset_specific_args_t *args,
...
typedef struct H5VL_datatype_class_t {
  void *(*commit)(void *obj, const H5VL_loc_params_t *loc_params,
                  const char *name, hid_t type_id, hid_t lcpl_id, hid_t tcpl_id,
                  hid_t tapl_id, hid_t dxpl_id, void **req);
  void *(*open)(void *obj, const H5VL_loc_params_t *loc_params,
                const char *name, hid_t tapl_id, hid_t dxpl_id, void **req);
  herr_t (*get)(void *obj, H5VL_datatype_get_args_t *args, hid_t dxpl_id,
                void **req);
  herr_t (*specific)(void *obj, H5VL_datatype_specific_args_t *args,
                     hid_t dxpl_id, void **req);
  herr_t (*optional)(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                     void **req);
...
typedef struct H5VL_file_class_t {
  ...
  void *(*open)(const char *name, unsigned flags, hid_t fapl_id, hid_t dxpl_id,
                void **req);
  herr_t (*get)(void *obj, H5VL_file_get_args_t *args, hid_t dxpl_id,
                void **req);
  herr_t (*specific)(void *obj, H5VL_file_specific_args_t *args, hid_t dxpl_id,
                     void **req);
  herr_t (*optional)(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                     void **req);
...
typedef struct H5VL_group_class_t {
  ...
  herr_t (*get)(void *obj, H5VL_group_get_args_t *args, hid_t dxpl_id,
                void **req);
...
typedef struct H5VL_link_class_t {
  ...
  herr_t (*move)(void *src_obj, const H5VL_loc_params_t *loc_params1,
                 void *dst_obj, const H5VL_loc_params_t *loc_params2,
                 hid_t lcpl_id, hid_t lapl_id, hid_t dxpl_id, void **req);
  herr_t (*get)(void *obj, const H5VL_loc_params_t *loc_params,
...
typedef herr_t (*H5VL_request_notify_t)(void *ctx,
...
typedef struct H5VL_introspect_class_t {
  ...
  herr_t (*opt_query)(void *obj, H5VL_subclass_t cls, int opt_type,
                      uint64_t *flags);
...
typedef struct H5VL_blob_class_t {
  herr_t (*put)(void *obj, const void *buf, size_t size, void *blob_id,
                void *ctx);
  herr_t (*get)(void *obj, const void *blob_id, void *buf, size_t size,
                void *ctx);
...
typedef struct H5VL_token_class_t {
  herr_t (*cmp)(void *obj, const H5O_token_t *token1, const H5O_token_t *token2,
                int *cmp_value);
  herr_t (*to_str)(void *obj, H5I_type_t obj_type, const H5O_token_t *token,
                   char **token_str);
...
typedef struct H5VL_class_t {
  ...
  herr_t (*initialize)(
      hid_t vipl_id);        /**< Connector initialization callback         */
  ...
  H5VL_introspect_class_t
      introspect_cls; /**< Container/connector introspection class callbacks */
  H5VL_request_class_t request_cls; /**< Asynchronous request class callbacks */
  H5VL_blob_class_t blob_cls;       /**< 'Blob' class callbacks */
  H5VL_token_class_t
      token_cls; /**< VOL connector object token class callbacks */
...
H5_DLL herr_t H5VLregister_opt_operation(H5VL_subclass_t subcls,
                                         const char *op_name, int *op_val);
H5_DLL herr_t H5VLfind_opt_operation(H5VL_subclass_t subcls,
                                     const char *op_name, int *op_val);
H5_DLL herr_t H5VLunregister_opt_operation(H5VL_subclass_t subcls,
                                           const char *op_name);
H5_DLL herr_t H5VLattr_optional_op(const char *app_file, const char *app_func,
...
H5_DLL herr_t H5VLdataset_optional_op(const char *app_file,
                                      ...
                                      hid_t dset_id, H5VL_optional_args_t *args,
...
H5_DLL herr_t H5VLdatatype_optional_op(const char *app_file,
                                       ...
                                       hid_t dxpl_id, hid_t es_id);
H5_DLL herr_t H5VLfile_optional_op(const char *app_file, const char *app_func,
                                   unsigned app_line, hid_t file_id,
                                   H5VL_optional_args_t *args, hid_t dxpl_id,
                                   hid_t es_id);
H5_DLL herr_t H5VLgroup_optional_op(const char *app_file, const char *app_func,
                                    unsigned app_line, hid_t group_id,
                                    H5VL_optional_args_t *args, hid_t dxpl_id,
                                    hid_t es_id);
H5_DLL herr_t H5VLlink_optional_op(const char *app_file, const char *app_func,
                                   unsigned app_line, hid_t loc_id,
                                   const char *name, hid_t lapl_id,
                                   H5VL_optional_args_t *args, hid_t dxpl_id,
                                   hid_t es_id);
H5_DLL herr_t H5VLobject_optional_op(const char *app_file, const char *app_func,
                                     unsigned app_line, hid_t loc_id,
                                     const char *name, hid_t lapl_id,
                                     H5VL_optional_args_t *args, hid_t dxpl_id,
                                     hid_t es_id);
H5_DLL herr_t H5VLrequest_optional_op(void *req, hid_t connector_id,
                                      H5VL_optional_args_t *args);
...
#define H5VLattr_optional_op(...)                                              \
  H5VLattr_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define H5VLdataset_optional_op(...)                                           \
  H5VLdataset_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define H5VLdatatype_optional_op(...)                                          \
  H5VLdatatype_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define H5VLfile_optional_op(...)                                              \
  H5VLfile_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define H5VLgroup_optional_op(...)                                             \
  H5VLgroup_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define H5VLlink_optional_op(...)                                              \
  H5VLlink_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define H5VLobject_optional_op(...)                                            \
  H5VLobject_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
