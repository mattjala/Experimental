...
H5_DLL herr_t H5R__create_object(const H5O_token_t *obj_token,
                                 size_t token_size, H5R_ref_priv_t *ref);
H5_DLL herr_t H5R__create_region(const H5O_token_t *obj_token,
                                 size_t token_size, H5S_t *space,
                                 H5R_ref_priv_t *ref);
H5_DLL herr_t H5R__create_attr(const H5O_token_t *obj_token, size_t token_size,
...
H5_DLL ssize_t H5R__get_file_name(const H5R_ref_priv_t *ref, char *buf,
                                  size_t size);
H5_DLL ssize_t H5R__get_attr_name(const H5R_ref_priv_t *ref, char *buf,
                                  size_t size);

H5_DLL herr_t H5R__encode(const char *filename, const H5R_ref_priv_t *ref,
                          unsigned char *buf, size_t *nalloc, unsigned flags);
H5_DLL herr_t H5R__decode(const unsigned char *buf, size_t *nbytes,
                          H5R_ref_priv_t *ref);

/* Native HDF5 specific routines */
H5_DLL herr_t H5R__encode_heap(H5F_t *f, unsigned char *buf, size_t *nalloc,
                               const unsigned char *data, size_t data_size);
H5_DLL herr_t H5R__decode_heap(H5F_t *f, const unsigned char *buf,
                               size_t *nbytes, unsigned char **data_ptr,
                               size_t *data_size);
...
H5_DLL herr_t H5R__decode_token_region_compat(
    H5F_t *f, const unsigned char *buf, size_t *nbytes, H5O_token_t *obj_token,
