...
typedef struct H5FD_onion_revision_index_hash_chain_node_t
...
extern "C" {
#endif
H5_DLL herr_t H5FD__onion_ingest_revision_record(
    H5FD_onion_revision_record_t *r_out, H5FD_t *raw_file,
    const H5FD_onion_history_t *history, uint64_t revision_num);

H5_DLL hbool_t
H5FD__onion_archival_index_is_valid(const H5FD_onion_archival_index_t *);
H5_DLL int H5FD__onion_archival_index_find(const H5FD_onion_archival_index_t *,
                                           uint64_t,
                                           const H5FD_onion_index_entry_t **);

H5_DLL H5FD_onion_revision_index_t *
...
H5_DLL herr_t H5FD__onion_revision_index_insert(
    H5FD_onion_revision_index_t *, const H5FD_onion_index_entry_t *);
...
H5_DLL herr_t H5FD__onion_merge_revision_index_into_archival_index(
    const H5FD_onion_revision_index_t *, H5FD_onion_archival_index_t *);

H5_DLL size_t H5FD__onion_revision_record_decode(
    unsigned char *buf, H5FD_onion_revision_record_t *record);
H5_DLL size_t
H5FD__onion_revision_record_encode(H5FD_onion_revision_record_t *record,
