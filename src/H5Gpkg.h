...
typedef herr_t (*H5G_bt_find_op_t)(const H5G_entry_t *ent /*in*/,
...
H5_DLL herr_t H5G__traverse_special(const H5G_loc_t *grp_loc,
                                    const H5O_link_t *lnk, unsigned target,
                                    hbool_t last_comp, H5G_loc_t *obj_loc,
                                    hbool_t *obj_exists);
...
H5_DLL herr_t H5G__stab_create(H5O_loc_t *grp_oloc, const H5O_ginfo_t *ginfo,
                               H5O_stab_t *stab);
H5_DLL herr_t H5G__stab_create_components(H5F_t *f, H5O_stab_t *stab,
                                          size_t size_hint);
...
H5_DLL herr_t H5G__stab_insert_real(H5F_t *f, const H5O_stab_t *stab,
                                    const char *name, H5O_link_t *obj_lnk,
...
H5_DLL herr_t H5G__stab_get_name_by_idx(const H5O_loc_t *oloc,
 ...
 */
H5_DLL void H5G__ent_copy(H5G_entry_t *dst, H5G_entry_t *src,
...
H5_DLL herr_t H5G__ent_decode_vec(const H5F_t *f, const uint8_t **pp,
                                  const uint8_t *p_end, H5G_entry_t *ent,
                                  unsigned n);
...
H5_DLL herr_t H5G__ent_convert(H5F_t *f, H5HL_t *heap, const char *name,
                               const H5O_link_t *lnk, H5O_type_t obj_type,
...
H5_DLL int H5G__node_build_table(H5F_t *f, const void *_lt_key, haddr_t addr,
                                 const void *_rt_key, void *_udata);
H5_DLL herr_t H5G__node_iterate_size(H5F_t *f, const void *_lt_key,
                                     haddr_t addr, const void *_rt_key,
                                     void *_udata);
...
H5_DLL herr_t H5G__compact_iterate(const H5O_loc_t *oloc,
                                   ...
                                   hsize_t skip, hsize_t *last_lnk,
                                   H5G_lib_iterate_t op, void *op_data);
H5_DLL herr_t H5G__compact_lookup(const H5O_loc_t *grp_oloc, const char *name,
                                  hbool_t *found, H5O_link_t *lnk);
...
H5_DLL herr_t H5G__dense_insert(H5F_t *f, const H5O_linfo_t *linfo,
                                const H5O_link_t *lnk);
H5_DLL herr_t H5G__dense_lookup(H5F_t *f, const H5O_linfo_t *linfo,
                                const char *name, hbool_t *found,
                                H5O_link_t *lnk);
...
H5_DLL herr_t H5G__dense_iterate(H5F_t *f, const H5O_linfo_t *linfo,
                                 ...
                                 hsize_t skip, hsize_t *last_lnk,
                                 H5G_lib_iterate_t op, void *op_data);
H5_DLL herr_t H5G__dense_get_name_by_idx(H5F_t *f, H5O_linfo_t *linfo,
                                         H5_index_t idx_type,
                                         H5_iter_order_t order, hsize_t n,
                                         char *name, size_t name_size,
                                         size_t *name_len);
...
H5_DLL herr_t H5G__obj_iterate(const H5O_loc_t *grp_oloc, H5_index_t idx_type,
                               H5_iter_order_t order, hsize_t skip,
                               hsize_t *last_lnk, H5G_lib_iterate_t op,
                               void *op_data);
H5_DLL herr_t H5G__obj_info(const H5O_loc_t *oloc, H5G_info_t *grp_info);
H5_DLL herr_t H5G__obj_lookup(const H5O_loc_t *grp_oloc, const char *name,
                              hbool_t *found, H5O_link_t *lnk);
 ...
 */
H5_DLL herr_t H5G__loc_insert(H5G_loc_t *grp_loc, char *name,
                              H5G_loc_t *obj_loc, H5O_type_t obj_type,
                              const void *crt_info);
...
H5_DLL herr_t H5G__new_dense_info_test(hid_t gid, hsize_t *name_count,
                                       hsize_t *corder_count);
H5_DLL herr_t H5G__lheap_size_test(hid_t gid, size_t *lheap_size);
H5_DLL herr_t H5G__user_path_test(hid_t obj_id, char *user_path,
