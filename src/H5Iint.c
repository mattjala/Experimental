...
#define H5I_MAKE(g, i)                                                         \
  ((((hid_t)(g)&TYPE_MASK) << ID_BITS) | ((hid_t)(i)&ID_MASK))

/******************/
/* Local Typedefs */
/******************/

/* User data for iterator callback for retrieving an ID corresponding to an
 * object pointer */
typedef struct {
...
typedef struct {
  ...
  hbool_t
      have_global_mutex; /* whether the global mutex is held by this thread */
} H5I_iterate_ud_t;
...
static herr_t H5I__unwrap(void *object, H5I_type_t type,
                          void **unwrapped_object_ptr);
...
H5I__new_mt_id_info(hid_t id, unsigned count, unsigned app_count,
                    const void *object, hbool_t is_future,
...
static H5I_mt_type_info_t *H5I__new_mt_type_info(const H5I_class_t *cls,
                                                 unsigned reserved);
#endif /* H5_HAVE_MULTITHREAD */
...
herr_t H5I_init(void) {
  ...
  atomic_init(&(H5I_mt_g.max_desired_id_info_fl_len),
              H5I__MAX_DESIRED_ID_INFO_FL_LEN);
  atomic_init(&(H5I_mt_g.num_id_info_fl_entries_reallocable), 0ULL);

  /* allocate the initial entry in the id info free list and initialize the id
   * info free list */
  id_info_ptr = H5I__new_mt_id_info(0, 0, 0, NULL, FALSE, NULL, NULL);
  if (NULL == id_info_ptr)
    HGOTO_ERROR(H5E_ID, H5E_CANTINIT, FAIL,
                "Can't initialize id info free list");
  ...
  /* allocate the initial entry in the type info free list and initialize the
   * type info free list */
  ...
  atomic_init(&(H5I_mt_g.max_desired_type_info_fl_len),
              H5I__MAX_DESIRED_TYPE_INFO_FL_LEN);
#if 1
  ...
  if (NULL == type_info_ptr)
    HGOTO_ERROR(H5E_ID, H5E_CANTINIT, FAIL,
                "Can't initialize type info free list");
  ...
  atomic_init(&(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small),
              0ULL);
  atomic_init(
  ...
  atomic_init(&(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions),
              0ULL);
  ...
  atomic_init(
      &(H5I_mt_g
            .num_type_info_fl_alloc_req_denied_due_to_no_reallocable_entries),
      0ULL);
  atomic_init(&(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_empty), 0ULL);
  atomic_init(&(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_fl_too_small),
              0ULL);
  atomic_init(
  ...
  atomic_init(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_discard_cb),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_discard_cb),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_free_func),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_free_func),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__find_id__global_mutex_locks_for_realize_cb),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_realize_cb),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__find_id__global_mutex_locks_for_discard_cb),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_discard_cb),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I_register_using_existing_id__num_marked_only),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I_register_using_existing_id__num_id_already_in_use),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__iterate_cb__global_mutex_locks_for_user_func),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__iterate_cb__global_mutex_unlocks_for_user_func),
              0ULL);
  ...
  atomic_init(&(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL),
              0ULL);
  atomic_init(&(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T), 0ULL);
  atomic_init(&(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T),
              0ULL);
...
void H5I_clear_stats(void) {
  ...
  atomic_store(&(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small),
               0ULL);
  atomic_store(
      &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_no_reallocable_entries),
      0ULL);
  ...
  atomic_store(&(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_empty),
               0ULL);
  atomic_store(
      &(H5I_mt_g
            .num_type_info_fl_alloc_req_denied_due_to_no_reallocable_entries),
  ...
  atomic_store(&(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_fl_too_small),
               0ULL);
  atomic_store(
      &(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_no_reallocable_entries),
      0ULL);
  atomic_store(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts),
               0ULL);
  atomic_store(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_noops), 0ULL);
  atomic_store(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__mark_node__num_calls_without_global_mutex),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_discard_cb),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_discard_cb),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_free_func),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_free_func),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__find_id__global_mutex_locks_for_realize_cb),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_realize_cb),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__find_id__global_mutex_locks_for_discard_cb),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_discard_cb),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I_register_using_existing_id__num_marked_only),
               0ULL);
  atomic_store(
      &(H5I_mt_g.H5I_register_using_existing_id__num_id_already_in_use), 0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__dec_ref__global_mutex_locks_for_free_func),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__iterate_cb__global_mutex_locks_for_user_func),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__iterate_cb__global_mutex_unlocks_for_user_func),
               0ULL);
  ...
  atomic_store(&(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T),
               0ULL);
  atomic_store(&(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T),
               0ULL);
 ...
 *-------------------------------------------------------------------------
 */
void H5I_dump_stats(FILE *file_ptr) {
  FUNC_ENTER_NOAPI_NOERR
  ...
  fprintf(
      file_ptr,
      "H5I_mt_g.init_type_registrations                                       "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.init_type_registrations))));
  fprintf(file_ptr,
          "H5I_mt_g.duplicate_type_registrations                               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.duplicate_type_registrations))));
  fprintf(file_ptr,
          "H5I_mt_g.type_registration_collisions                               "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.type_registration_collisions))));

  fprintf(file_ptr,
          "H5I_mt_g.id_info_fl_len                                             "
          "   = %lld\n",
  ...
  fprintf(file_ptr,
          ...
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_entries_reallocable))));
  fprintf(file_ptr,
          "H5I_mt_g.max_id_info_fl_len                                         "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.max_id_info_fl_len))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_structs_alloced_from_heap                      "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_structs_alloced_from_heap))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_structs_alloced_from_fl                        "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_structs_alloced_from_fl))));
  fprintf(
      file_ptr,
      "H5I_mt_g.num_id_info_structs_freed                                     "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.num_id_info_structs_freed))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_structs_added_to_fl                            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_structs_added_to_fl))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_head_update_cols                            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_head_update_cols))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_tail_update_cols                            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_tail_update_cols))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_append_cols                                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_append_cols))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_structs_marked_reallocatable                   "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_structs_marked_reallocatable))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_alloc_req_denied_due_to_empty               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_alloc_req_denied_due_to_empty))));
  fprintf(
      ...
      (unsigned long long)(atomic_load(&(
          H5I_mt_g
              .num_id_info_fl_alloc_req_denied_due_to_no_reallocable_entries))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_frees_skipped_due_to_empty                  "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_empty))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small))));
  fprintf(
      ...
      (unsigned long long)(atomic_load(
          &(H5I_mt_g
                .num_id_info_fl_frees_skipped_due_to_no_reallocable_entries))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_num_reallocable_update_aborts               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_num_reallocable_update_aborts))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_num_reallocable_update_noops                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_num_reallocable_update_noops))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_num_reallocable_updates                     "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_num_reallocable_updates))));
  fprintf(file_ptr,
          "H5I_mt_g.num_id_info_fl_num_reallocable_total                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_id_info_fl_num_reallocable_total))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__discard_mt_id_info__num_calls                         "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__discard_mt_id_info__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__new_mt_id_info__num_calls                             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__new_mt_id_info__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__clear_mt_id_info_free_list__num_calls                 "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__clear_mt_id_info_free_list__num_calls))));

  fprintf(file_ptr,
          "H5I_mt_g.type_info_fl_len                                           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.type_info_fl_len))));
#if 1
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_entries_reallocable                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_entries_reallocable))));
#else
...
#endif
  fprintf(file_ptr,
          "H5I_mt_g.max_type_info_fl_len                                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.max_type_info_fl_len))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_structs_alloced_from_heap                    "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_structs_alloced_from_heap))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_structs_alloced_from_fl                      "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_structs_alloced_from_fl))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_structs_freed                                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_structs_freed))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_structs_added_to_fl                          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_structs_added_to_fl))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_head_update_cols                          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_head_update_cols))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_tail_update_cols                          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_tail_update_cols))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_append_cols                               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_append_cols))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_structs_marked_reallocatable                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_structs_marked_reallocatable))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_empty             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_empty))));
  fprintf(
      file_ptr,
      "H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_no_reallocable_"
      "entries = %lld\n",
      (unsigned long long)(atomic_load(&(
          H5I_mt_g
              .num_type_info_fl_alloc_req_denied_due_to_no_reallocable_entries))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_frees_skipped_due_to_empty                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_empty))));
  fprintf(file_ptr,
  ...
  fprintf(
      ...
      (unsigned long long)(atomic_load(&(
          H5I_mt_g
              .num_type_info_fl_frees_skipped_due_to_no_reallocable_entries))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_num_reallocable_update_noops              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_num_reallocable_update_noops))));
  fprintf(file_ptr,
          ...
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_num_reallocable_updates                   "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_num_reallocable_updates))));
  fprintf(file_ptr,
          "H5I_mt_g.num_type_info_fl_num_reallocable_total                     "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_type_info_fl_num_reallocable_total))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__discard_type_id_info__num_calls                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__discard_mt_type_info__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__new_mt_type_info__num_calls                           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__new_mt_type_info__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__clear_mt_type_info_free_list__num_calls               "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__clear_mt_type_info_free_list__num_calls))));
  ...
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__mark_node__num_calls                                     "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__num_calls_with_global_mutex                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__num_calls_with_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__num_calls_without_global_mutex             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__num_calls_without_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__already_marked                             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__already_marked))));
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__mark_node__marked                                        "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__marked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__marked_by_another_thread                   "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__marked_by_another_thread))));
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__mark_node__no_ops                                        "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__no_ops))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__global_mutex_locks_for_discard_cb          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_discard_cb))));
  fprintf(file_ptr,
          ...
          (unsigned long long)(atomic_load(&(
              H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_discard_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__discard_cb_failures_marked                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__discard_cb_failures_marked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__discard_cb_failures_unmarked               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__discard_cb_failures_unmarked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__discard_cb_successes                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__discard_cb_successes))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__global_mutex_locks_for_free_func           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_free_func))));
  fprintf(file_ptr,
          ...
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_free_func))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__free_func_failures_marked                  "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__free_func_failures_marked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__free_func_failures_unmarked                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__free_func_failures_unmarked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__mark_node__free_func_successes                        "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__mark_node__free_func_successes))));
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__mark_node__retries                                       "
      "= %lld\n\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__retries))));

  fprintf(file_ptr,
          "H5I_mt_g.H5I__remove_common__num_calls                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__remove_common__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__remove_common__already_marked                         "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__remove_common__already_marked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__remove_common__marked_by_another_thread               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__remove_common__marked_by_another_thread))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__remove_common__marked                                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__remove_common__marked))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__remove_common__target_not_in_lfht                     "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__remove_common__target_not_in_lfht))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__remove_common__retries                                "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__remove_common__retries))));
  ...
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__find_id__num_calls                                       "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__find_id__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__num_calls_with_global_mutex                  "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__num_calls_with_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__num_calls_without_global_mutex               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__num_calls_without_global_mutex))));
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__find_id__ids_found                                       "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__find_id__ids_found))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__num_calls_to_realize_cb                      "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__num_calls_to_realize_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__global_mutex_locks_for_realize_cb            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__global_mutex_locks_for_realize_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_realize_cb          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_realize_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__num_calls_to_H5I__remove_common              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__num_calls_to_H5I__remove_common))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__num_calls_to_discard_cb                      "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__num_calls_to_discard_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__global_mutex_locks_for_discard_cb            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__global_mutex_locks_for_discard_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_discard_cb          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_discard_cb))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__future_id_conversions_attempted              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__future_id_conversions_attempted))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__future_id_conversions_completed              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__find_id__future_id_conversions_completed))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__find_id__retries                                      "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__find_id__retries))));

  fprintf(file_ptr,
          "H5I_mt_g.H5I_register_using_existing_id__num_calls                  "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_register_using_existing_id__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_register_using_existing_id__num_marked_only            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_register_using_existing_id__num_marked_only))));
  fprintf(
      ...
      (unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_register_using_existing_id__num_id_already_in_use))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_register_using_existing_id__num_failures               "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_register_using_existing_id__num_failures))));
  ...
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__num_calls                                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I_subst__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__num_calls__with_global_mutex                    "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_subst__num_calls__with_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__num_calls__without_global_mutex                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_subst__num_calls__without_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__marked_on_entry                                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_subst__marked_on_entry))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__marked_during_call                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_subst__marked_during_call))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__retries                                         "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I_subst__retries))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_subst__failures                                        "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I_subst__failures))));

  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__dec_ref__num_calls                                       "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__num_app_calls                                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__num_app_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__num_calls_with_global_mutex                  "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__num_calls_with_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__num_calls_without_global_mutex               "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__num_calls_without_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__marked_on_entry                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__marked_on_entry))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__marked_during_call                           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__marked_during_call))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__marked                                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__marked))));
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__dec_ref__decremented                                     "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__decremented))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__app_decremented                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__app_decremented))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__calls_to_free_func                           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__calls_to_free_func))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__global_mutex_locks_for_free_func             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__global_mutex_locks_for_free_func))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__free_func_failed                             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__dec_ref__free_func_failed))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__dec_ref__retries                                      "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__retries))));

  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__inc_ref__num_calls                                       "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__inc_ref__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__inc_ref__num_app_calls                                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__inc_ref__num_app_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__inc_ref__marked_on_entry                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__inc_ref__marked_on_entry))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__inc_ref__marked_during_call                           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__inc_ref__marked_during_call))));
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__inc_ref__incremented                                     "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__inc_ref__incremented))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__inc_ref__app_incremented                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__inc_ref__app_incremented))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__inc_ref__retries                                      "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__inc_ref__retries))));

  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_calls                                 "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_calls__with_global_mutex              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_calls__with_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__marked_during_call                        "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__marked_during_call))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_user_func_calls                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_user_func_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__global_mutex_locks_for_user_func          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__global_mutex_locks_for_user_func))));
  fprintf(file_ptr,
          ...
          (unsigned long long)(atomic_load(&(
              H5I_mt_g.H5I__iterate_cb__global_mutex_unlocks_for_user_func))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_user_func_successes                   "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_user_func_successes))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_user_func_iter_stops                  "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_user_func_iter_stops))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_user_func_fails                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_user_func_fails))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_user_func_skips                       "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_user_func_skips))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__iterate_cb__num_retries                               "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__iterate_cb__num_retries))));
  ...
  fprintf(
      file_ptr,
      "H5I_mt_g.H5I__unwrap__num_calls                                        "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.H5I__unwrap__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__unwrap__num_calls_with_global_mutex                   "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__unwrap__num_calls_with_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__unwrap__num_calls_without_global_mutex                "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__unwrap__num_calls_without_global_mutex))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL            "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL          "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T           "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T))));

  fprintf(file_ptr,
          "H5I_mt_g.H5I_is_file_object__num_calls                              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_is_file_object__num_calls))));
  fprintf(file_ptr,
          "H5I_mt_g.H5I_is_file_object__num_calls_to_H5T_is_named              "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.H5I_is_file_object__num_calls_to_H5T_is_named))));
  fprintf(
  ...
  fprintf(
      ...
      (unsigned long long)(atomic_load(
          &(H5I_mt_g
                .H5I_is_file_object__global_mutex_unlocks_for_H5T_is_named))));

  fprintf(
      file_ptr,
      "H5I_mt_g.num_do_not_disturb_yields                                     "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.num_do_not_disturb_yields))));
  fprintf(file_ptr,
          "H5I_mt_g.num_successful_do_not_disturb_sets                         "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_successful_do_not_disturb_sets))));
  fprintf(file_ptr,
          "H5I_mt_g.num_failed_do_not_disturb_sets                             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_failed_do_not_disturb_sets))));
  fprintf(
      file_ptr,
      "H5I_mt_g.num_do_not_disturb_resets                                     "
      "= %lld\n",
      (unsigned long long)(atomic_load(&(H5I_mt_g.num_do_not_disturb_resets))));
  fprintf(file_ptr,
          "H5I_mt_g.num_do_not_disturb_bypasses                                "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_do_not_disturb_bypasses))));

  fprintf(file_ptr,
          "H5I_mt_g.num_H5I_entries_via_public_API                             "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_H5I_entries_via_public_API))));
  fprintf(file_ptr,
          "H5I_mt_g.num_H5I_entries_via_internal_API                           "
          "   = %lld\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.num_H5I_entries_via_internal_API))));
  fprintf(file_ptr,
          "H5I_mt_g.max_active_threads                                         "
          "   = %lld\n",
          (unsigned long long)(atomic_load(&(H5I_mt_g.max_active_threads))));
  fprintf(file_ptr,
          "H5I_mt_g.times_active_threads_is_zero                               "
          "   = %lld\n\n",
          (unsigned long long)(atomic_load(
              &(H5I_mt_g.times_active_threads_is_zero))));
 ...
 *-------------------------------------------------------------------------
 */
void H5I_dump_nz_stats(FILE *file_ptr, const char *tag) {
  FUNC_ENTER_NOAPI_NOERR
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.init_type_registrations))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.init_type_registrations                                      "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.duplicate_type_registrations))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.duplicate_type_registrations                             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.type_registration_collisions))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.type_registration_collisions                             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_structs_alloced_from_heap))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_structs_alloced_from_heap                    "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_structs_alloced_from_fl))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_structs_alloced_from_fl                      "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.num_id_info_structs_freed))) >
      0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_structs_freed                                "
            "     = %lld\n",
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_structs_added_to_fl))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_structs_added_to_fl                          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_head_update_cols))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_head_update_cols                          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_tail_update_cols))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_tail_update_cols                          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_append_cols))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_append_cols                               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_structs_marked_reallocatable))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_structs_marked_reallocatable                 "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_alloc_req_denied_due_to_empty))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_alloc_req_denied_due_to_empty             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
    ...
    fprintf(
        file_ptr,
        "H5I_mt_g.num_id_info_fl_alloc_req_denied_due_to_no_reallocable_"
        "entries = %lld\n",
        (unsigned long long)(atomic_load(&(
            H5I_mt_g
                .num_id_info_fl_alloc_req_denied_due_to_no_reallocable_entries))));
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_empty))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_frees_skipped_due_to_empty                "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_num_reallocable_update_aborts))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_num_reallocable_update_aborts             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_num_reallocable_update_noops))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_num_reallocable_update_noops              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_num_reallocable_updates))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_num_reallocable_updates                   "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_id_info_fl_num_reallocable_total))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_id_info_fl_num_reallocable_total                     "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__discard_mt_id_info__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__discard_mt_id_info__num_calls                       "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__new_mt_id_info__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__new_mt_id_info__num_calls                           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__clear_mt_id_info_free_list__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__clear_mt_id_info_free_list__num_calls               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.max_type_info_fl_len))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.max_type_info_fl_len                                         "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_structs_alloced_from_heap))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_structs_alloced_from_heap                  "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_structs_alloced_from_fl))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_structs_alloced_from_fl                    "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_structs_freed))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_structs_freed                              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_structs_added_to_fl))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_structs_added_to_fl                        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_head_update_cols))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_head_update_cols                        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_tail_update_cols))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_tail_update_cols                        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_append_cols))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_append_cols                             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_structs_marked_reallocatable))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_structs_marked_reallocatable               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_empty))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_empty           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_empty))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_frees_skipped_due_to_empty              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.num_type_info_fl_frees_skipped_due_to_fl_too_small))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_frees_skipped_due_to_fl_too_small       "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_num_reallocable_update_noops))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_num_reallocable_update_noops            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions       "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_num_reallocable_updates))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_num_reallocable_updates                 "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_type_info_fl_num_reallocable_total))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_type_info_fl_num_reallocable_total                   "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__discard_mt_type_info__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__discard_mt_type_info__num_calls                     "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__new_mt_type_info__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__new_mt_type_info__num_calls                         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__clear_mt_type_info_free_list__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__clear_mt_type_info_free_list__num_calls             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__num_calls))) >
      0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__num_calls                                "
            "     = %lld\n",
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__num_calls_with_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__num_calls_with_global_mutex              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__num_calls_without_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__num_calls_without_global_mutex           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__already_marked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__already_marked                           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__marked))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__mark_node__marked                                       "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__marked_by_another_thread))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__marked_by_another_thread                 "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__no_ops))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__mark_node__no_ops                                       "
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.H5I__mark_node__global_mutex_locks_for_discard_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__global_mutex_locks_for_discard_cb        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__discard_cb_failures_marked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__discard_cb_failures_marked               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__discard_cb_failures_unmarked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__discard_cb_failures_unmarked             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__discard_cb_successes))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__discard_cb_successes                     "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__global_mutex_locks_for_free_func))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__global_mutex_locks_for_free_func         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_free_func))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__global_mutex_unlocks_for_free_func       "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__free_func_failures_marked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__free_func_failures_marked                "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__free_func_failures_unmarked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__free_func_failures_unmarked              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__mark_node__free_func_successes))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__mark_node__free_func_successes                      "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__mark_node__retries))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__mark_node__retries                                      "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__remove_common__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__remove_common__num_calls                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__remove_common__already_marked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__remove_common__already_marked                       "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__remove_common__marked_by_another_thread))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__remove_common__marked_by_another_thread             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__remove_common__marked))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__remove_common__marked                               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__remove_common__target_not_in_lfht))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__remove_common__target_not_in_lfht                   "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__remove_common__retries))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__remove_common__retries                              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__find_id__num_calls))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__find_id__num_calls                                      "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__num_calls_with_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__num_calls_with_global_mutex                "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__num_calls_without_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__num_calls_without_global_mutex             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__find_id__ids_found))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__find_id__ids_found                                      "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__num_calls_to_realize_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__num_calls_to_realize_cb                    "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__global_mutex_locks_for_realize_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__global_mutex_locks_for_realize_cb          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_realize_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_realize_cb        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__num_calls_to_H5I__remove_common))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__num_calls_to_H5I__remove_common            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__num_calls_to_discard_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__num_calls_to_discard_cb                    "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__global_mutex_locks_for_discard_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__global_mutex_locks_for_discard_cb          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_discard_cb))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__global_mutex_unlocks_for_discard_cb        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__future_id_conversions_attempted))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__future_id_conversions_attempted            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__find_id__future_id_conversions_completed))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__find_id__future_id_conversions_completed            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__find_id__retries))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__find_id__retries                                        "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_register_using_existing_id__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_register_using_existing_id__num_calls                "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_register_using_existing_id__num_marked_only))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_register_using_existing_id__num_marked_only          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_register_using_existing_id__num_failures))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_register_using_existing_id__num_failures             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I_subst__num_calls))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I_subst__num_calls                                         "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_subst__num_calls__with_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_subst__num_calls__with_global_mutex                  "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_subst__num_calls__without_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_subst__num_calls__without_global_mutex               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_subst__marked_on_entry))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_subst__marked_on_entry                               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_subst__marked_during_call))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_subst__marked_during_call                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__num_calls))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__dec_ref__num_calls                                      "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__num_app_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__num_app_calls                              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__num_calls_with_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__num_calls_with_global_mutex                "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__num_calls_without_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__num_calls_without_global_mutex             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__marked_on_entry))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__marked_on_entry                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__marked_during_call))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__marked_during_call                         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
                &(H5I_mt_g.H5I__dec_ref__marked_during_call))));
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__marked))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__dec_ref__marked                                         "
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__decremented))) >
      0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__decremented                                "
            "     = %lld\n",
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__app_decremented))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__app_decremented                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__calls_to_free_func))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__calls_to_free_func                         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__global_mutex_locks_for_free_func))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__global_mutex_locks_for_free_func           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__dec_ref__free_func_failed))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__dec_ref__free_func_failed                           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__dec_ref__retries))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__dec_ref__retries                                        "
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__inc_ref__num_calls))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__inc_ref__num_calls                                      "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__inc_ref__num_app_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__inc_ref__num_app_calls                              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__inc_ref__marked_on_entry))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__inc_ref__marked_on_entry                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__inc_ref__marked_during_call))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__inc_ref__marked_during_call                         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__inc_ref__incremented))) >
      0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__inc_ref__incremented                                "
            "     = %lld\n",
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__inc_ref__app_incremented))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__inc_ref__app_incremented                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__inc_ref__retries))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__inc_ref__retries                                        "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_calls                               "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_calls__with_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_calls__with_global_mutex            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__marked_during_call))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__marked_during_call                      "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_user_func_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_user_func_calls                     "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.H5I__iterate_cb__global_mutex_locks_for_user_func))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__global_mutex_locks_for_user_func        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_user_func_successes))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_user_func_successes                 "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_user_func_iter_stops))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_user_func_iter_stops                "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_user_func_fails))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_user_func_fails                     "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_user_func_skips))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_user_func_skips                     "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__iterate_cb__num_retries))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__iterate_cb__num_retries                             "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.H5I__unwrap__num_calls))) >
      0ULL)
    fprintf(
        file_ptr,
        "H5I_mt_g.H5I__unwrap__num_calls                                       "
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__unwrap__num_calls_with_global_mutex))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__unwrap__num_calls_with_global_mutex                 "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__unwrap__num_calls_without_global_mutex))) > 0)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__unwrap__num_calls_without_global_mutex              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL          "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
          H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL        "
            "     = %lld\n",
            (unsigned long long)(atomic_load(&(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T         "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_is_file_object__num_calls))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_is_file_object__num_calls                            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.H5I_is_file_object__num_calls_to_H5T_is_named))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.H5I_is_file_object__num_calls_to_H5T_is_named            "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(
    ...
    fprintf(
        ...
        (unsigned long long)(atomic_load(
            &(H5I_mt_g
                  .H5I_is_file_object__global_mutex_locks_for_H5T_is_named))));
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.num_do_not_disturb_yields))) >
      0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_do_not_disturb_yields                                "
            "     = %lld\n",
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_successful_do_not_disturb_sets))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_successful_do_not_disturb_sets                       "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_failed_do_not_disturb_sets))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_failed_do_not_disturb_sets                           "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
  ...
  if ((unsigned long long)(atomic_load(&(H5I_mt_g.num_do_not_disturb_resets))) >
      0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_do_not_disturb_resets                                "
            "     = %lld\n",
  ...
  if ((unsigned long long)(atomic_load(
          &(H5I_mt_g.num_do_not_disturb_bypasses))) > 0ULL)
    fprintf(file_ptr,
            "H5I_mt_g.num_do_not_disturb_bypasses                              "
            "     = %lld\n",
            (unsigned long long)(atomic_load(
...
herr_t H5I_register_type_internal(const H5I_class_t *cls) {
  ...
  if (NULL == type_info_ptr) {
...
#else  /* JRM  */
    if (NULL == (type_info_ptr = (H5I_mt_type_info_t *)H5MM_calloc(
                     sizeof(H5I_mt_type_info_t))))
      HGOTO_ERROR(H5E_ID, H5E_CANTALLOC, FAIL, "ID type allocation failed");
    ...
    /* now attempt to insert it into H5I_mt_g.type_info_array_[cls->type].  It
     * is possible that another thread has done the initialization while we were
     * allocating and and initializing the instance of H5I_type_info_t.  If so,
     * we will discard the instance just initialized and simply increment the
     * init_count on the instance that was created, initialized, and inserted by
     * another thread.
     *
     * Recall that expected_ptr is initialized to NULL, but will be set to the
     * current value of H5I_mt_g.type_info_array[class->type] if it is not NULL.
     */
    if (atomic_compare_exchange_strong(&(H5I_mt_g.type_info_array[cls->type]),
                                       &expected_ptr, type_info_ptr)) {

      /* We inserted the new instance of H5I_type_info_t into
       * H5I_mt_g.type_info_array[cls->type]. Update stats and goto done.
       */
      ...
      /* the atomic_compare_exchange_strong() failed because
       * H5I_mt_g.type_info_array[cls->type] is no longer NULL -- which means
       * that another thread beat us to creating and installing the new instance
       * of H5I_type_info_t.
       *
       * Thus we must discard the instance we just created, and increment the
       * init_count field of the existing instance of H5I_type_info_t.
       */
      ...
      /* If I read the specs on atomic_compare_exchange_strong() correctly,
       * expected_ptr should equal H5I_mt_g.type_info_array[cls->type] at this
       * point.  Verify this.
       */
      assert(expected_ptr);
      assert(expected_ptr ==
             atomic_load(&(H5I_mt_g.type_info_array[cls->type])));

      /* Having looked at the higher level code, I expect this will fail,
       * although a deep comparison of type_info->cls and cls should succeed.
       * Leave it for now to see what happens.
       */
...
herr_t H5I_register_type(const H5I_class_t *cls) {
  ...
  if (NULL == H5I_type_info_array_g[cls->type]) {
    ...
    if (NULL ==
        (type_info = (H5I_type_info_t *)H5MM_calloc(sizeof(H5I_type_info_t))))
      HGOTO_ERROR(H5E_ID, H5E_CANTALLOC, FAIL, "ID type allocation failed");
...
int64_t H5I_nmembers_internal(H5I_type_t type) {
  ...
  /* Set return value */
  H5_CHECKED_ASSIGN(ret_value, int64_t, atomic_load(&(type_info->id_count)),
                    uint64_t);
...
int64_t H5I_nmembers(H5I_type_t type) {
  ...
  if (type <= H5I_BADID || (int)type >= H5I_next_type_g)
    HGOTO_ERROR(H5E_ARGS, H5E_BADRANGE, FAIL, "invalid type number");
  if (NULL == (type_info = H5I_type_info_array_g[type]) ||
      type_info->init_count <= 0)
    HGOTO_DONE(0);
...
static herr_t H5I__unwrap(void *object, H5I_type_t type,
  ...
  if (H5TS_have_mutex(&H5_g.init_lock, &have_global_mutex) < 0)
    ...
    HGOTO_ERROR(H5E_LIB, H5E_CANTGET, FAIL,
                "Can't determine whether we have the global mutex");
  ...
  if (have_global_mutex) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I__unwrap__num_calls_without_global_mutex),
                     1);
  }
   ...
   */
  if (H5I_FILE == type || H5I_GROUP == type || H5I_DATASET == type ||
      H5I_ATTR == type) {
    ...
    if (!have_global_mutex) {
      ...
      atomic_fetch_add(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5VL), 1);
      H5_API_LOCK
      unwrapped_object = H5VL_object_data(vol_obj);
      H5_API_UNLOCK
      atomic_fetch_add(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5VL), 1);
    ...
    if (!have_global_mutex) {
      ...
      atomic_fetch_add(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_locked_for_H5T), 1);
      H5_API_LOCK
      unwrapped_object = (void *)H5T_get_actual_type(dt);
      H5_API_UNLOCK
      atomic_fetch_add(
          &(H5I_mt_g.H5I__unwrap__times_global_mutex_unlocked_for_H5T), 1);
...
herr_t H5I_clear_type_internal(H5I_type_t type, hbool_t force,
                               hbool_t app_ref) {
  ...
  if ((udata.type_info == NULL) ||
      (atomic_load(&(udata.type_info->init_count)) <= 0))
  ...
  if (lfht_get_first(&(udata.type_info->lfht), &id, &value)) {
    ...
    do {
       ...
       *
       * However, checking to see if *id_info_ptr is marked has become more
       * expensive, as we must do an atomic_load to obtain the kernel, and then
       * read the marked field.
       *
       ...
       *
       * Recall that value is a pointer to H5I_id_info_t which has been cast to
       * void *.
       */
      if (H5I__mark_node(value, NULL, (void *)&udata) < 0) {

        HGOTO_ERROR(H5E_ID, H5E_BADITER, FAIL,
                    "iteration failed while clearing the ID type");
      }
  ...
  if (lfht_get_first(&(udata.type_info->lfht), &id, &value)) {
    ...
    do {
      ...
      /* Only delete the id from the hash table if H5I_mt_g.marking_array[type]
       * is zero ond the id is marked for deletion.  Note that it is possible
       * that another  thread will increment or decrement
       * H5I_mt_g.marking_array[type] while this loop is running.  However, this
       * should not matter since marking an id for deletion is a one way
       * process, and the operations will appear to have been executed in some
       * order.
       */
      if ((0 == atomic_load(&(H5I_mt_g.marking_array[type])) &&
           (info_k.marked))) {

        /* this delete may fail, as it is possible that another thread will have
         * beaten us to the actual deletion of the entry from the lock free hash
         * table.  Thus don't flag an error if lfht_delete() fails, but don't
         * discard *id_info_ptr unless it succeeds.
         */
        if (lfht_delete(&(udata.type_info->lfht), id)) {

          if (H5I__discard_mt_id_info(id_info_ptr) < 0)

            HGOTO_ERROR(H5E_ID, H5E_CANTFREE, FAIL,
                        "Can't add id info to free list");
        }
      }
    } while (lfht_get_next(&(udata.type_info->lfht), id, &id, &value));
  }
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5I__mark_node(void *_info, void H5_ATTR_UNUSED *key,
                             void *_udata) {
  ...
  H5I_mt_id_info_t *id_info_ptr =
      (H5I_mt_id_info_t *)_info; /* Current ID info being worked with */
  H5I_mt_clear_type_ud_t *udata =
      (H5I_mt_clear_type_ud_t *)_udata; /* udata struct */
  herr_t result;
  herr_t ret_value = SUCCEED; /* Return value */
  ...
  if (have_global_mutex) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I__mark_node__num_calls_with_global_mutex),
                     1ULL);

  } else {

    atomic_fetch_add(&(H5I_mt_g.H5I__mark_node__num_calls_without_global_mutex),
                     1ULL);
  }

  do {

    /* If another thread modified id_info_ptr-k while we are preparing our
     * modified copy, or if we need to set the do not disturb flag to prevent
     * simultaneous calls to the future id discard_cb callback or the regular id
     * free_func, we will have to re-run this do-while loop.  Since we start
     * each pass fresh, start by reseting all the flags to their initial values.
     */
    is_candidate = FALSE;
    ...
    /* load the atomic kernel from *id_info_ptr into info_k.  Note that this is
     * a snapshot of the state of *id_info_ptr, and can be changed before we get
     * to writing it back.
     */
    info_k = atomic_load(&(id_info_ptr->k));
    ...
    if (info_k.marked) {
      ...
      if (pass <= 1) {
        ...
        atomic_fetch_add(&(H5I_mt_g.H5I__mark_node__marked_by_another_thread),
                         1ULL);
      }
      break;
    }
    ...
    if (info_k.do_not_disturb) {
      ...
      /* Another thread is in the process of performing an operation on the info
       * kernel that can't be rolled back -- either a future id realize_cb or
       * discard_cb, or a regular id free_func.
       *
       * Thus we must wait until that thread is done and then re-start the
       * operation -- which may be moot by that point.
       */
    ...
    if ((udata->force) ||
        ((info_k.count - ((!udata->app_ref) * info_k.app_count)) <= 1)) {
    ...
    if (cant_roll_back) {
      ...
      /* We don't want multiple threads trying to either realize or dispose of
       * the data associated with the future id or trying to free the data
       * associated with a regular id at the same time.
       *
       * To serialize such actions, we will attempt to set the do not disturb
       * flag.  If successful, this will prevent any other threads from
       * modifying id_info_ptr->k until after it is set back to FALSE.
       */
      if (!atomic_compare_exchange_strong(&(id_info_ptr->k), &info_k,
                                          mod_info_k)) {

        /* Some other thread changed the value of id_info_ptr->k since we last
         * read it.  Thus we must return to the beginning of the do loop and
         * start again.  Note that it is possible that by that time, there will
         ...
         * to match mod_info_k, and use it in the next
         * atomic_compare_exchange_strong() call.  However, for reason or
         * reasons unknown, this doesn't work.
         *
    ...
    if (info_k.is_future) {
      ...
      if (result < 0) {
        ...
        /* discard_cb has failed -- ignore the failure -- but update stats
         * below*/
        ...
        if (udata->force) {
          ...
          if (H5DEBUG(I)) {
            fprintf(H5DEBUG(I),
                    ...
                    "failure ignored\n",
                    (int)udata->type_info->cls->type,
                    (unsigned long)(info_k.object));
          }
#endif /* H5I_DEBUG */

          /* update stats */
          atomic_fetch_add(
              &(H5I_mt_g.H5I__mark_node__discard_cb_failures_marked), 1ULL);
          ...
          /* If the force flag is not set, we leave *info_ptr alone and don't
           * mark it for deletion.
           *
           * This seems questionable to me, since now info_ptr->object is
           * potentially corrupted.  However, that is what the single thread
           * code does, so keep it that way for now.  Obviously, this decision
           * should be reviewed once we have the prototype up and running. JRM
           * -- 9/8/23
           */
          atomic_fetch_add(
              &(H5I_mt_g.H5I__mark_node__discard_cb_failures_unmarked), 1ULL);
        }
      } else { /* discard_cb succeeded */

        /* update stats */
        atomic_fetch_add(&(H5I_mt_g.H5I__mark_node__discard_cb_successes),
                         1ULL);
      ...
      if (udata->type_info->cls->free_func) {
        ...
        if ((!have_global_mutex) && (!cls_is_mt_safe)) {
          ...
          H5_API_LOCK
          H5_GCC_CLANG_DIAG_OFF("cast-qual")
          result = (udata->type_info->cls->free_func)((void *)info_k.object,
                                                      H5_REQUEST_NULL);
          H5_GCC_CLANG_DIAG_ON("cast-qual")
          H5_API_UNLOCK
          atomic_fetch_add(
        ...
        if (result < 0) {
          ...
          if (udata->force) {
            ...
            /* update stats */
            atomic_fetch_add(
                &(H5I_mt_g.H5I__mark_node__free_func_failures_marked), 1ULL);
             ...
             */
            atomic_fetch_add(
                &(H5I_mt_g.H5I__mark_node__free_func_failures_unmarked), 1ULL);
          }
        } else { /* free function succeeded */

          /* update stats */
          atomic_fetch_add(&(H5I_mt_g.H5I__mark_node__free_func_successes),
                           1ULL);
    ...
    if ((mark) || (do_not_disturb_set)) {
      ...
      /* If we have set marked to TRUE, or if we have set the do_not_disturb
       * flag, we must attempt to replace the current value of info_ptr->k with
       * our modified version.
       *
       * First setup mod_info_k.  The only fields we will touch are
       * do_not_disturb and / or marked.  All other value are drawn from info_k
       * that we read at the top of the do/while loop.
       *
       * If mark == TRUE, set mod_info_k.count and mod_info_k.app_count to zero,
       * and set info_k.object to FALSE. Similarly, set info_k.is_future to
       * FALSE.  Do this because the instance of H5I_mt_id_info_t and its
       * associated id are effectively deleted as soon as id_info_ptr->k.marked
       * is set to TRUE.
       */
      if (mark) {
      ...
      /* now attempt to overwrite the value of info_ptr->k.  If
       * do_not_disturb_set is TRUE, this must succeed -- hence we do it in an
       * assert.  If do_not_disturb_set is FALSE, it may or may not succeed.  On
       * success we set done to TRUE.  Otherwise, some other therad has modified
       * id_info_ptr->k since we read it, and we must try again.
       */
      if (do_not_disturb_set) {
        ...
        bool_result = atomic_compare_exchange_strong(&(id_info_ptr->k), &info_k,
                                                     mod_info_k);
        assert(bool_result);
...
#if H5I_MT_DEBUG_DO_NOT_DISTURB
        fprintf(stdout,
                "H5I__mark_node() reset do not disturb on id = 0x%llx.\n",
                (unsigned long long)(id_info_ptr->id));
#endif /* H5I_MT_DEBUG_DO_NOT_DISTURB */

      } else if (atomic_compare_exchange_strong(&(id_info_ptr->k), &info_k,
                                                mod_info_k)) {

        /* no need to update update stats here -- will increment
         * H5I_mt_g.H5I__mark_node__marked after we exit the do/while loop
         */
...
static herr_t H5I__mark_node(void *_info, void H5_ATTR_UNUSED *key,
                             void *_udata) {
  H5I_id_info_t *info =
      (H5I_id_info_t *)_info; /* Current ID info being worked with */
   ...
   */
  if (udata->force ||
      (info->count - (!udata->app_ref * info->app_count)) <= 1) {
    ...
    if (info->is_future) {
      ...
      /* Check for a 'free' function and call it, if it exists */
      if (udata->type_info->cls->free_func &&
          (udata->type_info->cls->free_func)((void *)info->object,
                                             H5_REQUEST_NULL) < 0) {
        if (udata->force) {
#ifdef H5I_DEBUG
          if (H5DEBUG(I)) {
...
herr_t H5I__destroy_type(H5I_type_t type) {
  ...
  H5E_BEGIN_TRY { H5I_clear_type_internal(type, TRUE, FALSE); }
  ...
  result = atomic_compare_exchange_strong(&(H5I_mt_g.type_info_array[type]),
                                          &type_info_ptr, NULL);
  assert(result);

  result = atomic_compare_exchange_strong(
      &(H5I_mt_g.type_info_allocation_table[type]), &expected, FALSE);
  assert(result);
 ...
 *-------------------------------------------------------------------------
 */
hid_t H5I__register(H5I_type_t type, const void *object, hbool_t app_ref,
                    H5I_future_realize_func_t realize_cb,
                    H5I_future_discard_func_t discard_cb) {
  hbool_t result;
  ...
  if ((NULL == type_info_ptr) ||
      (atomic_load(&(type_info_ptr->init_count)) <= 0))
  ...
  /* strictly speaking there is a race condition here, but it doesn't matter
   * which thread incremented nextid beyond its limit as long as we catch it.
   */
  assert(atomic_load(&(type_info_ptr->nextid)) <= ID_MASK);

  id_info_ptr =
      H5I__new_mt_id_info(new_id, 1, !!app_ref, object, (NULL != realize_cb),
                          realize_cb, discard_cb);
  ...
  /* Note that the insertion if the new ID is not completely atomic -- as we
   * have three operations:
   *
   ...
   *
   * The rational for incrementing the id_count first is that it will keep the
   * index from being closed in some corner cases.
   *
   * I can't make a strong arguement for either ordering of the second two
   * items, so please view it as arbitrary until we come up with an argument to
   * the contrary.
   */
  ...
  result = lfht_add(&(type_info_ptr->lfht), (unsigned long long int)new_id,
                    (void *)id_info_ptr);
  assert(result);
...
hid_t H5I_register(H5I_type_t type, const void *object, hbool_t app_ref) {
  ...
  fprintf(
      stdout,
      "   H5I_register(type = %d, object = 0x%llx, app_ref = %d) called. \n",
  ...
  if (H5I_INVALID_HID ==
      (ret_value = H5I__register(type, object, app_ref, NULL, NULL)))
    HGOTO_ERROR(H5E_ID, H5E_CANTREGISTER, H5I_INVALID_HID,
                "unable to register object");

done:

#if H5I_MT_DEBUG
  fprintf(stdout,
          "   H5I_register(type = %d, object = 0x%llx, app_ref = %d) returns "
          "%llx. \n",
          (int)type, (unsigned long long)object, (int)app_ref,
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5I_register_using_existing_id(H5I_type_t type, void *object,
                                      hbool_t app_ref, hid_t existing_id) {
  hbool_t result;
  H5I_mt_id_info_kernel_t info_k;
  H5I_mt_type_info_t *type_info_ptr = NULL; /* Pointer to the type */
  H5I_mt_id_info_t *old_id_info_ptr =
      NULL; /* Pointer to the old ID information */
  H5I_mt_id_info_t *new_id_info_ptr =
      NULL;                   /* Pointer to the new ID information */
  herr_t ret_value = SUCCEED; /* Return value */
   ...
   *
   * Because of the H5I_mt_g.marking_array[type] flag, it is possible that an
   * entry with the specified ID will exist in the lock free hash table, but be
   * marked as deleted.
   *
   * This couldn't happen in the single thread version, but it becomes possible
   * in multi-thread.
   *
   * The correct solution is probably to get rid of the H5I_mt_g.marking_array[]
   * -- however that doesn't seem prudent until the initial version is up and
   * running, and I have a good understanding of why the mark and sweep approach
   * was thought necessary.
   *
   * Thus, at present, it seems best to code around the issue, and be able to
   * handle IDs that are still in the index but are marked as deleted.
   */
  if (NULL != (old_id_info_ptr = H5I__find_id(existing_id))) {
    ...
    if (info_k.marked) {
      ...
      atomic_fetch_add(
          &(H5I_mt_g.H5I_register_using_existing_id__num_marked_only), 1ULL);
   ...
   */
  new_id_info_ptr =
      H5I__new_mt_id_info(existing_id, 1, !!app_ref, object, FALSE, NULL, NULL);

  if (!new_id_info_ptr)

    HGOTO_ERROR(H5E_ID, H5E_NOSPACE, FAIL,
                "memory allocation and init of new id info failed");

  /* Now insert the ID into the index.  The H5I_mt_g.marking_array[type] flag
   * makes this more painful than it should be as it is possible that the id
   * info for the existing ID has only been marked for deletion, but not
   * actually deleted from the lock free hash table.  To make things more
   * interesting, in the multi-thread case, it is possible that another thread
   * has beaten us to the insertion.
   *
   * Supposedly, this API call is used only by the native VOL.  If so, this
   * latter item is not an issue until the relevant portions of the native VOL
   * are made multi-thread.
   *
   * Thus for now, it should be sufficient to delete the marked ID info from the
   * lock free hash table before inserting the new ID info.  However, for the
   * long term, we need a compare and swap call for the lock free hash table
   * instead of the existing unconditional swap value call.
   *
   * In the absence of the compare and swap for the lock free hash table, we
   * will simply try to delete the existing ID from the lock free hash table,
   * and then insert the new id info with the same ID.
   *
   * Note that the delete from the hash table may fail, as it is possible that
   * some other thread will have swept the marked IDs in the time since we
   * looked it up.
   */
  if (old_id_info_ptr) {
  ...
  result = lfht_add(&(type_info_ptr->lfht), (unsigned long long int)existing_id,
                    (void *)new_id_info_ptr);
  assert(result);
  ...
  if (FAIL == ret_value) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I_register_using_existing_id__num_failures),
                     1ULL);
  }
...
herr_t H5I_register_using_existing_id(H5I_type_t type, void *object,
  ...
  result = lfht_add(&(type_info->lfht), (unsigned long long int)existing_id,
                    (void *)info);
  assert(result);
...
void *H5I_subst(hid_t id, const void *new_object) {
  ...
  hbool_t have_global_mutex =
      TRUE; /* trivially true in the single thread case */
  int pass = 0;
  H5I_mt_id_info_kernel_t info_k;
  H5I_mt_id_info_kernel_t mod_info_k;
  ...
  if (H5TS_have_mutex(&H5_g.init_lock, &have_global_mutex) < 0)
    ...
    HGOTO_ERROR(H5E_LIB, H5E_CANTGET, NULL,
                "Can't determine whether we have the global mutex");
  ...
  if (have_global_mutex) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I_subst__num_calls__without_global_mutex),
                     1ULL);
  }
...
void *H5I_object_internal(hid_t id) {
  H5I_mt_id_info_kernel_t info_k;
...
void *H5I_object_verify_internal(hid_t id, H5I_type_t type) {
  H5I_mt_id_info_kernel_t info_k;
  H5I_mt_id_info_t *info_ptr = NULL; /* Pointer to the ID info */
  void *ret_value = NULL;            /* Return value */
...
#if H5I_MT_DEBUG
  fprintf(stdout,
          "   H5I_object_verify(id = 0x%llx, type = %d) returns 0x%llx. \n",
...
H5I_type_t H5I_get_type_internal(hid_t id) {
  H5I_type_t ret_value = H5I_BADID; /* Return value */
...
htri_t H5I_is_file_object(hid_t id) {
  ...
  if ((H5I_DATASET == type) || (H5I_GROUP == type) || (H5I_MAP == type)) {
...
#if defined(H5_HAVE_THREADSAFE) || defined(H5_HAVE_MULTITHREAD)
    /* test to see whether this thread currently holds the global mutex.  Store
     * the the result for later use.
     */
    if (H5TS_have_mutex(&H5_g.init_lock, &have_global_mutex) < 0)
     ...
     * in particular to keep deleted data types on a free list until all
     * references to the datatype have been deleted.
     *
     * However, that isn't an option for now.  Thus, to prevent this, increment
     * the reference count on id before we call H5I_object() and decrement it
     * after H5T_is_named() returns.
     *
     * Note that this isn't bullet proof at present -- there are routines that
     * delete IDs without checking the ID reference counts.  These should only
     * be run on shutdown when there is only one thread active, but this is a
     * point to consider in debugging.
     *
     * Further, note that the current implementation is very in-efficient due to
     * the ref count increment and decrement.  Think on converting this to a
     * single function using the do not disturb flag to avoid the possiblity of
     * the ID being deleted out from under the H5T_id_named() call.
     */

    if (-1 == H5I_inc_ref_internal(id, FALSE))

      HGOTO_ERROR(H5E_ARGS, H5E_BADTYPE, FAIL,
                  "unable to increment id ref count");

    if (NULL == (dt = (H5T_t *)H5I_object_internal(id)))

      HGOTO_ERROR(H5E_ARGS, H5E_BADTYPE, FAIL,
                  "unable to get underlying datatype struct");

    atomic_fetch_add(&(H5I_mt_g.H5I_is_file_object__num_calls_to_H5T_is_named),
                     1ULL);

    /* If this thread doesn't alread have the global mutex, we must grab it
     * before the call to H5T_is_named() and drop it afterwards.
     */
    if (!have_global_mutex) {
    ...
    if (-1 == H5I_dec_ref_internal(id))
      ...
      HGOTO_ERROR(H5E_ARGS, H5E_BADTYPE, FAIL,
                  "unable to decrement id ref count");
 ...
 *-------------------------------------------------------------------------
 */
static void *H5I__remove_common(H5I_type_info_t *type_info_ptr, hid_t id) {
  hbool_t done = FALSE;
  int pass = 0;
  H5I_type_t type;
  ...
  do {
    ...
    lfht_find(&(type_info_ptr->lfht), (unsigned long long int)id,
              (void **)&id_info_ptr);
    ...
    if (id_info_ptr) {
      ...
      if (info_k.marked) {
        ...
        if (pass <= 1) {
          ...
          atomic_fetch_add(&(H5I_mt_g.H5I__remove_common__already_marked),
                           1ULL);

        } else {

          atomic_fetch_add(
              &(H5I_mt_g.H5I__remove_common__marked_by_another_thread), 1ULL);
        }

        /* the target ID has been logically deleted from the index.
         * Thus set id_info_ptr = NULL, and flag an error.
         *
         * Note that for now at least, we don't distinguish between the case in
         * which the ID is logically deleted on entry vs. the case in which the
         * ID is logically deleted by another thread at a later point.
         */
        id_info_ptr = NULL;
        done = TRUE;
        ...
        /* Another thread is in the process of performing an operation on the
         * info kernel that can't be rolled back -- either a future id
         * realize_cb or discard_cb, or a regular id callback that must be
         * serialized.
         *
         * Thus we must wait until that thread is done and then re-start the
         * operation -- which may be moot by that point.
        ...
        /* The id and the associated instance of H5I_mt_id_info_t is logically
         * deleted as soon as we set id_info_ptr->k.marked to TRUE -- thus
         * update the remaining fields of id_info_ptr->k accordingly.
         */
      ...
      /* target entry doesn't exist in the lock free hash table, so can't
       * proceed. will flag an error later.
       */
      /* update stats */
      atomic_fetch_add(&(H5I_mt_g.H5I__remove_common__target_not_in_lfht),
                       1ULL);
  ...
  if (!id_info_ptr) {
    ...
    HGOTO_ERROR(H5E_ID, H5E_CANTDELETE, NULL,
                "can't mark ID for removal from hash table");

  } else {

    /* if this was the last ID accessed, set type_info_ptr->last_id_info to
     * NULL. Do this with a call to atomic_compare_exchange_strong().  This call
     * will NULL type_info_ptr->last_id_info if it is currently set to
     * id_info_ptr, and leave it unchanged otherwise.  If
     * type_info_ptr->last_id_info is not id_info_ptr,
     * atomic_compare_exchange_strong() will return its current value in the
     * second parameter -- hence the need for dup_id_info_ptr.
     */
    dup_id_info_ptr = id_info_ptr;
    atomic_compare_exchange_strong(&(type_info_ptr->last_id_info),
                                   &dup_id_info_ptr, NULL);
    ...
    if (0 == atomic_load(&(H5I_mt_g.marking_array[type]))) {
      ...
      if ((!lfht_delete(&(type_info_ptr->lfht), (unsigned long long int)id)))
        ...
        HGOTO_ERROR(H5E_ID, H5E_CANTDELETE, NULL,
                    "can't remove ID node from hash table");

      if (H5I__discard_mt_id_info(id_info_ptr) < 0)

        HGOTO_ERROR(H5E_ID, H5E_CANTDELETE, NULL,
                    "can't release ID info to free list");
    }
  }
...
void *H5I_remove_internal(hid_t id) {
  H5I_mt_type_info_t *type_info_ptr = NULL; /* Pointer to the ID type */
...
static int H5I__dec_ref(hid_t id, void **request, hbool_t app) {
  ...
  if (have_global_mutex) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I__dec_ref__num_calls_with_global_mutex),
                     1ULL);

  } else {

    atomic_fetch_add(&(H5I_mt_g.H5I__dec_ref__num_calls_without_global_mutex),
                     1ULL);
  }

  /* Get the ID's type */
  if (NULL ==
      (type_info_ptr = atomic_load(&(H5I_mt_g.type_info_array[H5I_TYPE(id)]))))

    HGOTO_ERROR(H5E_ID, H5E_BADID, (-1), "can't locate ID type");

  /* test the class flags to see if the class is multi-thread safe, and make
   * note of the result */
   ...
   * pass through the do/while loop, as any changes will be reflected in
   * *id_info_ptr.
   */
  if (NULL == (id_info_ptr = H5I__find_id(id)))
  ...
  do {
    ...
    if (info_k.do_not_disturb) {
      ...
      /* Another thread is in the process of performing an operation on the info
       * kernel that can't be rolled back -- either a future id realize_cb or
       * discard_cb, or a regular id callback that must be serialized.
       *
       * Thus we must wait until that thread is done and then re-start the
       * operation -- which may be moot by that point.
       */
    ...
    if ((info_k.count > 1) || (NULL == type_info_ptr->cls->free_func)) {
      ...
      if (info_k.count > 1) {
         ...
         * the ID and *id_info_ptr are about to be removed from the idex at
         * least logically, and probably physically as well.  Since the free
         * function is undefined, all we need to do is setup mod_info_k
         * accordingly and try to replace id_info_ptr->k with mod_info_k.
         */
        mod_info_k.count = 0;
        mod_info_k.app_count = 0;
        mod_info_k.object = NULL;
      ...
      cls_is_mt_safe =
          ((type_info_ptr->cls->flags & H5I_CLASS_IS_MT_SAFE) != 0);
       ...
       *
       *       In passing set the have_global_mutex flag to true if either we
       * currently have the global mutex, or if the H5I_CLASS_IS_MT_SAFE is set
       * in type_info_ptr->cls->flags.  Do this because we must obtain the
       * global mutex before calling the free_func() and drop if after the call
       * if we don't have the mutex already.
       *
       *    2) Call the free_func().  If the class is not multi-thread safe and
       *       we don't already hold the globla mutex, we must obtain it before
       * the call, and drop it afterwards.
       *
       ...
       *
       *    4) If H5I_mt_g.marking_array[H5I_TYPE(id)] is zero, remove the ID
       * from the lock free hash table, and release the associated instance of
      ...
      /* Note that the free_func may call back into H5I.  As long as it doesn't
       * try to access this ID, either directly or indirectly, there shouldn't
       * be a problem.
       *
       * In the case of indexes maintained by the HDF5 library proper, this
       * should be manageable as we have access to the code.  For external users
       * (either user programmer or VOL connectors), we must document this.
       */
      if ((!have_global_mutex) && (!cls_is_mt_safe)) {

        atomic_fetch_add(
            &(H5I_mt_g.H5I__dec_ref__global_mutex_locks_for_free_func), 1ULL);
        H5_API_LOCK
        H5_GCC_CLANG_DIAG_OFF("cast-qual")
        ...
        H5_API_UNLOCK
        atomic_fetch_add(
            &(H5I_mt_g.H5I__dec_ref__global_mutex_unlocks_for_free_func), 1ULL);
      ...
      if (result >= 0) {
        ...
        /* The free_func() succeeded -- reset the do_not_disturb flag, and set
         * marked to TRUE. Since the ID and the associated instance of
         * H5I_mt_id_info_t will be logically deleted as soon as we overwrite
         * id_info_ptr->k with mod_info_k, set the remaining fields to reflect
         * this.
         */
        mod_info_k.count = 0;
        mod_info_k.app_count = 0;
        ...
        /* The free_func() failed -- just update stats, reset the do not disturb
         * flag, and set ret_value = -1
         */
  ...
  if (marked_for_deletion) {
    ...
    if (0 == atomic_load(&(H5I_mt_g.marking_array[H5I_TYPE(id)]))) {
      ...
      if ((!lfht_delete(&(type_info_ptr->lfht), (unsigned long long int)id)))
        ...
        HGOTO_ERROR(H5E_ID, H5E_CANTDELETE, (-1),
                    "can't remove ID node from hash table");
  ...
  assert((ret_value >= 1) || (marked_for_deletion && (0 == ret_value)) ||
         (-1 == ret_value) ||
...
static int H5I__dec_ref(hid_t id, void **request) {
  ...
  if (1 == info->count) {
    ...
    if (!type_info->cls->free_func ||
        (type_info->cls->free_func)((void *)info->object, request) >= 0) {
      /* Remove the node from the type */
...
int H5I_dec_ref_internal(hid_t id) {
  int ret_value = 0; /* Return value */
...
int H5I_dec_app_ref_internal(hid_t id) {
  int ret_value = 0; /* Return value */
...
int H5I_dec_app_ref_async(hid_t id, void **token) {
  ...
  if ((ret_value = H5I__dec_app_ref(id, token)) < 0)
    HGOTO_ERROR(H5E_ID, H5E_CANTDEC, (-1),
                "can't asynchronously decrement ID ref count");
...
int H5I_inc_ref_internal(hid_t id, hbool_t app_ref) {
  hbool_t done = FALSE;
  int pass = 0;
  H5I_mt_id_info_kernel_t info_k;
  H5I_mt_id_info_kernel_t mod_info_k;
...
int H5I_get_ref_internal(hid_t id, hbool_t app_ref) {
  H5I_mt_id_info_t *id_info_ptr = NULL; /* Pointer to the ID */
  H5I_mt_id_info_kernel_t info_k;
  int ret_value = 0; /* Return value */
...
int H5I__inc_type_ref(H5I_type_t type) {
  ...
  /* Set return value -- atomic_fetch_add() returns the old value, hence the
   * plus 1 */
...
int H5I_dec_type_ref_internal(H5I_type_t type) {
  H5I_mt_type_info_t *type_info_ptr = NULL; /* Pointer to the ID type */
  ...
  if (1 == atomic_load(&(type_info_ptr->init_count))) {
    ...
    /* atomic_fetch_sub() returns the original value of the atomic variable --
     * hence the minus 1 */
 ...
 *-------------------------------------------------------------------------
 */
static int H5I__iterate_cb(void *_item, void H5_ATTR_UNUSED *_key,
                           void *_udata) {
  hbool_t have_global_mutex;
  hbool_t bool_result;
  H5I_mt_id_info_t *id_info_ptr =
      (H5I_mt_id_info_t *)_item; /* Pointer to the ID info */
  H5I_iterate_ud_t *udata =
      (H5I_iterate_ud_t *)_udata; /* User data for callback */
  H5I_mt_id_info_kernel_t info_k;
  herr_t result;
  ...
  if (have_global_mutex) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I__iterate_cb__num_calls__with_global_mutex),
                     1ULL);

  } else {

    atomic_fetch_add(
        &(H5I_mt_g.H5I__iterate_cb__num_calls__without_global_mutex), 1ULL);
  }

  /* read the current value of the id info kernel */
  info_k = atomic_load(&(id_info_ptr->k));

  /* Only invoke the callback function if this ID has not been marked for
   * deletion, is visible externally and its reference count is positive.
   *
   * While the user_func (and all the callbacks defined in the type) should be
   * thread safe, for now, use the do_not_disturb flag to ensure that user_func
   * has exclusive access to the object -- at least from within H5I.  (Note,
   * however, that the object can still be looked up by the user and accessed
   * outside the H5I code.  Similarly, the user may have a copy of the pointer,
   * and be able to access its data structure at will directly))
   *
   * If the limited protection given to the object associated with the ID is not
   * sufficient, the client object will have to be made multi-thread safe.
   * Indeed, this should be the end state -- but unless and until the native VOL
   * is made thread safe, this limited protection seems a reasonable middle
   * ground
   *
   * As per the other uses of the do_not_disturb flag, it is possible for the
   * user_func to trigger a deadlock if it attempts to access the current ID via
   * H5I either directly or through some sequence of calls.
   */
  if ((!info_k.marked) && (((!udata->app_ref) || (info_k.app_count > 0)))) {
    ...
    do {
      ...
      if (!bypass_do_not_disturb) {
        ...
        /* set mod_inf_k.have_global_mutex to TRUE since if we don't have the
         * global mutext, we will grab it before calling the user function, and
         * drop it as soon as it returns.
         */
        mod_info_k.have_global_mutex = have_global_mutex;
        ...
        if (!atomic_compare_exchange_strong(&(id_info_ptr->k), &info_k,
          ...
          /* Some other thread changed the value of id_info_ptr->k since we last
           * read it.  Thus we must return to the beginning of the do loop and
           * start again.  Note that it is possible that by that time, there
           ...
           * reasons unknown, this doesn't work.
           *
           * Instead, we reload info_k after the
           * atomic_compare_exchange_strong(), and verify that it contains the
           * expected values.
           */
          info_k = atomic_load(&(id_info_ptr->k));
          ...
          /* update stats */
          atomic_fetch_add(&(H5I_mt_g.num_successful_do_not_disturb_sets),
                           1ULL);

#if H5I_MT_DEBUG_DO_NOT_DISTURB
          fprintf(stdout,
                  "H5I__iterate_cb() set do not disturb on id = 0x%llx.\n",
                  (unsigned long long)(id_info_ptr->id));
#endif /* H5I_MT_DEBUG_DO_NOT_DISTURB */
        }
      } /* if ( ! bypass_do_not_disturb ) */
       ...
       */
            ...
            H5_GCC_CLANG_DIAG_ON("cast-qual")
#endif
      /* H5I__unwrap() can fail -- for now at least.  Handle this by treating
       * any failure as a callback failure.
       */
      H5_GCC_CLANG_DIAG_OFF("cast-qual")
      ...
      if (result < 0) {
        ...
        atomic_fetch_add(&(H5I_mt_g.H5I__iterate_cb__num_user_func_calls),
                         1ULL);

        /* Invoke callback function.  Grab the global mutex if we don't have it
         * already */
        if (!have_global_mutex) {
          ...
          atomic_fetch_add(
              ...
              1ULL);
          H5_API_LOCK
          cb_ret_val = (*udata->user_func)((void *)object, id_info_ptr->id,
                                           udata->user_udata);
          H5_API_UNLOCK
          atomic_fetch_add(
              &(H5I_mt_g.H5I__iterate_cb__global_mutex_unlocks_for_user_func),
      ...
      if (cb_ret_val > 0) {
        ...
        atomic_fetch_add(&(H5I_mt_g.H5I__iterate_cb__num_user_func_iter_stops),
                         1ULL);
        ...
        atomic_fetch_add(&(H5I_mt_g.H5I__iterate_cb__num_user_func_fails),
                         1ULL);

        ret_value =
            H5_ITER_ERROR; /* indicate failure (which terminates iteration) */

      } else {

        atomic_fetch_add(&(H5I_mt_g.H5I__iterate_cb__num_user_func_successes),
                         1ULL);
      }
...
#if H5I_MT_DEBUG_DO_NOT_DISTURB
        fprintf(stdout,
                "H5I__iterate_cb() reset do not disturb on id = 0x%llx.\n",
                (unsigned long long)(id_info_ptr->id));
#endif /* H5I_MT_DEBUG_DO_NOT_DISTURB */
      }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5I_iterate(H5I_type_t type, H5I_search_func_t func, void *udata,
                   hbool_t app_ref) {
  herr_t ret_value = SUCCEED; /* Return value */
...
herr_t H5I_iterate_internal(H5I_type_t type, H5I_search_func_t func,
                            void *udata, hbool_t app_ref) {
  hbool_t have_global_mutex =
      TRUE; /* trivially true in the single thread case */
  H5I_mt_type_info_t *type_info_ptr = NULL; /* Pointer to the type */
  H5I_mt_id_info_kernel_t info_k;
    ...
    if (lfht_get_first(&(type_info_ptr->lfht), &id, &value)) {
      ...
      do {
        ...
        if (!info_k.marked) {
          ...
          int ret =
              H5I__iterate_cb((void *)id_info_ptr, NULL, (void *)&iter_udata);
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5I_get_first(H5I_type_t type, hid_t *id_ptr, void **object_ptr,
  ...
  if (!called_from_H5I) {
    ...
    /* if H5I_get_first() is not called from withing H5I, it must have been
     * called from somewhere within the HDF5 library proper -- hence we set the
     * public_api parameter of H5I__enter() to FALSE.
     */
    H5I__enter(FALSE);
  }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5I_get_next(H5I_type_t type, hid_t last_id, hid_t *next_id_ptr,
 ...
 *-------------------------------------------------------------------------
 */
H5I_mt_id_info_t *H5I__find_id(hid_t id) {
  hbool_t do_not_disturb_set;
  hbool_t done = FALSE;
  ...
  if (have_global_mutex) {
    ...
    atomic_fetch_add(&(H5I_mt_g.H5I__find_id__num_calls_with_global_mutex),
                     1ULL);

  } else {

    atomic_fetch_add(&(H5I_mt_g.H5I__find_id__num_calls_without_global_mutex),
                     1ULL);
  }
  ...
  do {
    ...
    if ((last_id_info_ptr) && (last_id_info_ptr->id == id)) {
      ...
      if (!lfht_find(&(type_info_ptr->lfht), (unsigned long long int)id,
                     (void **)&id_info_ptr)) {
    ...
    if (id_info_ptr) {
      ...
      /* In principle, as long as we don't modify it, we can read an id whose do
       * not disturb flag is set.  This suggests that we only need to do a
       * thread yield and continue if the is_future flag is set.  However, this
       * happens infrequently, and it triggers false negatives in the test bed.
       * Thus do the thread yield if info_k.do_not_disturb is TRUE, regardless
       * of the value of info_k.is_future.
       */
      if (info_k.do_not_disturb) {

        /* It is possible that this call into H5I is recursive.  If so, it is
         * possible to deadlock on the do_not_discurb flag.  To avoid this, we
         * check to see if the the global lock was helf when the
         * have_global_mutex flag was set, and if it is is held by this thread
         * -- if so, we can ignore the do_not_disturb flag, since we are the
         * same thread.
         *
         * Note that this is a temporary hack that works with the existing
         * library to pass the regression tests.  A more general solution is
         * needed for the production version.
         */
        if ((have_global_mutex) && (info_k.have_global_mutex)) {
      ...
      if (info_k.is_future) {
        ...
        assert(!info_k.do_not_disturb); /* temporary check until future IDs are
                                           reworked */

        if (pass == 1) {

          atomic_fetch_add(
              &(H5I_mt_g.H5I__find_id__future_id_conversions_attempted), 1ULL);
        }
        ...
        /* set mod_info_k.have_global_mutex to TRUE if either this thread has
         * the global mutex or the class is not multi-thread safe.  Set
         * mod_info_k.have_global_mutex to TRUE in the latter case since we must
         * grab the global mutex before calling the realize callback and drop it
         * when it returns.
         */
        mod_info_k.have_global_mutex =
            ((have_global_mutex) || (!cls_is_mt_safe));
        ...
        if (!atomic_compare_exchange_strong(&(id_info_ptr->k), &info_k,
          ...
          /* setup mod_info_k to reset the do_not_disturb flag.  If we are
           * successful at realizing the future ID, we will make further changes
           * to mod_info_k before we use it to overwrite id_info_ptr->k.
           */
          mod_info_k.do_not_disturb = FALSE;
          mod_info_k.have_global_mutex = FALSE;
      ...
      /* save a copy of id_info_ptr for use when we reset the do_not_disturb
       * flag. */
      dup_id_info_ptr = id_info_ptr;
      ...
      if (info_k.is_future) {
        ...
        atomic_fetch_add(&(H5I_mt_g.H5I__find_id__num_calls_to_realize_cb),
                         1ULL);
        ...
        if ((!done) && ((H5I_INVALID_HID == actual_id) ||
                        (H5I_TYPE(id) != H5I_TYPE(actual_id)))) {

          /* either we received an invalid ID from the realize_cb(), or that ID
           * is not of the same type as the id passed into this function.  In
           * either case, we must reset the do_not_disturb flag and return NULL.
           */
        ...
        if (!done) {
          ...
          atomic_fetch_add(
              &(H5I_mt_g.H5I__find_id__num_calls_to_H5I__remove_common), 1ULL);

          if (NULL == actual_object) {

            /* According to the documentation, this means that
             * H5I__remove_common() has failed. However, if one examines the
             * code, it is also possible that no object is associated with the
             * real ID.
             *
             * The single thread code contains an assertion that actual_ovject
             * is not NULL -- from which I infer that a NULL actual_object
             * should be treated as an error.
             *
             * For now at least, rather than re-work H5I__find_id() to report an
             * error in this case, we will simply cause the realization of the
             * future ID to fail.
             */
            id_info_ptr = NULL;
            done = TRUE;
        ...
        if (!done) {
          ...
          atomic_fetch_add(&(H5I_mt_g.H5I__find_id__num_calls_to_discard_cb),
                           1ULL);
          ...
          if (result < 0) {
            ...
            /* The discard callback has failed.  We must reset the
             * do_not_disturb flag and return NULL.
             */
            id_info_ptr = NULL;
            done = TRUE;
      ...
      if (do_not_disturb_set) {
        ...
        /* we must reset the do_not_disturb flag, and possibly make other
         * changes to the id info kernel as well.  Do this with a call to
         * atomic_compare_exchange_strong(). This call must succeed, so simply
         * assert that it does.
         *
         * In the event of failure in realizing the future id, id_info_ptr will
         * have been set to NULL -- hence the use of dup_id_info_ptr below.
         */

        assert(!mod_info_k.do_not_disturb);

        bool_result = atomic_compare_exchange_strong(&(dup_id_info_ptr->k),
                                                     &info_k, mod_info_k);
        assert(bool_result);
 ...
 *-------------------------------------------------------------------------
 */
static int H5I__find_id_cb(void *_item, void H5_ATTR_UNUSED *_key,
                           void *_udata) {
  H5I_mt_id_info_t *id_info_ptr =
      (H5I_mt_id_info_t *)_item; /* Pointer to the ID info */
  H5I_mt_id_info_kernel_t info_k;
    ...
    if (lfht_get_first(&(type_info_ptr->lfht), &scan_id, &value)) {
      ...
      do {
        ...
        if (H5_ITER_STOP == ret)
          ...
          lfht_get_next(&(type_info_ptr->lfht), scan_id, &scan_id, &value));
    }
...
static herr_t H5I__clear_mt_id_info_free_list(void) {
  ...
  atomic_fetch_add(&(H5I_mt_g.H5I__clear_mt_id_info_free_list__num_calls),
                   1ULL);
...
static herr_t H5I__discard_mt_id_info(H5I_mt_id_info_t *id_info_ptr) {
  ...
  while (!done) {
    ...
    if ((test_fl_stail.ptr == fl_stail.ptr) &&
        (test_fl_stail.sn == fl_stail.sn)) {

      if (NULL == fl_snext.ptr) {

        /* attempt to append id_info_ptr by setting fl_tail->fl_snext.ptr to
         * id_info_ptr. If this succeeds, update stats and attempt to set
         * H5I_mt_g.id_info_fl_stail.ptr to id_info_ptr as well.  This may or
         * may not succeed, but in either case we are done.
         */
        new_fl_snext.ptr = id_info_ptr;
        new_fl_snext.sn = fl_snext.sn + 1;
        if (atomic_compare_exchange_strong(&(fl_stail.ptr->fl_snext), &fl_snext,
                                           new_fl_snext)) {
          ...
          /* if appropriate, attempt to update H5I_mt_g.max_id_info_fl_len.  In
           * the event of a collision, just ignore it and go on, as I don't see
           * any reasonable way to recover.
           */
          if ((fl_len = atomic_load(&(H5I_mt_g.id_info_fl_len))) >
              (max_fl_len = atomic_load(&(H5I_mt_g.max_id_info_fl_len)))) {

            atomic_compare_exchange_strong(&(H5I_mt_g.max_id_info_fl_len),
                                           &max_fl_len, fl_len);
          }
  ...
  /* test to see if both H5I_mt_g.id_info_fl_len and
   * H5I_mt_g.num_id_info_fl_entries_reallocable are greater than
   * H5I_mt_g.max_desired_id_info_fl_len.  Check both, as while we want to keep
   * the free list length around H5I_mt_g.max_desired_id_info_fl_len, we also
   * want to have an ample supply of reallocable free list entries on hand.
   */
  assert(atomic_load(&(H5I_mt_g.num_id_info_fl_entries_reallocable)) <=
         atomic_load(&(H5I_mt_g.id_info_fl_len)));

  if ((atomic_load(&(H5I_mt_g.id_info_fl_len)) >
    ...
    atomic_fetch_add(
        &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_fl_too_small), 1ULL);
  }
  ...
  if (try_to_free_an_entry) {
    ...
    while ((!reallocable_entry_available) &&
           (0 < (num_fl_entries_reallocable = atomic_load(
                     &(H5I_mt_g.num_id_info_fl_entries_reallocable))))) {
      ...
      if (atomic_compare_exchange_strong(
        ...
        /* update stats */
        atomic_fetch_add(
            &(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions), 1ULL);
      }
    } /* end while */
    ...
    if (!reallocable_entry_available) {
      ...
      while (!done) {
        ...
        if ((test_fl_shead.ptr == fl_shead.ptr) &&
            (test_fl_shead.sn == fl_shead.sn)) {
          ...
          if (fl_shead.ptr == fl_stail.ptr) {
            ...
            if (NULL == fl_snext.ptr) {
              ...
              atomic_fetch_add(
                  &(H5I_mt_g.num_id_info_fl_frees_skipped_due_to_empty), 1);
              done = TRUE;
              break;
            }
            ...
            if (!atomic_compare_exchange_strong(&(H5I_mt_g.id_info_fl_stail),
              ...
              atomic_fetch_add(&(H5I_mt_g.num_id_info_fl_tail_update_cols),
                               1ULL);
            }
          } else {
            ...
            if (!atomic_compare_exchange_strong(&(H5I_mt_g.id_info_fl_shead),
               ...
               */
              atomic_fetch_add(&(H5I_mt_g.num_id_info_fl_head_update_cols),
                               1ULL);
              ...
              /* first has been removed from the free list.  Set id_info_ptr to
               * fl_shead.ptr, discard *id_info_ptr, update stats, and exit the
               * loop by setting done to true.
               */
...
H5I__new_mt_id_info(hid_t id, unsigned count, unsigned app_count,
  ...
  /* Test to see if there is a re-allocable entry on the free list.
   * Conceptually, we test to see if H5I_mt_g.num_id_info_fl_entries_reallocable
   * is positive, we decrement it and set entry_reallocable to TRUE.
   * Practically, it is a bit more complicated, as it is possible that
   * H5I_mt_g.num_id_info_fl_entries_reallocable between the time that we read
   * it to see if it is positive, and we decrement it.  To deal with this, we
   * use an atomic compare exchange to set the new value, and retry if there is
   * a collision.
   */
  if (!fl_search_done) {
    ...
    if ((test_sfirst.ptr == sfirst.ptr) && (test_sfirst.sn == sfirst.sn)) {
      ...
      if (sfirst.ptr == slast.ptr) {
        ...
        if (NULL == snext.ptr) {
          ...
          /* the free list is empty */
          atomic_fetch_add(
              &(H5I_mt_g.num_id_info_fl_alloc_req_denied_due_to_empty), 1);
          fl_search_done = TRUE;
          break;
        }
        ...
        if (!atomic_compare_exchange_strong(&(H5I_mt_g.id_info_fl_shead),
          ...
          /* first has been removed from the free list.  Set fl_node_ptr to
           * first, update stats, and exit the loop by setting fl_search_done to
           * true.
           */
          id_info_ptr = sfirst.ptr;
          ...
          result = atomic_compare_exchange_strong(&(id_info_ptr->fl_snext),
                                                  &snext, new_snext);
          assert(result);
          ...
          atomic_fetch_sub(&(H5I_mt_g.id_info_fl_len), 1ULL);
          atomic_fetch_add(&(H5I_mt_g.num_id_info_structs_alloced_from_fl),
                           1ULL);
...
static herr_t H5I__discard_mt_type_info(H5I_mt_type_info_t *type_info_ptr) {
  ...
  result =
      atomic_compare_exchange_strong(&(type_info_ptr->on_fl), &on_fl, TRUE);
  assert(result);
  ...
  while (!done) {
    ...
    if ((test_fl_stail.ptr == fl_stail.ptr) &&
      ...
      if (NULL == fl_snext.ptr) {
        ...
        /* attempt to append type_info_ptr by setting fl_tail->fl_snext.ptr to
         * type_info_ptr. If this succeeds, update stats and attempt to set
         * H5I_mt_g.type_info_fl_stail.ptr to type_info_ptr as well.  This may
         * or may not succeed, but in either case we are done.
         */
        new_fl_snext.ptr = type_info_ptr;
        new_fl_snext.sn = fl_snext.sn + 1;
        if (atomic_compare_exchange_strong(&(fl_stail.ptr->fl_snext), &fl_snext,
          ...
          /* if appropriate, attempt to update H5I_mt_g.max_type_info_fl_len. In
           * the event of a collision, just ignore it and go on, as I don't see
           * any reasonable way to recover.
           */
          if ((fl_len = atomic_load(&(H5I_mt_g.type_info_fl_len))) >
            ...
            atomic_compare_exchange_strong(&(H5I_mt_g.max_type_info_fl_len),
                                           &max_fl_len, fl_len);
          }
  ...
  /* test to see if both H5I_mt_g.type_info_fl_len and
   * H5I_mt_g.num_type_info_fl_entries_reallocable are greater than
   * H5I_mt_g.max_desired_type_info_fl_len.  Check both, as while we want to
   * keep the free list length around H5I_mt_g.max_desired_type_info_fl_len, we
   * also want to have an ample supply of reallocable free list entries on hand.
   */
#if 1
...
#if 1
  if ((atomic_load(&(H5I_mt_g.type_info_fl_len)) >
  ...
  if ((atomic_load(&(H5I_mt_g.type_info_fl_len)) >
    ...
    atomic_fetch_add(
        &(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_fl_too_small), 1ULL);
  }
...
#else
    while ((!reallocable_entry_available) &&
           (0 < (snum_fl_entries_reallocable = atomic_load(
                     &(H5I_mt_g.snum_type_info_fl_entries_reallocable)))
                    .val)) {
      ...
      if (atomic_compare_exchange_strong(
        ...
        fprintf(stderr,
                "\ndisc: old/new snum_type_info_fl_entries_reallocable = "
                "{%lld, %lld} / {%lld, %lld}\n",
        ...
        if ((test_fl_shead.ptr == fl_shead.ptr) &&
          ...
          if (fl_shead.ptr == fl_stail.ptr) {
            ...
            if (NULL == fl_snext.ptr) {
              ...
              /* the free list is empty */
              atomic_fetch_add(
                  &(H5I_mt_g.num_type_info_fl_frees_skipped_due_to_empty), 1);
              done = TRUE;
              break;
            }

            /* attempt to set H5I_mt_g.type_info_fl_stail to fl_snext.  It
             * doesn't matter whether we succeed or fail, as if we fail, it just
             * means that some other thread beat us to it.
             *
             * that said, it doesn't hurt to collect stats
             */
            new_fl_stail.ptr = fl_snext.ptr;
            ...
            if (!atomic_compare_exchange_strong(&(H5I_mt_g.type_info_fl_stail),
              ...
              atomic_fetch_add(&(H5I_mt_g.num_type_info_fl_tail_update_cols),
                               1ULL);
            }
          } else {
            ...
            if (!atomic_compare_exchange_strong(&(H5I_mt_g.type_info_fl_shead),
               ...
               * failed.  Update stats and try again.
               */
              atomic_fetch_add(&(H5I_mt_g.num_type_info_fl_head_update_cols),
                               1ULL);
              ...
              /* first has been removed from the free list.  Set type_info_ptr
               * to fl_shead.ptr, discard *type_info_ptr, update stats, and exit
               * the loop by setting done to true.
               */
...
static H5I_mt_type_info_t *H5I__new_mt_type_info(const H5I_class_t *cls,
  ...
  /* Test to see if there is a re-allocable entry on the free list.
   * Conceptually, we test to see if
   * H5I_mt_g.num_type_info_fl_entries_reallocable is positive, we decrement it
   * and set entry_reallocable to TRUE.  Practically, it is a bit more
   * complicated, as it is possible that
   * H5I_mt_g.num_type_info_fl_entries_reallocable between the time that we read
   * it to see if it is positive, and we decrement it.  To deal with this, we
   * use an atomic compare exchange to set the new value, and retry if there is
   * a collision.
   */
  if (!fl_search_done) {
    ...
    while ((!reallocable_entry_available) &&
      ...
      if (atomic_compare_exchange_strong(
        ...
        fprintf(stderr,
                "\nalloc: old/new snum_type_info_fl_entries_reallocable = "
                "{%lld, %lld} / {%lld, %lld}\n",
                (long long)snum_fl_entries_reallocable.val,
                (long long)snum_fl_entries_reallocable.sn,
                (long long)new_snum_fl_entries_reallocable.val,
    ...
    if ((test_sfirst.ptr == sfirst.ptr) && (test_sfirst.sn == sfirst.sn)) {
      ...
      if (sfirst.ptr == slast.ptr) {
        ...
        if (NULL == snext.ptr) {
          ...
          /* the free list is empty */
          atomic_fetch_add(
              &(H5I_mt_g.num_type_info_fl_alloc_req_denied_due_to_empty), 1);
          fl_search_done = TRUE;
          break;
        }
        ...
        if (!atomic_compare_exchange_strong(&(H5I_mt_g.type_info_fl_shead),
          ...
          result = atomic_compare_exchange_strong(&(type_info_ptr->fl_snext),
                                                  &snext, new_snext);
          assert(result);

          atomic_fetch_sub(&(H5I_mt_g.type_info_fl_len), 1ULL);
          atomic_fetch_add(&(H5I_mt_g.num_type_info_structs_alloced_from_fl),
                           1ULL);
...
void H5I__enter(hbool_t public_api) {
  if (public_api) {
...
void H5I__exit(void) {
  ...
  if (1ULL == atomic_fetch_sub(&(H5I_mt_g.active_threads), 1ULL)) {
    ...
    pre_internal_entries =
        atomic_load(&(H5I_mt_g.num_H5I_entries_via_internal_API));
    ...
    post_internal_entries =
        atomic_load(&(H5I_mt_g.num_H5I_entries_via_internal_API));

    /* test to see if any threads have entered while we were collecting the
     * data on the free lists.  If any have, abort, as our data on the free
     * lists may be inconsistent.
     */
    if ((active_threads != 0) || (pre_api_entries != post_api_entries) ||
       ...
       */
      atomic_fetch_add(&(H5I_mt_g.num_id_info_fl_num_reallocable_update_aborts),
                       1ULL);
      ...
      if (id_info_fl_len == num_id_info_fl_entries_reallocable) {
         ...
         */
        atomic_fetch_add(
            &(H5I_mt_g.num_id_info_fl_num_reallocable_update_noops), 1ULL);
        ...
        new_num_id_info_fl_entries_reallocable =
            num_id_info_fl_entries_reallocable + delta;
        ...
        if (atomic_compare_exchange_strong(
          ...
          atomic_fetch_add(&(H5I_mt_g.num_id_info_fl_num_reallocable_updates),
                           1ULL);
          atomic_fetch_add(&(H5I_mt_g.num_id_info_fl_num_reallocable_total),
                           delta);
      ...
      if (type_info_fl_len == snum_type_info_fl_entries_reallocable.val) {
        ...
        /* All entries in the type info free list are already maked as
         * reallocable -- Nothing to do here -- just update stats
         */
        atomic_fetch_add(
            &(H5I_mt_g.num_type_info_fl_num_reallocable_update_noops), 1ULL);
        ...
        new_num_type_info_fl_entries_reallocable =
            num_type_info_fl_entries_reallocable + delta;
#else
        new_snum_type_info_fl_entries_reallocable.val =
            snum_type_info_fl_entries_reallocable.val + delta;
        new_snum_type_info_fl_entries_reallocable.sn =
            snum_type_info_fl_entries_reallocable.sn + 1;
#endif
        ...
        if (atomic_compare_exchange_strong(
          ...
          fprintf(stderr,
                  "\nexit: old/new snum_type_info_fl_entries_reallocable = "
                  "{%lld, %lld} / {%lld, %lld}\n",
          ...
          /* success -- update stats accordingly */
          atomic_fetch_add(&(H5I_mt_g.num_type_info_fl_num_reallocable_updates),
                           1ULL);
          atomic_fetch_add(&(H5I_mt_g.num_type_info_fl_num_reallocable_total),
                           delta);
