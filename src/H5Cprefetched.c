 ...
 ****************************************************************************/
static herr_t
H5C__prefetched_entry_get_initial_load_size(void *udata_ptr,
...
static herr_t H5C__prefetched_entry_get_initial_load_size(
    void H5_ATTR_UNUSED *udata_ptr, size_t H5_ATTR_UNUSED *image_len_ptr) {
  FUNC_ENTER_PACKAGE_NOERR /* Yes, even though this pushes an error on the stack
                            */

                               HERROR(H5E_CACHE, H5E_SYSTEM,
                                      "called unreachable fcn.");

  FUNC_LEAVE_NOAPI(FAIL)
} /* end H5C__prefetched_entry_get_initial_load_size() */

static herr_t H5C__prefetched_entry_get_final_load_size(
    const void H5_ATTR_UNUSED *image_ptr, size_t H5_ATTR_UNUSED image_len,
    void H5_ATTR_UNUSED *udata_ptr, size_t H5_ATTR_UNUSED *actual_len_ptr) {
  FUNC_ENTER_PACKAGE_NOERR /* Yes, even though this pushes an error on the stack
                            */
...
static void *H5C__prefetched_entry_deserialize(
    const void H5_ATTR_UNUSED *image_ptr, size_t H5_ATTR_UNUSED len,
...
static herr_t H5C__prefetched_entry_pre_serialize(
    H5F_t H5_ATTR_UNUSED *f, void H5_ATTR_UNUSED *thing,
...
static herr_t H5C__prefetched_entry_serialize(const H5F_t H5_ATTR_UNUSED *f,
...
static herr_t H5C__prefetched_entry_free_icr(void *_thing) {
  ...
  if (entry_ptr->image_ptr != NULL)
    HGOTO_ERROR(H5E_CACHE, H5E_SYSTEM, FAIL,
                "prefetched entry image buffer still attached?");
