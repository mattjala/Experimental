...
static void *H5O__stab_decode(H5F_t *f, H5O_t *open_oh, unsigned mesg_flags,
                              ...
                              const uint8_t *p);
static herr_t H5O__stab_encode(H5F_t *f, hbool_t disable_shared, uint8_t *p,
                               const void *_mesg);
static void *H5O__stab_copy(const void *_mesg, void *_dest);
static size_t H5O__stab_size(const H5F_t *f, hbool_t disable_shared,
                             const void *_mesg);
...
static herr_t H5O__stab_post_copy_file(const H5O_loc_t *src_oloc,
                                       ...
                                       unsigned *mesg_flags,
                                       H5O_copy_t *cpy_info);
static herr_t H5O__stab_debug(H5F_t *f, const void *_mesg, FILE *stream,
 ...
 *-------------------------------------------------------------------------
 */
static void *H5O__stab_decode(H5F_t *f, H5O_t H5_ATTR_UNUSED *open_oh,
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__stab_encode(H5F_t *f, hbool_t H5_ATTR_UNUSED disable_shared,
 ...
 *-------------------------------------------------------------------------
 */
static size_t H5O__stab_size(const H5F_t *f,
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__stab_delete(H5F_t *f, H5O_t H5_ATTR_UNUSED *open_oh,
                               void *mesg) {
...
static void *H5O__stab_copy_file(H5F_t *file_src, void *native_src,
  ...
  if (H5G__stab_create_components(file_dst, stab_dst, size_hint) < 0)
    HGOTO_ERROR_TAG(H5E_SYM, H5E_CANTINIT, NULL,
...
static herr_t H5O__stab_post_copy_file(const H5O_loc_t *src_oloc,
  ...
  if ((H5B_iterate(src_oloc->file, H5B_SNODE, stab_src->btree_addr,
                   H5G__node_copy, &udata)) < 0)
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__stab_debug(H5F_t H5_ATTR_UNUSED *f, const void *_mesg,
