...
static herr_t H5C__epoch_marker_get_final_load_size(const void *image_ptr,
                                                    ...
                                                    void *udata_ptr,
                                                    size_t *actual_len);
static htri_t H5C__epoch_marker_verify_chksum(const void *image_ptr, size_t len,
                                              void *udata_ptr);
static void *H5C__epoch_marker_deserialize(const void *image_ptr, size_t len,
                                           void *udata, hbool_t *dirty_ptr);
...
static herr_t H5C__epoch_marker_pre_serialize(H5F_t *f, void *thing,
                                              ...
                                              size_t *new_len_ptr,
                                              unsigned *flags_ptr);
static herr_t H5C__epoch_marker_serialize(const H5F_t *f, void *image_ptr,
...
static herr_t H5C__epoch_marker_get_final_load_size(
...
static htri_t
H5C__epoch_marker_verify_chksum(const void H5_ATTR_UNUSED *image_ptr,
...
static void *H5C__epoch_marker_deserialize(const void H5_ATTR_UNUSED *image_ptr,
                                           size_t H5_ATTR_UNUSED len,
...
static herr_t H5C__epoch_marker_pre_serialize(
...
static herr_t H5C__epoch_marker_serialize(const H5F_t H5_ATTR_UNUSED *f,
