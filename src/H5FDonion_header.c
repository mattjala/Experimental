 ...
 *-----------------------------------------------------------------------------
 */
herr_t H5FD__onion_ingest_header(H5FD_onion_header_t *hdr_out, H5FD_t *raw_file,
                                 haddr_t addr) {
 ...
 *-----------------------------------------------------------------------------
 */
size_t H5FD__onion_header_decode(unsigned char *buf,
 ...
 *-----------------------------------------------------------------------------
 */
size_t H5FD__onion_header_encode(H5FD_onion_header_t *header,
                                 unsigned char *buf,
                                 uint32_t *checksum /*out*/) {
