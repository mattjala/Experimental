...
/* Values for the optimization of compound data reading and writing.  They
 * indicate whether the fields of the source and destination are subset of each
 * other and there is no conversion needed.
 */
typedef enum {
...
H5_DLL herr_t H5T_reclaim_cb(void *elem, const H5T_t *dt, unsigned ndim,
...
H5_DLL herr_t H5T_invoke_vol_optional(H5T_t *dt, H5VL_optional_args_t *args,
