...
#define H5C__DURING_FLUSH_FLAG                                                 \
  0x10000 /* Set when the entire cache is being flushed */
 ...
 *
 *        typedef herr_t (*H5C_get_final_load_size_func_t)(const void
 **image_ptr, size_t image_len, void *udata_ptr, size_t *actual_len_ptr);
 *
...
typedef htri_t (*H5C_verify_chksum_func_t)(const void *image_ptr, size_t len,
                                           void *udata_ptr);
typedef void *(*H5C_deserialize_func_t)(const void *image_ptr, size_t len,
...
H5_DLL herr_t H5C_evict_tagged_entries(H5F_t *f, haddr_t tag,
                                       hbool_t match_global);
H5_DLL herr_t H5C_expunge_tag_type_metadata(H5F_t *f, haddr_t tag, int type_id,
                                            unsigned flags);
...
H5_DLL herr_t H5C_get_cache_size(const H5C_t *cache_ptr, size_t *max_size_ptr,
                                 size_t *min_clean_size_ptr,
                                 size_t *cur_size_ptr,
                                 uint32_t *cur_num_entries_ptr);
H5_DLL herr_t H5C_get_cache_flush_in_progress(const H5C_t *cache_ptr,
                                              hbool_t *flush_in_progress_ptr);
H5_DLL herr_t H5C_get_cache_hit_rate(const H5C_t *cache_ptr,
                                     double *hit_rate_ptr);
H5_DLL herr_t H5C_get_entry_status(
    const H5F_t *f, haddr_t addr, size_t *size_ptr, hbool_t *in_cache_ptr,
...
H5_DLL herr_t H5C_get_mdc_image_info(const H5C_t *cache_ptr,
                                     haddr_t *image_addr, hsize_t *image_len);
