...
public class TestH5Dplist {
  ...
  private final void _createDataset(long fid, long dsid, String name, long dcpl,
                                    long dapl) {
    try {
  ...
  public void testH5Dset_extent() {
    ...
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_INT, HDF5Constants.H5S_ALL,
    ...
    assertTrue("testH5Dset_extent - H5.H5Dread: ",
               extend_dset_data[3][6] == 12);
    assertTrue("testH5Dset_extent - H5.H5Dread: ",
               extend_dset_data[4][8] == 99);
  }
