...
public class TestH5Drw {
  ...
  public void testH5Dread_8bit_ints() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_UINT8, HDF5Constants.H5S_ALL,
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_INT8, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
      fail("testH5Dread_8bit_ints: H5Dread: " + err);
  ...
  public void testH5Dread_16bit_ints() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_UINT16, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_INT16, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
      fail("testH5Dread_16bit_ints: H5Dread: " + err);
  ...
  public void testH5Dread_32bit_ints() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_UINT32, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_INT32, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
      fail("testH5Dread_32bit_ints: H5Dread: " + err);
  ...
  public void testH5Dread_64bit_ints() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_UINT64, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_INT64, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
      fail("testH5Dread_64bit_ints: H5Dread: " + err);
  ...
  public void testH5Dread_32bit_floats() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_FLOAT, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
    ...
    for (int i = 0; i < DIM_X; i++)
      assertTrue("testH5Dread_32bit_floats - H5.H5Dread: ",
                 dset_data[i][0] == (32 - i));
  }
  ...
  public void testH5Dread_64bit_floats() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_DOUBLE, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
    ...
    for (int i = 0; i < DIM_X; i++)
      assertTrue("testH5Dread_64bit_floats - H5.H5Dread: ",
                 dset_data[i][0] == (64 - i));
  }
  ...
  public void testH5Dread_128bit_floats() {
    ...
    // Read data.
    try {
      H5.H5Dread(H5did, HDF5Constants.H5T_NATIVE_LDOUBLE, HDF5Constants.H5S_ALL,
                 HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT, dset_data);
    } catch (Exception err) {
      err.printStackTrace();
