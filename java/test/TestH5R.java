...
public class TestH5R {
  ...
  public void createH5file() throws NullPointerException, HDF5Exception {
    ...
    try {
      ...
      H5did2 =
          _createDataset(H5gid, H5dsid, "dset2", HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5Rcreate_regionref_object() {
    ...
    try {
      H5.H5Sselect_hyperslab(H5dsid, HDF5Constants.H5S_SELECT_SET, start,
                             stride, count, block);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  //            ref2 = H5.H5Rcreate(H5gid, "/Group1", HDF5Constants.H5R_OBJECT,
  //            -1); group_id= H5.H5Rdereference(H5gid,
  //            HDF5Constants.H5P_DEFAULT, HDF5Constants.H5R_OBJECT, ref2);
  //            assertNotNull(ref1); assertNotNull(ref2); assertTrue(dataset_id
  //            >= 0); assertTrue(group_id >= 0);
  //        }
  //        catch (Throwable err) {
  //            err.printStackTrace();
  ...
  //        }
  //        try {
  //            dsid = H5.H5Rget_region(H5fid, HDF5Constants.H5R_DATASET_REGION,
  //            ref); assertNotNull(ref); assertTrue(dsid >= 0);
  //        }
  //        catch (Throwable err) {
  //            err.printStackTrace();
  ...
  public void testH5RVLattr_ref() {
    ...
    try {
      ...
      ref1 = H5.H5Rcreate(H5fid, "/dset", HDF5Constants.H5R_DATASET_REGION,
                          H5dsid);
      assertNotNull(ref1);
      ref2 = H5.H5Rcreate(H5gid, "dset2", HDF5Constants.H5R_DATASET_REGION,
                          H5dsid);
      assertNotNull(ref2);
    ...
    try {
      ...
      vl_obj_data[3] =
          new ArrayList<byte[]>(Arrays.asList(ref4, ref4, ref4, ref4));
      Class dataClass = vl_obj_data.getClass();
      assertTrue("testH5RVLattr_ref.getClass: " + dataClass,
                 dataClass.isArray());
      ...
      try {
        ...
        attr_obj_id =
            H5.H5Acreate(H5did, attr_obj_name, atype_obj_id, aspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
      ...
      vl_reg_data[3] =
          new ArrayList<byte[]>(Arrays.asList(ref2, ref2, ref2, ref2));
      ...
      try {
        ...
        assertTrue(aspace_id > 0);
        attr_reg_id =
            H5.H5Acreate(H5did, attr_reg_name, atype_reg_id, aspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
      ...
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[0].get(0))[0],
                 ((byte[])vl_obj_data[0].get(0))[0] ==
                     ((byte[])vl_readbuf[0].get(0))[0]);
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[1].get(0))[0],
                 ((byte[])vl_obj_data[1].get(0))[0] ==
                     ((byte[])vl_readbuf[1].get(0))[0]);
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[2].get(0))[0],
                 ((byte[])vl_obj_data[2].get(0))[0] ==
                     ((byte[])vl_readbuf[2].get(0))[0]);
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[3].get(0))[0],
                 ((byte[])vl_obj_data[3].get(0))[0] ==
                     ((byte[])vl_readbuf[3].get(0))[0]);
      ...
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[0].get(0))[0],
                 ((byte[])vl_reg_data[0].get(0))[0] ==
                     ((byte[])vl_readbuf[0].get(0))[0]);
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[1].get(0))[0],
                 ((byte[])vl_reg_data[1].get(0))[0] ==
                     ((byte[])vl_readbuf[1].get(0))[0]);
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[2].get(0))[0],
                 ((byte[])vl_reg_data[2].get(0))[0] ==
                     ((byte[])vl_readbuf[2].get(0))[0]);
      assertTrue("testH5RVLattr_ref:" + ((byte[])vl_readbuf[3].get(0))[0],
                 ((byte[])vl_reg_data[3].get(0))[0] ==
                     ((byte[])vl_readbuf[3].get(0))[0]);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.testH5RVLattr_ref: " + err);
  ...
  public void testH5RVLdset_ref() {
    ...
    try {
      ...
      vl_obj_data[3] =
          new ArrayList<byte[]>(Arrays.asList(ref4, ref4, ref4, ref4));
      Class dataClass = vl_obj_data.getClass();
      assertTrue("testH5RVLdset_ref.getClass: " + dataClass,
                 dataClass.isArray());
      ...
      try {
        ...
        dset_obj_id =
            H5.H5Dcreate(H5fid, dset_obj_name, dtype_obj_id, dspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT,
                         HDF5Constants.H5P_DEFAULT);
        assertTrue("testH5RVLdset_ref: ", dset_obj_id >= 0);

        H5.H5Dwrite(dset_obj_id, dtype_obj_id, HDF5Constants.H5S_ALL,
      ...
      try {
        ...
        assertTrue(dspace_id > 0);
        dset_reg_id =
            H5.H5Dcreate(H5fid, dset_reg_name, dtype_reg_id, dspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT,
                         HDF5Constants.H5P_DEFAULT);
        assertTrue("testH5RVLdset_ref: ", dset_reg_id >= 0);

        H5.H5Dwrite(dset_reg_id, dtype_reg_id, HDF5Constants.H5S_ALL,
                    HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT,
                    vl_reg_data);
      } catch (Exception err) {
        if (dset_reg_id > 0)
      ...
      try {
        H5.H5Dread(dset_obj_id, dtype_obj_id, HDF5Constants.H5S_ALL,
                   HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT,
                   vl_readbuf);
      } catch (Exception ex) {
        ex.printStackTrace();
      ...
      try {
        H5.H5Dread(dset_reg_id, dtype_reg_id, HDF5Constants.H5S_ALL,
                   HDF5Constants.H5S_ALL, HDF5Constants.H5P_DEFAULT,
                   vl_readbuf);
      } catch (Exception ex) {
        ex.printStackTrace();
