...
public class TestH5Giterate {
  ...
  public void testH5Gget_obj_info_all() {
    ...
    try {
      names_found =
          H5.H5Gget_obj_info_all(H5fid, "/", objNames, objTypes, lnkTypes,
    ...
    for (int i = 0; i < objNames.length; i++) {
      ...
      if (objTypes[i] == HDF5Constants.H5O_TYPE_GROUP) {
        ...
        assertTrue("Group is : " + objNames[i] + " ",
                   objNames[i].compareToIgnoreCase("G1") == 0);
        ...
        assertTrue("Datatype is : " + objNames[i] + " ",
                   objNames[i].compareToIgnoreCase("DT1") == 0);
      } else {
