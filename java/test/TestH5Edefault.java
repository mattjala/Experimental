...
public class TestH5Edefault {
  ...
  public void testH5Eprint() {
    ...
    if (connector == null) {
      try {
        H5.H5Fopen("test", HDF5Constants.H5F_ACC_RDWR,
  ...
  public void testH5Eget_current_stack_pop() {
    ...
    assertTrue("H5.H5Eget_current_stack: pop #:" + num_msg_default,
               num_msg_default == saved_num_msg - 1);
  ...
  public void testH5Epush_null_name() throws Throwable {
    H5.H5Epush(HDF5Constants.H5E_DEFAULT, null, "Invalid", 0,
               HDF5Constants.H5E_DEFAULT, HDF5Constants.H5E_DEFAULT,
               HDF5Constants.H5E_DEFAULT, "Invalid message");
  }
