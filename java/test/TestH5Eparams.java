...
public class TestH5Eparams {
  ...
  public void testH5Ecreate_msg_major() {
    try {
      long err_id = H5.H5Ecreate_msg(hdf_java_classid, HDF5Constants.H5E_MAJOR,
                                     "Error in Test");
  ...
  public void testH5Ecreate_msg_minor() {
    try {
      long err_id = H5.H5Ecreate_msg(hdf_java_classid, HDF5Constants.H5E_MINOR,
  ...
  public void testH5Eget_msg() {
    ...
    String msg = null;
    try {
      err_id = H5.H5Ecreate_msg(hdf_java_classid, HDF5Constants.H5E_MAJOR,
                                "Error in Test");
    } catch (Throwable err) {
      err.printStackTrace();
