...
public class TestH5S {
  ...
  public void testH5Sget_simple_extent_dims() {
    ...
    try {
      ...
      assertTrue("H5.H5Sget_simple_extent_dims:maxdims",
                 H5maxdims[0] == maxdims[0]);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Sget_simple_extent_dims: " + err);
    }
  ...
  public void testH5Sget_simple_extent_npoints() {
    ...
    try {
      ...
      assertTrue("H5.H5Sget_simple_extent_npoints",
                 (H5dims[0] * H5dims[1]) == num_elements);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Sget_simple_extent_type() {
    ...
    try {
      ...
      assertTrue("H5.H5Sget_simple_extent_type",
                 HDF5Constants.H5S_SIMPLE == read_type);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Sset_extent_simple() {
    ...
    try {
      ...
      num_elements = H5.H5Sget_simple_extent_npoints(H5sid);
      assertTrue("H5.H5Sget_simple_extent_npoints",
                 (H5maxdims[0] * H5maxdims[1]) == num_elements);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Sget_select_type() {
    ...
    try {
      ...
      assertTrue("H5.H5Sget_select_type",
                 HDF5Constants.H5S_SEL_ALL == read_type);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Sset_extent_none() {
    ...
    try {
      ...
      read_type = H5.H5Sget_simple_extent_type(H5sid);
      assertTrue("H5.H5Sget_simple_extent_type: " + read_type,
                 HDF5Constants.H5S_NULL == read_type);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Sset_extent_none: " + err);
    }
  ...
  public void testH5Sextent_copy() {
    ...
    try {
      ...
      assertTrue("H5.H5Screate_null: type",
                 class_type == HDF5Constants.H5S_SIMPLE);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Sselect_none() {
    ...
    try {
      ...
      read_type = H5.H5Sget_select_type(H5sid);
      assertTrue("H5.H5Sget_select_type: " + read_type,
                 HDF5Constants.H5S_SEL_NONE == read_type);
  ...
  public void testH5Sget_select_elem_pointlist() {
    long coord[][] = {
        {0, 1}, {2, 3}, {4, 5}}; /* Coordinates for point selection */
    long getcoord[] = {-1, -1, -1,
                       -1, -1, -1}; /* Coordinates for get point selection */
    try {
      H5.H5Sselect_elements(H5sid, HDF5Constants.H5S_SELECT_SET, 3, coord);
      H5.H5Sget_select_elem_pointlist(H5sid, 0, 3, getcoord);
  ...
  public void testH5Soffset_simple() {
    long coord[][] = {
        {2, 2}, {2, 4}, {4, 2}, {4, 4}}; /* Coordinates for point selection */
    long lowbounds[] = {-1, -1};
    long hibounds[] = {-1, -1};
    try {
  ...
  public void testH5Sget_select_hyper() {
    ...
    try {
      ...
      H5.H5Sselect_hyperslab(space1, HDF5Constants.H5S_SELECT_AND, start,
                             stride, count, block);
  ...
  public void testH5Sget_select_valid() {
    ...
    try {
      ...
      assertTrue("H5.H5Scopy", H5sid > 0);
      // 'AND' "all" selection with another hyperslab
      H5.H5Sselect_hyperslab(space1, HDF5Constants.H5S_SELECT_SET, start,
                             stride, count, block);
  ...
  public void testH5Shyper_regular() {
    ...
    try {
      ...
      H5.H5Sselect_hyperslab(H5sid, HDF5Constants.H5S_SELECT_SET, start, stride,
                             count, block);
      ...
      for (int u = 0; u < H5rank; u++) {
        ...
        assertTrue("H5Sget_regular_hyperslab, stride",
                   stride[u] == q_stride[u]);
