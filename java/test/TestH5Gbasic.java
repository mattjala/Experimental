...
public class TestH5Gbasic {
  ...
  public void testH5Gcreate() {
    long gid = HDF5Constants.H5I_INVALID_HID;
    try {
      gid = H5.H5Gcreate(H5fid, "/testH5Gcreate", HDF5Constants.H5P_DEFAULT,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Gcreate: " + err);
  ...
  public void testH5Gget_info_by_idx_not_exists() throws Throwable {
    H5.H5Gget_info_by_idx(H5fid, "/testH5Gcreate", HDF5Constants.H5_INDEX_NAME,
                          HDF5Constants.H5_ITER_INC, 1L,
                          HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Gget_info_by_idx_fileid() {
    ...
    try {
      info = H5.H5Gget_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_NAME,
                                   HDF5Constants.H5_ITER_INC, 0,
                                   HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
