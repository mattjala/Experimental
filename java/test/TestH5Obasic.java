...
public class TestH5Obasic {
  ...
  public void testH5Oget_info_dataset() {
    ...
    assertTrue("H5Oget_info object type",
  ...
  public void testH5Oget_info_group() {
    ...
    assertFalse("H5Oget_info ", obj_info == null);
    assertTrue("H5Oget_info object type",
               obj_info.type == HDF5Constants.H5O_TYPE_GROUP);
    try {
      H5.H5Oclose(oid);
    } catch (Exception ex) {
    }
  ...
  public void testH5Oget_info_datatype() {
    ...
    assertFalse("H5Oget_info ", obj_info == null);
    assertTrue("H5Oget_info object type",
               obj_info.type == HDF5Constants.H5O_TYPE_NAMED_DATATYPE);
    try {
      H5.H5Oclose(oid);
    } catch (Exception ex) {
    }
  ...
  public void testH5Oget_info_by_name_dataset() {
    ...
    try {
      obj_info =
          H5.H5Oget_info_by_name(H5fid, "DS1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Oget_info: " + err);
    }
  ...
  public void testH5Oget_info_by_name_datatype() {
    ...
    try {
      obj_info =
          H5.H5Oget_info_by_name(H5fid, "DT1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Oget_info: " + err);
    }
  ...
  public void testH5Oget_info_by_idx_name_not_exist_name() throws Throwable {
    H5.H5Oget_info_by_idx(H5fid, "None", HDF5Constants.H5_INDEX_NAME,
  ...
  public void testH5Oget_info_by_idx_name_not_exist_create() throws Throwable {
    H5.H5Oget_info_by_idx(H5fid, "None", HDF5Constants.H5_INDEX_CRT_ORDER,
                          HDF5Constants.H5_ITER_INC, 0,
                          HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Oget_info_by_idx_not_exist_name() throws Throwable {
    H5.H5Oget_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_NAME,
                          HDF5Constants.H5_ITER_INC, 5,
                          HDF5Constants.H5P_DEFAULT);
  }

  @Test(expected = HDF5LibraryException.class)
  public void testH5Oget_info_by_idx_not_exist_create() throws Throwable {
    H5.H5Oget_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_CRT_ORDER,
                          HDF5Constants.H5_ITER_INC, 5,
                          HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Oget_info_by_idx_n0() {
    ...
    assertFalse("testH5Oget_info_by_idx_n0:H5Oget_info_by_idx ",
                obj_info == null);
    assertTrue("testH5Oget_info_by_idx_n0:H5Oget_info_by_idx link type",
               obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
    assertTrue("testH5Oget_info_by_idx_n0:Link Object token",
               obj_info.token.equals(H5la_ds1));
  }
  ...
  public void testH5Oget_info_by_idx_n3() {
    ...
    try {
      obj_info = H5.H5Oget_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_NAME,
                                       HDF5Constants.H5_ITER_INC, 3,
                                       HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("testH5Oget_info_by_idx_n3:H5.H5Oget_info_by_idx: " + err);
    }
    assertFalse("testH5Oget_info_by_idx_n3:H5Oget_info_by_idx ",
                obj_info == null);
    assertTrue("testH5Oget_info_by_idx_n3:H5Oget_info_by_idx link type",
               obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
    assertTrue("testH5Oget_info_by_idx_n3:Link Object Token",
               obj_info.token.equals(H5la_l1));
  }
  ...
  public void testH5Oget_native_info_by_name_dataset() {
    ...
    try {
      native_info = H5.H5Oget_native_info_by_name(H5fid, "DS1",
                                                  HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Oget_native_info_by_name_hardlink() {
    ...
    try {
      native_info =
          H5.H5Oget_native_info_by_name(H5fid, "L1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Oget_native_info_by_name: " + err);
    }
  ...
  public void testH5Oget_native_info_by_name_group() {
    ...
    try {
      native_info =
          H5.H5Oget_native_info_by_name(H5fid, "G1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Oget_native_info_by_name: " + err);
    }
  ...
  public void testH5Oget_native_info_by_name_datatype() {
    ...
    try {
      native_info = H5.H5Oget_native_info_by_name(H5fid, "DT1",
                                                  HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Oget_native_info_by_name: " + err);
  ...
  @Test(expected = HDF5LibraryException.class)
  public void testH5Oget_native_info_by_idx_name_not_exist_name()
      throws Throwable {
    H5.H5Oget_native_info_by_idx(H5fid, "None", HDF5Constants.H5_INDEX_NAME,
                                 HDF5Constants.H5_ITER_INC, 0,
                                 HDF5Constants.H5P_DEFAULT);
  }

  @Test(expected = HDF5LibraryException.class)
  public void testH5Oget_native_info_by_idx_name_not_exist_create()
      throws Throwable {
    H5.H5Oget_native_info_by_idx(
        H5fid, "None", HDF5Constants.H5_INDEX_CRT_ORDER,
  ...
  @Test(expected = HDF5LibraryException.class)
  public void testH5Oget_native_info_by_idx_not_exist_create()
      throws Throwable {
    H5.H5Oget_native_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_CRT_ORDER,
                                 HDF5Constants.H5_ITER_INC, 5,
                                 HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Oget_native_info_by_idx_n0() {
    ...
    try {
      native_info = H5.H5Oget_native_info_by_idx(
          H5fid, "/", HDF5Constants.H5_INDEX_NAME, HDF5Constants.H5_ITER_INC, 0,
          HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("testH5Oget_native_info_by_idx_n0:H5.H5Oget_native_info_by_idx: " +
           err);
    }
    ...
    assertTrue("testH5Oget_native_info_by_idx_n0:Object Header Info",
               native_info.hdr_info.equals(ohdr));
    assertTrue("testH5Oget_native_info_by_idx_n0:Object Info",
               native_info.obj_info.equals(oinfo));
    assertTrue("testH5Oget_native_info_by_idx_n0:Attribute Info",
               native_info.attr_info.equals(ainfo));
  }
  ...
  public void testH5Oget_native_info_by_idx_n3() {
    ...
    try {
      native_info = H5.H5Oget_native_info_by_idx(
          H5fid, "/", HDF5Constants.H5_INDEX_NAME, HDF5Constants.H5_ITER_INC, 3,
          HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("testH5Oget_native_info_by_idx_n3:H5.H5Oget_native_info_by_idx: " +
           err);
    }
    assertFalse("H5Oget_native_info_by_idx ", native_info == null);
    assertFalse("H5Oget_native_info_by_idx ", native_info.hdr_info == null);
    assertFalse("H5Oget_native_info_by_idx ", native_info.obj_info == null);
    assertFalse("H5Oget_native_info_by_idx ", native_info.attr_info == null);
    assertTrue("testH5Oget_native_info_by_idx_n3:Object Header Info",
               native_info.hdr_info.equals(ohdr));
    assertTrue("testH5Oget_native_info_by_idx_n3:Object Info",
               native_info.obj_info.equals(oinfo));
    assertTrue("testH5Oget_native_info_by_idx_n3:Attribute Info",
               native_info.attr_info.equals(ainfo));
  }
  ...
  public void testH5Ovisit() {
    ...
    class H5O_iter_callback implements H5O_iterate_t {
      public int callback(long group, String name, H5O_info_t info,
    ...
    try {
      H5.H5Ovisit(H5fid, HDF5Constants.H5_INDEX_NAME, HDF5Constants.H5_ITER_INC,
                  iter_cb, iter_data);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    assertTrue("H5Ovisit " +
                   (((H5O_iter_data)iter_data).iterdata.get(0)).link_name,
               (((H5O_iter_data)iter_data).iterdata.get(0))
                       .link_name.compareToIgnoreCase(".") == 0);
    assertTrue("H5Ovisit " +
                   (((H5O_iter_data)iter_data).iterdata.get(1)).link_name,
               (((H5O_iter_data)iter_data).iterdata.get(1))
                       .link_name.compareToIgnoreCase("DS1") == 0);
    assertTrue("H5Ovisit " +
                   (((H5O_iter_data)iter_data).iterdata.get(2)).link_name,
               (((H5O_iter_data)iter_data).iterdata.get(2))
                       .link_name.compareToIgnoreCase("DT1") == 0);
    assertTrue("H5Ovisit " +
                   (((H5O_iter_data)iter_data).iterdata.get(3)).link_name,
               (((H5O_iter_data)iter_data).iterdata.get(3))
                       .link_name.compareToIgnoreCase("G1") == 0);
    assertTrue("H5Ovisit " +
                   (((H5O_iter_data)iter_data).iterdata.get(4)).link_name,
               (((H5O_iter_data)iter_data).iterdata.get(4))
  ...
  public void testH5Ovisit_by_name() {
    ...
    H5O_iterate_t iter_cb = new H5O_iter_callback();
    try {
      H5.H5Ovisit_by_name(H5fid, "G1", HDF5Constants.H5_INDEX_NAME,
    ...
    assertTrue("H5Ovisit_by_name " +
                   (((H5O_iter_data)iter_data).iterdata.get(1)).link_name,
               (((H5O_iter_data)iter_data).iterdata.get(1))
                       .link_name.compareToIgnoreCase("DS2") == 0);
  }
  ...
  public void testH5Oexists_by_name() {
    ...
    try {
      name_exists =
          H5.H5Oexists_by_name(H5fid, "G1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Oopen_by_token() {
    ...
    try {
      ...
      assertTrue("testH5Oopen_by_token: H5Oget_info link type",
                 obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
      assertTrue("testH5Oopen_by_token: Link Object Token",
                 obj_info.token.equals(H5la_ds1));
    } finally {
      try {
        H5.H5Oclose(oid);
  ...
  public void testH5Oopen_by_idx_n0() {
    ...
    try {
      ...
      try {
        oid = H5.H5Oopen_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_NAME,
                                HDF5Constants.H5_ITER_INC, 0,
                                HDF5Constants.H5P_DEFAULT);
      } catch (Throwable err) {
        err.printStackTrace();
      ...
      assertFalse("testH5Oopen_by_idx_n0: H5Oget_info_by_idx ",
                  obj_info == null);
      assertTrue("testH5Oopen_by_idx_n0: H5Oget_info_by_idx link type",
                 obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
      assertTrue("testH5Oopen_by_idx_n0: Link Object Token",
                 obj_info.token.equals(H5la_ds1));
    } finally {
      try {
        H5.H5Oclose(oid);
  ...
  public void testH5Oopen_by_idx_n3() {
    ...
    try {
      ...
      assertFalse("testH5Oopen_by_idx_n3:H5Oget_info_by_idx ",
                  obj_info == null);
      assertTrue("testH5Oopen_by_idx_n3:H5Oget_info_by_idx link type",
                 obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
      assertTrue("testH5Oopen_by_idx_n3:Link Object Token",
                 obj_info.token.equals(H5la_l1));
    } finally {
      try {
        H5.H5Oclose(oid);
