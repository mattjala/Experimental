...
public class TestH5F {
  ...
  private static final int COUNT_OBJ_ALL =
      (COUNT_OBJ_FILE + COUNT_OBJ_DATASET + COUNT_OBJ_GROUP +
       COUNT_OBJ_DATATYPE + COUNT_OBJ_ATTR);
  private static final int[] OBJ_COUNTS = {COUNT_OBJ_FILE,  COUNT_OBJ_DATASET,
                                           COUNT_OBJ_GROUP, COUNT_OBJ_DATATYPE,
                                           COUNT_OBJ_ATTR,  COUNT_OBJ_ALL};
  private static final int[] OBJ_TYPES = {
      HDF5Constants.H5F_OBJ_FILE,  HDF5Constants.H5F_OBJ_DATASET,
  ...
  public void testH5Fget_fileno_same() {
    ...
    try {
      ...
      assertEquals("fileno1[" + fileno1 + "]!=fileno2[" + fileno2 + "]",
                   fileno1, fileno2);
    } catch (Throwable err) {
  ...
  public void testH5Fget_fileno_diff() {
    ...
    try {
      ...
      assertNotEquals("fileno1[" + fileno1 + "]==fileno2[" + fileno2 + "]",
                      fileno1, fileno2);
    } catch (Throwable err) {
