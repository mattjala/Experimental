...
public class TestH5A {
  ...
  private final long _createDataset(long fid, long dsid, String name,
                                    long dapl) {
  ...
  public void createH5file() throws NullPointerException, HDF5Exception {
    ...
    try {
      H5fid =
          H5.H5Fcreate(H5_FILE, HDF5Constants.H5F_ACC_TRUNC,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5Acreate2() {
    ...
    try {
      attr_id =
          H5.H5Acreate(H5did, "dset", type_id, space_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5Acreate2_invalidobject() throws Throwable {
    H5.H5Acreate(H5dsid, "dset", type_id, space_id, HDF5Constants.H5P_DEFAULT,
                 HDF5Constants.H5P_DEFAULT);
  }

  @Test(expected = NullPointerException.class)
  public void testH5Acreate2_nullname() throws Throwable {
    H5.H5Acreate(H5did, null, type_id, space_id, HDF5Constants.H5P_DEFAULT,
                 HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Aopen() {
    ...
    try {
      attr_id =
          H5.H5Acreate(H5did, attr_name, type_id, space_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    ...
    try {
      ...
      try {
        ...
        H5.H5Aopen_by_idx(loc_id, obj_name, idx_type, order, n, aapl_id,
                          lapl_id);
        fail(
            "Negative Test Failed:- Error not Thrown when attribute name is invalid.");
      } catch (AssertionError err) {
        fail("H5.H5Aopen_by_idx: " + err);
      } catch (HDF5LibraryException err) {
      }
  ...
  public void testH5Acreate_by_name() {
    ...
    try {
      attribute_id =
          H5.H5Acreate_by_name(H5fid, obj_name, attr_name, type_id, space_id,
  ...
  public void testH5Arename()
    ...
    try {
      attr_id = H5.H5Acreate(loc_id, old_attr_name, type_id, space_id,
                             HDF5Constants.H5P_DEFAULT, aapl_id);
  ...
  public void testH5Arename_by_name() {
    ...
    try {
      attr_id = H5.H5Acreate_by_name(loc_id, obj_name, old_attr_name, type_id,
  ...
  public void testH5Aget_name_by_idx() {
    ...
    try {
      attr1_id = H5.H5Acreate_by_name(loc_id, obj_name, attr_name, type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr2_id = H5.H5Acreate_by_name(loc_id, obj_name, attr2_name, type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);

      // getting the 1st attribute name(n=0).
      ret_name =
          H5.H5Aget_name_by_idx(loc_id, obj_name, idx_type, order, n, lapl_id);
      assertFalse("H5Aget_name_by_idx ", ret_name == null);
      assertEquals(ret_name, attr_name);

      // getting the second attribute name(n=1)
      ret_name =
          H5.H5Aget_name_by_idx(loc_id, obj_name, idx_type, order, 1, lapl_id);
      assertFalse("H5Aget_name_by_idx ", ret_name == null);
  ...
  public void testH5Aget_info1() {
    ...
    try {
      attr_id =
          H5.H5Acreate(H5did, ".", type_id, space_id, HDF5Constants.H5P_DEFAULT,
                       HDF5Constants.H5P_DEFAULT);
      attribute_id =
          H5.H5Aopen_by_idx(H5did, ".", HDF5Constants.H5_INDEX_CRT_ORDER, order,
  ...
  public void testH5Aget_info_by_idx() {
    ...
    try {
      attr_id =
          H5.H5Acreate(H5did, "dset1", type_id, space_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
      attr2_id =
          H5.H5Acreate(H5did, "dataset2", type_id, space_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);

      // Verify info for 1st attribute, in increasing creation order
      attr_info =
          H5.H5Aget_info_by_idx(H5did, ".", HDF5Constants.H5_INDEX_CRT_ORDER,
                                HDF5Constants.H5_ITER_INC, 0, lapl_id);
      assertNotNull(attr_info);
      assertTrue("Corder ",
                 attr_info.corder == 0); // should equal 0 as this is the order
                                         // of 1st attribute created.
      assertEquals(attr_info.data_size, H5.H5Aget_storage_size(attr_id));
      ...
      assertNotNull(attr_info);
      assertTrue("Corder",
                 attr_info.corder == 1); // should equal 1 as this is the order
                                         // of 2nd attribute created.
  ...
  public void testH5Aexists() {
    ...
    try {
      attr_id =
          H5.H5Acreate(H5fid, "dset", type_id, space_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
      exists = H5.H5Aexists(H5fid, "dset");
      assertTrue("H5Aexists ", exists);

      attribute_id = H5.H5Acreate_by_name(H5fid, ".", "attribute", type_id,
                                          space_id, HDF5Constants.H5P_DEFAULT,
                                          HDF5Constants.H5P_DEFAULT, lapl_id);
  ...
  public void testH5Adelete_by_idx_order() {
    ...
    try {
      attr1_id = H5.H5Acreate_by_name(H5fid, ".", "attribute1", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr2_id = H5.H5Acreate_by_name(H5fid, ".", "attribute2", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr3_id = H5.H5Acreate_by_name(H5fid, ".", "attribute3", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr4_id = H5.H5Acreate_by_name(H5fid, ".", "attribute4", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);

      H5.H5Adelete_by_idx(H5fid, ".", HDF5Constants.H5_INDEX_CRT_ORDER,
                          HDF5Constants.H5_ITER_INC, 3, lapl_id);
  ...
  public void testH5Adelete_by_idx_name1() {
    ...
    try {
      ...
      attr3_id = H5.H5Acreate_by_name(H5fid, ".", "attribute3", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      H5.H5Adelete_by_idx(H5fid, ".", HDF5Constants.H5_INDEX_NAME,
                          HDF5Constants.H5_ITER_INC, 2, lapl_id);
  ...
  public void testH5Adelete_by_idx_name2() {
    ...
    try {
      ...
      H5.H5Adelete_by_idx(H5fid, ".", HDF5Constants.H5_INDEX_NAME,
                          HDF5Constants.H5_ITER_DEC, 3, lapl_id);
  ...
  public void testH5Aopen_by_name() {
    ...
    try {
      attribute_id = H5.H5Acreate_by_name(H5fid, obj_name, attr_name, type_id,
                                          space_id, HDF5Constants.H5P_DEFAULT,
                                          HDF5Constants.H5P_DEFAULT, lapl_id);
      ...
      if (attribute_id >= 0) {
        try {
          aid = H5.H5Aopen_by_name(H5fid, obj_name, attr_name,
                                   HDF5Constants.H5P_DEFAULT, lapl_id);
  ...
  public void testH5Awrite_readVL() {
    ...
    try {
      ...
      assertTrue("testH5Awrite_readVL.H5Tis_variable_str",
                 H5.H5Tis_variable_str(atype_id));
    } catch (Exception err) {
      if (atype_id > 0)
        try {
    ...
    try {
      ...
      attr_id =
          H5.H5Acreate(H5did, attr_name, atype_id, aspace_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5Aget_create_plist() {
    ...
    try {
      ...
      try {
        attribute_id = H5.H5Acreate(H5fid, attr_name, type_id, space_id,
  ...
  public void testH5Aiterate() {
    ...
    class H5A_iter_callback implements H5A_iterate_cb {
      public int callback(long group, String name, H5A_info_t info,
    ...
    try {
      ...
      try {
        H5.H5Aiterate(H5fid, HDF5Constants.H5_INDEX_CRT_ORDER,
                      HDF5Constants.H5_ITER_INC, 0L, iter_cb, iter_data);
      } catch (Throwable err) {
        err.printStackTrace();
      ...
      assertTrue("H5Aiterate " +
                     (((H5A_iter_data)iter_data).iterdata.get(0)).attr_name,
                 (((H5A_iter_data)iter_data).iterdata.get(0))
                         .attr_name.compareToIgnoreCase("attribute1") == 0);
      assertTrue("H5Aiterate " +
                     (((H5A_iter_data)iter_data).iterdata.get(1)).attr_name,
                 (((H5A_iter_data)iter_data).iterdata.get(1))
                         .attr_name.compareToIgnoreCase("attribute2") == 0);
      assertTrue(
          "H5Aiterate " +
              ((idata)((H5A_iter_data)iter_data).iterdata.get(2)).attr_name,
          (((H5A_iter_data)iter_data).iterdata.get(2))
                  .attr_name.compareToIgnoreCase("attribute3") == 0);
      assertTrue(
          "H5Aiterate " +
              ((idata)((H5A_iter_data)iter_data).iterdata.get(3)).attr_name,
  ...
  public void testH5Aiterate_by_name() {
    ...
    try {
      attr1_id = H5.H5Acreate_by_name(H5fid, ".", "attribute4", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr2_id = H5.H5Acreate_by_name(H5fid, ".", "attribute3", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr3_id = H5.H5Acreate_by_name(H5fid, ".", "attribute2", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      attr4_id = H5.H5Acreate_by_name(H5fid, ".", "attribute1", type_id,
                                      space_id, HDF5Constants.H5P_DEFAULT,
                                      HDF5Constants.H5P_DEFAULT, lapl_id);
      H5A_iterate_cb iter_cb = new H5A_iter_callback();
      try {
        H5.H5Aiterate_by_name(H5fid, ".", HDF5Constants.H5_INDEX_NAME,
                              HDF5Constants.H5_ITER_INC, 0L, iter_cb, iter_data,
                              HDF5Constants.H5P_DEFAULT);
      } catch (Throwable err) {
        err.printStackTrace();
      ...
      assertFalse("H5Aiterate_by_name ",
                  ((H5A_iter_data)iter_data).iterdata.isEmpty());
      assertTrue("H5Aiterate_by_name " +
                     ((H5A_iter_data)iter_data).iterdata.size(),
                 ((H5A_iter_data)iter_data).iterdata.size() == 4);
      assertTrue(
          "H5Aiterate_by_name " +
              ((idata)((H5A_iter_data)iter_data).iterdata.get(1)).attr_name,
  ...
  public void testH5AVLwr() {
    ...
    try {
      ...
      try {
        ...
        assertTrue(aspace_id > 0);
        attr_int_id =
            H5.H5Acreate(H5did, attr_int_name, atype_int_id, aspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
      ...
      vl_dbl_data[3] =
          new ArrayList<Double>(Arrays.asList(7.7, 8.8, 9.9, 10.0));
      ...
      try {
        ...
        assertTrue(aspace_id > 0);
        attr_dbl_id =
            H5.H5Acreate(H5did, attr_dbl_name, atype_dbl_id, aspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5AVLwrVL() {
    ...
    try {
      ...
      try {
        ...
        assertTrue(aspace_id > 0);
        attr_int_id =
            H5.H5Acreate(H5did, attr_int_name, base_atype_int_id, aspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
      ...
      ArrayList<ArrayList<Integer>> vl_readbuf =
          (ArrayList<ArrayList<Integer>>)base_vl_readbuf[0];
      assertTrue("vl_readbuf 0 exists", vl_readbuf != null);
      ArrayList<Integer> vl_readbuf_int =
          (ArrayList<Integer>)(vl_readbuf.get(0));
      /*
      ...
      /*
       * System.out.println("vl_readbuf: " + vl_readbuf);
       * System.out.println("vl_readbuf_int: " + vl_readbuf_int);
       */
  ...
  public void testH5AArraywr() {
    ...
    try {
      ...
      try {
        ...
        assertTrue(aspace_id > 0);
        att_int_id =
            H5.H5Acreate(H5did, att_int_name, atype_int_id, aspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5AArray_string_buffer() throws Throwable {
    ...
    try {
      ...
      assertTrue("testH5AArray_string_buffer.H5Tis_variable_str",
                 H5.H5Tis_variable_str(H5atid));
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      assertTrue("testH5AArray_string_buffer.H5Tarray_create: ",
                 atype_str_id >= 0);
    } catch (Exception err) {
      if (atype_str_id > 0)
        try {
    ...
    try {
      ...
      assertTrue(aspace_id > 0);
      att_str_id =
          H5.H5Acreate(H5did, att_str_name, atype_str_id, aspace_id,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
