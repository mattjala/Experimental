...
public class TestH5OcopyOld {
  ...
  public void createH5file() throws NullPointerException, HDF5Exception {
    ...
    try {
      H5fid =
          H5.H5Fcreate(FILENAME, HDF5Constants.H5F_ACC_TRUNC,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5OcopyRefsAttr() {
    ...
    try {
      attribute_id =
          H5.H5Acreate(H5did2, "A1", HDF5Constants.H5T_STD_REF_OBJ, H5dsid,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    ...
    try {
      ...
      H5.H5Ocopy(H5fid, ".", H5fid, "CPYREF", ocp_plist_id,
                 HDF5Constants.H5P_DEFAULT);
    } catch (Exception ex) {
  ...
  public void testH5OcopyRefsDatasettodiffFile() {
    ...
    try {
      ...
      dataset_id =
          H5.H5Dcreate(H5fid, "DSREF", HDF5Constants.H5T_STD_REF_OBJ, H5dsid,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT,
                       HDF5Constants.H5P_DEFAULT);
      assertTrue("testH5OcopyRefsDatasettodiffFile.H5Dcreate: ",
                 dataset_id >= 0);
    ...
    try {
      // create new file
      H5fid2 =
          H5.H5Fcreate("copy_old.h5", HDF5Constants.H5F_ACC_TRUNC,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    ...
    try {
      ...
      ocp_plist_id = H5.H5Pcreate(HDF5Constants.H5P_OBJECT_COPY);
      assertTrue("testH5OcopyRefsDatasettodiffFile.H5Pcreate: ",
                 ocp_plist_id >= 0);
      H5.H5Pset_copy_object(ocp_plist_id,
                            HDF5Constants.H5O_COPY_EXPAND_REFERENCE_FLAG);

      // Perform copy function.
      H5.H5Ocopy(H5fid, ".", H5fid2, "CPYREFD", ocp_plist_id,
                 HDF5Constants.H5P_DEFAULT);
    } catch (Exception ex) {
      ex.printStackTrace();
  ...
  public void testH5OcopyRefsDatasettosameFile() {
    ...
    try {
      ...
      dataset_id =
          H5.H5Dcreate(H5fid, "DSREF", HDF5Constants.H5T_STD_REF_OBJ, H5dsid,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT,
                       HDF5Constants.H5P_DEFAULT);
      assertTrue("testH5OcopyRefsDatasettosameFile.H5Dcreate: ",
                 dataset_id >= 0);
      H5.H5Dwrite(dataset_id, HDF5Constants.H5T_STD_REF_OBJ,
                  HDF5Constants.H5S_ALL, HDF5Constants.H5S_ALL,
                  HDF5Constants.H5P_DEFAULT, dset_data);
    ...
    try {
      ocp_plist_id = H5.H5Pcreate(HDF5Constants.H5P_OBJECT_COPY);
      assertTrue("testH5OcopyRefsDatasettosameFile.H5Pcreate: ",
                 ocp_plist_id >= 0);
      H5.H5Pset_copy_object(ocp_plist_id,
                            HDF5Constants.H5O_COPY_EXPAND_REFERENCE_FLAG);
    } catch (Exception ex) {
    ...
    // Perform copy function.
    try {
      H5.H5Ocopy(H5fid, "DSREF", H5fid, "CPYREFD", ocp_plist_id,
                 HDF5Constants.H5P_DEFAULT);
    } catch (Exception ex) {
      try {
        H5.H5Pclose(ocp_plist_id);
    ...
    try {
      ...
      H5.H5Dread(did, HDF5Constants.H5T_STD_REF_OBJ, HDF5Constants.H5S_ALL,
  ...
  public void testH5OcopyNullRef() throws Throwable {
    ...
    try {
      ...
      did =
          H5.H5Dcreate(H5fid, "Dataset_with_null_Ref",
                       HDF5Constants.H5T_NATIVE_INT, sid, _pid_, _pid_, _pid_);
      assertTrue("testH5OcopyNullRef.H5Dcreate: ", did > 0);
      aid = H5.H5Acreate(did, "Null_Ref", HDF5Constants.H5T_STD_REF_OBJ, sid,
                         _pid_, _pid_);
    ...
    H5.H5Pset_copy_object(ocp_plist_id,
                          HDF5Constants.H5O_COPY_EXPAND_REFERENCE_FLAG);
    try {
      H5.H5Ocopy(H5fid, "/Dataset_with_null_Ref", H5fid,
                 "/Dataset_with_null_Ref_cp", ocp_plist_id, _pid_);
    } finally {
      try {
        H5.H5Pclose(ocp_plist_id);
      } catch (Exception exx) {
  ...
  //        try {
  //            sid = H5.H5Screate_simple(1, new long[] {1}, null);
  //            assertTrue("testH5OcopyInvalidRef.H5Screate_simple: ", sid >=
  //            0); did = H5.H5Dcreate(H5fid, "Dataset_with_invalid_Ref",
  //            HDF5Constants.H5T_NATIVE_INT, sid, _pid_, _pid_, _pid_);
  //            assertTrue("testH5OcopyInvalidRef.H5Dcreate: ", did > 0); aid =
  //            H5.H5Acreate(did, "Invalid_Ref", HDF5Constants.H5T_STD_REF_OBJ,
  //            sid, _pid_, _pid_); assertTrue("testH5OcopyInvalidRef.H5Acreate:
  //            ", aid > 0); H5.H5Awrite(aid, HDF5Constants.H5T_STD_REF_OBJ, new
  //            long[]{-1});
  //        }
  //        catch (Exception ex) {
  //            ex.printStackTrace();
  ...
  //        H5.H5Pset_copy_object(ocp_plist_id,
  //        HDF5Constants.H5O_COPY_EXPAND_REFERENCE_FLAG); try {
  //            H5.H5Ocopy(H5fid, "/Dataset_with_invalid_Ref", H5fid,
  //            "/Dataset_with_invalid_Ref_cp", ocp_plist_id, _pid_);
  //        }
  //        finally {
