...
public class TestH5PData {
  ...
  private final long _createFloatDataset(long fid, long dsid, String name,
                                         long dapl) {
  ...
  public void createH5file() throws NullPointerException, HDF5Exception {
    ...
    try {
      ...
      H5did =
          _createFloatDataset(H5fid, H5dsid, "dset", HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5Pdata_transform() {
    ...
    try {
      ...
      H5.H5Dwrite(H5did, HDF5Constants.H5T_NATIVE_DOUBLE, HDF5Constants.H5S_ALL,
                  HDF5Constants.H5S_ALL, plist_id, windchillF);
  ...
  public void testH5P_buffer() {
    ...
    assertTrue("H5P_buffer default: " + default_size,
