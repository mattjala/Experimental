...
public class TestH5Ocopy {
  ...
  public void testH5OcopyRefsAttr() {
    ...
    try {
      try {
        dset_data[0] =
            H5.H5Rcreate_object(H5fid, "/G1", HDF5Constants.H5P_DEFAULT);
      } catch (Throwable err) {
        err.printStackTrace();
      ...
      try {
        dset_data[1] =
            H5.H5Rcreate_object(H5fid, "DS2", HDF5Constants.H5P_DEFAULT);
      } catch (Throwable err) {
        err.printStackTrace();
        fail("testH5OcopyRefsAttr: H5Rcreate_object " + err);
      }
      ...
      try {
        attribute_id =
            H5.H5Acreate(H5did2, "A1", HDF5Constants.H5T_STD_REF, H5dsid,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5OcopyRefsDatasettodiffFile() {
    ...
    try {
      ...
      try {
        dataset_id =
            H5.H5Dcreate(H5fid, "DSREF", HDF5Constants.H5T_STD_REF, H5dsid,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT,
                         HDF5Constants.H5P_DEFAULT);
    ...
    try {
      // create new file
      H5fid2 =
          H5.H5Fcreate("copy.h5", HDF5Constants.H5F_ACC_TRUNC,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
  ...
  public void testH5OcopyRefsDatasettosameFile() {
    ...
    try {
      ...
      try {
        H5.H5Dread(did, HDF5Constants.H5T_STD_REF, HDF5Constants.H5S_ALL,
  ...
  public void testH5OcopyNullRef() throws Throwable {
    ...
    try {
      ...
      aid = H5.H5Acreate(did, "Null_Ref", HDF5Constants.H5T_STD_REF, sid, _pid_,
                         _pid_);
