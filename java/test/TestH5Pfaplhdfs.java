...
public class TestH5Pfaplhdfs {
  ...
  public void testH5Pget_fapl_hdfs_fapl_id_of_wrong_driver_type()
    ...
    assertEquals("fapl_id was not set properly", HDF5Constants.H5FD_SEC2,
                 H5.H5Pget_driver(fapl_id));
