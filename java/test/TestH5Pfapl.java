...
public class TestH5Pfapl {
  ...
  double windchillF[][] = {
      {36.0, 31.0, 25.0, 19.0, 13.0, 7.0, 1.0, -5.0, -11.0, -16.0, -22.0, -28.0,
       -34.0, -40.0, -46.0, -52.0, -57.0, -63.0},
  ...
  private final void _deleteFamilyFile() {
    ...
    for (int indx = 0;; indx++) {
      ...
      try {
        file =
            new File("test" + myFormat.format(Integer.valueOf(indx)) + ".h5");
      } catch (Throwable err) {
      }
  ...
  private final void _createFloatDataset() {
    try {
      ...
      H5Fdid =
          H5.H5Dcreate(H5fid, "dsfloat", HDF5Constants.H5T_NATIVE_FLOAT,
                       H5Fdsid, HDF5Constants.H5P_DEFAULT,
                       HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Dcreate: " + err);
  ...
  public void testH5P_fclose_degree() {
    ...
    try {
      ...
      assertTrue("H5Pget_fclose_degree default",
                 ret_val_id == HDF5Constants.H5F_CLOSE_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      ret_val_id = H5.H5Pget_fclose_degree(fapl_id);
      assertTrue("H5Pget_fclose_degree",
                 ret_val_id == HDF5Constants.H5F_CLOSE_STRONG);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      ret_val_id = H5.H5Pget_fclose_degree(fapl_id);
      assertTrue("H5Pget_fclose_degree",
                 ret_val_id == HDF5Constants.H5F_CLOSE_SEMI);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_chunk_cache() {
    ...
    try {
      rdcc_nslots[0] = 4096;
      H5.H5Pset_chunk_cache(dapl_id, rdcc_nslots[0], rdcc_nbytes[0],
                            rdcc_w0[0]);
      H5.H5Pget_chunk_cache(dapl_id, rdcc_nslots, rdcc_nbytes, rdcc_w0);
  ...
  public void testH5P_fapl_core() {
    ...
    try {
      ...
      assertTrue("H5Pget_driver: core = " + driver_type,
                 HDF5Constants.H5FD_CORE == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_core: increment=" + increment[0],
                 increment[0] == 4096);
      assertTrue("H5Pget_fapl_core: backingstore=" + backingstore[0],
                 !backingstore[0]);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_fapl_family() {
    ...
    try {
      ...
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: family = " + driver_type,
                 HDF5Constants.H5FD_FAMILY == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_family: member_size=" + member_size[0],
                 member_size[0] == 1024);
      assertTrue(
          "H5Pget_fapl_family: member_fapl ",
  ...
  public void testH5P_family_offset() {
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_family: offset=" + offset,
  ...
  public void testH5Pset_fapl_sec2() {
    ...
    try {
      ...
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: sec2 = " + driver_type,
                 HDF5Constants.H5FD_SEC2 == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Pset_fapl_stdio() {
    ...
    try {
      ...
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: stdio = " + driver_type,
                 HDF5Constants.H5FD_STDIO == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Pset_fapl_log() {
    ...
    try {
      ...
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: log = " + driver_type,
                 HDF5Constants.H5FD_LOG == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_fapl_muti_nulls() {
    ...
    try {
      H5.H5Pset_fapl_multi(fapl_id, member_map, member_fapl, member_name,
                           member_addr, true);
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: multi = " + driver_type,
                 HDF5Constants.H5FD_MULTI == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5Pset_fapl_muti: " + err);
    }
    try {
      boolean relax = H5.H5Pget_fapl_multi(fapl_id, member_map, member_fapl,
  ...
  public void testH5P_fapl_muti_defaults() {
    ...
    try {
      ...
      boolean relax = H5.H5Pget_fapl_multi(fapl_id, member_map, member_fapl,
                                           member_name, member_addr);
      assertTrue("H5Pget_fapl_muti: relax ", relax);
      assertTrue("H5Pget_fapl_muti: member_map=" +
                     member_map[HDF5Constants.H5FD_MEM_DEFAULT],
                 member_map[HDF5Constants.H5FD_MEM_DEFAULT] ==
                     HDF5Constants.H5FD_MEM_DEFAULT);
      ...
      assertTrue("H5Pget_fapl_muti: member_name=" +
                     member_name[HDF5Constants.H5FD_MEM_DEFAULT],
                 member_name[HDF5Constants.H5FD_MEM_DEFAULT].compareTo(
                     "%s-X.h5") == 0);
      assertTrue(
          "H5Pget_fapl_muti: member_name=" +
              member_name[HDF5Constants.H5FD_MEM_SUPER],
          member_name[HDF5Constants.H5FD_MEM_SUPER].compareTo("%s-s.h5") == 0);
      assertTrue(
          "H5Pget_fapl_muti: member_name=" +
              member_name[HDF5Constants.H5FD_MEM_BTREE],
          member_name[HDF5Constants.H5FD_MEM_BTREE].compareTo("%s-b.h5") == 0);
      assertTrue(
          "H5Pget_fapl_muti: member_name=" +
              member_name[HDF5Constants.H5FD_MEM_DRAW],
          member_name[HDF5Constants.H5FD_MEM_DRAW].compareTo("%s-r.h5") == 0);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_DEFAULT],
                 member_addr[HDF5Constants.H5FD_MEM_DEFAULT] ==
                     sH5FD_MEM_HADDR);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_SUPER],
                 member_addr[HDF5Constants.H5FD_MEM_SUPER] ==
                     sH5FD_MEM_SUPER_HADDR);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_BTREE],
                 member_addr[HDF5Constants.H5FD_MEM_BTREE] ==
                     sH5FD_MEM_BTREE_HADDR);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_DRAW],
                 member_addr[HDF5Constants.H5FD_MEM_DRAW] ==
                     sH5FD_MEM_DRAW_HADDR);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_GHEAP],
                 member_addr[HDF5Constants.H5FD_MEM_GHEAP] ==
                     sH5FD_MEM_GHEAP_HADDR);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_LHEAP],
                 member_addr[HDF5Constants.H5FD_MEM_LHEAP] ==
                     sH5FD_MEM_LHEAP_HADDR);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_OHDR],
                 member_addr[HDF5Constants.H5FD_MEM_OHDR] ==
                     sH5FD_MEM_OHDR_HADDR);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5Pget_fapl_muti: " + err);
    }
  ...
  public void testH5P_fapl_muti() {
    ...
    for (int mt = HDF5Constants.H5FD_MEM_DEFAULT;
         mt < HDF5Constants.H5FD_MEM_NTYPES; mt++) {
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_muti: member_map=" +
                     member_map[HDF5Constants.H5FD_MEM_DEFAULT],
                 member_map[HDF5Constants.H5FD_MEM_DEFAULT] ==
                     HDF5Constants.H5FD_MEM_SUPER);
      assertTrue("H5Pget_fapl_muti: member_map=" +
                     member_map[HDF5Constants.H5FD_MEM_DRAW],
                 member_map[HDF5Constants.H5FD_MEM_DRAW] ==
                     HDF5Constants.H5FD_MEM_DRAW);
      assertTrue("H5Pget_fapl_muti: member_map=" +
                     member_map[HDF5Constants.H5FD_MEM_BTREE],
                 member_map[HDF5Constants.H5FD_MEM_BTREE] ==
                     HDF5Constants.H5FD_MEM_BTREE);
      assertTrue("H5Pget_fapl_muti: member_map=" +
                     member_map[HDF5Constants.H5FD_MEM_GHEAP],
                 member_map[HDF5Constants.H5FD_MEM_GHEAP] ==
                     HDF5Constants.H5FD_MEM_GHEAP);
      ...
      assertTrue("H5Pget_fapl_muti: member_name=" +
                     member_name[HDF5Constants.H5FD_MEM_SUPER],
                 member_name[HDF5Constants.H5FD_MEM_SUPER].compareTo(
                     "%s-super.h5") == 0);

      assertTrue("H5Pget_fapl_muti: member_name=" +
                     member_name[HDF5Constants.H5FD_MEM_BTREE],
                 member_name[HDF5Constants.H5FD_MEM_BTREE].compareTo(
                     "%s-btree.h5") == 0);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_BTREE],
                 member_addr[HDF5Constants.H5FD_MEM_BTREE] ==
                     HADDR_DEFAULT_SIZE / 4);

      assertTrue("H5Pget_fapl_muti: member_name=" +
                     member_name[HDF5Constants.H5FD_MEM_DRAW],
                 member_name[HDF5Constants.H5FD_MEM_DRAW].compareTo(
                     "%s-draw.h5") == 0);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_DRAW],
                 member_addr[HDF5Constants.H5FD_MEM_DRAW] ==
                     HADDR_DEFAULT_SIZE / 2);

      assertTrue("H5Pget_fapl_muti: member_name=" +
                     member_name[HDF5Constants.H5FD_MEM_GHEAP],
                 member_name[HDF5Constants.H5FD_MEM_GHEAP].compareTo(
                     "%s-gheap.h5") == 0);
      assertTrue("H5Pget_fapl_muti: member_addr=" +
                     member_addr[HDF5Constants.H5FD_MEM_GHEAP],
                 member_addr[HDF5Constants.H5FD_MEM_GHEAP] ==
                     (HADDR_DEFAULT_SIZE / 4) * 3);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5Pget_fapl_muti: " + err);
    }
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_muti: file_size ",
                 file_size >= HADDR_DEFAULT_SIZE / 4 ||
                     file_size <= HADDR_DEFAULT_SIZE / 2);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_fapl_split() {
    ...
    try {
      H5.H5Pset_fapl_split(fapl_id, "-meta.h5", HDF5Constants.H5P_DEFAULT,
                           "-raw.h5", HDF5Constants.H5P_DEFAULT);
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: split = " + driver_type,
                 HDF5Constants.H5FD_MULTI == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_multi: member_name=" +
                     member_name[HDF5Constants.H5FD_MEM_SUPER],
                 member_name[HDF5Constants.H5FD_MEM_SUPER].compareTo(
                     "%s-meta.h5") == 0);
      assertTrue(
          "H5Pget_fapl_multi: member_name=" +
              member_name[HDF5Constants.H5FD_MEM_DRAW],
  ...
  public void testH5P_fapl_direct() {
    ...
    try {
      ...
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: direct = " + driver_type,
                 HDF5Constants.H5FD_DIRECT == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      ...
      assertTrue("H5Pget_fapl_direct: alignment=" + params[0],
                 params[0] == 1024);
      assertTrue("H5Pget_fapl_direct: block_size=" + params[1],
                 params[1] == 4096);
      assertTrue("H5Pget_fapl_direct: cbuf_size=" + params[2],
                 params[2] == 8 * 4096);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Pset_fapl_windows() {
    ...
    try {
      ...
      long driver_type = H5.H5Pget_driver(fapl_id);
      assertTrue("H5Pget_driver: windows = " + driver_type,
                 HDF5Constants.H5FD_WINDOWS == driver_type);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Pmulti_transform() {
    ...
    try {
      H5.H5Dwrite(H5Fdid, HDF5Constants.H5T_NATIVE_DOUBLE,
                  HDF5Constants.H5S_ALL, HDF5Constants.H5S_ALL, plist_id,
                  windchillF);
      H5.H5Dread(H5Fdid, HDF5Constants.H5T_NATIVE_DOUBLE, HDF5Constants.H5S_ALL,
    ...
    for (int row = 0; row < DIMF_X; row++) {
      for (int col = 0; col < DIMF_Y; col++) {
        ...
        assertTrue("H5Pdata_transform: <" + row + "," + col + ">" + Fread +
                       "=" + Cstr,
  ...
  public void testH5Fmdc_logging() {
    ...
    try {
      ...
      H5.H5Pset_mdc_log_options(fapl_id, is_enabled, H5_LOG_FILE,
                                start_on_access);
      ...
      assertFalse("H5.H5Pget_mdc_log_options: start_on_access_out",
                  mdc_log_options[1]);
  ...
  public void testH5P_file_locking() {
    ...
    try {
      ...
      ignore_disabled_file_locking =
          H5.H5Pget_ignore_disabled_file_locking(fapl_id);
