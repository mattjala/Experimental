...
public class TestH5Ocreate {
  ...
  public void testH5Ocopy_cur_not_exists() throws Throwable {
    H5.H5Ocopy(H5fid, "None", H5fid, "DS1", HDF5Constants.H5P_DEFAULT,
               HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Ocopy() {
    try {
      H5.H5Ocopy(H5fid, "DS1", H5fid, "CPY1", HDF5Constants.H5P_DEFAULT,
                 HDF5Constants.H5P_DEFAULT);
      H5.H5Fflush(H5fid, HDF5Constants.H5F_SCOPE_LOCAL);
      boolean link_exists =
  ...
  public void testH5Ocopy_dst_link_exists() throws Throwable {
    _createHardLink(H5fid, H5fid, "/G1/DS2", H5fid, "CPY1",
                    HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    H5.H5Ocopy(H5fid, "CPY1", H5fid, "/G1/DS2", HDF5Constants.H5P_DEFAULT,
               HDF5Constants.H5P_DEFAULT);
  }
  ...
  public void testH5Oget_info_by_idx_n0_create() {
    ...
    try {
      obj_info = H5.H5Oget_info_by_idx(
    ...
    assertTrue("H5Oget_info_by_idx link type",
  ...
  public void testH5Oget_info_softlink() {
    ...
    assertTrue("H5Oget_info link type",
               obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
  ...
  public void testH5Olink() {
    ...
    try {
      H5.H5Olink(oid, H5fid, "CPY1", HDF5Constants.H5P_DEFAULT,
                 HDF5Constants.H5P_DEFAULT);
      H5.H5Fflush(H5fid, HDF5Constants.H5F_SCOPE_LOCAL);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      dst_obj_info =
          H5.H5Oget_info_by_name(H5fid, "CPY1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    assertTrue("H5Oget_info object type",
               dst_obj_info.type == HDF5Constants.H5O_TYPE_DATASET);
  }
  ...
  public void testH5Ovisit_create() {
    ...
    try {
      H5.H5Ovisit(H5fid, HDF5Constants.H5_INDEX_CRT_ORDER,
    ...
    assertTrue(
        "H5Ovisit " +
            ((idata)((H5O_iter_data)iter_data).iterdata.get(0)).link_name,
        ((idata)((H5O_iter_data)iter_data).iterdata.get(0))
                .link_name.compareToIgnoreCase(".") == 0);
    assertTrue(
        "H5Ovisit " +
            ((idata)((H5O_iter_data)iter_data).iterdata.get(1)).link_name,
        ((idata)((H5O_iter_data)iter_data).iterdata.get(1))
                .link_name.compareToIgnoreCase("DS1") == 0);
    assertTrue(
        "H5Ovisit " +
            ((idata)((H5O_iter_data)iter_data).iterdata.get(2)).link_name,
        ((idata)((H5O_iter_data)iter_data).iterdata.get(2))
                .link_name.compareToIgnoreCase("G1") == 0);
    assertTrue(
        "H5Ovisit " +
            ((idata)((H5O_iter_data)iter_data).iterdata.get(3)).link_name,
        ((idata)((H5O_iter_data)iter_data).iterdata.get(3))
  ...
  public void testH5Ocomment_by_name() {
    String obj_comment = null;
    try {
      H5.H5Oset_comment_by_name(H5fid, "DS1", "Test Comment",
                                HDF5Constants.H5P_DEFAULT);
      H5.H5Fflush(H5fid, HDF5Constants.H5F_SCOPE_LOCAL);
    } catch (Throwable err) {
      err.printStackTrace();
    ...
    try {
      obj_comment =
          H5.H5Oget_comment_by_name(H5fid, "DS1", HDF5Constants.H5P_DEFAULT);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5.H5Oget_comment_by_name: " + err);
    }
    assertFalse("H5Oget_comment_by_name: ", obj_comment == null);
    assertTrue("H5Oget_comment_by_name: ",
               obj_comment.compareTo("Test Comment") == 0);
  }
  ...
  public void testH5Oinc_dec_count() {
    ...
    try {
      try {
        ...
        assertTrue("testH5Oinc_dec_count: H5Oget_info reference count",
                   obj_info.rc == 1);
      } catch (Throwable err) {
        err.printStackTrace();
