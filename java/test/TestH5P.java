...
public class TestH5P {
  ...
  public void testH5Pset_link_creation_order_trackedPLUSindexed() {
    ...
    assertTrue("testH5Pset_link_creation_order_trackedPLUSindexed",
               ret_val >= 0);
  ...
  public void testH5Pset_link_creation_order_tracked() {
    ...
    try {
      ret_val = H5.H5Pset_link_creation_order(
          fcpl_id, HDF5Constants.H5P_CRT_ORDER_TRACKED);
      crtorderflags = H5.H5Pget_link_creation_order(fcpl_id);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5Pset_link_creation_order: " + err);
  ...
  public void testH5Pset_attr_creation_order_trackedPLUSindexed() {
    ...
    assertTrue("testH5Pset_attr_creation_order_trackedPLUSindexed",
               ret_val >= 0);
    assertEquals(crt_order_flags, crtorderflags);
  }
  ...
  public void testH5Pset_attr_creation_order_tracked() {
    ...
    try {
      ret_val = H5.H5Pset_attr_creation_order(
          ocpl_id, HDF5Constants.H5P_CRT_ORDER_TRACKED);
      crtorderflags = H5.H5Pget_attr_creation_order(ocpl_id);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5Pset_attr_creation_order: " + err);
  ...
  public void testH5Pset_copy_object() {
    ...
    try {
      H5.H5Pset_copy_object(ocp_plist_id,
                            HDF5Constants.H5O_COPY_SHALLOW_HIERARCHY_FLAG);
    ...
    try {
      H5.H5Pset_copy_object(ocp_plist_id,
                            HDF5Constants.H5O_COPY_EXPAND_REFERENCE_FLAG);
      cpy_option = H5.H5Pget_copy_object(ocp_plist_id);
    } catch (Throwable err) {
      err.printStackTrace();
      fail("H5Pset_copy_object: " + err);
  ...
  public void testH5Pset_copy_object_invalidobject() throws Throwable {
    H5.H5Pset_copy_object(HDF5Constants.H5P_DEFAULT,
                          HDF5Constants.H5O_COPY_SHALLOW_HIERARCHY_FLAG);
  }
  ...
  @Test(expected = HDF5LibraryException.class)
  public void testH5Pset_create_intermediate_group_invalidobject()
      throws Throwable {
  ...
  public void testH5Pget_data_transform() {
    ...
    assertTrue("The data transform expression: ",
               expression.equals(express[0]));
  }
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testH5Pset_link_phase_change_max_compactLESSTHANmin_dense()
      throws Throwable {
  ...
  public void testH5Pget_attr_phase_change() {
    ...
    assertEquals(
        "Default value of the max. no. of attributes stored in compact storage",
        8, attributes[0]);
    assertEquals(
        "Default value of the min. no. of attributes stored in dense storage",
        6, attributes[1]);
    try {
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testH5PH5Pset_shared_mesg_phase_change_HighMaxlistValue()
      throws Throwable {
    H5.H5Pset_shared_mesg_phase_change(fcpl_id, 5001, 4000);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testH5PH5Pset_shared_mesg_phase_change_HighMinbtreeValue()
      throws Throwable {
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testH5Pset_shared_mesg_nindexes_InvalidHIGHnindexes()
      throws Throwable {
  ...
  public void testH5Pset_shared_mesg_index() {
    ...
    try {
      ...
      ret_val = H5.H5Pset_shared_mesg_index(
          fcpl_id, 0, HDF5Constants.H5O_SHMESG_ATTR_FLAG, 10);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5Pset_shared_mesg_index_Invalid_indexnum() throws Throwable {
    H5.H5Pset_shared_mesg_index(fcpl_id, 2, HDF5Constants.H5O_SHMESG_ATTR_FLAG,
                                10);
  }
  ...
  public void testH5Pset_shared_mesg_index_InvalidFlag() throws Throwable {
    ...
    H5.H5Pset_shared_mesg_index(fcpl_id, 2,
                                HDF5Constants.H5O_SHMESG_ALL_FLAG + 1, 10);
  }
  ...
  public void testH5Pget_shared_mesg_index() {
    ...
    try {
      H5.H5Pset_shared_mesg_nindexes(fcpl_id, 2);
      H5.H5Pset_shared_mesg_index(fcpl_id, 0,
                                  HDF5Constants.H5O_SHMESG_ATTR_FLAG, 10);
    ...
    assertEquals("Type of message", HDF5Constants.H5O_SHMESG_ATTR_FLAG,
                 mesg_info[0]);
  ...
  public void testH5P_userblock() {
    ...
    try {
      ...
      assertTrue("super block version: " + finfo.super_version,
                 finfo.super_version == 0);
      assertTrue("free-space manager version: " + finfo.free_version,
                 finfo.free_version == 0);
      assertTrue("shared object header version: " + finfo.sohm_version,
                 finfo.sohm_version == 0);
  ...
  public void testH5Pget_char_encoding() {
    ...
    assertTrue("testH5Pget_char_encoding",
    ...
    assertTrue("testH5Pget_char_encoding",
               char_encoding == HDF5Constants.H5T_CSET_UTF8);
  }
  ...
  public void testH5P_fill_time() {
    ...
    try {
      ...
      assertTrue("fill_time: " + fill_time[0],
                 fill_time[0] == HDF5Constants.H5D_FILL_TIME_IFSET);
      H5.H5Pset_fill_time(ocpl_id, HDF5Constants.H5D_FILL_TIME_ALLOC);
      H5.H5Pget_fill_time(ocpl_id, fill_time);
      assertTrue("fill_time: " + fill_time[0],
                 fill_time[0] == HDF5Constants.H5D_FILL_TIME_ALLOC);
      H5.H5Pset_fill_time(ocpl_id, HDF5Constants.H5D_FILL_TIME_NEVER);
      H5.H5Pget_fill_time(ocpl_id, fill_time);
      assertTrue("fill_time: " + fill_time[0],
                 fill_time[0] == HDF5Constants.H5D_FILL_TIME_NEVER);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_alloc_time() {
    ...
    try {
      ...
      assertTrue("alloc_time: " + alloc_time[0],
                 alloc_time[0] == HDF5Constants.H5D_ALLOC_TIME_LATE);
      H5.H5Pset_alloc_time(ocpl_id, HDF5Constants.H5D_ALLOC_TIME_EARLY);
      H5.H5Pget_alloc_time(ocpl_id, alloc_time);
      assertTrue("alloc_time: " + alloc_time[0],
                 alloc_time[0] == HDF5Constants.H5D_ALLOC_TIME_EARLY);
      H5.H5Pset_alloc_time(ocpl_id, HDF5Constants.H5D_ALLOC_TIME_INCR);
      H5.H5Pget_alloc_time(ocpl_id, alloc_time);
      assertTrue("alloc_time: " + alloc_time[0],
                 alloc_time[0] == HDF5Constants.H5D_ALLOC_TIME_INCR);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_fill_value() {
    ...
    try {
      ...
      assertTrue("fill_value_status: " + fill_value_status[0],
                 fill_value_status[0] ==
                     HDF5Constants.H5D_FILL_VALUE_USER_DEFINED);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_layout() {
    ...
    try {
      ...
      assertTrue("layout: " + layout_type,
                 layout_type == HDF5Constants.H5D_CONTIGUOUS);
      H5.H5Pset_layout(ocpl_id, HDF5Constants.H5D_COMPACT);
      layout_type = H5.H5Pget_layout(ocpl_id);
      assertTrue("layout: " + layout_type,
                 layout_type == HDF5Constants.H5D_COMPACT);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_chunk() {
    ...
    try {
      ...
      layout_type = H5.H5Pget_layout(ocpl_id);
      assertTrue("layout: " + layout_type,
                 layout_type == HDF5Constants.H5D_CHUNKED);
    } catch (Throwable err) {
      err.printStackTrace();
  ...
  public void testH5P_file_space_strategy() {
    ...
    try {
      ...
      H5.H5Pset_file_space_strategy(
          fcpl_id, HDF5Constants.H5F_FSPACE_STRATEGY_PAGE, true, 1);
      strategy = H5.H5Pget_file_space_strategy(fcpl_id, persist, threshold);
      assertTrue("strategy: " + strategy,
                 strategy == HDF5Constants.H5F_FSPACE_STRATEGY_PAGE);
  ...
  public void testH5P_chunk_opts() {
    ...
    try {
      ...
      H5.H5Pset_chunk_opts(ocpl_id,
                           HDF5Constants.H5D_CHUNK_DONT_FILTER_PARTIAL_CHUNKS);
      chunk_opts = H5.H5Pget_chunk_opts(ocpl_id);
