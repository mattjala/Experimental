...
static herr_t H5P_cls_copy_cb(hid_t new_prop_id, hid_t old_prop_id,
                              void *copy_data);
...
static herr_t H5P_prp_get_cb(hid_t prop_id, const char *name, size_t size,
                             void *value);
static herr_t H5P_prp_set_cb(hid_t prop_id, const char *name, size_t size,
                             void *value);
static herr_t H5P_prp_delete_cb(hid_t prop_id, const char *name, size_t size,
                                void *value);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Pcreate(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type) {
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1class(JNIEnv *env,
                                                          jclass clss,
                                                          jlong plist) {
  hid_t retVal = H5I_INVALID_HID;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Pcopy(JNIEnv *env, jclass clss,
                                                      jlong plist) {
  hid_t retVal = H5I_INVALID_HID;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5__1H5Pclose(JNIEnv *env, jclass clss,
                                                      jlong plist) {
  herr_t retVal = FAIL;
...
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Pcreate_1class(
    ...
    jobject create_op, jobject create_data, jobject copy_op, jobject copy_data,
    jobject close_op, jobject close_data) {
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "_H5Pcreate_class: class name not pinned");

  if ((class_id = H5Pcreate_class(
           (hid_t)parent_class, cstr, (H5P_cls_create_func_t)H5P_cls_create_cb,
           (void *)create_data, (H5P_cls_copy_func_t)H5P_cls_copy_cb,
           (void *)copy_data, (H5P_cls_close_func_t)H5P_cls_close_cb,
           (void *)close_data)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Pcreate_1class_1nocb(
  ...
  if (NULL == name)
    H5_NULL_ARGUMENT_ERROR(ENVONLY,
                           "_H5Pcreate_class_nocb: class name is NULL");

  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "_H5Pcreate_class_nocb: class name not pinned");

  if ((class_id = H5Pcreate_class((hid_t)parent_class, cstr, NULL, NULL, NULL,
                                  NULL, NULL, NULL)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pregister2(
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pregister2: property name not pinned");

  PIN_BYTE_ARRAY(ENVONLY, def_value, propValBuf, &isCopy,
                 "H5Pregister2: default property value buffer not pinned");

  if ((status = H5Pregister2((hid_t)cls_id, cstr, (size_t)prp_size,
                             (void *)propValBuf,
                             (H5P_prp_create_func_t)H5P_prp_create_cb,
                             (H5P_prp_set_func_t)H5P_prp_set_cb,
                             (H5P_prp_get_func_t)H5P_prp_get_cb,
                             (H5P_prp_delete_func_t)H5P_prp_delete_cb,
                             (H5P_prp_copy_func_t)H5P_prp_copy_cb,
  ...
  if (propValBuf)
    UNPIN_BYTE_ARRAY(ENVONLY, def_value, propValBuf,
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pregister2_1nocb(
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pregister2_nocb: property name not pinned");

  PIN_BYTE_ARRAY(ENVONLY, def_value, propValBuf, &isCopy,
                 "H5Pregister2_nocb: default property value buffer not pinned");

  if ((status = H5Pregister2((hid_t)cls_id, cstr, (size_t)prp_size,
                             (void *)propValBuf, NULL, NULL, NULL, NULL, NULL,
                             NULL, NULL)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pinsert2(
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pinsert2: property name not pinned");

  PIN_BYTE_ARRAY(ENVONLY, def_value, propValBuf, &isCopy,
                 "H5Pinsert2: property value buffer not pinned");

  if ((status =
           H5Pinsert2((hid_t)cls_id, cstr, (size_t)prp_size, (void *)propValBuf,
                      (H5P_prp_set_func_t)H5P_prp_set_cb,
                      (H5P_prp_get_func_t)H5P_prp_get_cb,
                      (H5P_prp_delete_func_t)H5P_prp_delete_cb,
                      (H5P_prp_copy_func_t)H5P_prp_copy_cb,
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pinsert2_1nocb(
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pinsert2_nocb: property name not pinned");
 ...
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pset(JNIEnv *env, jclass clss,
                                                   jlong plid, jstring name,
                                                   jint val) {
  const char *cstr = NULL;
  hid_t retVal = H5I_INVALID_HID;
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pset: property name not pinned");
 ...
 */
JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Pexist(JNIEnv *env,
                                                        jclass clss, jlong plid,
                                                        jstring name) {
  const char *cstr = NULL;
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pexist: property name not pinned");
 ...
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1size(JNIEnv *env,
                                                         jclass clss,
                                                         jlong plid,
                                                         jstring name) {
  const char *cstr = NULL;
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pget_size: property name not pinned");
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1nprops(JNIEnv *env,
                                                           jclass clss,
                                                           jlong plid) {
  size_t nprops = 0;
 ...
 */
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Pget_1class_1name(JNIEnv *env,
                                                                  jclass clss,
                                                                  jlong plid) {
  char *c_str = NULL;
  jstring j_str = NULL;
  ...
  if (NULL == (j_str = ENVPTR->NewStringUTF(ENVONLY, c_str))) {
    ...
    H5_OUT_OF_MEMORY_ERROR(ENVONLY, "H5Pget_class_name: out of memory - unable "
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1class_1parent(JNIEnv *env,
                                                                  jclass clss,
                                                                  jlong plid) {
  hid_t retVal = H5I_INVALID_HID;
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pisa_1class(JNIEnv *env,
                                                         jclass clss,
                                                         jlong plid,
                                                         jlong pcls) {
  htri_t retVal = FAIL;
 ...
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget(JNIEnv *env, jclass clss,
                                                  jlong plid, jstring name) {
  const char *cstr = NULL;
  jint val;
  herr_t status = FAIL;
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pget: property name not pinned");
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pequal(JNIEnv *env, jclass clss,
                                                    jlong plid1, jlong plid2) {
  htri_t retVal = FAIL;
 ...
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Piterate(JNIEnv *env, jclass clss,
                                                      jlong prop_id,
                                                      jintArray idx,
                                                      jobject callback_op,
                                                      jobject op_data) {
  ...
  if (NULL == idx) {
    if ((status = H5Piterate((hid_t)prop_id, NULL,
                             (H5P_iterate_t)H5P_iterate_cb, (void *)&wrapper)) <
        0)
      H5_LIBRARY_ERROR(ENVONLY);
  } else {
    PIN_INT_ARRAY(ENVONLY, idx, theArray, &isCopy,
                  "H5Piterate: idx not pinned");

    if ((status = H5Piterate((hid_t)prop_id, (int *)&theArray[0],
                             (H5P_iterate_t)H5P_iterate_cb, (void *)&wrapper)) <
        0)
      H5_LIBRARY_ERROR(ENVONLY);
  }
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pcopy_1prop(
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Pcopy_prop: property name not pinned");
 ...
 * Signature: (JLjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Premove(JNIEnv *env, jclass clss,
                                                     jlong plid, jstring name) {
  const char *cstr = NULL;
  herr_t retVal = FAIL;
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Premove: property name not pinned");
 ...
 * Signature: (JLjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Punregister(JNIEnv *env,
                                                         jclass clss,
                                                         jlong plid,
                                                         jstring name) {
  const char *cstr = NULL;
  ...
  PIN_JAVA_STRING(ENVONLY, name, cstr, NULL,
                  "H5Punregister: property name not pinned");
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5__1H5Pclose_1class(JNIEnv *env,
                                                             jclass clss,
                                                             jlong plid) {
  herr_t retVal = FAIL;
...
static herr_t H5P_cls_create_cb(hid_t prop_id, void *create_data) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    ...
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_cls_create_cb: failed to attach current thread to JVM");
  }
  ...
  status = CBENVPTR->CallIntMethod(CBENVONLY, create_callback, mid, prop_id,
                                   create_data);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_cls_copy_cb(hid_t new_prop_id, hid_t old_prop_id,
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_cls_copy_cb: failed to attach current thread to JVM");
  }
  ...
  status = CBENVPTR->CallIntMethod(CBENVONLY, copy_callback, mid, new_prop_id,
                                   old_prop_id, copy_data);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_cls_close_cb(hid_t prop_id, void *close_data) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_cls_close_cb: failed to attach current thread to JVM");
  }
  ...
  status = CBENVPTR->CallIntMethod(CBENVONLY, close_callback, mid, prop_id,
                                   close_data);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_prp_create_cb(const char *name, size_t size, void *value) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_prp_create_cb: failed to attach current thread to JVM");
  }
...
static herr_t H5P_prp_set_cb(hid_t prop_id, const char *name, size_t size,
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_prp_set_cb: failed to attach current thread to JVM");
  }
  ...
  if (NULL == (mid = CBENVPTR->GetMethodID(CBENVONLY, cls, "callback",
                                           "(JLjava/lang/String;J[B)I")))
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);

  if (NULL == (str = CBENVPTR->NewStringUTF(CBENVONLY, name)))
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);

  status = CBENVPTR->CallIntMethod(CBENVONLY, set_callback, mid, prop_id, str,
                                   size, value);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_prp_get_cb(hid_t prop_id, const char *name, size_t size,
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_prp_get_cb: failed to attach current thread to JVM");
  }
  ...
  status = CBENVPTR->CallIntMethod(CBENVONLY, get_callback, mid, prop_id, str,
                                   size, value);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_prp_delete_cb(hid_t prop_id, const char *name, size_t size,
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_prp_delete_cb: failed to attach current thread to JVM");
  }
  ...
  status = CBENVPTR->CallIntMethod(CBENVONLY, delete_callback, mid, prop_id,
                                   str, size, value);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_prp_copy_cb(const char *name, size_t size, void *value) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_prp_copy_cb: failed to attach current thread to JVM");
  }
  ...
  status =
      CBENVPTR->CallIntMethod(CBENVONLY, copy_callback, mid, str, size, value);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static int H5P_prp_compare_cb(void *value1, void *value2, size_t size) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    ...
    H5_JNI_FATAL_ERROR(
        CBENVONLY,
        "H5P_prp_compare_cb: failed to attach current thread to JVM");
  }
  ...
  if (NULL ==
      (mid = CBENVPTR->GetMethodID(CBENVONLY, cls, "callback", "([B[BJ)I")))
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);

  status = CBENVPTR->CallIntMethod(CBENVONLY, compare_callback, mid, value1,
                                   value2, size);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_prp_close_cb(const char *name, size_t size, void *value) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_prp_close_cb: failed to attach current thread to JVM");
  }
  ...
  status =
      CBENVPTR->CallIntMethod(CBENVONLY, close_callback, mid, str, size, value);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
...
static herr_t H5P_iterate_cb(hid_t prop_id, const char *name, void *cb_data) {
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    CHECK_JNI_EXCEPTION(CBENVONLY, JNI_TRUE);
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5P_iterate_cb: failed to attach current thread to JVM");
  }
  ...
  status = CBENVPTR->CallIntMethod(CBENVONLY, visit_callback, mid, prop_id, str,
                                   op_data);
  CHECK_JNI_EXCEPTION(CBENVONLY, JNI_FALSE);
