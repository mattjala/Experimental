 ...
 * Signature: (JJJD)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1chunk_1cache(JNIEnv *,
                                                                jclass, jlong,
                                                                jlong, jlong,
                                                                jdouble);
 ...
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1efile_1prefix(JNIEnv *,
                                                                 jclass, jlong,
                                                                 jstring);
 ...
 */
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Pget_1efile_1prefix(JNIEnv *,
                                                                    jclass,
                                                                    jlong);
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1virtual_1view(JNIEnv *,
                                                                 jclass, jlong,
                                                                 jint);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1virtual_1view(JNIEnv *,
                                                                 jclass, jlong);
...
Java_hdf_hdf5lib_H5_H5Pget_1virtual_1printf_1gap(JNIEnv *, jclass, jlong);
