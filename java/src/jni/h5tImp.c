 ...
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Topen2(JNIEnv *env, jclass clss,
                                                       jlong loc_id,
                                                       jstring name,
                                                       jlong access_plist) {
  ...
  PIN_JAVA_STRING(ENVONLY, name, datatypeName, NULL,
                  "H5Topen2: datatype name not pinned");
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Tcommitted(JNIEnv *env,
                                                            jclass clss,
                                                            jlong type_id) {
 ...
 * Signature: (IJ)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tcreate(JNIEnv *env,
                                                        jclass clss,
                                                        jint dclass,
                                                        jlong size) {
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tcopy(JNIEnv *env, jclass clss,
                                                      jlong type_id) {
  hid_t retVal = H5I_INVALID_HID;
 ...
 * Signature: (JJ)Z
 */
JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Tequal(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id1,
                                                        jlong type_id2) {
  htri_t bval = JNI_FALSE;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tlock(JNIEnv *env, jclass clss,
                                                   jlong type_id) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1class(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id) {
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Tget_1size(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id) {
  size_t retVal = 0;
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1size(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id,
                                                        jlong size) {
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1order(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1order(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id,
                                                         jint order) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1precision(JNIEnv *env,
                                                             jclass clss,
                                                             jlong type_id) {
  size_t retVal = 0;
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1precision(JNIEnv *env,
                                                             jclass clss,
                                                             jlong type_id,
                                                             jlong precision) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1offset(JNIEnv *env,
                                                          jclass clss,
                                                          jlong type_id) {
  int retVal = -1;
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1offset(JNIEnv *env,
                                                          jclass clss,
                                                          jlong type_id,
                                                          jlong offset) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J[I)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1pad(JNIEnv *env, jclass clss,
                                                       jlong type_id,
                                                       jintArray pad) {
  jboolean isCopy;
  jint *P = NULL;
  ...
  if ((status = H5Tget_pad((hid_t)type_id, (H5T_pad_t *)&(P[0]),
                           (H5T_pad_t *)&(P[1]))) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (JII)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1pad(JNIEnv *env, jclass clss,
                                                       jlong type_id, jint lsb,
                                                       jint msb) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1sign(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1sign(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id,
                                                        jint sign) {
  herr_t retVal = FAIL;
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1fields_1int(
  ...
  if ((arrLen = ENVPTR->GetArrayLength(ENVONLY, fields)) < 0) {
    ...
    H5_BAD_ARGUMENT_ERROR(ENVONLY,
                          "H5Tget_fields_int: fields array length < 0");
  }
  if (arrLen < 5)
    H5_BAD_ARGUMENT_ERROR(ENVONLY,
                          "H5Tget_fields_int: fields input array < order 5");

  PIN_INT_ARRAY(ENVONLY, fields, P, &isCopy,
                "H5Tget_fields_int: fields not pinned");

  if ((status = H5Tget_fields((hid_t)type_id, (size_t *)&(P[0]),
                              (size_t *)&(P[1]), (size_t *)&(P[2]),
 ...
 * Signature: (J[J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tget_1fields(JNIEnv *env,
                                                          jclass clss,
                                                          jlong type_id,
                                                          jlongArray fields) {
  jboolean isCopy;
  ...
  if (arrLen < 5)
    H5_BAD_ARGUMENT_ERROR(ENVONLY,
                          "H5Tget_fields: fields input array < order 5");

  PIN_LONG_ARRAY(ENVONLY, fields, fieldsArray, &isCopy,
                 "H5Tget_fields: fields not pinned");
  ...
  { /* Direct cast (size_t *)variable fails on 32-bit environment */
    ...
    if ((status = H5Tget_fields((hid_t)type_id, &spos_t, &epos_t, &esize_t,
                                &mpos_t, &msize_t)) < 0)
      H5_LIBRARY_ERROR(ENVONLY);
  ...
  if (fieldsArray)
    UNPIN_LONG_ARRAY(ENVONLY, fields, fieldsArray,
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tset_1fields(
  ...
  if (H5Tset_fields((hid_t)type_id, (size_t)spos, (size_t)epos, (size_t)esize,
                    (size_t)mpos, (size_t)msize) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1ebias(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id) {
  size_t retVal = 0;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Tget_1ebias_1long(JNIEnv *env,
                                                                jclass clss,
                                                                jlong type_id) {
  size_t retVal = 0;
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1ebias(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id,
                                                         jlong ebias) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1norm(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1norm(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id,
                                                        jint norm) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1inpad(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1inpad(JNIEnv *env,
                                                         jclass clss,
                                                         jlong type_id,
                                                         jint inpad) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1cset(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1cset(JNIEnv *env,
                                                        jclass clss,
                                                        jlong type_id,
                                                        jint cset) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1strpad(JNIEnv *env,
                                                          jclass clss,
                                                          jlong type_id) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1strpad(JNIEnv *env,
                                                          jclass clss,
                                                          jlong type_id,
                                                          jint strpad) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1nmembers(JNIEnv *env,
                                                            jclass clss,
                                                            jlong type_id) {
  int retVal = -1;
...
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Tget_1member_1name(
  ...
  if (NULL ==
      (member_name = H5Tget_member_name((hid_t)type_id, (unsigned)field_idx)))
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1member_1index(
  ...
  PIN_JAVA_STRING(ENVONLY, field_name, datatypeName, NULL,
                  "H5Tget_member_index: field name not pinned");
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1member_1class(JNIEnv *env,
                                                                 jclass clss,
                                                                 jlong type_id,
                                                                 jint memno) {
  H5T_class_t retVal = H5T_NO_CLASS;
 ...
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tinsert(JNIEnv *env, jclass clss,
                                                     jlong type_id,
                                                     jstring name, jlong offset,
                                                     jlong field_id) {
  const char *datatypeName = NULL;
  ...
  PIN_JAVA_STRING(ENVONLY, name, datatypeName, NULL,
                  "H5Tinsert: datatype name not pinned");

  if ((status =
           H5Tinsert((hid_t)type_id, datatypeName, (size_t)off, field_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tpack(JNIEnv *env, jclass clss,
                                                   jlong type_id) {
  herr_t retVal = FAIL;
 ...
 * Signature: (JJJ[B)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Treclaim(JNIEnv *env, jclass clss,
                                                      jlong type_id,
                                                      jlong space_id,
                                                      jlong xfer_plist_id,
                                                      jbyteArray buf) {
  ...
  PIN_BYTE_ARRAY(ENVONLY, buf, pinBuf, &bufIsCopy,
                 "H5Treclaim: buffer not pinned");

  if ((status = H5Treclaim((hid_t)type_id, (hid_t)space_id,
                           (hid_t)xfer_plist_id, pinBuf)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5__1H5Tclose(JNIEnv *env, jclass clss,
                                                      jlong type_id) {
  herr_t retVal = FAIL;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tvlen_1create(JNIEnv *env,
                                                              jclass clss,
                                                              jlong base_id) {
  hid_t retVal = H5I_INVALID_HID;
 ...
 * Signature: (JLjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tset_1tag(JNIEnv *env, jclass clss,
                                                       jlong type,
                                                       jstring tag) {
  ...
  PIN_JAVA_STRING(ENVONLY, tag, tagBuf, NULL,
                  "H5Tset_tag: tag buffer not pinned");
 ...
 */
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Tget_1tag(JNIEnv *env,
                                                          jclass clss,
                                                          jlong type) {
  jstring str = NULL;
  char *tag = NULL;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tget_1super(JNIEnv *env,
                                                            jclass clss,
                                                            jlong type_id) {
  hid_t retVal = H5I_INVALID_HID;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tenum_1create(JNIEnv *env,
                                                              jclass clss,
                                                              jlong base_id) {
  hid_t retVal = H5I_INVALID_HID;
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tenum_1insert_1int(
  ...
  PIN_JAVA_STRING(ENVONLY, name, memberName, NULL,
                  "H5Tenum_insert_int: member name not pinned");

  PIN_INT_ARRAY(ENVONLY, value, intBuf, &isCopy,
                "H5Tenum_insert_int: int buffer not pinned");
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tenum_1insert(
  ...
  PIN_JAVA_STRING(ENVONLY, name, memberName, NULL,
                  "H5Tenum_insert: member name not pinned");

  PIN_BYTE_ARRAY(ENVONLY, value, memberBuf, &isCopy,
                 "H5Tenum_insert: member buffer not pinned");
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tenum_1nameof_1int(
  ...
  if (NULL == (nameP = (char *)malloc(sizeof(char) * (size_t)size)))
    H5_OUT_OF_MEMORY_ERROR(
        ENVONLY, "H5Tenum_nameof_int: failed to allocate name buffer");

  PIN_INT_ARRAY(ENVONLY, value, intP, &isCopy,
                "H5Tenum_nameof_int: value not pinned");
...
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Tenum_1nameof(
  ...
  if (NULL == (nameP = (char *)malloc(sizeof(char) * (size_t)size)))
    H5_OUT_OF_MEMORY_ERROR(ENVONLY,
                           "H5Tenum_nameof: failed to allocate name buffer");

  PIN_BYTE_ARRAY(ENVONLY, value, byteP, &isCopy,
                 "H5Tenum_nameof: value not pinned");
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tenum_1valueof_1int(
  ...
  if (NULL == name)
    H5_NULL_ARGUMENT_ERROR(ENVONLY,
                           "H5Tenum_valueof_int: enum value name is NULL");

  PIN_JAVA_STRING(ENVONLY, name, enumValue, NULL,
                  "H5Tenum_valueof_int: enum value not pinned");

  PIN_INT_ARRAY(ENVONLY, value, enumValueBuf, &isCopy,
                "H5Tenum_valueof_int: enum value buffer not pinned");
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tenum_1valueof(
  ...
  PIN_JAVA_STRING(ENVONLY, name, enumValue, NULL,
                  "H5Tenum_valueof: enum value not pinned");

  PIN_BYTE_ARRAY(ENVONLY, value, enumValueBuf, &isCopy,
                 "H5Tenum_valueof: enum value buffer not pinned");
  ...
  if (enumValueBuf)
    UNPIN_BYTE_ARRAY(ENVONLY, value, enumValueBuf,
                     (status < 0) ? JNI_ABORT : 0);
  if (enumValue)
    UNPIN_JAVA_STRING(ENVONLY, name, enumValue);
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1member_1value_1int(
  ...
  PIN_INT_ARRAY(ENVONLY, value, intP, &isCopy,
                "H5Tget_member_value: value not pinned");

  if ((status = H5Tget_member_value((hid_t)type_id, (unsigned)membno, intP)) <
      0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tget_1member_1value(
  ...
  if ((status = H5Tget_member_value((hid_t)type_id, (unsigned)membno, byteP)) <
      0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1array_1ndims(JNIEnv *env,
                                                                jclass clss,
                                                                jlong type_id) {
  int ndims = -1;
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1array_1dims(
  ...
  PIN_INT_ARRAY(ENVONLY, dims, dimsP, &isCopy,
                "H5Tget_array_dims: dimsP not pinned");
  ...
  if (NULL == (cdims = (hsize_t *)malloc((size_t)dlen * sizeof(hsize_t))))
    H5_OUT_OF_MEMORY_ERROR(
        ENVONLY, "H5Tget_array_dims: failed to allocate dimension buffer");
...
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tget_1native_1type(
  ...
  if ((native_tid =
           H5Tget_native_type((hid_t)type_id, (H5T_direction_t)direction)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tcommit(
  ...
  PIN_JAVA_STRING(ENVONLY, name, datatypeName, NULL,
                  "H5Tcommit: datatype name not pinned");

  if ((status = H5Tcommit2((hid_t)loc_id, datatypeName, (hid_t)type,
                           (hid_t)link_plist_id, (hid_t)create_plist_id,
...
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Tarray_1create2(
  ...
  PIN_LONG_ARRAY(ENVONLY, dims, dimsP, &isCopy,
                 "H5Tarray_create: dimsP not pinned");
  ...
  if (dlen != rank)
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "H5Tarray_create: dimension array length != array rank");

  if (NULL == (cdims = (hsize_t *)malloc((size_t)dlen * sizeof(hsize_t))))
    H5_OUT_OF_MEMORY_ERROR(
        ENVONLY, "H5Tarray_create: failed to allocate dimension buffer");

  for (i = 0; i < (size_t)dlen; i++) {
    cdims[i] = (hsize_t)dimsP[i];
  } /* end for */

  if ((retVal = H5Tarray_create2((hid_t)base_id, (unsigned)rank,
                                 (const hsize_t *)cdims)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Tget_1array_1dims2(
  ...
  PIN_LONG_ARRAY(ENVONLY, dims, dimsP, &isCopy,
                 "H5Tarray_get_dims2: dimsP not pinned");
  ...
  if (NULL == (cdims = (hsize_t *)malloc((size_t)dlen * sizeof(hsize_t))))
    H5_OUT_OF_MEMORY_ERROR(
        ENVONLY, "H5Tarray_get_dims2: failed to allocate dimension buffer");
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tconvert(
  ...
  if (background)
    PIN_BYTE_ARRAY(ENVONLY, background, bgP, &isCopy,
                   "H5Tconvert: background buffer not pinned");

  if ((status = H5Tconvert((hid_t)src_id, (hid_t)dst_id, (size_t)nelmts,
                           (void *)bufP, (void *)bgP, (hid_t)plist_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Tflush(JNIEnv *env, jclass clss,
                                                    jlong loc_id) {
  UNUSED(clss);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Trefresh(JNIEnv *env, jclass clss,
                                                      jlong loc_id) {
  UNUSED(clss);
