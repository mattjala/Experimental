...
static herr_t H5O_iterate_cb(hid_t g_id, const char *name,
                             const H5O_info2_t *info, void *cb_data);

/*
 * Create a java object of hdf.hdf5lib.structs.H5O_token_t.
 */
jobject create_H5O_token_t(JNIEnv *envptr, const H5O_token_t *token,
  ...
  if (NULL ==
      (tokenByteBuf = (*envptr)->NewByteArray(envptr, H5O_MAX_TOKEN_SIZE)))
    CHECK_JNI_EXCEPTION(envptr, JNI_FALSE);

  if (is_critical_pinning)
    PIN_BYTE_ARRAY_CRITICAL(
        envptr, tokenByteBuf, token_buf, &token_buf_is_copy,
  ...
  CALL_CONSTRUCTOR(envptr, "hdf/hdf5lib/structs/H5O_token_t", "([B)V",
                   constructor_args, ret_token_obj);
 ...
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Oopen(JNIEnv *env, jclass clss,
                                                      jlong loc_id,
                                                      jstring name,
  ...
  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Oopen: object name not pinned");
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5__1H5Oclose(JNIEnv *env, jclass clss,
                                                      jlong object_id) {
  herr_t retVal = FAIL;
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Ocopy(
  ...
  PIN_JAVA_STRING(ENVONLY, cur_name, lCurName, NULL,
                  "H5Ocopy: src name not pinned");
  PIN_JAVA_STRING(ENVONLY, dst_name, lDstName, NULL,
                  "H5Ocopy: dest name not pinned");

  if ((status = H5Ocopy((hid_t)cur_loc_id, lCurName, (hid_t)dst_loc_id,
                        lDstName, (hid_t)create_id, (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 */
JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Oget_1info(JNIEnv *env,
                                                           jclass clss,
                                                           jlong loc_id,
                                                           jint fields) {
  H5O_info2_t infobuf;
  ...
  CALL_CONSTRUCTOR(ENVONLY, "hdf/hdf5lib/structs/H5O_info_t",
                   "(JLhdf/hdf5lib/structs/H5O_token_t;IIJJJJJ)V", args,
                   ret_obj);
...
JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Oget_1info_1by_1name(
    JNIEnv *env, jclass clss, jlong loc_id, jstring name, jint fields,
    jlong access_id) {
  H5O_info2_t infobuf;
  const char *objName = NULL;
  jobject token;
  ...
  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Oget_info_by_name: object name not pinned");

  if ((status = H5Oget_info_by_name3((hid_t)loc_id, objName, &infobuf,
...
JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Oget_1info_1by_1idx(
    JNIEnv *env, jclass clss, jlong loc_id, jstring name, jint index_field,
    jint order, jlong link_n, jint fields, jlong access_id) {
  H5O_info2_t infobuf;
  ...
  PIN_JAVA_STRING(ENVONLY, name, grpName, NULL,
                  "H5Oget_info_by_idx: group name not pinned");

  if ((status = H5Oget_info_by_idx3(
           (hid_t)loc_id, grpName, (H5_index_t)index_field,
           (H5_iter_order_t)order, (hsize_t)link_n, &infobuf, (unsigned)fields,
           (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 */
JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Oget_1native_1info(
  ...
  if ((status = H5Oget_native_info((hid_t)loc_id, &infobuf, (unsigned)fields)) <
      0)
    H5_LIBRARY_ERROR(ENVONLY);
  ...
  CALL_CONSTRUCTOR(ENVONLY, "hdf/hdf5lib/structs/H5O_hdr_info_t",
                   "(IIIIJJJJJJ)V", args, ret_obj);
  hdrinfobuf = ret_obj;

  args[0].j = (jlong)infobuf.meta_size.obj.index_size;
  args[1].j = (jlong)infobuf.meta_size.obj.heap_size;

  CALL_CONSTRUCTOR(ENVONLY, "hdf/hdf5lib/structs/H5_ih_info_t", "(JJ)V", args,
                   ret_obj);
  ...
  CALL_CONSTRUCTOR(ENVONLY, "hdf/hdf5lib/structs/H5O_native_info_t",
                   "(Lhdf/hdf5lib/structs/H5O_hdr_info_t;Lhdf/hdf5lib/structs/"
                   "H5_ih_info_t;Lhdf/hdf5lib/"
 ...
 */
JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Oget_1native_1info_1by_1name(
    JNIEnv *env, jclass clss, jlong loc_id, jstring name, jint fields,
    jlong access_id) {
  H5O_native_info_t infobuf;
  const char *objName = NULL;
  ...
  if (NULL == name)
    H5_NULL_ARGUMENT_ERROR(ENVONLY,
                           "H5Oget_native_info_by_name: object name is NULL");

  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Oget_native_info_by_name: object name not pinned");

  if ((status =
           H5Oget_native_info_by_name((hid_t)loc_id, objName, &infobuf,
                                      (unsigned)fields, (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 */
JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Oget_1native_1info_1by_1idx(
    JNIEnv *env, jclass clss, jlong loc_id, jstring name, jint index_field,
    jint order, jlong link_n, jint fields, jlong access_id) {
  H5O_native_info_t infobuf;
  const char *grpName = NULL;
  ...
  if (NULL == name)
    H5_NULL_ARGUMENT_ERROR(ENVONLY,
                           "H5Oget_native_info_by_idx: group name is NULL");

  PIN_JAVA_STRING(ENVONLY, name, grpName, NULL,
                  "H5Oget_native_info_by_idx: group name not pinned");

  if ((status = H5Oget_native_info_by_idx(
           (hid_t)loc_id, grpName, (H5_index_t)index_field,
           (H5_iter_order_t)order, (hsize_t)link_n, &infobuf, (unsigned)fields,
           (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Olink(
  ...
  PIN_JAVA_STRING(ENVONLY, dst_name, linkDstName, NULL,
                  "H5Olink: link destination name not pinned");

  if ((status = H5Olink((hid_t)cur_loc_id, (hid_t)dst_loc_id, linkDstName,
                        (hid_t)create_id, (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
...
static herr_t H5O_iterate_cb(hid_t g_id, const char *name,
  ...
  if (JVMPTR->AttachCurrentThread(JVMPAR, (void **)&cbenv, NULL) < 0) {
    ...
    H5_JNI_FATAL_ERROR(
        CBENVONLY, "H5O_iterate_cb: failed to attach current thread to JVM");
  }
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Ovisit(
  ...
  if ((status = H5Ovisit3((hid_t)grp_id, (H5_index_t)idx_type,
                          (H5_iter_order_t)order, H5O_iterate_cb,
...
JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Ovisit_1by_1name(
  ...
  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Ovisit_by_name: object name not pinned");

  if ((status = H5Ovisit_by_name3((hid_t)grp_id, objName, (H5_index_t)idx_type,
                                  (H5_iter_order_t)order, H5O_iterate_cb,
                                  (void *)&wrapper, (unsigned)fields,
                                  (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Oset_1comment(JNIEnv *env,
                                                           jclass clss,
                                                           jlong loc_id,
                                                           jstring comment) {
  ...
  if (NULL != comment)
    PIN_JAVA_STRING(ENVONLY, comment, oComment, NULL,
                    "H5Oset_comment: object comment not pinned");
...
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Oset_1comment_1by_1name(
  ...
  if (NULL == name)
    H5_NULL_ARGUMENT_ERROR(ENVONLY,
                           "H5Oset_comment_by_name: object name is NULL");

  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Oset_comment_by_name: object name not pinned");

  if (NULL != comment)
    PIN_JAVA_STRING(ENVONLY, comment, objComment, &isCopy,
                    "H5Oset_comment_by_name: object comment not pinned");

  if ((status = H5Oset_comment_by_name((hid_t)loc_id, objName, objComment,
                                       (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 */
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Oget_1comment(JNIEnv *env,
                                                              jclass clss,
                                                              jlong loc_id) {
  jstring str = NULL;
  ssize_t buf_size;
  ...
  if (buf_size) {
    if (NULL ==
        (oComment = (char *)malloc(sizeof(char) * (size_t)buf_size + 1)))
      H5_OUT_OF_MEMORY_ERROR(
          ENVONLY, "H5Oget_comment: failed to allocate object comment buffer");

    if ((status =
             H5Oget_comment((hid_t)loc_id, oComment, (size_t)buf_size + 1)) < 0)
      H5_LIBRARY_ERROR(ENVONLY);
    oComment[buf_size] = '\0';
...
JNIEXPORT jstring JNICALL Java_hdf_hdf5lib_H5_H5Oget_1comment_1by_1name(
  ...
  if (NULL == name)
    H5_NULL_ARGUMENT_ERROR(ENVONLY,
                           "H5Oget_comment_by_name: object name is NULL");

  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Oget_comment_by_name: object name not pinned");

  /* Get the length of the comment */
  if ((buf_size = H5Oget_comment_by_name((hid_t)loc_id, objName, NULL, 0,
                                         (hid_t)access_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);

  if (buf_size) {
    if (NULL ==
        (objComment = (char *)malloc(sizeof(char) * (size_t)buf_size + 1)))
      H5_OUT_OF_MEMORY_ERROR(ENVONLY, "H5Oget_comment_by_name: failed to "
                                      "allocate buffer for object comment");

    if ((status = H5Oget_comment_by_name((hid_t)loc_id, objName, objComment,
                                         (size_t)buf_size + 1,
                                         (hid_t)access_id)) < 0)
      H5_LIBRARY_ERROR(ENVONLY);
...
JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Oexists_1by_1name(
  ...
  PIN_JAVA_STRING(ENVONLY, name, objName, NULL,
                  "H5Oexists_by_name: object name not pinned");
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Odecr_1refcount(JNIEnv *env,
                                                             jclass clss,
                                                             jlong object_id) {
  UNUSED(clss);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Oincr_1refcount(JNIEnv *env,
                                                             jclass clss,
                                                             jlong object_id) {
  UNUSED(clss);
 ...
 */
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Oopen_1by_1token(
  ...
  if (NULL == (token_data_field_id =
                   ENVPTR->GetFieldID(ENVONLY, token_cls, "data", "[B")))
    CHECK_JNI_EXCEPTION(ENVONLY, JNI_FALSE);
  ...
  if (token_buf)
    UNPIN_BYTE_ARRAY(ENVONLY, (jbyteArray)token_data, token_buf,
...
JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5__1H5Oopen_1by_1idx(
  ...
  PIN_JAVA_STRING(ENVONLY, name, grpName, NULL,
                  "H5Oopen_by_idx: object name not pinned");

  if ((retVal = H5Oopen_by_idx((hid_t)loc_id, grpName, (H5_index_t)index_field,
                               (H5_iter_order_t)order, (hsize_t)link_n,
                               (hid_t)lapl_id)) < 0)
    H5_LIBRARY_ERROR(ENVONLY);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Oflush(JNIEnv *env, jclass clss,
                                                    jlong loc_id) {
  UNUSED(clss);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Orefresh(JNIEnv *env, jclass clss,
                                                      jlong loc_id) {
  UNUSED(clss);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Odisable_1mdc_1flushes(
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Oenable_1mdc_1flushes(
    JNIEnv *env, jclass clss, jlong loc_id) {
  UNUSED(clss);
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Oare_1mdc_1flushes_1disabled(
    JNIEnv *env, jclass clss, jlong loc_id) {
