...
JNIEXPORT jintArray JNICALL Java_hdf_hdf5lib_HDFNativeData_byteToInt___3B(
  ...
  PIN_INT_ARRAY(ENVONLY, rarray, iarray, &bb,
                "byteToInt: int array not pinned");
    ...
    JNIEnv *env, jclass clss, jbyteArray bdata) /* IN: array of bytes */
{
  ...
  PIN_BYTE_ARRAY(ENVONLY, bdata, barr, &bb,
                 "byteToFloat: byte array not pinned");
  ...
  PIN_FLOAT_ARRAY(ENVONLY, rarray, farray, &bb,
                  "byteToFloat: float array not pinned");
    ...
    JNIEnv *env, jclass clss, jbyteArray bdata) /* IN: array of bytes */
{
  ...
  PIN_BYTE_ARRAY(ENVONLY, bdata, barr, &bb,
                 "byteToShort: byte array not pinned");
  ...
  PIN_SHORT_ARRAY(ENVONLY, rarray, sarray, &bb,
                  "byteToShort: short array not pinned");
    ...
    JNIEnv *env, jclass clss, jbyteArray bdata) /* IN: array of bytes */
{
  ...
  PIN_BYTE_ARRAY(ENVONLY, bdata, barr, &bb,
                 "byteToLong: byte array not pinned");
  ...
  PIN_LONG_ARRAY(ENVONLY, rarray, larray, &bb,
                 "byteToLong: long array not pinned");
    ...
    JNIEnv *env, jclass clss, jbyteArray bdata) /* IN: array of bytes */
{
  ...
  PIN_BYTE_ARRAY(ENVONLY, bdata, barr, &bb,
                 "byteToDouble: byte array not pinned");
  ...
  PIN_DOUBLE_ARRAY(ENVONLY, rarray, darray, &bb,
                   "byteToDouble: double array not pinned");
...
JNIEXPORT jintArray JNICALL Java_hdf_hdf5lib_HDFNativeData_byteToInt__II_3B(
    JNIEnv *env, jclass clss, jint start, jint len,
    jbyteArray bdata) /* IN: array of bytes */
{
  ...
  if ((start < 0) || ((int)(start + (len * (int)sizeof(jint))) > blen))
    H5_BAD_ARGUMENT_ERROR(ENVONLY,
                          "byteToInt: start < 0 or len exceeded buffer length");
    ...
    jbyteArray bdata) /* IN: array of bytes */
{
  ...
  if ((start < 0) || ((int)(start + (len * (int)sizeof(jshort))) > blen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "byteToShort: start < 0 or len exceeded buffer length");
    ...
    jbyteArray bdata) /* IN: array of bytes */
{
  ...
  if ((start < 0) || ((int)(start + (len * (int)sizeof(jfloat))) > blen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "byteToFloat: start < 0 or len exceeded buffer length");
    ...
    jbyteArray bdata) /* IN: array of bytes */
{
  ...
  if ((start < 0) || ((int)(start + (len * (int)sizeof(jlong))) > blen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "byteToLong: start < 0 or len exceeded buffer length");
    ...
    jbyteArray bdata) /* IN: array of bytes */
{
  ...
  if ((start < 0) || ((int)(start + (len * (int)sizeof(jdouble))) > blen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "byteToDouble: start < 0 or len exceeded buffer length");
    ...
    jintArray idata) /* IN: array of int */
{
  ...
  if ((start < 0) || (((start + len)) > ilen))
    H5_BAD_ARGUMENT_ERROR(ENVONLY,
                          "intToByte: start < 0 or len exceeded buffer length");
  ...
  PIN_BYTE_ARRAY(ENVONLY, rarray, barray, &bb,
                 "intToByte: byte array not pinned");
    ...
    jshortArray sdata) /* IN: array of short */
{
  ...
  PIN_SHORT_ARRAY(ENVONLY, sdata, sarr, &bb,
                  "shortToByte: short array not pinned");
  ...
  if ((start < 0) || (((start + len)) > ilen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "shortToByte: start < 0 or len exceeded buffer length");
  ...
  PIN_BYTE_ARRAY(ENVONLY, rarray, barray, &bb,
                 "shortToByte: byte array not pinned");
    ...
    jfloatArray fdata) /* IN: array of float */
{
  ...
  PIN_FLOAT_ARRAY(ENVONLY, fdata, farr, &bb,
                  "floatToByte: float array not pinned");
  ...
  if ((start < 0) || (((start + len)) > ilen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "floatToByte: start < 0 or len exceeded buffer length");
  ...
  PIN_BYTE_ARRAY(ENVONLY, rarray, barray, &bb,
                 "floatToByte: byte array not pinned");
    ...
    jdoubleArray ddata) /* IN: array of double */
{
  ...
  PIN_DOUBLE_ARRAY(ENVONLY, ddata, darr, &bb,
                   "doubleToByte: double array not pinned");
  ...
  if ((start < 0) || (((start + len)) > ilen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "doubleToByte: start < 0 or len exceeded buffer length");
  ...
  PIN_BYTE_ARRAY(ENVONLY, rarray, barray, &bb,
                 "doubleToByte: byte array not pinned");
    ...
    jlongArray ldata) /* IN: array of long */
{
  ...
  PIN_LONG_ARRAY(ENVONLY, ldata, larr, &bb,
                 "longToByte: long array not pinned");
  ...
  if ((start < 0) || (((start + len)) > ilen))
    H5_BAD_ARGUMENT_ERROR(
        ENVONLY, "longToByte: start < 0 or len exceeded buffer length");
  ...
  PIN_BYTE_ARRAY(ENVONLY, rarray, barray, &bb,
                 "longToByte: byte array not pinned");
    ...
    JNIEnv *env, jclass clss, jbyte bdata) /* IN: byte */
{
  ...
  PIN_BYTE_ARRAY(ENVONLY, rarray, barray, &bb,
                 "byteToByte: byte array not pinned");
