 ...
 * the JNI function jconstant, where jconstant is used for any of the private
 * constants which start their name with "H5" need to be converted. <P> <B>Do
 * not edit this file!</b>
 *
 * @see @ref HDF5LIB
 */
public class HDF5Constants {
  ...
  /**
   * increase the current maximum cache size by x * flash_multiple less any
  ...
  /**
   * Minor error codes - Function entry/exit interface - Object already
   * initialized
   */
  ...
  /**
   * Minor error codes - Object ID related errors - Unable to find ID
   * information (already closed?)
   */
  ...
  /**
   * Minor error codes - Object ID related errors - Unable to find ID group
   * information
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to mark metadata as
   * clean
   */
  ...
  /**
   * Minor error codes - Object ID related errors - Unable to decrement
   * reference count
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to create a flush
   * dependency
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to expunge a metadata
   * cache entry
   */
  ...
  /**
   * Minor error codes - Function entry/exit interface - Unable to initialize
   * object
   */
  public static final long H5E_CANTINIT = H5E_CANTINIT();
  /**
   * Minor error codes - Cache related errors - Unable to insert metadata into
   * cache
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to load metadata into
   * cache
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to mark a pinned entry
   * as clean
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to mark an entry as
   * unserialized
   */
  ...
  /**
   * Minor error codes - Dataspace errors - Can't move to next iterator
   * location
   */
  public static final long H5E_CANTNEXT = H5E_CANTNEXT();
  /**
   * Minor error codes - Cache related errors - Unable to notify object about
   * action
   */
  ...
  /**
   * Minor error codes - Function entry/exit interface - Unable to release
   * object
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to resize a metadata
   * cache entry
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to serialize data from
   * cache
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to tag metadata in the
   * cache
   */
  ...
  /**
   * Minor error codes - Cache related errors - Unable to destroy a flush
   * dependency
   */
  ...
  /**
   * Minor error codes - Property list errors - Duplicate class name in parent
   * class
   */
  ...
  /**
   * Minor error codes - Object header related errors - Bad object header link
   * count
   */
  public static final long H5E_LINKCOUNT = H5E_LINKCOUNT();
  /**
   * Minor error codes - Cache related errors - Failure in the cache logging
   * framework
   */
  ...
  /**
   * Different ways of combining selections - Binary "and" operation for
   * hyperslabs
   */
  public static final int H5S_SELECT_AND = H5S_SELECT_AND();
  /**
   * Different ways of combining selections - Append elements to end of point
   * selection
   */
  public static final int H5S_SELECT_APPEND = H5S_SELECT_APPEND();
  /**
   * Different ways of combining selections - Invalid upper bound on selection
   * operations
   */
  ...
  /**
   * Different ways of combining selections - Binary "not" operation for
   * hyperslabs
   */
  ...
  /**
   * Different ways of combining selections - Binary "or" operation for
   * hyperslabs
   */
  public static final int H5S_SELECT_OR = H5S_SELECT_OR();
  /**
   * Different ways of combining selections - Prepend elements to beginning of
   * point selection
   */
  ...
  /**
   * Different ways of combining selections - Binary "xor" operation for
   * hyperslabs
   */
  ...
  private static native final int
  H5AC_METADATA_WRITE_STRATEGY_PROCESS_ZERO_ONLY();
