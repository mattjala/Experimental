...
public interface H5D_iterate_cb extends Callbacks {
   ...
   *
   *  @param elem      the pointer to the element in memory containing the
   * current point
   *  @param elem_type the datatype ID for the elements stored in elem
   *  @param ndim      the number of dimensions for POINT array
   *  @param point     the array containing the location of the element within
   ...
   *          attribute.
   */
  int callback(byte[] elem, long elem_type, int ndim, long[] point,
