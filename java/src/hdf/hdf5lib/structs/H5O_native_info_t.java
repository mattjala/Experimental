...
/**
 * Information struct for native HDF5 object info, such as object header
 * metadata (for H5Oget_info/H5Oget_info_by_name/H5Oget_info_by_idx).
 *
 */
public class H5O_native_info_t implements Serializable {
  ...
  /**
   * v1/v2 B-tree and local/fractal heap for groups, B-tree for chunked
   * datasets
   */
  ...
  H5O_native_info_t(H5O_hdr_info_t oheader_info, H5_ih_info_t obj_info,
