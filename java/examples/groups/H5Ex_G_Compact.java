...
public class H5Ex_G_Compact {
  ...
  public static void CreateGroup() {
    ...
    try {
      file_id =
          H5.H5Fcreate(FILE1, HDF5Constants.H5F_ACC_TRUNC,
    ...
    try {
      if (file_id >= 0)
        group_id =
            H5.H5Gcreate(file_id, GROUP, HDF5Constants.H5P_DEFAULT,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    try {
      file_id = H5.H5Fopen(FILE1, HDF5Constants.H5F_ACC_RDONLY,
    ...
    try {
      file_id = H5.H5Fcreate(FILE2, HDF5Constants.H5F_ACC_TRUNC,
