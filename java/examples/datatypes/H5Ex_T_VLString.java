...
public class H5Ex_T_VLString {
  ...
  private static void createDataset() {
    ...
    try {
      if ((file_id >= 0) && (type_id >= 0) && (dataspace_id >= 0)) {
        dataset_id =
            H5.H5Dcreate(file_id, DATASETNAME, type_id, dataspace_id,
                         HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT,
    ...
    try {
      if (dataset_id >= 0)
        H5.H5DwriteVL(dataset_id, type_id, HDF5Constants.H5S_ALL,
  ...
  private static void readDataset() {
    ...
    try {
      ...
      H5.H5DreadVL(dataset_id, type_id, HDF5Constants.H5S_ALL,
