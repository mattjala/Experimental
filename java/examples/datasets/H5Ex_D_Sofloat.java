...
public class H5Ex_D_Sofloat {
    ...
    try {
      if ((file_id >= 0) && (filespace_id >= 0) && (dcpl_id >= 0))
        dataset_id = H5.H5Dcreate(
            file_id, DATASETNAME, HDF5Constants.H5T_IEEE_F64LE, filespace_id,
  ...
  private static void readData() {
    ...
    DecimalFormat df =
        new DecimalFormat("#,##0.000000", new DecimalFormatSymbols(Locale.US));
    System.out.println("Maximum value in " + DATASETNAME +
                       " is: " + df.format(max));
    System.out.println("Minimum value in " + DATASETNAME +
                       " is: " + df.format(min));
