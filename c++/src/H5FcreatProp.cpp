...
//              constant H5P_FILE_ACCESS, pointed to by
//              FileCreatPropList::DEFAULT_
...
FileCreatPropList *FileCreatPropList::getConstant() {
  ...
  if (DEFAULT_ == 0)
    ...
    throw PropListIException("FileCreatPropList::getConstant",
                             "FileCreatPropList::getConstant is being invoked "
...
//              points to.
//--------------------------------------------------------------------------
void FileCreatPropList::deleteConstants() { delete DEFAULT_; }
...
///\brief       Sets the user block size field of this file creation property
///list. \param       size - IN: User block size to be set, in bytes \exception
...
///\exception   H5::PropListIException
//--------------------------------------------------------------------------
void FileCreatPropList::getSizes(size_t &sizeof_addr,
...
//--------------------------------------------------------------------------
void FileCreatPropList::setFileSpaceStrategy(H5F_fspace_strategy_t strategy,
                                             hbool_t persist,
...
///\exception   H5::PropListIException
//--------------------------------------------------------------------------
void FileCreatPropList::getFileSpaceStrategy(H5F_fspace_strategy_t &strategy,
                                             hbool_t &persist,
                                             hsize_t &threshold) const {
  herr_t ret_value =
