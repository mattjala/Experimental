...
public:
  ...
  void getVersion(unsigned &super, unsigned &freelist, unsigned &stab,
  ...
  void setFileSpaceStrategy(H5F_fspace_strategy_t strategy, hbool_t persist,
                            hsize_t threshold) const;

  // Returns the strategy that the library uses in managing file space.
  void getFileSpaceStrategy(H5F_fspace_strategy_t &strategy, hbool_t &persist,
                            hsize_t &threshold) const;
