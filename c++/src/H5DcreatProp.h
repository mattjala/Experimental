...
public:
  ...
  void getExternal(unsigned idx, size_t name_size, char *name, off_t &offset,
                   hsize_t &size) const;
  ...
  H5Z_filter_t getFilter(int filter_number, unsigned int &flags,
  ...
  void getFilterById(H5Z_filter_t filter_id, unsigned int &flags,
                     size_t &cd_nelmts, unsigned int *cd_values, size_t namelen,
                     char name[], unsigned int &filter_config) const;
  ...
  void modifyFilter(H5Z_filter_t filter_id, unsigned int flags,
  ...
  void setFilter(H5Z_filter_t filter, unsigned int flags = 0,
                 size_t cd_nelmts = 0,
  ...
  void setVirtual(const DataSpace &vspace, const char *src_fname,
                  const char *src_dsname, const DataSpace &sspace) const;
