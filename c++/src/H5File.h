...
public:
  ...
  static bool
  isAccessible(const char *name,
               const FileAccPropList &access_plist = FileAccPropList::DEFAULT);
  static bool
  isAccessible(const H5std_string &name,
               const FileAccPropList &access_plist = FileAccPropList::DEFAULT);
  ...
  virtual void throwException(const H5std_string &func_name,
                              const H5std_string &msg) const override;
...
private:
  ...
  void p_get_file(const char *name, unsigned int flags,
