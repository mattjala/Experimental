...
int main(void) {
  ...
  try {
    ...
    DataSet *dataset = new DataSet(
        file->createDataSet("/Data/Compressed_Data", PredType::NATIVE_INT,
    ...
    dataset = new DataSet(file->createDataSet(
        "/Data/Float_Data", PredType::NATIVE_FLOAT, *dataspace));
    ...
    herr_t idx = H5Literate2(file->getId(), H5_INDEX_NAME, H5_ITER_INC, NULL,
                             file_info, NULL);
    cout << endl;
    ...
    idx = H5Literate2(file->getId(), H5_INDEX_NAME, H5_ITER_INC, NULL,
                      file_info, NULL);
    cout << endl;
 ...
 * Operator function.
 */
herr_t file_info(hid_t loc_id, const char *name, const H5L_info2_t *linfo,
                 void *opdata) {
  hid_t group;
