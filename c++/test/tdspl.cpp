...
static void test_transfplist() {
  ...
  try {
    ...
    size_t tran_len =
        static_cast<size_t>(dxpl_c_to_f_copy.getDataTransform(NULL));
    ...
    verify_val(const_cast<const char *>(c_to_f_read),
               const_cast<const char *>(c_to_f),
    ...
    verify_val(const_cast<const char *>(simple_read.c_str()),
               const_cast<const char *>(simple),
               "DSetMemXferPropList::getDataTransform", __LINE__, __FILE__);
    ...
    verify_val(const_cast<const char *>(utrans_inv_read),
               const_cast<const char *>(utrans_inv),
               "DSetMemXferPropList::getDataTransform", __LINE__, __FILE__);
 ...
 *-------------------------------------------------------------------------
 */
extern "C" void cleanup_dsproplist() { HDremove(FILENAME.c_str()); }
