...
static void test_reference_params() {
  ...
  try {
    ...
    DataSet dataset =
        group.createDataSet(DSET1_NAME, PredType::NATIVE_UINT, sid1);
...
static void test_reference_obj() {
  ...
  try {
    ...
    verify_val(static_cast<long>(refobj_type),
               static_cast<long>(H5O_TYPE_DATASET), "DataSet::getRefObjType",
               __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(refobj_type),
               static_cast<long>(H5O_TYPE_GROUP), "DataSet::getRefObjType",
               __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(refobj_type),
               static_cast<long>(H5O_TYPE_NAMED_DATATYPE),
    ...
    verify_val(static_cast<long>(n_elements), 4,
               "DataSpace::getSimpleExtentNpoints", __LINE__, __FILE__);

    // Read from disk
    dset2.read(tbuf, PredType::NATIVE_UINT);

    for (tu32 = reinterpret_cast<unsigned *>(tbuf), i = 0; i < SPACE1_DIM1;
         i++, tu32++)
      verify_val(*tu32, static_cast<uint32_t>(i * 3),
                 "DataSpace::getSimpleExtentNpoints", __LINE__, __FILE__);
    ...
    verify_val(read_comment1.c_str(), write_comment, "Group::getComment",
               __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(tclass), static_cast<long>(H5T_COMPOUND),
               "DataType::getClass", __LINE__, __FILE__);
    ...
    issue_fail_msg("test_reference_obj()", __LINE__, __FILE__, E.getCFuncName(),
                   E.getCDetailMsg());
  }
...
static void test_reference_group() {
  ...
  try {
    ...
    verify_val(static_cast<long>(nobjs), 3, "H5Group::getNumObjs", __LINE__,
               __FILE__);
    ...
    verify_val(static_cast<long>(oinfo.type),
               static_cast<long>(H5O_TYPE_DATASET), "Group::getObjinfo",
               __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(nobjs), 2, "H5Group::getNumObjs", __LINE__,
               __FILE__);
...
static void test_reference_region_1D() {
  ...
  try {
    ...
    // Allocate write & read buffers
    wbuf = static_cast<hdset_reg_ref_t *>(
        calloc(sizeof(hdset_reg_ref_t), SPACE1_DIM1));
    rbuf = static_cast<hdset_reg_ref_t *>(
        malloc(sizeof(hdset_reg_ref_t) * SPACE1_DIM1));
    ...
    // Create a dataset
    DataSet dset1 =
        file1.createDataSet(DSET1_NAME, PredType::STD_REF_DSETREG, sid1);
    ...
    sid3.selectElements(H5S_SELECT_SET, POINT1_NPOINTS,
    ...
    { // Test DataSet::dereference
      ...
      verify_val(static_cast<long>(obj_type),
                 static_cast<long>(H5O_TYPE_DATASET), "DataSet::getRefObjType",
                 __LINE__, __FILE__);
      ...
      verify_val(static_cast<long>(nelms), 100,
                 "DataSpace::getSimpleExtentNpoints", __LINE__, __FILE__);
    ...
    for (tu8 = static_cast<uint8_t *>(drbuf), i = 0; i < SPACE3_DIM1;
         i++, tu8++)
      verify_val(*tu8, static_cast<uint8_t>(i),
                 "DataSpace::getSimpleExtentNpoints", __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(nelms), 30, "DataSpace::getSelectNpoints",
               __LINE__, __FILE__);

    // Get and verify number of hyperslab blocks
    nelms = reg_sp.getSelectHyperNblocks();
    verify_val(static_cast<long>(nelms), 15, "DataSpace::getSelectNpoints",
               __LINE__, __FILE__);

    /* Allocate space for the hyperslab blocks */
    coords = static_cast<hsize_t *>(
        malloc(static_cast<size_t>(nelms) * SPACE3_RANK * sizeof(hsize_t) * 2));

    // Get the list of hyperslab blocks currently selected
    reg_sp.getSelectHyperBlocklist(0, static_cast<hsize_t>(nelms), coords);

    // Verify values in the list
    verify_val(static_cast<long>(coords[0]), 2, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[1]), 3, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[2]), 7, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[3]), 8, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[4]), 12, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[5]), 13, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[6]), 17, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[7]), 18, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[8]), 22, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[9]), 23, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[10]), 27, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[11]), 28, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[12]), 32, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[13]), 33, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[14]), 37, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[15]), 38, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[16]), 42, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[17]), 43, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[18]), 47, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[19]), 48, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[20]), 52, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[21]), 53, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[22]), 57, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[23]), 58, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[24]), 62, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[25]), 63, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[26]), 67, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[27]), 68, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[28]), 72, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(coords[29]), 73, "Hyperslab Coordinates",
               __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(low[0]), 2, "DataSpace::getSelectBounds",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(high[0]), 73, "DataSpace::getSelectBounds",
               __LINE__, __FILE__);
    ...
    verify_val(static_cast<long>(nelmspts), 10, "DataSpace::getSelectNpoints",
               __LINE__, __FILE__);

    /* Allocate space for the hyperslab blocks */
    coords = static_cast<hsize_t *>(
        malloc(static_cast<size_t>(nelmspts) * SPACE3_RANK * sizeof(hsize_t)));

    // Get the list of element points currently selected
    elm_sp.getSelectElemPointlist(0, static_cast<hsize_t>(nelmspts), coords);

    // Verify points
    verify_val(coords[0], coord1[0][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[1], coord1[1][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[2], coord1[2][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[3], coord1[3][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[4], coord1[4][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[5], coord1[5][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[6], coord1[6][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[7], coord1[7][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[8], coord1[8][0], "Element Coordinates", __LINE__,
               __FILE__);
    verify_val(coords[9], coord1[9][0], "Element Coordinates", __LINE__,
               __FILE__);
    ...
    verify_val(static_cast<long>(low[0]), 3, "DataSpace::getSelectBounds",
               __LINE__, __FILE__);
    verify_val(static_cast<long>(high[0]), 97, "DataSpace::getSelectBounds",
               __LINE__, __FILE__);
 ...
 *-------------------------------------------------------------------------
 */
extern "C" void cleanup_reference() {
