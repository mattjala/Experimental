...
void issue_fail_msg(const char *where, int line, const char *file_name,
  ...
  if (GetTestVerbosity() >= VERBO_HI) {
    cerr << endl;
    cerr << ">>> FAILED in " << where << " at line " << line << " in "
...
//              message - IN: Message
//--------------------------------------------------------------------------
InvalidActionException::InvalidActionException(const H5std_string &func,
...
//              message - IN: Message
//--------------------------------------------------------------------------
TestFailedException::TestFailedException(const H5std_string &func,
                                         const H5std_string &message)
    : Exception(func, message) {}
