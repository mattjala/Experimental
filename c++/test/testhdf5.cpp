...
int main(int argc, char *argv[]) {
  try {
    ...
    AddTest("tvlstr", test_vlstrings, cleanup_vlstrings,
    ...
    AddTest("tcompound", test_compound, cleanup_compound, "Compound Data Types",
            NULL);
    AddTest("tdspl", test_dsproplist, cleanup_dsproplist,
            "Dataset Property List", NULL);
    ...
    */
    ...
    /*
            AddTest("genprop", test_genprop, cleanup_genprop,  "Generic
    Properties", NULL); AddTest("id", test_ids, NULL,  "User-Created
    Identifiers", NULL);
