...
#define FHCOUNT0                                                               \
  1 /* Count of the first dimension of the first hyperslab selection*/
#define FHCOUNT1                                                               \
  768 /* Count of the second dimension of the first hyperslab selection*/
#define FHSTRIDE0                                                              \
  4 /* Stride of the first dimension of the first hyperslab selection*/
#define FHSTRIDE1                                                              \
  3 /* Stride of the second dimension of the first hyperslab selection*/
#define FHBLOCK0                                                               \
  3 /* Block of the first dimension of the first hyperslab selection*/
#define FHBLOCK1                                                               \
  2 /* Block of the second dimension of the first hyperslab selection*/
#define FHSTART0                                                               \
  0 /* start of the first dimension of the first hyperslab selection*/
#define FHSTART1                                                               \
  1 /* start of the second dimension of the first hyperslab selection*/

#define SHCOUNT0                                                               \
  1 /* Count of the first dimension of the first hyperslab selection*/
#define SHCOUNT1                                                               \
  1 /* Count of the second dimension of the first hyperslab selection*/
#define SHSTRIDE0                                                              \
  1 /* Stride of the first dimension of the first hyperslab selection*/
#define SHSTRIDE1                                                              \
  1 /* Stride of the second dimension of the first hyperslab selection*/
#define SHBLOCK0                                                               \
  3 /* Block of the first dimension of the first hyperslab selection*/
#define SHBLOCK1                                                               \
  768 /* Block of the second dimension of the first hyperslab selection*/
#define SHSTART0                                                               \
  4 /* start of the first dimension of the first hyperslab selection*/
#define SHSTART1                                                               \
  0 /* start of the second dimension of the first hyperslab selection*/

#define MHCOUNT0                                                               \
  6912 /* Count of the first dimension of the first hyperslab selection*/
#define MHSTRIDE0                                                              \
  1 /* Stride of the first dimension of the first hyperslab selection*/
#define MHBLOCK0                                                               \
  1 /* Block of the first dimension of the first hyperslab selection*/
#define MHSTART0                                                               \
  1 /* start of the first dimension of the first hyperslab selection*/

#define RFFHCOUNT0                                                             \
  3 /* Count of the first dimension of the first hyperslab selection*/
#define RFFHCOUNT1                                                             \
  768 /* Count of the second dimension of the first hyperslab selection*/
#define RFFHSTRIDE0                                                            \
  1 /* Stride of the first dimension of the first hyperslab selection*/
...
#define RFFHBLOCK0                                                             \
  1 /* Block of the first dimension of the first hyperslab selection*/
#define RFFHBLOCK1                                                             \
  1 /* Block of the second dimension of the first hyperslab selection*/
#define RFFHSTART0                                                             \
  1 /* start of the first dimension of the first hyperslab selection*/
#define RFFHSTART1                                                             \
  2 /* start of the second dimension of the first hyperslab selection*/

#define RFSHCOUNT0                                                             \
  3 /* Count of the first dimension of the first hyperslab selection*/
#define RFSHCOUNT1                                                             \
  1536 /* Count of the second dimension of the first hyperslab selection*/
#define RFSHSTRIDE0                                                            \
  1 /* Stride of the first dimension of the first hyperslab selection*/
#define RFSHSTRIDE1                                                            \
  1 /* Stride of the second dimension of the first hyperslab selection*/
...
#define RFSHBLOCK1                                                             \
  1 /* Block of the second dimension of the first hyperslab selection*/
#define RFSHSTART0                                                             \
  2 /* start of the first dimension of the first hyperslab selection*/
#define RFSHSTART1                                                             \
  4 /* start of the second dimension of the first hyperslab selection*/
...
MPI_Offset h5_mpi_get_file_size(const char *filename, MPI_Comm comm,
                                MPI_Info info);
...
void point_set(hsize_t start[], hsize_t count[], hsize_t stride[],
               hsize_t block[], size_t num_points, hsize_t coords[], int order);
#endif /* PHDF5TEST_H */
