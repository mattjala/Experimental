...
/* #define DYNAMIC_FILTER */ /* Uncomment and define the fields below to use a
...
/* For experimental purposes only, will cause tests to fail data verification
 * phase - JTH */
/* #define GEN_DATA(i)          RANK_DATA(i) */ /* Given an index value i,
                                                   generates test data based
                                                   upon selected mode */

#define INCREMENTAL_DATA(i)                                                    \
  ((size_t)mpi_rank + i) /* Generates incremental test data */
#define RANK_DATA(i)                                                           \
  (mpi_rank) /* Generates test data to visibly show which rank wrote to which  \
...
#define WRITE_ONE_CHUNK_FILTERED_DATASET_NROWS                                 \
  (mpi_size * DIM0_SCALE_FACTOR) /* Must be an even multiple of the number of  \
                                    ranks to avoid issues */
#define WRITE_ONE_CHUNK_FILTERED_DATASET_NCOLS                                 \
  (mpi_size * DIM1_SCALE_FACTOR) /* Must be an even multiple of the number of  \
                                    ranks to avoid issues */
#define WRITE_ONE_CHUNK_FILTERED_DATASET_CH_NROWS                              \
  WRITE_ONE_CHUNK_FILTERED_DATASET_NROWS
#define WRITE_ONE_CHUNK_FILTERED_DATASET_CH_NCOLS                              \
  WRITE_ONE_CHUNK_FILTERED_DATASET_NCOLS

/* Defines for the unshared filtered chunks write test */
#define WRITE_UNSHARED_FILTERED_CHUNKS_DATASET_NAME                            \
  "unshared_filtered_chunks_write"
...
#define WRITE_UNSHARED_FILTERED_CHUNKS_CH_NROWS                                \
  (WRITE_UNSHARED_FILTERED_CHUNKS_NROWS / mpi_size)
#define WRITE_UNSHARED_FILTERED_CHUNKS_CH_NCOLS                                \
  (WRITE_UNSHARED_FILTERED_CHUNKS_NCOLS / mpi_size)

/* Defines for the unshared filtered chunks partial write test */
#define WRITE_UNSHARED_FILTERED_CHUNKS_PARTIAL_DATASET_NAME                    \
  "unshared_filtered_chunks_partial_write"
#define WRITE_UNSHARED_FILTERED_CHUNKS_PARTIAL_DATASET_DIMS 2
#define WRITE_UNSHARED_FILTERED_CHUNKS_PARTIAL_NROWS                           \
  (mpi_size * DIM0_SCALE_FACTOR)
#define WRITE_UNSHARED_FILTERED_CHUNKS_PARTIAL_NCOLS                           \
...
#define WRITE_SHARED_FILTERED_CHUNKS_NROWS                                     \
  (WRITE_SHARED_FILTERED_CHUNKS_CH_NROWS * DIM0_SCALE_FACTOR)
#define WRITE_SHARED_FILTERED_CHUNKS_NCOLS                                     \
  (WRITE_SHARED_FILTERED_CHUNKS_CH_NCOLS * DIM1_SCALE_FACTOR)

/* Defines for the unshared filtered chunks w/ single unlim. dimension write
 * test */
#define WRITE_UNSHARED_ONE_UNLIM_DIM_DATASET_NAME                              \
  "unshared_filtered_chunks_single_unlim_dim_write"
...
#define WRITE_UNSHARED_ONE_UNLIM_DIM_CH_NROWS                                  \
  (WRITE_UNSHARED_ONE_UNLIM_DIM_NROWS / mpi_size)
#define WRITE_UNSHARED_ONE_UNLIM_DIM_CH_NCOLS                                  \
  (WRITE_UNSHARED_ONE_UNLIM_DIM_NCOLS / mpi_size)
#define WRITE_UNSHARED_ONE_UNLIM_DIM_NLOOPS 5

/* Defines for the shared filtered chunks w/ single unlim. dimension write test
 */
#define WRITE_SHARED_ONE_UNLIM_DIM_DATASET_NAME                                \
...
#define WRITE_SHARED_ONE_UNLIM_DIM_NROWS                                       \
  (WRITE_SHARED_ONE_UNLIM_DIM_CH_NROWS * DIM0_SCALE_FACTOR)
#define WRITE_SHARED_ONE_UNLIM_DIM_NCOLS                                       \
  (WRITE_SHARED_ONE_UNLIM_DIM_CH_NCOLS * DIM1_SCALE_FACTOR)
#define WRITE_SHARED_ONE_UNLIM_DIM_NLOOPS 5

/* Defines for the unshared filtered chunks w/ two unlim. dimension write test
 */
#define WRITE_UNSHARED_TWO_UNLIM_DIM_DATASET_NAME                              \
  "unshared_filtered_chunks_two_unlim_dim_write"
...
#define WRITE_SHARED_TWO_UNLIM_DIM_DATASET_NAME                                \
  "shared_filtered_chunks_two_unlim_dim_write"
 ...
 */
#define WRITE_SINGLE_NO_SELECTION_FILTERED_CHUNKS_DATASET_NAME                 \
  "single_no_selection_filtered_chunks_write"
 ...
 */
#define WRITE_ALL_NO_SELECTION_FILTERED_CHUNKS_DATASET_NAME                    \
...
#define WRITE_POINT_SELECTION_FILTERED_CHUNKS_DATASET_NAME                     \
  "point_selection_filtered_chunks_write"
...
#define INTERLEAVED_WRITE_FILTERED_DATASET_NAME                                \
  "filtered_dataset_interleaved_write"
...
#define WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_DATASET_NAME                \
  "unshared_transformed_filtered_chunks_write"
#define WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_DATASET_DIMS 2
#define WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NROWS                       \
  (mpi_size * DIM0_SCALE_FACTOR)
#define WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NCOLS                       \
  (mpi_size * DIM1_SCALE_FACTOR)
...
#define WRITE_UNSHARED_FILTERED_CHUNKS_3D_SEP_PAGE_NROWS                       \
  (mpi_size * DIM0_SCALE_FACTOR)
#define WRITE_UNSHARED_FILTERED_CHUNKS_3D_SEP_PAGE_NCOLS                       \
  (mpi_size * DIM1_SCALE_FACTOR)
...
#define WRITE_UNSHARED_FILTERED_CHUNKS_3D_SAME_PAGE_NROWS                      \
  (mpi_size * DIM0_SCALE_FACTOR)
#define WRITE_UNSHARED_FILTERED_CHUNKS_3D_SAME_PAGE_NCOLS                      \
  (mpi_size * DIM1_SCALE_FACTOR)
...
#define WRITE_SHARED_FILTERED_CHUNKS_3D_DATASET_NAME                           \
  "3D_shared_filtered_chunks_write"
...
#define WRITE_SHARED_FILTERED_CHUNKS_3D_NROWS                                  \
  (WRITE_SHARED_FILTERED_CHUNKS_3D_CH_NROWS * DIM0_SCALE_FACTOR)
#define WRITE_SHARED_FILTERED_CHUNKS_3D_NCOLS                                  \
  (WRITE_SHARED_FILTERED_CHUNKS_3D_CH_NCOLS * DIM1_SCALE_FACTOR)
#define WRITE_SHARED_FILTERED_CHUNKS_3D_DEPTH (mpi_size)

/* Defines for the compound datatype filtered dataset no conversion write test
 * with unshared chunks */
...
/* Defines for the compound datatype filtered dataset type conversion write test
 * with unshared chunks */
...
#define READ_ONE_CHUNK_FILTERED_DATASET_NCOLS                                  \
  (mpi_size * DIM1_SCALE_FACTOR) /* Must be an even multiple of the number of  \
                                    ranks to avoid issues */
#define READ_ONE_CHUNK_FILTERED_DATASET_CH_NROWS                               \
  READ_ONE_CHUNK_FILTERED_DATASET_NROWS
#define READ_ONE_CHUNK_FILTERED_DATASET_CH_NCOLS                               \
  READ_ONE_CHUNK_FILTERED_DATASET_NCOLS

/* Defines for the unshared filtered chunks read test */
#define READ_UNSHARED_FILTERED_CHUNKS_DATASET_NAME                             \
  "unshared_filtered_chunks_read"
...
#define READ_UNSHARED_FILTERED_CHUNKS_CH_NROWS                                 \
  (READ_UNSHARED_FILTERED_CHUNKS_NROWS / mpi_size)
#define READ_UNSHARED_FILTERED_CHUNKS_CH_NCOLS                                 \
...
#define READ_SHARED_FILTERED_CHUNKS_NROWS                                      \
  (READ_SHARED_FILTERED_CHUNKS_CH_NROWS * DIM0_SCALE_FACTOR)
#define READ_SHARED_FILTERED_CHUNKS_NCOLS                                      \
  (READ_SHARED_FILTERED_CHUNKS_CH_NCOLS * DIM1_SCALE_FACTOR)

/* Defines for the filtered chunks read test where a process has no selection */
#define READ_SINGLE_NO_SELECTION_FILTERED_CHUNKS_DATASET_NAME                  \
  "single_no_selection_filtered_chunks_read"
...
#define READ_ALL_NO_SELECTION_FILTERED_CHUNKS_DATASET_NAME                     \
...
#define READ_POINT_SELECTION_FILTERED_CHUNKS_DATASET_NAME                      \
  "point_selection_filtered_chunks_read"
...
#define READ_POINT_SELECTION_FILTERED_CHUNKS_NROWS                             \
  (READ_POINT_SELECTION_FILTERED_CHUNKS_CH_NROWS * mpi_size)
#define READ_POINT_SELECTION_FILTERED_CHUNKS_NCOLS                             \
  (READ_POINT_SELECTION_FILTERED_CHUNKS_CH_NCOLS * mpi_size)

/* Defines for the filtered dataset interleaved read test */
#define INTERLEAVED_READ_FILTERED_DATASET_NAME                                 \
  "filtered_dataset_interleaved_read"
...
#define READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_DATASET_NAME                 \
  "unshared_transformed_filtered_chunks_read"
#define READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_DATASET_DIMS 2
#define READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NROWS                        \
  (mpi_size * DIM0_SCALE_FACTOR)
#define READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NCOLS                        \
  (mpi_size * DIM1_SCALE_FACTOR)
...
#define READ_UNSHARED_FILTERED_CHUNKS_3D_SEP_PAGE_NROWS                        \
  (mpi_size * DIM0_SCALE_FACTOR)
#define READ_UNSHARED_FILTERED_CHUNKS_3D_SEP_PAGE_NCOLS                        \
  (mpi_size * DIM1_SCALE_FACTOR)
...
#define READ_UNSHARED_FILTERED_CHUNKS_3D_SAME_PAGE_DATASET_NAME                \
  "3D_unshared_filtered_chunks_same_pages_read"
#define READ_UNSHARED_FILTERED_CHUNKS_3D_SAME_PAGE_DATASET_DIMS 3
#define READ_UNSHARED_FILTERED_CHUNKS_3D_SAME_PAGE_NROWS                       \
  (mpi_size * DIM0_SCALE_FACTOR)
#define READ_UNSHARED_FILTERED_CHUNKS_3D_SAME_PAGE_NCOLS                       \
  (mpi_size * DIM1_SCALE_FACTOR)
...
#define READ_SHARED_FILTERED_CHUNKS_3D_DATASET_NAME                            \
  "3D_shared_filtered_chunks_read"
...
#define READ_SHARED_FILTERED_CHUNKS_3D_NROWS                                   \
  (READ_SHARED_FILTERED_CHUNKS_3D_CH_NROWS * DIM0_SCALE_FACTOR)
#define READ_SHARED_FILTERED_CHUNKS_3D_NCOLS                                   \
  (READ_SHARED_FILTERED_CHUNKS_3D_CH_NCOLS * DIM1_SCALE_FACTOR)
#define READ_SHARED_FILTERED_CHUNKS_3D_DEPTH (mpi_size)

/* Defines for the compound datatype filtered dataset no conversion read test
 * with unshared chunks */
...
#define WRITE_SERIAL_READ_PARALLEL_CH_NROWS                                    \
  (WRITE_SERIAL_READ_PARALLEL_NROWS / mpi_size)
#define WRITE_SERIAL_READ_PARALLEL_CH_NCOLS                                    \
  (WRITE_SERIAL_READ_PARALLEL_NCOLS / mpi_size)
...
#define WRITE_PARALLEL_READ_SERIAL_CH_NROWS                                    \
  (WRITE_PARALLEL_READ_SERIAL_NROWS / mpi_size)
#define WRITE_PARALLEL_READ_SERIAL_CH_NCOLS                                    \
  (WRITE_PARALLEL_READ_SERIAL_NCOLS / mpi_size)
...
#define SHRINKING_GROWING_CHUNKS_CH_NROWS                                      \
  (SHRINKING_GROWING_CHUNKS_NROWS / mpi_size)
#define SHRINKING_GROWING_CHUNKS_CH_NCOLS                                      \
  (SHRINKING_GROWING_CHUNKS_NCOLS / mpi_size)
#define SHRINKING_GROWING_CHUNKS_NLOOPS 20

/* Defines for the unshared filtered edge chunks write test */
#define WRITE_UNSHARED_FILTERED_EDGE_CHUNKS_DATASET_NAME                       \
  "unshared_filtered_edge_chunks_write"
#define WRITE_UNSHARED_FILTERED_EDGE_CHUNKS_DATASET_NAME2                      \
  "unshared_filtered_edge_chunks_no_filter_write"
...
#define WRITE_UNSHARED_FILTERED_EDGE_CHUNKS_NCOLS                              \
  (mpi_size * DIM1_SCALE_FACTOR) +                                             \
      (WRITE_UNSHARED_FILTERED_EDGE_CHUNKS_CH_NCOLS - 1)

/* Defines for the shared filtered edge chunks write test */
#define WRITE_SHARED_FILTERED_EDGE_CHUNKS_DATASET_NAME                         \
  "shared_filtered_edge_chunks_write"
#define WRITE_SHARED_FILTERED_EDGE_CHUNKS_DATASET_NAME2                        \
  "shared_filtered_edge_chunks_no_filter_write"
...
#define FILL_VALUE_UNDEFINED_TEST_NROWS                                        \
  (FILL_VALUE_UNDEFINED_TEST_CH_NROWS * DIM0_SCALE_FACTOR)
#define FILL_VALUE_UNDEFINED_TEST_NCOLS                                        \
  (FILL_VALUE_UNDEFINED_TEST_CH_NCOLS * DIM1_SCALE_FACTOR)
...
#define FILL_TIME_NEVER_TEST_NROWS                                             \
  (FILL_TIME_NEVER_TEST_CH_NROWS * DIM0_SCALE_FACTOR)
#define FILL_TIME_NEVER_TEST_NCOLS                                             \
  (FILL_TIME_NEVER_TEST_CH_NCOLS * DIM1_SCALE_FACTOR)
