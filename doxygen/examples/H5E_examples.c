...
int main(void) {
  ...
  //! <!-- [create] -->
  {
    ...
    if ((cls = H5Eregister_class("Custom error class", "H5E_examples",
                                 "0.1")) == H5I_INVALID_HID) {
    ...
    if ((major = H5Ecreate_msg(cls, H5E_MAJOR,
    ...
    if (H5Epush2(H5E_DEFAULT, __FILE__, __FUNCTION__, __LINE__, cls, major,
                 minor, "Hello, Error!\n") < 0) {
      ret_val = EXIT_FAILURE;
      goto fail_push;
    }
