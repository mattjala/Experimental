...
static const char *FILENAME[] = {"efc0", "efc1", "efc2", "efc3",
                                 "efc4", "efc5", NULL};
...
static unsigned test_single(void) {
  ...
  /* Open parent file */
  if (NULL ==
      (f0 = H5F_open(filename[0], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f1 = H5F__efc_open(f0->shared->efc, filename[1],
                                  H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f0, f1) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (f1 = H5F__efc_open(f0->shared->efc, filename[1], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (f1 != ftmp1)
    TEST_ERROR;
  ...
  if (NULL == (ftmp3 = H5F__efc_open(f0->shared->efc, filename[3], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (ftmp2 = H5F__efc_open(f0->shared->efc, filename[2], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (ftmp1 = H5F__efc_open(f0->shared->efc, filename[1], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (ftmp4 = H5F__efc_open(f0->shared->efc, filename[4], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (ftmp1->shared->nrefs != 2)
    TEST_ERROR;
  if (NULL == (f2 = H5F__efc_open(f0->shared->efc, filename[2], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (H5F_efc_close(f0, f2) < 0)
    FAIL_STACK_ERROR;
...
static unsigned test_graph_nocycle(void) {
  ...
  if (NULL ==
    ...
    FAIL_STACK_ERROR;
  if (NULL ==
      (f1 = H5F_open(filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (f2 = H5F__efc_open(f0->shared->efc, filename[2],
                                  H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp2 = H5F__efc_open(f1->shared->efc, filename[2], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f2, f3) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (f3 = H5F__efc_open(f1->shared->efc, filename[3], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f3 = H5F__efc_open(f1->shared->efc, filename[3], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (f4 = H5F__efc_open(f1->shared->efc, filename[4], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f0, f1) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (f3 = H5F__efc_open(f2->shared->efc, filename[3], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (f4 = H5F__efc_open(f2->shared->efc, filename[4], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f0, f2) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (f4 = H5F__efc_open(f3->shared->efc, filename[4], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (H5F_efc_close(f3, f4) < 0)
    FAIL_STACK_ERROR;
...
static unsigned test_graph_cycle(void) {
  ...
  if (NULL ==
      (f0 = H5F_open(filename[0], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp0 = H5F__efc_open(f0->shared->efc, filename[0], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f1 = H5F__efc_open(f0->shared->efc, filename[1],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp1 = H5F__efc_open(f1->shared->efc, filename[1], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f1 = H5F__efc_open(f0->shared->efc, filename[1],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp0 = H5F__efc_open(f1->shared->efc, filename[0], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f2 = H5F__efc_open(f1->shared->efc, filename[2],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp1 = H5F__efc_open(f2->shared->efc, filename[1], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f2 = H5F__efc_open(f0->shared->efc, filename[2],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp0 = H5F__efc_open(f2->shared->efc, filename[0], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f3 = H5F__efc_open(f1->shared->efc, filename[3],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp1 = H5F__efc_open(f3->shared->efc, filename[1], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f1 = H5F__efc_open(f0->shared->efc, filename[1],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp1 = H5F__efc_open(f1->shared->efc, filename[0], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (H5F_efc_close(f1, ftmp1) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5F_try_close(f1, NULL) < 0)
    FAIL_STACK_ERROR;
  if (NULL ==
      (f2 = H5F_open(filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (f2->shared->nrefs != 1)
    TEST_ERROR;
  ...
  if (H5F_try_close(f2, NULL) < 0)
    FAIL_STACK_ERROR;
  if (NULL ==
      (f3 = H5F_open(filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (f3->shared->nrefs != 1)
    TEST_ERROR;
  ...
  if (NULL == (f3 = H5F__efc_open(f2->shared->efc, filename[3],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp2 = H5F__efc_open(f3->shared->efc, filename[2], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f2, f3) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (f3 = H5F__efc_open(f0->shared->efc, filename[3], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp0 = H5F__efc_open(f3->shared->efc, filename[0], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f4 = H5F__efc_open(f1->shared->efc, filename[4],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp1 = H5F__efc_open(f4->shared->efc, filename[1], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL == (f5 = H5F__efc_open(f2->shared->efc, filename[5],
                                  ...
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (ftmp2 = H5F__efc_open(f5->shared->efc, filename[2], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_try_close(f3, NULL) < 0)
    FAIL_STACK_ERROR;
  if (NULL ==
      (f4 = H5F_open(filename[4], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (f4->shared->nrefs != 1)
    TEST_ERROR;
  if (H5F_try_close(f4, NULL) < 0)
    FAIL_STACK_ERROR;
  if (NULL ==
      (f5 = H5F_open(filename[5], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f1, ftmp2) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (ftmp3 = H5F__efc_open(f1->shared->efc, filename[3], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f2, ftmp1) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (ftmp2 = H5F__efc_open(f2->shared->efc, filename[2], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (H5F_efc_close(f2, ftmp2) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (ftmp3 = H5F__efc_open(f2->shared->efc, filename[3], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (H5F_efc_close(f3, ftmp2) < 0)
    FAIL_STACK_ERROR;
  if (NULL == (ftmp3 = H5F__efc_open(f3->shared->efc, filename[3], H5F_ACC_RDWR,
                                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  ...
  if (NULL ==
      (f2 = H5F_open(filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
                     fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (f1 = H5F__efc_open(f2->shared->efc, filename[1], H5F_ACC_RDWR,
                                  fcpl_id, fapl_id)))
    FAIL_STACK_ERROR;
  if (NULL == (f3 = H5F__efc_open(f1->shared->efc, filename[3],
                                  H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC,
