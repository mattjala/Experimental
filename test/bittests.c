...
failed:
  printf("    i=%d, s_offset=%lu, d_offset=%lu, size=%lu\n", i,
         (unsigned long)s_offset, (unsigned long)d_offset, (unsigned long)size);
  printf("    s = 0x");
...
failed:
  printf("    i=%d, offset=%lu, size=%lu, shift_dist=%lu\n", i,
         (unsigned long)offset, (unsigned long)size, (unsigned long)shift_dist);
