...
int main(void) {
  ...
  dset_id = H5Dcreate2(file_id, "noencoder_szip_dset.h5", H5T_NATIVE_INT,
  ...
  dset_id =
      H5Dcreate2(file_id, "noencoder_szip_shuffle_fletcher_dset.h5",
                 H5T_NATIVE_INT, space_id, H5P_DEFAULT, dcpl_id, H5P_DEFAULT);
