 ...
 *		This program is used to create the test file `tnullspace.h5'
 *which has dataspaces stored in the newer (version 2) style in the object
 *headers. To build the test file, this program MUST be compiled and linked with
...
int main(void) {
  ...
  attr =
      H5Acreate2(gid, NULLATTR, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT);
  assert(attr > 0);
