...
/* These are needed for multiple tests, so are declared here globally and are
 * init'ed in init_test */
hid_t dset_id_int = -1;
...
const float windchillFfloat[ROWS][COLS] = {
    {36.0F, 31.0F, 25.0F, 19.0F, 13.0F, 7.0F, 1.0F, -5.0F, -11.0F, -16.0F,
     -22.0F, -28.0F, -34.0F, -40.0F, -46.0F, -52.0F, -57.0F, -63.0F},
    {34.0F, 27.0F, 21.0F, 15.0F, 9.0F, 3.0F, -4.0F, -10.0F, -16.0F, -22.0F,
     -28.0F, -35.0F, -41.0F, -47.0F, -53.0F, -59.0F, -66.0F, -72.0F},
    {32.0F, 25.0F, 19.0F, 13.0F, 6.0F, 0.0F, -7.0F, -13.0F, -19.0F, -26.0F,
     -32.0F, -39.0F, -45.0F, -51.0F, -58.0F, -64.0F, -71.0F, -77.0F},
    {30.0F, 24.0F, 17.0F, 11.0F, 4.0F, -2.0F, -9.0F, -15.0F, -22.0F, -29.0F,
     -35.0F, -42.0F, -48.0F, -55.0F, -61.0F, -68.0F, -74.0F, -81.0F},
    {29.0F, 23.0F, 16.0F, 9.0F, 3.0F, -4.0F, -11.0F, -17.0F, -24.0F, -31.0F,
     -37.0F, -44.0F, -51.0F, -58.0F, -64.0F, -71.0F, -78.0F, -84.0F},
    {28.0F, 22.0F, 15.0F, 8.0F, 1.0F, -5.0F, -12.0F, -19.0F, -26.0F, -33.0F,
     -39.0F, -46.0F, -53.0F, -60.0F, -67.0F, -73.0F, -80.0F, -87.0F},
    {28.0F, 21.0F, 14.0F, 7.0F, 0.0F, -7.0F, -14.0F, -21.0F, -27.0F, -34.0F,
     -41.0F, -48.0F, -55.0F, -62.0F, -69.0F, -76.0F, -82.0F, -89.0F},
    {27.0F, 20.0F, 13.0F, 6.0F, -1.0F, -8.0F, -15.0F, -22.0F, -29.0F, -36.0F,
     -43.0F, -50.0F, -57.0F, -64.0F, -71.0F, -78.0F, -84.0F, -91.0F},
    {26.0F, 19.0F, 12.0F, 5.0F, -2.0F, -9.0F, -16.0F, -23.0F, -30.0F, -37.0F,
     -44.0F, -51.0F, -58.0F, -65.0F, -72.0F, -79.0F, -86.0F, -93.0F},
    {26.0F, 19.0F, 12.0F, 4.0F, -3.0F, -10.0F, -17.0F, -24.0F, -31.0F, -38.0F,
     -45.0F, -52.0F, -60.0F, -67.0F, -74.0F, -81.0F, -88.0F, -95.0F},
    {25.0F, 18.0F, 11.0F, 4.0F, -3.0F, -11.0F, -18.0F, -25.0F, -32.0F, -39.0F,
     -46.0F, -54.0F, -61.0F, -68.0F, -75.0F, -82.0F, -89.0F, -97.0F},
    {25.0F, 17.0F, 10.0F, 3.0F, -4.0F, -11.0F, -19.0F, -26.0F, -33.0F, -40.0F,
     -48.0F, -55.0F, -62.0F, -69.0F, -76.0F, -84.0F, -91.0F, -98.0F}};
...
#define TEST_TYPE_CONTIG(XFORM, TYPE, HDF_TYPE, TEST_STR, COMPARE_DATA,        \
                         SIGNED)                                               \
  do {                                                                         \
    struct {                                                                   \
      TYPE arr[ROWS][COLS];                                                    \
    ...
    /* utrans is a transform for char types: numbers are restricted from -128  \
     * to 127, fits into char */                                               \
    ...
    if ((dataspace = H5Screate_simple(2, dim, NULL)) < 0)                      \
      TEST_ERROR;                                                              \
    if ((dset = H5Dcreate2(file_id, "/transformtest_" TEST_STR, HDF_TYPE,      \
    ...
    if ((order = H5Tget_order(dt_nn)) == H5T_ORDER_ERROR)                      \
      TEST_ERROR;                                                              \
    if (H5Tset_order(dt_nn,                                                    \
                     order == H5T_ORDER_LE ? H5T_ORDER_BE : H5T_ORDER_LE) < 0) \
      TEST_ERROR;                                                              \
    if ((dset_nn = H5Dcreate2(file_id, "/nonnative_transformtest_" TEST_STR,   \
                              dt_nn, dataspace, H5P_DEFAULT, H5P_DEFAULT,      \
                              H5P_DEFAULT)) < 0)                               \
      TEST_ERROR;                                                              \
    if (H5Tclose(dt_nn) < 0)                                                   \
      TEST_ERROR;                                                              \
    ...
    if (SIGNED) {                                                              \
      ...
      if (H5Pset_data_transform(dxpl_id_f_to_c, f_to_c) < 0)                   \
        TEST_ERROR;                                                            \
      if (H5Dwrite(dset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, dxpl_id_f_to_c,   \
                   windchillFfloat) < 0)                                       \
        TEST_ERROR;                                                            \
      if (H5Dwrite(dset_nn, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL,                \
      ...
      if (H5Pset_data_transform(dxpl_id_utrans, utrans) < 0)                   \
        TEST_ERROR;                                                            \
      if (H5Dwrite(dset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id_utrans,     \
                   transformData) < 0)                                         \
        TEST_ERROR;                                                            \
      if (H5Dwrite(dset_nn, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id_utrans,  \
                   transformData) < 0)                                         \
        TEST_ERROR;                                                            \
    ...
    if (SIGNED) {                                                              \
      TESTING("contiguous, with type conversion (float->" TEST_STR ")");       \
                                                                               \
      if (H5Dread(dset_id_float, HDF_TYPE, H5S_ALL, H5S_ALL, XFORM, array) <   \
          0)                                                                   \
        TEST_ERROR;                                                            \
      COMPARE(TYPE, array->arr, COMPARE_DATA, 2);                              \
    }                                                                          \
...
#define TEST_TYPE_CHUNK(XFORM, TYPE, HDF_TYPE, TEST_STR, COMPARE_DATA, SIGNED) \
  do {                                                                         \
    ...
    const char *utrans = "(x/4+25)*3";                                         \
                                                                               \
    hid_t dataspace, dxpl_id_f_to_c, dxpl_id_utrans, cparms, memspace,         \
        dset_chunk, filespace;                                                 \
    hsize_t dim[2] = {ROWS, COLS};                                             \
    ...
    if (H5Pset_chunk(cparms, 2, dim) < 0)                                      \
      TEST_ERROR;                                                              \
                                                                               \
    if ((dset_chunk =                                                          \
             H5Dcreate2(file_id, "/transformtest_chunk_" TEST_STR, HDF_TYPE,   \
    ...
    if ((memspace = H5Screate_simple(2, dim, NULL)) < 0)                       \
      TEST_ERROR;                                                              \
    if (H5Sselect_hyperslab(filespace, H5S_SELECT_SET, offset, NULL, dim,      \
                            NULL) < 0)                                         \
      TEST_ERROR;                                                              \
                                                                               \
    if (SIGNED) {                                                              \
      ...
      if (H5Pset_data_transform(dxpl_id_f_to_c, f_to_c) < 0)                   \
        TEST_ERROR;                                                            \
      if (H5Dwrite(dset_chunk, H5T_NATIVE_FLOAT, dataspace, filespace,         \
                   dxpl_id_f_to_c, windchillFfloat) < 0)                       \
        TEST_ERROR;                                                            \
      if (H5Pclose(dxpl_id_f_to_c) < 0)                                        \
        TEST_ERROR;                                                            \
      ...
      if (H5Pset_data_transform(dxpl_id_utrans, utrans) < 0)                   \
        TEST_ERROR;                                                            \
      if (H5Dwrite(dset_chunk, H5T_NATIVE_INT, dataspace, filespace,           \
                   dxpl_id_utrans, transformData) < 0)                         \
        TEST_ERROR;                                                            \
      if (H5Pclose(dxpl_id_utrans) < 0)                                        \
        TEST_ERROR;                                                            \
    }                                                                          \
    ...
    if (SIGNED) {                                                              \
      TESTING("chunked, with type conversion (float->" TEST_STR ")");          \
                                                                               \
      if (H5Dread(dset_id_float_chunk, HDF_TYPE, memspace, filespace, XFORM,   \
                  array) < 0)                                                  \
        TEST_ERROR;                                                            \
      COMPARE(TYPE, array->arr, COMPARE_DATA, 2);                              \
    }                                                                          \
...
#define INVALID_SET_TEST(TRANSFORM)                                            \
  do {                                                                         \
    if (H5Pset_data_transform(dxpl_id, TRANSFORM) < 0) {                       \
      ...
      H5_FAILED();                                                             \
      fprintf(stderr, "    ERROR: Data transform allowed invalid TRANSFORM "   \
                      "transform to be set\n");                                \
      goto error;                                                              \
    }                                                                          \
  } while (0)
...
int main(void) {
  ...
  if ((file_id = H5Fcreate("dtransform.h5", H5F_ACC_TRUNC, H5P_DEFAULT,
                           H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  TEST_TYPE_CONTIG(dxpl_id_utrans_inv, char, H5T_NATIVE_CHAR, "char",
                   transformData, 0);
  TEST_TYPE_CONTIG(dxpl_id_utrans_inv, unsigned char, H5T_NATIVE_UCHAR, "uchar",
                   transformData, 0);
  ...
  TEST_TYPE_CONTIG(dxpl_id_c_to_f, int, H5T_NATIVE_INT, "int", windchillFfloat,
                   1);
  TEST_TYPE_CONTIG(dxpl_id_utrans_inv, unsigned int, H5T_NATIVE_UINT, "uint",
                   transformData, 0);
  TEST_TYPE_CONTIG(dxpl_id_c_to_f, long, H5T_NATIVE_LONG, "long",
                   windchillFfloat, 1);
  TEST_TYPE_CONTIG(dxpl_id_utrans_inv, unsigned long, H5T_NATIVE_ULONG, "ulong",
                   transformData, 0);
  TEST_TYPE_CONTIG(dxpl_id_c_to_f, long long, H5T_NATIVE_LLONG, "llong",
                   windchillFfloat, 1);
  TEST_TYPE_CONTIG(dxpl_id_utrans_inv, unsigned long long, H5T_NATIVE_ULLONG,
                   "ullong", transformData, 0);
  TEST_TYPE_CONTIG(dxpl_id_c_to_f, float, H5T_NATIVE_FLOAT, "float",
                   windchillFfloat, 1);
  TEST_TYPE_CONTIG(dxpl_id_c_to_f, double, H5T_NATIVE_DOUBLE, "double",
                   windchillFfloat, 1);
  TEST_TYPE_CONTIG(dxpl_id_c_to_f, long double, H5T_NATIVE_LDOUBLE, "ldouble",
                   windchillFfloat, 1);

  TEST_TYPE_CHUNK(dxpl_id_utrans_inv, char, H5T_NATIVE_CHAR, "char",
                  transformData, 0);
  TEST_TYPE_CHUNK(dxpl_id_utrans_inv, unsigned char, H5T_NATIVE_UCHAR, "uchar",
                  transformData, 0);
  ...
  TEST_TYPE_CHUNK(dxpl_id_utrans_inv, unsigned short, H5T_NATIVE_USHORT,
                  "ushort", transformData, 0);
  TEST_TYPE_CHUNK(dxpl_id_c_to_f, int, H5T_NATIVE_INT, "int", windchillFfloat,
                  1);
  TEST_TYPE_CHUNK(dxpl_id_utrans_inv, unsigned int, H5T_NATIVE_UINT, "uint",
                  transformData, 0);
  TEST_TYPE_CHUNK(dxpl_id_c_to_f, long, H5T_NATIVE_LONG, "long",
                  windchillFfloat, 1);
  TEST_TYPE_CHUNK(dxpl_id_utrans_inv, unsigned long, H5T_NATIVE_ULONG, "ulong",
                  transformData, 0);
  TEST_TYPE_CHUNK(dxpl_id_c_to_f, long long, H5T_NATIVE_LLONG, "llong",
                  windchillFfloat, 1);
  TEST_TYPE_CHUNK(dxpl_id_utrans_inv, unsigned long long, H5T_NATIVE_ULLONG,
                  "ullong", transformData, 0);
  TEST_TYPE_CHUNK(dxpl_id_c_to_f, float, H5T_NATIVE_FLOAT, "float",
                  windchillFfloat, 1);
  TEST_TYPE_CHUNK(dxpl_id_c_to_f, double, H5T_NATIVE_DOUBLE, "double",
                  windchillFfloat, 1);
  TEST_TYPE_CHUNK(dxpl_id_c_to_f, long double, H5T_NATIVE_LDOUBLE, "ldouble",
                  windchillFfloat, 1);
...
static int init_test(hid_t file_id) {
  const char *f_to_c = "(5/9.0)*(x-32)";
  /* utrans is a transform for char types: numbers are restricted from -128 to
   * 127, fits into char */
  const char *utrans = "(x/4+25)*3";
  ...
  if ((dset_id_int =
           H5Dcreate2(file_id, "/default_int", H5T_NATIVE_INT, dataspace,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id_int, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, dxpl_id_f_to_c,
               windchillFfloat) < 0)
    TEST_ERROR;

  if ((dset_id_float =
           H5Dcreate2(file_id, "/default_float", H5T_NATIVE_FLOAT, dataspace,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  if ((filespace = H5Dget_space(dset_id_int_chunk)) < 0)
    TEST_ERROR;
  if (H5Sselect_hyperslab(filespace, H5S_SELECT_SET, offset, NULL, dim, NULL) <
      0)
    TEST_ERROR;
  ...
  if ((dset_id_float_chunk =
           H5Dcreate2(file_id, "/default_chunk_float", H5T_NATIVE_FLOAT,
                      dataspace, H5P_DEFAULT, cparms, H5P_DEFAULT)) < 0)
    TEST_ERROR;
...
static int test_poly(const hid_t dxpl_id_polynomial) {
  ...
  for (row = 0; row < ROWS; row++)
    for (col = 0; col < COLS; col++) {
      ...
      polyflres[row][col] =
          ((2.0F + (float)windchillC) * (((float)windchillC - 8.0F) / 2.0F));
    }
...
static int test_specials(hid_t file) {
  ...
  if ((dset_id = H5Dcreate2(file, "/special1", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
    TEST_ERROR;
  ...
  if ((dset_id = H5Dcreate2(file, "/special2", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
  ...
  if ((dset_id = H5Dcreate2(file, "/special3", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
  ...
  if ((dset_id = H5Dcreate2(file, "/special4", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
  ...
  if ((dset_id = H5Dcreate2(file, "/special5", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
  ...
  if ((dset_id = H5Dcreate2(file, "/special6", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
  ...
  if ((dset_id = H5Dcreate2(file, "/special7", H5T_NATIVE_INT, dataspace,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id,
               transformData) < 0)
...
static int test_copy(const hid_t dxpl_id_c_to_f_copy,
                     const hid_t dxpl_id_polynomial_copy) {
  int windchillC;
  float polyflres[ROWS][COLS];
  int polyintread[ROWS][COLS];
...
static int test_trivial(const hid_t dxpl_id_simple) {
  ...
  if (H5Dread(dset_id_float, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, dxpl_id_simple,
              windchillFfloatread) < 0)
    TEST_ERROR;
  for (row = 0; row < ROWS; row++)
    for (col = 0; col < COLS; col++) {
  ...
  if (H5Dread(dset_id_float, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id_simple,
              windchillFintread) < 0)
    TEST_ERROR;
  for (row = 0; row < ROWS; row++)
    for (col = 0; col < COLS; col++) {
...
static int test_getset(const hid_t dxpl_id_c_to_f) {
  ...
  if (H5Pget_data_transform(dxpl_id_c_to_f, ptrgetTest, HDstrlen(c_to_f) + 1) <
      0)
    TEST_ERROR;
  ...
  if (H5Dread(dset_id_float, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, dxpl_id_c_to_f,
              windchillFfloatread) < 0)
    TEST_ERROR;
  ...
  if (NULL == (ptrgetTest = (char *)calloc((size_t)1, HDstrlen(simple) + 1)))
    TEST_ERROR;
  if (H5Pget_data_transform(dxpl_id_c_to_f, ptrgetTest, HDstrlen(simple) + 1) <
      0)
    TEST_ERROR;
...
static int test_set(void) {
  ...
  if (H5Pget_data_transform(dxpl_id, ptrgetTest, HDstrlen(str) + 1) < 0)
    ...
    FAIL_PUTS_ERROR("    ERROR: Data transform get before set succeeded (it "
                    "shouldn't have)\n");
