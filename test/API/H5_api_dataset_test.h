...
#define DATASET_CREATE_INVALID_PARAMS_GROUP_NAME                               \
  "dset_create_invalid_params_test"
...
#define DATASET_CREATE_ANONYMOUS_INVALID_PARAMS_DATASET_NAME                   \
  "invalid_params_anon_dset"
#define DATASET_CREATE_ANONYMOUS_INVALID_PARAMS_GROUP_NAME                     \
  "anon_dset_creation_invalid_params_test"
#define DATASET_CREATE_ANONYMOUS_INVALID_PARAMS_SPACE_RANK 2

#define DATASET_CREATE_NULL_DATASPACE_TEST_SUBGROUP_NAME                       \
  "dataset_with_null_space_test"
#define DATASET_CREATE_NULL_DATASPACE_TEST_DSET_NAME "dataset_with_null_space"

#define DATASET_CREATE_SCALAR_DATASPACE_TEST_SUBGROUP_NAME                     \
  "dataset_with_scalar_space_test"
#define DATASET_CREATE_SCALAR_DATASPACE_TEST_DSET_NAME                         \
  "dataset_with_scalar_space"
...
#define DATASET_PREDEFINED_TYPE_TEST_SUBGROUP_NAME                             \
...
#define DATASET_CREATION_PROPERTIES_TEST_TRACK_TIMES_YES_DSET_NAME             \
  "track_times_true_test"
#define DATASET_CREATION_PROPERTIES_TEST_TRACK_TIMES_NO_DSET_NAME              \
  "track_times_false_test"
#define DATASET_CREATION_PROPERTIES_TEST_PHASE_CHANGE_DSET_NAME                \
...
#define DATASET_CREATION_PROPERTIES_TEST_CRT_ORDER_BASE_NAME                   \
  "creation_order_test"
...
#define DATASET_CREATION_PROPERTIES_TEST_CHUNK_DIM_RANK                        \
  DATASET_CREATION_PROPERTIES_TEST_SHAPE_RANK
...
#define DATASET_GET_SPACE_TYPE_INVALID_PARAMS_TEST_GROUP_NAME                  \
  "get_dset_space_type_invalid_params_test"
#define DATASET_GET_SPACE_TYPE_INVALID_PARAMS_TEST_DSET_NAME                   \
  "get_space_type_test_invalid_params_dset"

#define DATASET_PROPERTY_LIST_TEST_SUBGROUP_NAME                               \
  "dataset_property_list_test_group"
...
#define DATASET_SMALL_READ_TEST_HYPERSLAB_GROUP_NAME                           \
  "dataset_small_read_hyperslab_test"
#define DATASET_SMALL_READ_TEST_HYPERSLAB_DSET_NAME                            \
  "dataset_small_read_hyperslab_dset"
...
#define DATASET_SMALL_READ_TEST_POINT_SELECTION_GROUP_NAME                     \
  "dataset_small_read_point_selection_test"
#define DATASET_SMALL_READ_TEST_POINT_SELECTION_DSET_NAME                      \
  "dataset_small_read_point_selection_dset"

#define DATASET_IO_POINT_GROUP_NAME "dataset_io_point_selection_test"
#define DATASET_IO_POINT_DSET_NAME_NOCHUNK                                     \
  "dataset_io_point_selection_dset_nochunk"
...
#define DATASET_READ_INVALID_PARAMS_TEST_GROUP_NAME                            \
  "dataset_read_invalid_params_test"
#define DATASET_READ_INVALID_PARAMS_TEST_DSET_NAME                             \
  "dataset_read_invalid_params_dset"
...
#define DATASET_SMALL_WRITE_TEST_HYPERSLAB_GROUP_NAME                          \
  "dataset_small_write_hyperslab_test"
#define DATASET_SMALL_WRITE_TEST_HYPERSLAB_DSET_NAME                           \
  "dataset_small_write_hyperslab_dset"
...
#define DATASET_SMALL_WRITE_TEST_POINT_SELECTION_GROUP_NAME                    \
  "dataset_small_write_point_selection_test"
#define DATASET_SMALL_WRITE_TEST_POINT_SELECTION_DSET_NAME                     \
  "dataset_small_write_point_selection_dset"
...
#define DATASET_DATA_VERIFY_WRITE_TEST_GROUP_NAME                              \
  "dataset_data_write_verification_test"
#define DATASET_DATA_VERIFY_WRITE_TEST_DSET_NAME                               \
  "dataset_data_write_verification_dset"
...
#define DATASET_WRITE_INVALID_PARAMS_TEST_GROUP_NAME                           \
  "dataset_write_invalid_params_test"
#define DATASET_WRITE_INVALID_PARAMS_TEST_DSET_NAME                            \
  "dataset_write_invalid_params_dset"
...
#define DATASET_DATA_BUILTIN_CONVERSION_TEST_GROUP_NAME                        \
  "dataset_builtin_conversion_verification_test"
#define DATASET_DATA_BUILTIN_CONVERSION_TEST_DSET_NAME                         \
  "dataset_builtin_conversion_verification_dset"

#define DATASET_COMPOUND_PARTIAL_IO_DSET_DIMS 10
#define DATASET_DATA_COMPOUND_PARTIAL_IO_TEST_GROUP_NAME                       \
  "dataset_compound_partial_io_test"
#define DATASET_DATA_COMPOUND_PARTIAL_IO_TEST_DSET_NAME                        \
  "dataset_compound_partial_io_test"
...
#define DATASET_SET_EXTENT_CHUNKED_UNLIMITED_TEST_GROUP_NAME                   \
  "set_extent_chunked_unlimited_test"
#define DATASET_SET_EXTENT_CHUNKED_UNLIMITED_TEST_DSET_NAME                    \
...
#define DATASET_SET_EXTENT_CHUNKED_FIXED_TEST_GROUP_NAME                       \
  "set_extent_chunked_fixed_test"
#define DATASET_SET_EXTENT_CHUNKED_FIXED_TEST_DSET_NAME                        \
  "set_extent_chunked_fixed_test_dset"
#define DATASET_SET_EXTENT_CHUNKED_FIXED_TEST_DSET_NAME2                       \
  "set_extent_chunked_fixed_test_dset2"
...
#define DATASET_SET_EXTENT_DATA_TEST_DSET_NAME                                 \
...
#define DATASET_SET_EXTENT_DOUBLE_HANDLES_TEST_GROUP_NAME                      \
  "set_extent_chunked_double_handles_test"
#define DATASET_SET_EXTENT_DOUBLE_HANDLES_TEST_DSET_NAME                       \
  "set_extent_chunked_double_handles_test_dset"
#define DATASET_SET_EXTENT_DOUBLE_HANDLES_TEST_SPACE_DIM 8

#define DATASET_SET_EXTENT_INVALID_PARAMS_TEST_SPACE_RANK 2
#define DATASET_SET_EXTENT_INVALID_PARAMS_TEST_GROUP_NAME                      \
  "set_extent_invalid_params_test"
#define DATASET_SET_EXTENT_INVALID_PARAMS_TEST_DSET_NAME                       \
  "set_extent_invalid_params_test_dset"
#define DATASET_SET_EXTENT_INVALID_LAYOUT_TEST_COMPACT_DSET_NAME               \
  "set_extent_invalid_layout_test_compact_dset"
...
#define DATASET_SINGLE_CHUNK_WRITE_TEST_GROUP_NAME                             \
  "single_chunk_dataset_write_test"
...
#define DATASET_PARTIAL_CHUNK_READ_ALL_SEL_TEST_GROUP_NAME                     \
  "read_partial_chunk_all_sel_test"
#define DATASET_PARTIAL_CHUNK_READ_ALL_SEL_TEST_DSET_NAME                      \
  "read_partial_chunk_all_sel_dset"
...
#define DATASET_PARTIAL_CHUNK_READ_HYPER_SEL_TEST_GROUP_NAME                   \
  "read_partial_chunk_hyper_sel_test"
#define DATASET_PARTIAL_CHUNK_READ_HYPER_SEL_TEST_DSET_NAME                    \
  "read_partial_chunk_hyper_sel_dset"
