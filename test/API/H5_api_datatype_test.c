...
static int test_create_committed_datatype(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file, group, or stored datatype aren't "
           "supported with this "
           "connector\n");
    return 0;
  }
  ...
  if ((group_id = H5Gcreate2(container_group, DATATYPE_CREATE_TEST_GROUP_NAME,
  ...
  if (H5Tcommit2(group_id, DATATYPE_CREATE_TEST_TYPE_NAME, type_id, H5P_DEFAULT,
...
static int test_create_committed_datatype_invalid_params(void) {
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Tcommit2_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Tcommit2(H5I_INVALID_HID,
                             DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME,
                             type_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit2_invalid_type_name) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Tcommit2(group_id, NULL, type_id, H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT);
      }
      H5E_END_TRY
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Tcommit2(group_id, "", type_id, H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit2_invalid_type_id) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit2(group_id, DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME,
    ...
    PART_BEGIN(H5Tcommit2_invalid_lcpl) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit2(group_id, DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME,
                       type_id, H5I_INVALID_HID, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit2_invalid_tcpl) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit2(group_id, DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME,
                       type_id, H5P_DEFAULT, H5I_INVALID_HID, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit2_invalid_tapl) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit2(group_id, DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME,
                       type_id, H5P_DEFAULT, H5P_DEFAULT, H5I_INVALID_HID);
      }
      H5E_END_TRY
...
static int test_create_anonymous_committed_datatype(void) {
  ...
  if ((group_id =
           H5Gcreate2(container_group, DATATYPE_CREATE_ANONYMOUS_GROUP_NAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
...
static int test_create_anonymous_committed_datatype_invalid_params(void) {
  ...
  if ((group_id = H5Gcreate2(
           container_group, DATATYPE_CREATE_ANONYMOUS_INVALID_PARAMS_GROUP_NAME,
           H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Tcommit_anon_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit_anon(H5I_INVALID_HID, type_id, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit_anon_invalid_type_id) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit_anon(group_id, H5I_INVALID_HID, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit_anon_invalid_tcpl) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit_anon(group_id, type_id, H5I_INVALID_HID, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tcommit_anon_invalid_tapl) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Tcommit_anon(group_id, type_id, H5P_DEFAULT, H5I_INVALID_HID);
      }
      H5E_END_TRY
...
static int test_create_committed_datatype_empty_types(void) {
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Tcommit_empty_compound_type) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Tcommit2(group_id,
                             DATATYPE_CREATE_EMPTY_TYPES_TEST_CMPD_TYPE_NAME,
                             type_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
      ...
      if (H5Tcommit2(group_id, DATATYPE_CREATE_EMPTY_TYPES_TEST_CMPD_TYPE_NAME,
                     type_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        H5_FAILED_API();
    ...
    PART_BEGIN(H5Tcommit_empty_enum_type) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Tcommit2(group_id,
                             DATATYPE_CREATE_EMPTY_TYPES_TEST_ENUM_TYPE_NAME,
                             type_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
      ...
      if (H5Tcommit2(group_id, DATATYPE_CREATE_EMPTY_TYPES_TEST_ENUM_TYPE_NAME,
                     type_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        H5_FAILED_API();
...
static int test_recommit_committed_type(void) {
  ...
  if ((group_id =
           H5Gcreate2(container_group, RECOMMIT_COMMITTED_TYPE_TEST_GROUP_NAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  if (H5Tcommit2(group_id, "native_int", type_id, H5P_DEFAULT, H5P_DEFAULT,
                 H5P_DEFAULT) < 0) {
    H5_FAILED_API();
  ...
  H5E_BEGIN_TRY {
    err_ret = H5Tcommit2(group_id, "native_int", type_id, H5P_DEFAULT,
...
static int test_open_committed_datatype(void) {
  ...
  if ((group_id = H5Gcreate2(container_group, DATATYPE_OPEN_TEST_GROUP_NAME,
                             H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  if (H5Tcommit2(group_id, DATATYPE_OPEN_TEST_TYPE_NAME, type_id, H5P_DEFAULT,
                 H5P_DEFAULT, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
  ...
  if ((type_id =
           H5Topen2(group_id, DATATYPE_OPEN_TEST_TYPE_NAME, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int test_open_committed_datatype_invalid_params(void) {
  ...
  if (H5Tcommit2(group_id, DATATYPE_OPEN_INVALID_PARAMS_TEST_TYPE_NAME, type_id,
                 H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
    printf("    couldn't commit datatype '%s'\n",
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Topen2_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        type_id =
            H5Topen2(H5I_INVALID_HID,
                     DATATYPE_OPEN_INVALID_PARAMS_TEST_TYPE_NAME, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Topen2_invalid_type_name) {
      ...
      H5E_BEGIN_TRY { type_id = H5Topen2(group_id, NULL, H5P_DEFAULT); }
      H5E_END_TRY

      if (type_id >= 0) {
        H5_FAILED_API();
        printf(
            "    opened committed datatype with an invalid datatype name!\n");
        H5Tclose(type_id);
        PART_ERROR_API(H5Topen2_invalid_type_name);
      }

      H5E_BEGIN_TRY { type_id = H5Topen2(group_id, "", H5P_DEFAULT); }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Topen2_invalid_tapl) {
      ...
      H5E_BEGIN_TRY {
        type_id =
            H5Topen2(group_id, DATATYPE_OPEN_INVALID_PARAMS_TEST_TYPE_NAME,
                     H5I_INVALID_HID);
      }
      H5E_END_TRY
...
static int test_reopen_committed_datatype_indirect(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file, group, dataset, or stored "
           "datatype aren't supported with "
           "this connector\n");
    return 0;
  }
  ...
  if ((group_id = H5Gcreate2(container_group, DATATYPE_REOPEN_TEST_GROUP_NAME,
                             H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  if ((space_id = generate_random_dataspace(DATATYPE_REOPEN_TEST_SPACE_RANK,
                                            NULL, NULL, FALSE)) < 0)
    TEST_ERROR;
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(reopen_compound_type) {
      ...
      if (H5Tcommit2(group_id, "cmpd_type", type_id, H5P_DEFAULT, H5P_DEFAULT,
                     H5P_DEFAULT) < 0) {
        H5_FAILED_API();
      ...
      if ((dset_id = H5Dcreate2(group_id, "cmpd_dset", type_id, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
      ...
      if (dt_size != H5Tget_size(reopened_type_id)) {
        H5_FAILED_API();
        printf("    size of re-opened datatype didn't match size of original "
               "datatype\n");
        PART_ERROR_API(reopen_compound_type);
      }
    ...
    PART_BEGIN(reopen_enum_type) {
      ...
      if (H5Tcommit2(group_id, "enum_type", type_id, H5P_DEFAULT, H5P_DEFAULT,
                     H5P_DEFAULT) < 0) {
        H5_FAILED_API();
      ...
      if ((dset_id = H5Dcreate2(group_id, "enum_dset", type_id, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    failed to create dataset using committed datatype\n");
        PART_ERROR_API(reopen_enum_type);
    ...
    PART_BEGIN(reopen_vlen_type) {
      ...
      if (H5Tcommit2(group_id, "vlen_type", type_id, H5P_DEFAULT, H5P_DEFAULT,
                     H5P_DEFAULT) < 0) {
        H5_FAILED_API();
      ...
      if ((dset_id = H5Dcreate2(group_id, "vlen_dset", type_id, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    failed to create dataset using committed datatype\n");
        PART_ERROR_API(reopen_vlen_type);
    ...
    PART_BEGIN(reopen_opaque_type) {
      ...
      if (H5Tcommit2(group_id, "opaque_type", type_id, H5P_DEFAULT, H5P_DEFAULT,
                     H5P_DEFAULT) < 0) {
        H5_FAILED_API();
      ...
      if ((dset_id = H5Dcreate2(group_id, "opaque_dset", type_id, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    failed to create dataset using committed datatype\n");
        PART_ERROR_API(reopen_opaque_type);
    ...
    PART_BEGIN(reopen_array_type) {
      ...
      if (H5Tcommit2(group_id, "array_type", type_id, H5P_DEFAULT, H5P_DEFAULT,
                     H5P_DEFAULT) < 0) {
        H5_FAILED_API();
      ...
      if ((dset_id = H5Dcreate2(group_id, "array_dset", type_id, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    failed to create dataset using committed datatype\n");
        PART_ERROR_API(reopen_array_type);
...
static int test_close_committed_datatype_invalid_id(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
      !(vol_cap_flags_g & H5VL_CAP_FLAG_STORED_DATATYPES)) {
    SKIPPED_API();
    printf("    API functions for basic file or stored datatype aren't "
  ...
  H5E_BEGIN_TRY { err_ret = H5Tclose(H5I_INVALID_HID); }
  H5E_END_TRY
...
static int test_datatype_property_lists(void) {
  ...
  if (H5Tcommit2(group_id, DATATYPE_PROPERTY_LIST_TEST_DATATYPE_NAME1, type_id1,
                 H5P_DEFAULT, tcpl_id1, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
    printf("    couldn't commit datatype '%s'\n",
  ...
  if (H5Tcommit2(group_id, DATATYPE_PROPERTY_LIST_TEST_DATATYPE_NAME2, type_id2,
                 H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
    printf("    couldn't commit datatype '%s'\n",
  ...
  BEGIN_MULTIPART {
    ...
    /* Now close the property lists and datatypes and see if we can still
     * retrieve copies of the property lists upon opening (instead of creating)
     * a datatype
     */
    if (tcpl_id1 >= 0) {
      H5E_BEGIN_TRY { H5Pclose(tcpl_id1); }
      H5E_END_TRY
      tcpl_id1 = H5I_INVALID_HID;
    }
    if (tcpl_id2 >= 0) {
      H5E_BEGIN_TRY { H5Pclose(tcpl_id2); }
      H5E_END_TRY
      tcpl_id2 = H5I_INVALID_HID;
    }
    if (type_id1 >= 0) {
      H5E_BEGIN_TRY { H5Tclose(type_id1); }
      H5E_END_TRY
      type_id1 = H5I_INVALID_HID;
    }
    if (type_id2 >= 0) {
      H5E_BEGIN_TRY { H5Tclose(type_id2); }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Tget_create_plist_reopened) {
      ...
      if ((type_id1 =
               H5Topen2(group_id, DATATYPE_PROPERTY_LIST_TEST_DATATYPE_NAME1,
                        H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
      ...
      if ((type_id2 =
               H5Topen2(group_id, DATATYPE_PROPERTY_LIST_TEST_DATATYPE_NAME2,
                        H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    couldn't open datatype '%s'\n",
               DATATYPE_PROPERTY_LIST_TEST_DATATYPE_NAME2);
...
static int test_create_dataset_with_committed_type(void) {
  ...
  if ((type_id = H5Topen2(group_id, DATASET_CREATE_WITH_DATATYPE_TEST_TYPE_NAME,
                          H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't open committed datatype '%s'\n",
           DATASET_CREATE_WITH_DATATYPE_TEST_TYPE_NAME);
  ...
  if ((fspace_id = generate_random_dataspace(DATATYPE_CREATE_TEST_DATASET_DIMS,
                                             NULL, NULL, FALSE)) < 0)
    TEST_ERROR;

  if ((dset_id = H5Dcreate2(
           group_id, DATASET_CREATE_WITH_DATATYPE_TEST_DSET_NAME, type_id,
  ...
  if ((dset_id = H5Dopen2(group_id, DATASET_CREATE_WITH_DATATYPE_TEST_DSET_NAME,
                          H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int test_create_attribute_with_committed_type(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file, group, attribute, or stored "
           "datatype aren't supported "
           "with this connector\n");
    return 0;
  }
  ...
  if (H5Tcommit2(group_id, ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_DTYPE_NAME,
                 type_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
    printf("    couldn't commit datatype '%s'\n",
  ...
  if ((type_id =
           H5Topen2(group_id, ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_DTYPE_NAME,
                    H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't open committed datatype '%s'\n",
           ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_DTYPE_NAME);
  ...
  if ((space_id = generate_random_dataspace(
           ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_SPACE_RANK, NULL, NULL, TRUE)) <
      0)
    TEST_ERROR;

  if ((attr_id =
           H5Acreate2(group_id, ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_ATTR_NAME,
                      type_id, space_id, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
  ...
  if ((attr_exists = H5Aexists(
           group_id, ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_ATTR_NAME)) < 0) {
    H5_FAILED_API();
  ...
  if ((attr_id =
           H5Aopen(group_id, ATTRIBUTE_CREATE_WITH_DATATYPE_TEST_ATTR_NAME,
                   H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int test_delete_committed_type(void) {
  ...
  if (H5Tcommit2(group_id, DATATYPE_DELETE_TEST_DTYPE_NAME, type_id,
                 H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
    printf("    couldn't commit datatype '%s'\n",
  ...
  if ((type_exists = H5Lexists(group_id, DATATYPE_DELETE_TEST_DTYPE_NAME,
                               H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int test_resurrect_datatype(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file, group, link, hard link, or "
  ...
  if ((group_id =
           H5Gcreate2(container_group, DATATYPE_RESURRECT_TEST_GROUP_NAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  if (H5Tcommit2(group_id, DATATYPE_RESURRECT_TEST_DTYPE_NAME, type_id,
                 H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
    H5_FAILED_API();
    printf("    failed to commit datatype\n");
    goto error;
   ...
   */
  if (H5Ldelete(group_id, DATATYPE_RESURRECT_TEST_DTYPE_NAME, H5P_DEFAULT) <
      0) {
    H5_FAILED_API();
  ...
  if (H5Lcreate_hard(type_id, ".", group_id,
                     DATATYPE_RESURRECT_TEST_DTYPE_NAME2, H5P_DEFAULT,
                     H5P_DEFAULT) < 0) {
    H5_FAILED_API();
  ...
  if ((group_id = H5Gopen2(container_group, DATATYPE_RESURRECT_TEST_GROUP_NAME,
                           H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
  ...
  if ((type_id = H5Topen2(group_id, DATATYPE_RESURRECT_TEST_DTYPE_NAME2,
                          H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int test_cant_commit_predefined(void) {
  ...
  if ((group_id =
           H5Gcreate2(container_group, PREDEFINED_TYPE_COMMIT_TEST_GROUP_NAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  H5E_BEGIN_TRY {
    err_ret = H5Tcommit2(group_id, "committed_predefined_type", H5T_NATIVE_INT,
  ...
  if (err_ret >= 0) {
    H5_FAILED_API();
    printf(
        "    committed a predefined datatype directly (without copying it)!\n");
    goto error;
  }
...
/*
 * A test to check that a datatype cannot be modified once it has been
 * committed.
 */
static int test_cant_modify_committed_type(void) {
  htri_t is_committed = FALSE;
  ...
  if ((group_id =
           H5Gcreate2(container_group, MODIFY_COMMITTED_TYPE_TEST_GROUP_NAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create container sub-group '%s'\n",
  ...
  H5E_BEGIN_TRY { err_ret = H5Tset_precision(type_id, (size_t)256); }
  H5E_END_TRY
