...
int main(int argc, char *argv[]) {
  ...
  /* AddTest("config", test_configure, cleanup_configure, "Configure
   * definitions", NULL); */
  printf("** CONFIGURE DEFINITIONS **\n");
  test_configure();
  printf("\n");

  /* AddTest("metadata", test_metadata, cleanup_metadata, "Encoding/decoding
   * metadata", NULL); */

  /* AddTest("checksum", test_checksum, cleanup_checksum, "Checksum algorithm",
   * NULL); */
  ...
  /* AddTest("objects", test_h5o, cleanup_h5o, "Generic Object Functions",
   * NULL); */
  ...
  /* AddTest("vlstrings", test_vlstrings, cleanup_vlstrings,  "Variable-Length
   * Strings", NULL); */
  printf("** VARIABLE-LENGTH STRINGS **\n");
  test_vlstrings();
  printf("\n");

  /* AddTest("iterate", test_iterate, cleanup_iterate,  "Group & Attribute
   * Iteration", NULL); */
