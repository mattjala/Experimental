...
static int test_create_group_under_root(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file or group aren't supported with "
           "this connector\n");
    return 0;
  }
  ...
  if ((parent_gid = H5Gcreate2(file_id, GROUP_CREATE_UNDER_ROOT_GNAME,
...
static int test_create_group_under_existing_group(void) {
  ...
  if ((parent_group_id =
           H5Gopen2(file_id, GROUP_TEST_GROUP_NAME, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't open group\n");
    goto error;
  }

  /* Create a new group (/group_tests/child_group) under the already-existing
   * parent Group using a relative path */
  if ((child_group_id =
           H5Gcreate2(parent_group_id, GROUP_CREATE_UNDER_GROUP_REL_GNAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
  ...
  /* Create a new group (child_group/grandchild_group) under the
   * already-existing parent Group using an absolute path */
  if ((grandchild_group_id =
           H5Gcreate2(parent_group_id, GROUP_CREATE_UNDER_GROUP_ABS_GNAME,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int test_create_many_groups(void) {
  ...
  if ((parent_group_id = H5Gcreate2(container_group, MANY_GROUP_CREATIONS_GNAME,
  ...
  for (i = 0; i < GROUP_NUMB_MANY; i++) {
    ...
    if ((child_group_id = H5Gcreate2(parent_group_id, group_name, H5P_DEFAULT,
...
static int test_create_deep_groups(void) {
  ...
  /* Create the group under the root group of the file */
  if ((group_id = H5Gcreate2(container_group, DEEP_GROUP_CREATIONS_GNAME,
                             H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
...
static int create_group_recursive(hid_t parent_gid, unsigned counter) {
  ...
  if ((child_gid = H5Gcreate2(parent_gid, gname, H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create group '%s'\n", gname);
    goto error;
...
error:
  H5E_BEGIN_TRY { H5Gclose(child_gid); }
  H5E_END_TRY
...
static int test_create_intermediate_group(void) {
  ...
  if ((group_id = H5Gcreate2(container_group,
                             GROUP_CREATE_INTMD_REL_INTMD_NAME
  ...
  if ((group_id = H5Gopen2(
           file_id, GROUP_TEST_GROUP_NAME "/" GROUP_CREATE_INTMD_REL_INTMD_NAME,
           H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Gclose(group_id) < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(container_group,
                             ...
                             "/" GROUP_CREATE_INTMD_ABS_INTMD_NAME
  ...
  /* Verify both groups were created */
  if ((group_id = H5Gopen2(
           file_id, GROUP_TEST_GROUP_NAME "/" GROUP_CREATE_INTMD_ABS_INTMD_NAME,
           H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Gclose(group_id) < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(container_group,
                             "/" GROUP_TEST_GROUP_NAME
                             "/" GROUP_CREATE_INTMD_MULT_INTMD1_NAME
...
static int test_create_group_invalid_params(void) {
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Gcreate_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        group_id =
            H5Gcreate2(H5I_INVALID_HID, GROUP_CREATE_INVALID_PARAMS_GROUP_NAME,
                       H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gcreate_invalid_grp_name) {
      ...
      H5E_BEGIN_TRY {
        group_id =
            H5Gcreate2(file_id, NULL, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
      ...
      H5E_BEGIN_TRY {
        group_id =
            H5Gcreate2(file_id, "", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gcreate_invalid_lcpl) {
      ...
      H5E_BEGIN_TRY {
        group_id = H5Gcreate2(file_id, GROUP_CREATE_INVALID_PARAMS_GROUP_NAME,
...
static int test_create_anonymous_group_invalid_params(void) {
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Gcreate_anon_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        new_group_id =
            H5Gcreate_anon(H5I_INVALID_HID, H5P_DEFAULT, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gcreate_anon_invalid_gcpl) {
      ...
      H5E_BEGIN_TRY {
        new_group_id =
            H5Gcreate_anon(container_group, H5I_INVALID_HID, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gcreate_anon_invalid_gapl) {
      ...
      H5E_BEGIN_TRY {
        new_group_id =
            H5Gcreate_anon(container_group, H5P_DEFAULT, H5I_INVALID_HID);
      }
      H5E_END_TRY
...
static int test_open_nonexistent_group(void) {
  ...
  H5E_BEGIN_TRY {
    group_id =
        H5Gopen2(file_id, OPEN_NONEXISTENT_GROUP_TEST_GNAME, H5P_DEFAULT);
  }
  H5E_END_TRY
...
static int test_open_group_invalid_params(void) {
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Gopen_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        group_id =
            H5Gopen2(H5I_INVALID_HID, GROUP_TEST_GROUP_NAME, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gopen_invalid_grp_name) {
      ...
      H5E_BEGIN_TRY { group_id = H5Gopen2(file_id, NULL, H5P_DEFAULT); }
      H5E_END_TRY
      ...
      H5E_BEGIN_TRY { group_id = H5Gopen2(file_id, "", H5P_DEFAULT); }
      H5E_END_TRY
...
static int test_close_group_invalid_id(void) {
  ...
  if (!(vol_cap_flags_g & H5VL_CAP_FLAG_GROUP_BASIC)) {
    SKIPPED_API();
    printf("    API functions for basic group aren't supported with this "
           "connector\n");
    return 0;
  }

  H5E_BEGIN_TRY { err_ret = H5Gclose(H5I_INVALID_HID); }
  H5E_END_TRY
...
static int test_group_property_lists(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file, group, property list, or "
           "creation order aren't supported "
           "with this connector\n");
    return 0;
  }
  ...
  if ((group_id1 =
           H5Gcreate2(container_group, GROUP_PROPERTY_LIST_TEST_GROUP_NAME1,
                      H5P_DEFAULT, gcpl_id1, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
  ...
  if ((group_id2 =
           H5Gcreate2(container_group, GROUP_PROPERTY_LIST_TEST_GROUP_NAME2,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create group\n");
    goto error;
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Gget_create_plist) {
      ...
      if (dummy_prop_val != GROUP_PROPERTY_LIST_TEST_DUMMY_VAL) {
        H5_FAILED_API();
        printf("    retrieved GCPL property value '%llu' did not match "
               "expected value '%llu'\n",
      ...
      if (dummy_prop_val == GROUP_PROPERTY_LIST_TEST_DUMMY_VAL) {
        H5_FAILED_API();
        printf("    retrieved GCPL property value '%llu' matched control value "
               "'%llu' when it "
               "shouldn't have\n",
               (unsigned long long)dummy_prop_val,
               (unsigned long long)GROUP_PROPERTY_LIST_TEST_DUMMY_VAL);
     ...
     * opening (instead of creating) a group. If they were reconstructed
     * properly upon file open, the creation property lists should also have the
     * same test values as set before.
     */
    if (gcpl_id1 >= 0) {
      H5E_BEGIN_TRY { H5Pclose(gcpl_id1); }
      H5E_END_TRY
      gcpl_id1 = H5I_INVALID_HID;
    }
    if (gcpl_id2 >= 0) {
      H5E_BEGIN_TRY { H5Pclose(gcpl_id2); }
      H5E_END_TRY
      gcpl_id2 = H5I_INVALID_HID;
    }
    if (group_id1 >= 0) {
      H5E_BEGIN_TRY { H5Gclose(group_id1); }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gget_create_plist_reopened) {
      ...
      if ((group_id1 =
               H5Gopen2(container_group, GROUP_PROPERTY_LIST_TEST_GROUP_NAME1,
                        H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    couldn't open group\n");
      ...
      if ((group_id2 =
               H5Gopen2(container_group, GROUP_PROPERTY_LIST_TEST_GROUP_NAME2,
                        H5P_DEFAULT)) < 0) {
        H5_FAILED_API();
        printf("    couldn't open group\n");
        PART_ERROR_API(H5Gget_create_plist_reopened);
...
static int test_get_group_info(void) {
  ...
  if ((parent_group_id =
           H5Gcreate2(container_group, GROUP_GET_INFO_TEST_GROUP_NAME,
  ...
  for (i = 0; i < GROUP_GET_INFO_TEST_GROUP_NUMB; i++) {
    /* Create the groups with a reverse-ordering naming scheme to test creation
     * order */
    HDsnprintf(group_name, NAME_BUF_SIZE, "group %02u",
               (unsigned)(GROUP_GET_INFO_TEST_GROUP_NUMB - i - 1));

    if ((group_id = H5Gcreate2(parent_group_id, group_name, H5P_DEFAULT,
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Gget_info) {
      ...
      if (group_info.nlinks != GROUP_GET_INFO_TEST_GROUP_NUMB) {
        H5_FAILED_API();
        printf("    group's number of links '%lu' doesn't match expected value "
               "'%u'\n",
      ...
      if (group_info.max_corder != GROUP_GET_INFO_TEST_GROUP_NUMB) {
        H5_FAILED_API();
        printf("    group's max creation order '%lld' doesn't match expected "
               "value '%lld'\n",
      ...
      /* Ensure that the storage_type field is at least set to a meaningful
       * value */
      if (group_info.storage_type != H5G_STORAGE_TYPE_SYMBOL_TABLE &&
        ...
        H5_FAILED_API();
        printf("    group info's 'storage_type' field wasn't set to a "
               "meaningful value\n");
        PART_ERROR_API(H5Gget_info);
      }
      ...
      if (group_info.mounted != FALSE) {
        H5_FAILED_API();
        printf("    group info's 'mounted' field was TRUE when it should have "
               "been FALSE\n");
        PART_ERROR_API(H5Gget_info);
      }
    ...
    PART_BEGIN(H5Gget_info_by_name) {
      ...
      /* Retrieve information about the parent group */
      if (H5Gget_info_by_name(container_group, GROUP_GET_INFO_TEST_GROUP_NAME,
                              &group_info, H5P_DEFAULT) < 0) {
        H5_FAILED_API();
    ...
    PART_BEGIN(H5Gget_info_by_idx_crt_order_increasing) {
      ...
      for (i = 0; i < GROUP_GET_INFO_TEST_GROUP_NUMB; i++) {
        ...
        if (H5Gget_info_by_idx(container_group, GROUP_GET_INFO_TEST_GROUP_NAME,
                               H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)i,
                               &group_info, H5P_DEFAULT) < 0) {
          H5_FAILED_API();
        ...
        if (group_info.nlinks != 0) {
          H5_FAILED_API();
          printf("    group's number of links '%lu' doesn't match expected "
                 "value '%d'\n",
                 group_info.nlinks, 0);
          PART_ERROR_API(H5Gget_info_by_idx_crt_order_increasing);
        }
        ...
        if (group_info.mounted != FALSE) {
          H5_FAILED_API();
          printf("    group info's 'mounted' field was TRUE when it should "
                 "have been FALSE\n");
          PART_ERROR_API(H5Gget_info_by_idx_crt_order_increasing);
        }
      }
    ...
    PART_BEGIN(H5Gget_info_by_idx_crt_order_decreasing) {
      ...
      for (i = 0; i < GROUP_GET_INFO_TEST_GROUP_NUMB; i++) {
        ...
        /* Retrieve information about each group under the parent group */
        if (H5Gget_info_by_idx(container_group, GROUP_GET_INFO_TEST_GROUP_NAME,
                               H5_INDEX_CRT_ORDER, H5_ITER_DEC, (hsize_t)i,
                               &group_info, H5P_DEFAULT) < 0) {
          H5_FAILED_API();
          printf("    couldn't get group info for group at index %u\n", i);
    ...
    PART_BEGIN(H5Gget_info_by_idx_name_order_increasing) {
      TESTING_2_API(
          "H5Gget_info_by_idx by alphabetical order in increasing order");
      ...
      for (i = 0; i < GROUP_GET_INFO_TEST_GROUP_NUMB; i++) {
        ...
        /* Retrieve information about each group under the parent group */
        if (H5Gget_info_by_idx(container_group, GROUP_GET_INFO_TEST_GROUP_NAME,
                               H5_INDEX_NAME, H5_ITER_INC, (hsize_t)i,
                               &group_info, H5P_DEFAULT) < 0) {
          H5_FAILED_API();
          printf("    couldn't get group info for group at index %u\n", i);
    ...
    PART_BEGIN(H5Gget_info_by_idx_name_order_decreasing) {
      TESTING_2_API(
          "H5Gget_info_by_idx by alphabetical order in decreasing order");
      ...
      for (i = 0; i < GROUP_GET_INFO_TEST_GROUP_NUMB; i++) {
        ...
        /* Retrieve information about each group under the parent group */
        if (H5Gget_info_by_idx(container_group, GROUP_GET_INFO_TEST_GROUP_NAME,
                               H5_INDEX_NAME, H5_ITER_DEC, (hsize_t)i,
                               &group_info, H5P_DEFAULT) < 0) {
          H5_FAILED_API();
          printf("    couldn't get group info for group at index %u\n", i);
        ...
        if (group_info.nlinks != 0) {
          H5_FAILED_API();
          printf("    group's number of links '%" PRIuHSIZE
...
static int test_get_group_info_invalid_params(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
      !(vol_cap_flags_g & H5VL_CAP_FLAG_GROUP_MORE)) {
    SKIPPED_API();
    printf("    API functions for basic file, or more group aren't supported "
           "with this "
           "connector\n");
    return 0;
  }
  ...
  BEGIN_MULTIPART {
    PART_BEGIN(H5Gget_info_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY { err_ret = H5Gget_info(H5I_INVALID_HID, &group_info); }
      H5E_END_TRY

      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info with an invalid "
               "loc_id!\n");
    ...
    PART_BEGIN(H5Gget_info_invalid_grp_info_pointer) {
      ...
      H5E_BEGIN_TRY { err_ret = H5Gget_info(file_id, NULL); }
      H5E_END_TRY

      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info with invalid "
               "group info pointer!\n");
    ...
    PART_BEGIN(H5Gget_info_by_name_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Gget_info_by_name(H5I_INVALID_HID, ".", &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY

      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info_by_name with an "
               "invalid loc_id!\n");
    ...
    PART_BEGIN(H5Gget_info_by_name_invalid_grp_name) {
      ...
      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info_by_name with a "
               "NULL name!\n");
    ...
    PART_BEGIN(H5Gget_info_by_name_invalid_lapl) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Gget_info_by_name(file_id, ".", &group_info, H5I_INVALID_HID);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gget_info_by_idx_invalid_loc_id) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(H5I_INVALID_HID, ".", H5_INDEX_NAME,
                                     H5_ITER_INC, 0, &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY

      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info_by_idx with an "
               "invalid loc_id!\n");
    ...
    PART_BEGIN(H5Gget_info_by_idx_invalid_grp_name) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(file_id, NULL, H5_INDEX_NAME, H5_ITER_INC,
                                     0, &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY

      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info_by_idx with a "
               "NULL group name!\n");
        PART_ERROR_API(H5Gget_info_by_idx_invalid_grp_name);
      }

      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(file_id, "", H5_INDEX_NAME, H5_ITER_INC, 0,
    ...
    PART_BEGIN(H5Gget_info_by_idx_invalid_index_type) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(file_id, ".", H5_INDEX_UNKNOWN,
                                     H5_ITER_INC, 0, &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY
      ...
      if (err_ret >= 0) {
        H5_FAILED_API();
        printf("    retrieved info of group using H5Gget_info_by_idx with "
               "invalid index type "
               "H5_INDEX_UNKNOWN!\n");
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(file_id, ".", H5_INDEX_N, H5_ITER_INC, 0,
                                     &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gget_info_by_idx_invalid_iter_order) {
      ...
      H5E_BEGIN_TRY {
        err_ret =
            H5Gget_info_by_idx(file_id, ".", H5_INDEX_NAME, H5_ITER_UNKNOWN, 0,
                               &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(file_id, ".", H5_INDEX_NAME, H5_ITER_N, 0,
                                     &group_info, H5P_DEFAULT);
      }
      H5E_END_TRY
    ...
    PART_BEGIN(H5Gget_info_by_idx_invalid_grp_info_pointer) {
      ...
      H5E_BEGIN_TRY {
        err_ret = H5Gget_info_by_idx(file_id, ".", H5_INDEX_NAME, H5_ITER_INC,
                                     0, NULL, H5P_DEFAULT);
      }
      H5E_END_TRY
...
static int test_flush_group(void) {
  ...
  if (!(vol_cap_flags_g & (H5VL_CAP_FLAG_FILE_BASIC)) ||
    ...
    SKIPPED_API();
    printf("    API functions for basic file, group, or flush refresh aren't "
           "supported with this "
           "connector\n");
    return 0;
  }
  ...
  if ((group_id = H5Gcreate2(container_group, GROUP_FLUSH_GNAME, H5P_DEFAULT,
                             H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create group '%s'\n", GROUP_FLUSH_GNAME);
    goto error;
...
static int test_flush_group_invalid_params(void) {
  ...
  if (!(vol_cap_flags_g & H5VL_CAP_FLAG_FLUSH_REFRESH)) {
    SKIPPED_API();
    printf("    API functions for group flush aren't supported with this "
           "connector\n");
    return 0;
  }

  H5E_BEGIN_TRY { status = H5Gflush(H5I_INVALID_HID); }
  H5E_END_TRY
...
static int test_refresh_group(void) {
  ...
  if ((group_id = H5Gcreate2(container_group, GROUP_REFRESH_GNAME, H5P_DEFAULT,
                             H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    H5_FAILED_API();
    printf("    couldn't create group '%s'\n", GROUP_REFRESH_GNAME);
    goto error;
...
static int test_refresh_group_invalid_params(void) {
  ...
  if (!(vol_cap_flags_g & H5VL_CAP_FLAG_FLUSH_REFRESH)) {
    SKIPPED_API();
    printf("    API functions for group refresh aren't supported with this "
           "connector\n");
    return 0;
  }

  H5E_BEGIN_TRY { status = H5Grefresh(H5I_INVALID_HID); }
  H5E_END_TRY
