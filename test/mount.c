...
static int setup(hid_t fapl) {
  ...
  if ((file = H5Fcreate(filename, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(
          H5Gcreate2(file, "/mnt1", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/mnt1/file1", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/mnt_unlink", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/mnt_move_a", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Lcreate_hard(file, "/mnt1/file1", H5L_SAME_LOC, "/file1", H5P_DEFAULT,
                     H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Lcreate_hard(file, "/mnt1", H5L_SAME_LOC, "/mnt1_link", H5P_DEFAULT,
                     H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Fclose(file) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((file = H5Fcreate(filename, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/file2", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/rename_a", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/rename_b", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(H5Gcreate2(file, "/rename_a/x", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Fclose(file) < 0)
    FAIL_STACK_ERROR;
...
static int test_illegal(hid_t fapl) {
  ...
  if (status >= 0) {
    H5_FAILED();
    HDputs("    Mounting same file opened twice at one mount point should have "
           "failed.");
    TEST_ERROR;
  } /* end if */
  if (H5Funmount(mnt, ".") < 0)
...
static int test_samefile(hid_t fapl) {
  ...
  if (status >= 0)
    FAIL_PUTS_ERROR(
        "    Mounting different files at one mount point should have failed.");
  ...
  if (status >= 0)
    FAIL_PUTS_ERROR(
        "    Mounting same files at one mount point should have failed.");
  if (H5Funmount(mnt1a, ".") < 0)
    FAIL_STACK_ERROR;
  if (H5Gclose(mnt1a) < 0)
    FAIL_STACK_ERROR;
...
static int test_hide(hid_t fapl) {
  ...
  if (H5Oget_info_by_name3(file1, "/mnt1/file1", &oi1, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
   ...
   */
  if (H5Oget_info_by_name3(file1, "/file1", &oi2, H5O_INFO_BASIC, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
...
static int test_assoc(hid_t fapl) {
   ...
   * of file2.
   */
  if (H5Oget_info_by_name3(file1, "/mnt1", &oi2, H5O_INFO_BASIC, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
...
static int test_move(hid_t fapl) {
  ...
  if (H5Lmove(file1, "/mnt1/rename_a/x", H5L_SAME_LOC, "/mnt1/rename_b/y",
...
static int test_postopen(hid_t fapl) {
  ...
  if (H5Oget_info_by_name3(file2, "/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
...
static int test_unlink(hid_t fapl) {
   ...
   */
  if (H5Oget_info_by_name3(file1, "/mnt_unlink/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(mnt, "/mnt_unlink/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(root, "/mnt_unlink/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(root, "file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  H5E_BEGIN_TRY {
    status =
        H5Oget_info_by_name3(mnt, "file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT);
  }
  H5E_END_TRY
  if (status >= 0) {
    H5_FAILED();
  ...
  H5E_BEGIN_TRY {
    status = H5Oget_info_by_name3(file2, "/mnt_unlink/file2", &oinfo,
...
static int test_mvmpt(hid_t fapl) {
  ...
  if (H5Lmove(file1, "/mnt_move_a", H5L_SAME_LOC, "/mnt_move_b", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;

  /* Access something under the new name */
  if (H5Oget_info_by_name3(file1, "/mnt_move_b/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
...
static int test_interlink(hid_t fapl) {
  ...
  H5E_BEGIN_TRY {
    status = H5Lcreate_hard(file1, "/mnt1/file2", H5L_SAME_LOC, "/file2",
 ...
 */
  ...
  if ((type = H5Tcopy(H5T_NATIVE_INT)) < 0)
    FAIL_STACK_ERROR;
  if (H5Tcommit2(file1, "/type1", type, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  if ((space = H5Screate_simple(1, cur_dims, NULL)) < 0)
    FAIL_STACK_ERROR;
  H5E_BEGIN_TRY {
    dset = H5Dcreate2(file1, "/mnt1/file2/dset", type, space, H5P_DEFAULT,
                      H5P_DEFAULT, H5P_DEFAULT);
  }
  H5E_END_TRY
  if (dset >= 0) {
...
static int test_uniformity(hid_t fapl) {
  ...
  if (H5Oget_info_by_name3(file1, "/", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file1, "/mnt1", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file1, "mnt1", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file1, "/mnt1/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file1, "mnt1/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
  ...
  if (H5Oget_info_by_name3(file2, "/", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file2, "/mnt1", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file2, "mnt1", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file2, "/mnt1/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  if (H5Oget_info_by_name3(file2, "mnt1/file2", &oinfo, H5O_INFO_BASIC,
                           H5P_DEFAULT) < 0)
...
static int test_mount_after_close(hid_t fapl) {
  ...
  hid_t gidA = -1, gidAB = -1, gidABM = -1, gidX = -1,
        gidXY = -1;                             /* Group identifiers */
  ...
  */
  ...
  if ((gidA = H5Gcreate2(fid1, "A", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((gidAB = H5Gcreate2(gidA, "B", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    FAIL_STACK_ERROR;
  /* Mount point */
  if ((gidABM = H5Gcreate2(gidAB, "M", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    FAIL_STACK_ERROR;
  /* Soft link */
  ...
  if ((gidX = H5Gcreate2(fid2, "/X", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    FAIL_STACK_ERROR;
  if ((gidXY = H5Gcreate2(gidX, "Y", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    FAIL_STACK_ERROR;
  if ((did = H5Dcreate2(gidXY, "D", H5T_NATIVE_INT, sid, H5P_DEFAULT,
                        H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  /* Soft link */
  ...
  /*
   *  Close the parent file. This keeps the file open because of the other
   * handle on the group within
   */
...
static int test_mount_after_unmount(hid_t fapl) {
  ...
  hid_t gidA = -1, gidB = -1, gidX = -1, gidY = -1,
        gidZ = -1;     /* Group identifiers */
  ...
  if ((gidA = H5Gcreate2(fid1, "A", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if ((gidAM = H5Gcreate2(gidA, "M", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidAM) < 0)
    TEST_ERROR;
  ...
  if ((gidB = H5Gcreate2(fid1, "B", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if ((gidBM = H5Gcreate2(gidB, "M", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidBM) < 0)
    TEST_ERROR;
  ...
  if ((gidX = H5Gcreate2(fid2, "/X", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if ((gidXM = H5Gcreate2(gidX, "M", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidXM) < 0)
    TEST_ERROR;
  if ((gidXX = H5Gcreate2(gidX, "X", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidXX) < 0)
    TEST_ERROR;
  ...
  if ((fid3 = H5Fcreate(filename3, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    TEST_ERROR;
  if ((gidY = H5Gcreate2(fid3, "/Y", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidY) < 0)
    TEST_ERROR;
  ...
  if ((fid4 = H5Fcreate(filename4, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    TEST_ERROR;
  if ((gidZ = H5Gcreate2(fid4, "/Z", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidZ) < 0)
    TEST_ERROR;
...
static int test_missing_unmount(hid_t fapl) {
  ...
  /* Create file #1 */
  if ((fid1 = H5Fcreate(filename1, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  /* Create file #2 */
  if ((fid2 = H5Fcreate(filename2, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  /* Create file #3 */
  if ((fid3 = H5Fcreate(filename3, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
...
static int test_fcdegree_semi(hid_t fapl) {
  ...
  /* Try closing file #2 (should still fail, since there are still objects open
   * in child file) */
  H5E_BEGIN_TRY { ret = H5Fclose(fid2); }
  H5E_END_TRY
  if (ret >= 0)
...
static int test_acc_perm(hid_t fapl) {
  hid_t fid1 = -1, fid2 = -1, fid3 = -1; /* File IDs */
  hid_t gidA = -1, gidB = -1, gidC = -1, gidM = -1, gidAM = -1,
        gidAMZ = -1;        /* Group IDs */
  ...
  if ((gidB = H5Gcreate2(fid2, "/B", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gidB) < 0)
    TEST_ERROR;

  /* (Note that this object should get created in the "hidden" group for "A" in
   * parent file) */
  ...
  /* Attempt to create objects in read/write file (should succeed) */
  if ((gidAMZ = H5Gcreate2(fid1, "/A/M/Z", H5P_DEFAULT, H5P_DEFAULT,
                           H5P_DEFAULT)) < 0)
    TEST_ERROR;
...
static int test_mult_mount(hid_t fapl) {
  ...
  hid_t gidS = -1, gidT = -1, gidU = -1, gidBS = -1,
        gidAMT = -1;        /* Group IDs in file #3 */
  char name[NAME_BUF_SIZE]; /* Buffer for filename retrieved */
  char filename1[1024], filename2[1024],
      filename3[1024]; /* Name of files to mount */
  ...
  *name = '\0';
  ...
  if ((gidU = H5Gcreate2(gidAMT, "U", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
...
static int test_cut_graph(hid_t fapl) {
  hid_t fid1 = -1, fid2 = -1, fid3 = -1, fid4 = -1, fid5 = -1, fid6 = -1,
        fid7 = -1;            /* File IDs */
  hid_t gidA = -1, gidB = -1; /* Group IDs in file #1 */
  ...
  char filename1[NAME_BUF_SIZE], filename2[NAME_BUF_SIZE],
      filename3[NAME_BUF_SIZE], filename4[NAME_BUF_SIZE],
      filename5[NAME_BUF_SIZE], filename6[NAME_BUF_SIZE],
  ...
  if ((fid4 = H5Fcreate(filename4, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  if ((fid5 = H5Fcreate(filename5, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  if ((fid6 = H5Fcreate(filename6, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  if ((fid7 = H5Fcreate(filename7, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
...
static int test_symlink(hid_t fapl) {
  ...
  if (H5Lcreate_soft("./A/D/H", fid1, "L", H5P_DEFAULT, H5P_DEFAULT) <
      0) /* Soft link */
    TEST_ERROR;
...
static int test_sharedacc(hid_t fapl) {
  ...
  if ((fid1[0] =
           H5Fcreate(filename1, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if ((gid = H5Gcreate2(fid1[0], "A", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gid) < 0)
    TEST_ERROR;
  ...
  if ((fid2[0] =
           H5Fcreate(filename2, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if ((gid = H5Gcreate2(fid2[0], "B", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(gid) < 0)
    TEST_ERROR;
...
static int test_sharedclose(hid_t fapl) {
  ...
  if ((fid1a = H5Fcreate(filename1, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if ((gid1 = H5Gcreate2(fid1a, "A", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  if ((fid1b = H5Freopen(fid1a)) < 0)
    TEST_ERROR;
  if ((gid2 = H5Gcreate2(fid1b, "B", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if ((gid3 = H5Gcreate2(fid1b, "B/C", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
...
static int test_multisharedclose(hid_t fapl) {
  ...
  if ((fid1 = H5Fcreate(filename4, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(
          H5Gcreate2(fid1, "mnt1", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Gclose(
          H5Gcreate2(fid1, "mnt2", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Gclose(
          H5Gcreate2(fid1, "mnt3", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  if (H5Fclose(fid1) < 0)
    TEST_ERROR;
  ...
  if ((fid1 = H5Fcreate(filename1, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(H5Gcreate2(fid1, "grp", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Fclose(fid1) < 0)
    TEST_ERROR;
  ...
  /* Create child file with group */
  if ((fid1 = H5Fcreate(filename2, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(H5Gcreate2(fid1, "grp", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
  ...
  /* Create child file with group */
  if ((fid1 = H5Fcreate(filename3, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  if (H5Gclose(H5Gcreate2(fid1, "grp", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
