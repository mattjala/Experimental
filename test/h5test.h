...
H5TEST_DLL char *h5_fixname(const char *base_name, hid_t fapl, char *fullname,
                            size_t size);
H5TEST_DLL char *h5_fixname_superblock(const char *base_name, hid_t fapl,
                                       char *fullname, size_t size);
H5TEST_DLL char *h5_fixname_no_suffix(const char *base_name, hid_t fapl,
                                      char *fullname, size_t size);
H5TEST_DLL char *h5_fixname_printf(const char *base_name, hid_t fapl,
                                   char *fullname, size_t size);
...
H5TEST_DLL int h5_make_local_copy(const char *origfilename,
                                  const char *local_copy_name);
...
H5TEST_DLL herr_t h5_using_parallel_driver(hid_t fapl_id,
                                           hbool_t *driver_is_parallel);
H5TEST_DLL herr_t h5_driver_is_default_vfd_compatible(
    hid_t fapl_id, hbool_t *default_vfd_compatible);
H5TEST_DLL hbool_t h5_driver_uses_multiple_files(const char *drv_name,
                                                 unsigned flags);
...
H5TEST_DLL void h5_send_message(const char *file, const char *arg1,
                                const char *arg2);
H5TEST_DLL herr_t h5_wait_message(const char *file);

/* A VOL class struct to verify registering optional operations */
H5TEST_DLLVAR herr_t reg_opt_op_optional(void *obj, H5VL_optional_args_t *args,
                                         hid_t dxpl_id, void **req);
H5TEST_DLLVAR herr_t reg_opt_link_optional(void *obj,
                                           const H5VL_loc_params_t *loc_params,
                                           H5VL_optional_args_t *args,
                                           hid_t dxpl_id, void **req);
H5TEST_DLLVAR herr_t reg_opt_datatype_get(void *obj,
