 ...
 *
 * Purpose:     Verify that the target file is found successfully in
 *"tmp_links_env" directory via searching the pathnames set in the environment
 *variable HDF5_EXT_PREFIX.
 *        1. Target link: "extlinks_env1"
 *        2. Main file: "extlinks_env0"
 *        3. Target file is created in: "tmp_links_env/extlinks_env1"
 *         4. The environment variable "HDF5_EXT_PREFIX" is set to
 *".:tmp_links_env"
 *
 * Return:      Success:        0
 *              Failure:        -1
