...
static void test_reference_params(void) {
  ...
  dataset = H5Dcreate2(group, "Dataset1", H5T_NATIVE_UINT, sid1, H5P_DEFAULT,
  ...
  dataset = H5Dcreate2(group, "Dataset2", H5T_NATIVE_UCHAR, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");

  /* Create an attribute for the dataset */
  attr = H5Acreate2(dataset, "Attr", H5T_NATIVE_UINT, sid1, H5P_DEFAULT,
                    H5P_DEFAULT);
  ...
  ret = H5Tcommit2(group, "Datatype1", tid1, H5P_DEFAULT, H5P_DEFAULT,
                   H5P_DEFAULT);
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid1, "Dataset3", H5T_STD_REF, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  ...
  H5E_BEGIN_TRY {
    ret = H5Rcreate_object(H5I_INVALID_HID, "/Group1/Dataset1", H5P_DEFAULT,
                           &wbuf[0]);
  }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Rcreate_object loc_id");
  H5E_BEGIN_TRY { ret = H5Rcreate_object(fid1, NULL, H5P_DEFAULT, &wbuf[0]); }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Rcreate_object name");
  H5E_BEGIN_TRY { ret = H5Rcreate_object(fid1, "", H5P_DEFAULT, &wbuf[0]); }
  H5E_END_TRY
  ...
  H5E_BEGIN_TRY {
    ret = H5Rcreate_region(H5I_INVALID_HID, "/Group1/Dataset1", sid1,
                           H5P_DEFAULT, &wbuf[0]);
  }
  H5E_END_TRY
  ...
  H5E_BEGIN_TRY {
    ret = H5Rcreate_region(fid1, "/Group1/Dataset1", H5I_INVALID_HID,
                           H5P_DEFAULT, &wbuf[0]);
  }
  H5E_END_TRY
  ...
  H5E_BEGIN_TRY {
    ret = H5Rcreate_attr(H5I_INVALID_HID, "/Group1/Dataset2", "Attr",
                         H5P_DEFAULT, &wbuf[0]);
  }
  H5E_END_TRY
  ...
  H5E_BEGIN_TRY { ret = H5Rdestroy(NULL); }
  H5E_END_TRY
  ...
  H5E_BEGIN_TRY { ret = H5Requal(NULL, &rbuf[0]); }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Requal ref1");
  H5E_BEGIN_TRY { ret = H5Requal(&rbuf[0], NULL); }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Requal ref2");

  /* Test parameters to H5Rcopy */
  H5E_BEGIN_TRY { ret = H5Rcopy(NULL, &wbuf[0]); }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Rcopy src_ref");
  H5E_BEGIN_TRY { ret = H5Rcopy(&rbuf[0], NULL); }
  H5E_END_TRY
  ...
  H5E_BEGIN_TRY { dset2 = H5Ropen_object(NULL, H5P_DEFAULT, dapl_id); }
  H5E_END_TRY
...
static void test_reference_obj(void) {
  ...
  /* Open datatype object. TAPL isn't supported yet.  But it's harmless to pass
   * in */
...
static void test_reference_vlen_obj(void) {
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid1, "Dataset3", tid1, sid1, H5P_DEFAULT, H5P_DEFAULT,
                       H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
...
static void test_reference_cmpnd_obj(void) {
  ...
  /* Create reference to dataset */
  ret =
      H5Rcreate_object(fid1, "/Group1/Dataset1", H5P_DEFAULT, &cmpnd_wbuf.ref0);
  CHECK(ret, FAIL, "H5Rcreate_object");
  ...
  /* Create reference to dataset */
  ret =
      H5Rcreate_object(fid1, "/Group1/Dataset2", H5P_DEFAULT, &cmpnd_wbuf.ref1);
  CHECK(ret, FAIL, "H5Rcreate_object");
  ...
  /* Create reference to named datatype */
  ret = H5Rcreate_object(fid1, "/Group1/Datatype1", H5P_DEFAULT,
                         &cmpnd_wbuf.ref3);
  CHECK(ret, FAIL, "H5Rcreate_object");
...
**
****************************************************************/
static void test_reference_region(H5F_libver_t libver_low,
  ...
  H5R_ref_t *wbuf = NULL,      /* buffer to write to disk */
      *rbuf = NULL;            /* buffer read from disk */
  H5R_ref_t nvrbuf[3] = {
      {{{0}}}, {{{101}}}, {{{255}}}}; /* buffer with non-valid refs */
  ...
  /* Create a dataset */
  H5E_BEGIN_TRY {
    dset1 = H5Dcreate2(fid1, "Dataset1", H5T_STD_REF, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  }
  H5E_END_TRY
  ...
  if (dset1 < 0) {
    ...
    /* Read the data */
    ret =
        H5Dread(dset_NA, H5T_STD_REF, H5S_ALL, H5S_ALL, H5P_DEFAULT, rdata_NA);
    CHECK(ret, FAIL, "H5Dread");
    ...
    for (tu8 = (uint8_t *)drbuf, i = 0; i < (SPACE2_DIM1 * SPACE2_DIM2);
         i++, tu8++)
...
**
****************************************************************/
static void test_reference_region_1D(H5F_libver_t libver_low,
                                     H5F_libver_t libver_high) {
  hid_t fid1;            /* HDF5 File IDs        */
  hid_t fapl;            /* File access property list */
  hid_t dset1,           /* Dataset ID            */
  ...
  /* Create a dataset */
  dset3 = H5Dcreate2(fid1, "Dataset2", H5T_STD_U8LE, sid3, H5P_DEFAULT,
                     H5P_DEFAULT, H5P_DEFAULT);
  ...
  if (dset1 < 0) {
    ...
    block[0] = 2;
    ret =
        H5Sselect_hyperslab(sid3, H5S_SELECT_SET, start, stride, count, block);
    CHECK(ret, FAIL, "H5Sselect_hyperslab");
    ...
    coord1[8][0] = 97;
    coord1[9][0] = 03;
    ret = H5Sselect_elements(sid3, H5S_SELECT_SET, (size_t)POINT1_NPOINTS,
                             (const hsize_t *)coord1);
    CHECK(ret, FAIL, "H5Sselect_elements");
...
static void test_reference_obj_deleted(void) {
  ...
  dataset = H5Dcreate2(fid1, "Dataset1", H5T_NATIVE_INT, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid1, "Dataset2", H5T_STD_REF, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
...
**
****************************************************************/
static herr_t test_deref_iter_op(hid_t H5_ATTR_UNUSED group, const char *name,
...
static void test_reference_group(void) {
  ...
  /* Create file with a group and a dataset containing an object reference to
   * the group */
  ...
  did = H5Dcreate2(gid, DSETNAME2, H5T_NATIVE_INT, sid, H5P_DEFAULT,
                   H5P_DEFAULT, H5P_DEFAULT);
  ...
  /* Create dataset */
  did = H5Dcreate2(fid, DSETNAME, H5T_STD_REF, sid, H5P_DEFAULT, H5P_DEFAULT,
                   H5P_DEFAULT);
  CHECK(did, H5I_INVALID_HID, "H5Dcreate2");
  ...
  ret = H5Literate2(gid, H5_INDEX_NAME, H5_ITER_INC, NULL, test_deref_iter_op,
                    &count);
  ...
  size = H5Lget_name_by_idx(gid, ".", H5_INDEX_NAME, H5_ITER_INC, (hsize_t)0,
                            objname, (size_t)NAME_SIZE, H5P_DEFAULT);
  CHECK(size, (-1), "H5Lget_name_by_idx");
  VERIFY_STR(objname, DSETNAME2, "H5Lget_name_by_idx");

  ret = H5Oget_info_by_idx3(gid, ".", H5_INDEX_NAME, H5_ITER_INC, (hsize_t)0,
...
static void test_reference_attr(void) {
  ...
  /* Create an attribute for the dataset */
  attr = H5Acreate2(group, "Attr2", H5T_NATIVE_UINT, sid, H5P_DEFAULT,
                    H5P_DEFAULT);
  CHECK(attr, H5I_INVALID_HID, "H5Acreate2");
  ...
  /* Create a dataset (inside Group1) */
  dataset = H5Dcreate2(group, "Dataset1", H5T_NATIVE_UINT, sid, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");

  /* Create an attribute for the dataset */
  attr = H5Acreate2(dataset, "Attr1", H5T_NATIVE_UINT, sid, H5P_DEFAULT,
                    H5P_DEFAULT);
  CHECK(attr, H5I_INVALID_HID, "H5Acreate2");
  ...
  /* Create another dataset (inside Group1) */
  dataset = H5Dcreate2(group, "Dataset2", H5T_NATIVE_UCHAR, sid, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  /* Save datatype for later */
  ret = H5Tcommit2(group, "Datatype1", tid, H5P_DEFAULT, H5P_DEFAULT,
                   H5P_DEFAULT);
  CHECK(ret, FAIL, "H5Tcommit2");

  /* Create an attribute for the datatype */
  attr =
      H5Acreate2(tid, "Attr3", H5T_NATIVE_UINT, sid, H5P_DEFAULT, H5P_DEFAULT);
  CHECK(attr, H5I_INVALID_HID, "H5Acreate2");
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid, "Dataset3", H5T_STD_REF, sid, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  ret = H5Rcreate_attr(fid, "/Group1/Dataset2", "Attr1", H5P_DEFAULT,
                       &ref_wbuf[1]);
  CHECK(ret, FAIL, "H5Rcreate_attr");
  ...
  ret = H5Rcreate_attr(fid, "/Group1/Datatype1", "Attr3", H5P_DEFAULT,
                       &ref_wbuf[3]);
  CHECK(ret, FAIL, "H5Rcreate_attr");
...
static void test_reference_external(void) {
  ...
  /* Create reference to dataset2 attribute */
  ret = H5Rcreate_attr(fid1, "/Group1/Dataset2", "Attr1", H5P_DEFAULT,
                       &ref_wbuf[1]);
  CHECK(ret, FAIL, "H5Rcreate_attr");
  ret = H5Rget_obj_type3(&ref_wbuf[1], H5P_DEFAULT, &obj_type);
  CHECK(ret, FAIL, "H5Rget_obj_type3");
  ...
  /* Create reference to named datatype attribute */
  ret = H5Rcreate_attr(fid1, "/Group1/Datatype1", "Attr3", H5P_DEFAULT,
                       &ref_wbuf[3]);
  CHECK(ret, FAIL, "H5Rcreate_attr");
  ret = H5Rget_obj_type3(&ref_wbuf[3], H5P_DEFAULT, &obj_type);
  CHECK(ret, FAIL, "H5Rget_obj_type3");
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid2, "Dataset3", H5T_STD_REF, sid, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
...
/****************************************************************
**
**  test_reference_compat_conv(): Test basic H5R (reference) object reference
*code.
...
static void test_reference_compat_conv(void) {
  ...
  hsize_t dims1[] = {SPACE1_DIM1}, dims2[] = {SPACE2_DIM1, SPACE2_DIM2},
          dims3[] = {SPACE1_DIM1}; /* Purposely set dimension larger to test
                                      NULL references */
  hsize_t start[SPACE2_RANK];      /* Starting location of hyperslab */
  hsize_t stride[SPACE2_RANK];     /* Stride of hyperslab      */
  hsize_t count[SPACE2_RANK];      /* Element count of hyperslab */
  ...
  /* Create a dataset (inside Group1) */
  dataset = H5Dcreate2(group, "Dataset1", H5T_NATIVE_UINT, sid2, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  /* Create another dataset (inside Group1) */
  dataset = H5Dcreate2(group, "Dataset2", H5T_NATIVE_UCHAR, sid2, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  /* Create reference to dataset */
  ret = H5Rcreate(&wbuf_obj[0], fid1, "/Group1/Dataset1", H5R_OBJECT,
                  H5I_INVALID_HID);
  CHECK(ret, FAIL, "H5Rcreate");

  /* Create reference to dataset */
  ret = H5Rcreate(&wbuf_obj[1], fid1, "/Group1/Dataset2", H5R_OBJECT,
                  H5I_INVALID_HID);
  CHECK(ret, FAIL, "H5Rcreate");
  ...
  /* Create reference to named datatype */
  ret = H5Rcreate(&wbuf_obj[3], fid1, "/Group1/Datatype1", H5R_OBJECT,
                  H5I_INVALID_HID);
  CHECK(ret, FAIL, "H5Rcreate");
  ...
  dataset = H5Dcreate2(fid1, "Dataset4", H5T_STD_REF_DSETREG, sid3, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  ret = H5Rcreate(&wbuf_reg[0], fid1, "/Group1/Dataset1", H5R_DATASET_REGION,
                  sid2);
  CHECK(ret, FAIL, "H5Rcreate");
  ...
  ret = H5Rcreate(&wbuf_reg[1], fid1, "/Group1/Dataset2", H5R_DATASET_REGION,
                  sid2);
  CHECK(ret, FAIL, "H5Rcreate");

  /* Write selection to disk */
  ret = H5Dwrite(dataset, H5T_STD_REF_DSETREG, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                 wbuf_reg);
  CHECK(ret, FAIL, "H5Dwrite");
...
static void test_reference_perf(void) {
  ...
  wbuf_reg_deprec =
      (hdset_reg_ref_t *)calloc(sizeof(hdset_reg_ref_t), SPACE1_DIM1);
  rbuf_reg_deprec =
      (hdset_reg_ref_t *)calloc(sizeof(hdset_reg_ref_t), SPACE1_DIM1);
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid1, "Dataset4", H5T_STD_REF_OBJ, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  for (i = 0; i < MAX_ITER_CREATE; i++) {
    t1 = H5_get_time();
    ret = H5Rcreate(&wbuf_deprec[0], fid1, "/Group1/Dataset1", H5R_OBJECT1,
                    H5I_INVALID_HID);
    CHECK(ret, FAIL, "H5Rcreate");
    t2 = H5_get_time();
    t += t2 - t1;
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid1, "Dataset5", H5T_STD_REF, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  for (i = 0; i < MAX_ITER_CREATE; i++) {
    t1 = H5_get_time();
    /* Store first dataset region */
    ret = H5Rcreate_region(fid1, "/Group1/Dataset1", sid1, H5P_DEFAULT,
                           &wbuf_reg[0]);
    CHECK(ret, FAIL, "H5Rcreate_region");
    t2 = H5_get_time();
    t += t2 - t1;
  ...
  for (i = 0; i < MAX_ITER_WRITE; i++) {
    ...
    /* Write selection to disk */
    ret =
        H5Dwrite(dataset, H5T_STD_REF, H5S_ALL, H5S_ALL, H5P_DEFAULT, wbuf_reg);
    CHECK(ret, FAIL, "H5Dwrite");
    t2 = H5_get_time();
    t += t2 - t1;
  }
  ...
  /* Create a dataset */
  dataset = H5Dcreate2(fid1, "Dataset6", H5T_STD_REF_DSETREG, sid1, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  CHECK(dataset, H5I_INVALID_HID, "H5Dcreate2");
  ...
  for (i = 0; i < MAX_ITER_CREATE; i++) {
    t1 = H5_get_time();
    /* Store first dataset region */
    ret = H5Rcreate(&wbuf_reg_deprec[0], fid1, "/Group1/Dataset1",
                    H5R_DATASET_REGION1, sid1);
    CHECK(ret, FAIL, "H5Rcreate");
    t2 = H5_get_time();
    t += t2 - t1;
  }
  ...
  for (i = 0; i < MAX_ITER_READ; i++) {
    t1 = H5_get_time();
    /* Read selection from disk */
    ret = H5Dread(dataset, H5T_STD_REF_OBJ, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                  rbuf_deprec);
    CHECK(ret, FAIL, "H5Dread");
    t2 = H5_get_time();
    t += t2 - t1;
  ...
  for (i = 0; i < MAX_ITER_READ; i++) {
    ...
    /* Read selection from disk */
    ret =
        H5Dread(dataset, H5T_STD_REF, H5S_ALL, H5S_ALL, H5P_DEFAULT, rbuf_reg);
    CHECK(ret, FAIL, "H5Dread");
    t2 = H5_get_time();
    t += t2 - t1;
  ...
  for (i = 0; i < MAX_ITER_READ; i++) {
    t1 = H5_get_time();
    /* Read selection from disk */
    ret = H5Dread(dataset, H5T_STD_REF_DSETREG, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                  rbuf_reg_deprec);
    CHECK(ret, FAIL, "H5Dread");
    t2 = H5_get_time();
    t += t2 - t1;
...
void test_reference(void) {
  ...
  for (low = H5F_LIBVER_EARLIEST; low < H5F_LIBVER_NBOUNDS; low++) {
    for (high = H5F_LIBVER_EARLIEST; high < H5F_LIBVER_NBOUNDS; high++) {
      ...
      test_reference_region(
          low, high); /* Test basic H5R dataset region reference code */
      test_reference_region_1D(
          low,
          high); /* Test H5R dataset region reference code for 1-D datasets */
  ...
  if (HDstrcmp(env_h5_drvr, "direct") != 0) {
    test_reference_obj_deleted(); /* Test H5R object reference code for deleted
                                     objects */
  }
