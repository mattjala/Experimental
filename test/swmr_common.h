...
/* The message sent by writer that the file open is done--releasing the file
 * lock */
...
H5TEST_DLL int generate_name(char *name_buf, size_t name_buf_length,
                             unsigned level, unsigned count);
