...
static const char *FILENAME[] = {
    "fillval_1", "fillval_2", "fillval_3", "fillval_4", "fillval_5",
...
static hid_t create_compound_type(void) {
  ...
  if ((ret_value = H5Tcreate(H5T_COMPOUND, sizeof(comp_datatype))) < 0)
    goto error;
  if (H5Tinsert(ret_value, "a", HOFFSET(comp_datatype, a), H5T_NATIVE_FLOAT) <
      0)
    goto error;
  if (H5Tinsert(ret_value, "x", HOFFSET(comp_datatype, x), H5T_NATIVE_INT) < 0)
    goto error;
  if (H5Tinsert(ret_value, "y", HOFFSET(comp_datatype, y), H5T_NATIVE_DOUBLE) <
      0)
    goto error;
...
static hid_t create_compound_vl_type(void) {
  ...
  if ((ret_value = H5Tcreate(H5T_COMPOUND, sizeof(comp_vl_datatype))) < 0)
    TEST_ERROR;
  if (H5Tinsert(ret_value, "x", HOFFSET(comp_vl_datatype, x), H5T_NATIVE_INT) <
      0)
    TEST_ERROR;
  ...
  if (H5Tinsert(ret_value, "b", HOFFSET(comp_vl_datatype, b), str_id) < 0)
    TEST_ERROR;
  if (H5Tinsert(ret_value, "y", HOFFSET(comp_vl_datatype, y), H5T_NATIVE_INT) <
      0)
    TEST_ERROR;
...
static int test_getset(void) {
  ...
  if ((type_ss = H5Tcreate(H5T_COMPOUND, sizeof fill_ss)) < 0 ||
      H5Tinsert(type_ss, "v1", HOFFSET(struct fill_ss, v1), H5T_NATIVE_SHORT) <
          0 ||
      H5Tinsert(type_ss, "v2", HOFFSET(struct fill_ss, v2), H5T_NATIVE_SHORT) <
          0) {
    goto error;
  }
  if ((type_si = H5Tcreate(H5T_COMPOUND, sizeof fill_si)) < 0 ||
      H5Tinsert(type_si, "v1", HOFFSET(struct fill_si, v1), H5T_NATIVE_INT) <
          0 ||
      H5Tinsert(type_si, "v2", HOFFSET(struct fill_si, v2), H5T_NATIVE_INT) <
          0) {
    goto error;
  }
...
static int test_getset_vl(hid_t fapl) {
  hsize_t dims[1] = {2};
  hid_t fileid = (-1), spaceid = (-1), dtypeid = (-1), datasetid = (-1),
        plistid = (-1);
  ...
  if ((fileid = H5Fcreate(filename, H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT)) <
      0)
    TEST_ERROR;
  ...
  if ((spaceid = H5Screate_simple(1, dims, NULL)) < 0)
    TEST_ERROR;
  if ((datasetid = H5Dcreate2(fileid, "Dataset", dtypeid, spaceid, H5P_DEFAULT,
                              plistid, H5P_DEFAULT)) < 0)
    TEST_ERROR;
...
static int test_create(hid_t fapl, const char *base_name, H5D_layout_t layout) {
  ...
  hid_t dset1 = H5I_INVALID_HID, dset2 = H5I_INVALID_HID,
        dset3 = H5I_INVALID_HID, dset4 = H5I_INVALID_HID,
        dset5 = H5I_INVALID_HID, dset6 = H5I_INVALID_HID,
        /* dset7=H5I_INVALID_HID, */ dset8 = H5I_INVALID_HID,
        dset9 = H5I_INVALID_HID, dset10 = H5I_INVALID_HID;
  ...
  if (H5D_COMPACT != layout) {
    ...
    if (H5Pset_fill_value(dcpl, comp_type_id, &fill_ctype) < 0)
      goto error;
    if ((dset9 = H5Dcreate2(file, "dset9", comp_type_id, space, H5P_DEFAULT,
                            dcpl, H5P_DEFAULT)) < 0)
      goto error;
    ...
    if (H5Pset_fill_value(dcpl, H5T_NATIVE_SHORT, &fill_s) < 0)
      goto error;
#endif
    if ((dset1 = H5Dcreate2(file, "dset1", H5T_NATIVE_LONG, space, H5P_DEFAULT,
                            dcpl, H5P_DEFAULT)) < 0)
      goto error;
    ...
    if (H5Pset_fill_value(dcpl, H5T_NATIVE_LONG, &fill_l) < 0)
      goto error;
#endif
    if ((dset2 = H5Dcreate2(file, "dset2", H5T_NATIVE_SHORT, space, H5P_DEFAULT,
                            dcpl, H5P_DEFAULT)) < 0)
      goto error;
    ...
    if (H5Pset_fill_value(dcpl, H5T_NATIVE_LONG, &fill_l) < 0)
      goto error;
#endif
    if ((dset3 = H5Dcreate2(file, "dset3", H5T_NATIVE_LONG, space, H5P_DEFAULT,
                            dcpl, H5P_DEFAULT)) < 0)
      goto error;
    ...
    if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_NEVER) < 0)
      goto error;
    if ((dset4 = H5Dcreate2(file, "dset4", H5T_NATIVE_LONG, space, H5P_DEFAULT,
                            dcpl, H5P_DEFAULT)) < 0)
      goto error;
  ...
  if (H5Pset_fill_value(dcpl, comp_type_id, &fill_ctype) < 0)
    goto error;
  if ((dset8 = H5Dcreate2(file, "dset8", comp_type_id, space, H5P_DEFAULT, dcpl,
                          H5P_DEFAULT)) < 0)
    goto error;
  ...
  if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_NEVER) < 0)
    goto error;
  if ((dset5 = H5Dcreate2(file, "dset5", H5T_NATIVE_INT, space, H5P_DEFAULT,
                          dcpl, H5P_DEFAULT)) < 0)
    goto error;
  ...
  if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_ALLOC) < 0)
    goto error;
  if ((dset6 = H5Dcreate2(file, "dset6", H5T_NATIVE_LONG, space, H5P_DEFAULT,
                          dcpl, H5P_DEFAULT)) < 0)
    goto error;
  ...
  if (H5Pset_fill_value(dcpl, H5T_NATIVE_INT, NULL) < 0)
    goto error;
  if ((dset10 = H5Dcreate2(file, "dset10", H5T_NATIVE_INT, space, H5P_DEFAULT,
                           dcpl, H5P_DEFAULT)) < 0)
    goto error;
  ...
  if (H5D_COMPACT != layout) {
    ...
    if (H5Pget_fill_value(dcpl, comp_type_id, &rd_c) < 0)
      goto error;
    if (!H5_FLT_ABS_EQUAL(rd_c.a, 0) ||
        !H5_DBL_ABS_EQUAL(rd_c.y, fill_ctype.y) || rd_c.x != 0 ||
        rd_c.z != '\0') {
      H5_FAILED();
  ...
  if (H5Pget_fill_value(dcpl, comp_type_id, &rd_c) < 0)
    goto error;
  if (!H5_FLT_ABS_EQUAL(rd_c.a, 0) || !H5_DBL_ABS_EQUAL(rd_c.y, fill_ctype.y) ||
      rd_c.x != 0 || rd_c.z != '\0') {
    H5_FAILED();
    HDputs("    Got wrong fill value");
    printf("    Got rd_c.a=%f, rd_c.y=%f and rd_c.x=%d, rd_c.z=%c\n",
 ...
 *-------------------------------------------------------------------------
 */
static int test_rdwr_cases(hid_t file, hid_t dcpl, const char *dname,
                           void *_fillval, H5D_fill_time_t fill_time,
                           H5D_layout_t layout, H5T_class_t datatype,
                           hid_t ctype_id) {
  ...
  if ((fspace = H5Screate_simple(5, cur_size, cur_size)) < 0)
    goto error;
  if (datatype == H5T_INTEGER &&
      (dset1 = H5Dcreate2(file, dname, H5T_NATIVE_INT, fspace, H5P_DEFAULT,
                          dcpl, H5P_DEFAULT)) < 0)
    goto error;
  if (datatype == H5T_COMPOUND &&
      (dset2 = H5Dcreate2(file, dname, ctype_id, fspace, H5P_DEFAULT, dcpl,
                          H5P_DEFAULT)) < 0)
    goto error;
  ...
  for (i = 0; i < 1000; i++) {
    ...
    if (H5Sselect_hyperslab(fspace, H5S_SELECT_SET, hs_offset, NULL, one,
                            NULL) < 0)
      goto error;

    /* case for atomic datatype */
    if (datatype == H5T_INTEGER) {
      if (H5Dread(dset1, H5T_NATIVE_INT, mspace, fspace, H5P_DEFAULT, &val_rd) <
          0)
        goto error;
      if (fill_time != H5D_FILL_TIME_NEVER && val_rd != fillval) {
        ...
        fprintf(stdout, "%u: Value read was not a fill value.\n",
                (unsigned)__LINE__);
        fprintf(stdout,
                "    Elmt={%" PRIuHSIZE ",%" PRIuHSIZE ",%" PRIuHSIZE
                ",%" PRIuHSIZE ",%" PRIuHSIZE "}, read: %u, "
                "Fill value: %u\n",
                hs_offset[0], hs_offset[1], hs_offset[2], hs_offset[3],
      ...
      if (fill_time != H5D_FILL_TIME_NEVER &&
        ...
        fprintf(stdout,
                "    Elmt={%" PRIuHSIZE ",%" PRIuHSIZE ",%" PRIuHSIZE
                ",%" PRIuHSIZE ",%" PRIuHSIZE "}, read: %f, %d, %f, %c"
                "Fill value: %f, %d, %f, %c\n",
                hs_offset[0], hs_offset[1], hs_offset[2], hs_offset[3],
  ...
  if ((mspace = H5Screate_simple(5, hs_size, hs_size)) < 0)
    goto error;
  if (H5Sselect_hyperslab(fspace, H5S_SELECT_SET, hs_offset, hs_stride, hs_size,
                          NULL) < 0)
    goto error;
      ...
      for (u = 0; u < nelmts; u++) {
        if (!H5_FLT_ABS_EQUAL(buf_c[u].a, fill_c.a) || buf_c[u].x != fill_c.x ||
          ...
          fprintf(stdout,
                  ...
                  "Fill value: %f, %d, %f, %c\n",
                  hs_offset[0], hs_offset[1], hs_offset[2], hs_offset[3],
                  hs_offset[4], (double)buf_c[u].a, buf_c[u].x, buf_c[u].y,
                  buf_c[u].z, (double)fill_c.a, fill_c.x, fill_c.y, fill_c.z);
          goto error;
        } /* end if */
      }   /* end for */
    }     /* end if */
  ...
  for (i = 0; i < 1000; i++) {
      ...
      if (fill_time == H5D_FILL_TIME_ALLOC) {
        ...
        if (val_rd != should_be) {
          ...
          printf("    Elmt={%ld,%ld,%ld,%ld,%ld}, read: %u, "
                 "should be: %u\n",
                 (long)hs_offset[0], (long)hs_offset[1], (long)hs_offset[2],
                 (long)hs_offset[3], (long)hs_offset[4], val_rd, should_be);
          goto error;
        }
    ...
    /* case for compound datatype */
      ...
      if (fill_time == H5D_FILL_TIME_ALLOC) {
        ...
        if (!H5_FLT_ABS_EQUAL(rd_c.a, should_be_c.a) ||
            rd_c.x != should_be_c.x ||
            !H5_DBL_ABS_EQUAL(rd_c.y, should_be_c.y) ||
            rd_c.z != should_be_c.z) {
          H5_FAILED();
          fprintf(stdout, "%u: Value read was not correct.\n",
                  (unsigned)__LINE__);
          printf("    Elmt={%ld,%ld,%ld,%ld,%ld}, read: %f,%d,%f,%c "
                 "should be: %f,%d,%f,%c\n",
                 (long)hs_offset[0], (long)hs_offset[1], (long)hs_offset[2],
                 (long)hs_offset[3], (long)hs_offset[4], (double)rd_c.a, rd_c.x,
                 rd_c.y, rd_c.z, (double)should_be_c.a, should_be_c.x,
                 should_be_c.y, should_be_c.z);
          goto error;
        }
...
static int test_rdwr(hid_t fapl, const char *base_name, H5D_layout_t layout) {
  ...
  if (H5D_COMPACT != layout) {
    ...
    /* case for H5D_FILL_TIME_ALLOC as fill write time and fill value to be
     * default */
    if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_ALLOC) < 0)
      goto error;
    fillval = 0;
    nerrors +=
        test_rdwr_cases(file, dcpl, "dset1", &fillval, H5D_FILL_TIME_ALLOC,
                        layout, H5T_INTEGER, (hid_t)-1);

    /* case for H5D_FILL_TIME_NEVER as fill write time and fill value to be
     * default */
    if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_NEVER) < 0)
      goto error;
    nerrors +=
        test_rdwr_cases(file, dcpl, "dset2", &fillval, H5D_FILL_TIME_NEVER,
                        layout, H5T_INTEGER, (hid_t)-1);

    /* case for H5D_FILL_TIME_ALLOC as fill write time and fill value is
     * user-defined */
    if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_ALLOC) < 0)
      goto error;
    fillval = 0x4c70f1cd;
    if (H5Pset_fill_value(dcpl, H5T_NATIVE_INT, &fillval) < 0)
      goto error;
    nerrors +=
        test_rdwr_cases(file, dcpl, "dset3", &fillval, H5D_FILL_TIME_ALLOC,
                        layout, H5T_INTEGER, (hid_t)-1);

    /* case for H5D_FILL_TIME_NEVER as fill write time and fill value is
     * user-defined */
    if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_NEVER) < 0)
      goto error;
    if (H5Pset_fill_value(dcpl, H5T_NATIVE_INT, &fillval) < 0)
      goto error;
    nerrors +=
        test_rdwr_cases(file, dcpl, "dset4", &fillval, H5D_FILL_TIME_NEVER,
                        layout, H5T_INTEGER, (hid_t)-1);
    ...
    if (H5Pset_fill_value(dcpl, (hid_t)-1, NULL) < 0)
      goto error;
    nerrors +=
        test_rdwr_cases(file, dcpl, "dset5", &fillval, H5D_FILL_TIME_NEVER,
                        layout, H5T_INTEGER, (hid_t)-1);

    /* case for H5D_FILL_TIME_ALLOC as fill write time and fill value is
     * user-defined as compound type */
    if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_ALLOC) < 0)
      goto error;
    ...
    if (H5Pset_fill_value(dcpl, ctype_id, &fill_ctype) < 0)
      goto error;
    nerrors +=
        test_rdwr_cases(file, dcpl, "dset11", &fill_ctype, H5D_FILL_TIME_ALLOC,
  ...
  if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_NEVER) < 0)
    goto error;
  nerrors += test_rdwr_cases(file, dcpl, "dset7", &fillval, H5D_FILL_TIME_NEVER,
                             layout, H5T_INTEGER, (hid_t)-1);
  ...
  if (H5Pset_fill_value(dcpl, (hid_t)-1, NULL) < 0)
    goto error;
  nerrors +=
      test_rdwr_cases(file, dcpl, "dset10", &fillval, H5D_FILL_TIME_NEVER,
                      layout, H5T_INTEGER, (hid_t)-1);
  ...
  if (H5Pset_fill_value(dcpl, ctype_id, &fill_ctype) < 0)
    goto error;
  nerrors +=
      test_rdwr_cases(file, dcpl, "dset12", &fill_ctype, H5D_FILL_TIME_ALLOC,
                      layout, H5T_COMPOUND, ctype_id);
 ...
 *-------------------------------------------------------------------------
 */
static int test_extend_init_integer(void *_buf, size_t nelmts,
                                    const void *_val) {
 ...
 *-------------------------------------------------------------------------
 */
static int test_extend_verify_integer(unsigned lineno, const hsize_t *offset,
                                      const void *_test_val,
                                      const void *_compare_val) {
  const int *test_val = (const int *)_test_val; /* Value to test */
  const int *compare_val =
      (const int *)_compare_val; /* Value to compare against */
  ...
  if (*test_val != *compare_val) {
    ...
    fprintf(stdout,
            "    Elmt = {%" PRIuHSIZE ", %" PRIuHSIZE ", %" PRIuHSIZE
            ", %" PRIuHSIZE ", %" PRIuHSIZE "}, read: %d, "
            "expected: %d\n",
            offset[0], offset[1], offset[2], offset[3], offset[4], *test_val,
            *compare_val);
    goto error;
  } /* end if */
 ...
 *-------------------------------------------------------------------------
 */
static int test_extend_init_cmpd_vl(void *_buf, size_t nelmts,
                                    const void *_val) {
  comp_vl_datatype *buf = (comp_vl_datatype *)_buf; /* Buffer to initialize */
  const comp_vl_datatype *val =
      (const comp_vl_datatype *)_val; /* Value to use */
 ...
 *-------------------------------------------------------------------------
 */
static int test_extend_verify_cmpd_vl(unsigned lineno, const hsize_t *offset,
                                      const void *_test_val,
                                      const void *_compare_val) {
  const comp_vl_datatype *test_val =
      (const comp_vl_datatype *)_test_val; /* Value to test */
  ...
  if ((test_val->x != compare_val->x) ||
      HDstrcmp(test_val->a, compare_val->a) != 0 ||
      HDstrcmp(test_val->b, compare_val->b) != 0 ||
      (test_val->y != compare_val->y)) {
    fprintf(stdout, "%u: Value read was not expected.\n", lineno);
    fprintf(stdout,
            "    Elmt = {%" PRIuHSIZE ", %" PRIuHSIZE ", %" PRIuHSIZE
            ", %" PRIuHSIZE ", %" PRIuHSIZE "}, read: {%d, '%s', '%s', %d} "
            "expected: {%d, '%s', '%s', %d}\n",
            offset[0], offset[1], offset[2], offset[3], offset[4], test_val->x,
            test_val->a, test_val->b, test_val->y, compare_val->x,
            compare_val->a, compare_val->b, compare_val->y);
    goto error;
  } /* end if */
 ...
 *-------------------------------------------------------------------------
 */
static int test_extend_cases(hid_t file, hid_t _dcpl, const char *dset_name,
                             const hsize_t *ch_size, hsize_t *start_size,
  ...
  /* Create dataset */
  if ((dset = H5Dcreate2(file, dset_name, dtype, fspace, H5P_DEFAULT, dcpl,
                         H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  /* Select the element */
  if (H5Sselect_hyperslab(fspace, H5S_SELECT_SET, hs_offset, NULL, one, NULL) <
      0)
    TEST_ERROR;
...
static int test_extend(hid_t fapl, const char *base_name, H5D_layout_t layout) {
  ...
  comp_vl_datatype fillval_c = {
      32, NULL, NULL, 64}; /* Fill value for compound+vl datatype tests */
  char filename[1024];
  ...
  if (H5D_CONTIGUOUS == layout) {
    max_size[0] =
        (max_size[0] * max_size[1] * max_size[2] * max_size[3] * max_size[4]) /
  ...
  if (H5D_CONTIGUOUS == layout) {
    ...
    nelmts =
        max_size[0] * max_size[1] * max_size[2] * max_size[3] * max_size[4];
    if ((fd = HDopen(FILE_NAME_RAW, O_RDWR | O_CREAT | O_TRUNC,
                     H5_POSIX_CREATE_MODE_RW)) < 0 ||
        HDclose(fd) < 0)
      goto error;
    if (H5Pset_external(dcpl, FILE_NAME_RAW, (off_t)0,
                        (hsize_t)nelmts * sizeof(int)) < 0)
      goto error;
  }
#endif
...
static int test_compatible(void) {
  ...
  const char *testfile =
      H5_get_srcdir_filename(FILE_COMPATIBLE); /* Corrected test file name */
...
static int test_partalloc_cases(hid_t file, hid_t dcpl, const char *dname,
                                H5D_fill_time_t fill_time) {
  ...
  int f_values[4] = {88, 88, 88,
                     88}; /* pre-seed read buffer with known values */
  int r_values[4] = {88, 88, 88,
                     88}; /* pre-seed read buffer with known values */
  ...
  if ((fspace = H5Screate_simple(2, ds_size, max_size)) < 0)
    goto error;
  if ((dset1 = H5Dcreate2(file, dname, H5T_NATIVE_INT, fspace, H5P_DEFAULT,
                          dcpl, H5P_DEFAULT)) < 0)
    goto error;
  ...
  coord[0][0] = 0;
  coord[0][1] = 0;
  if (H5Sselect_elements(fspace, H5S_SELECT_SET, (size_t)1,
                         (const hsize_t *)coord))
    goto error;
   ...
   */
  if ((ret = H5Dwrite(dset1, H5T_NATIVE_INT, H5S_ALL, fspace, H5P_DEFAULT,
                      w_values)) < 0) {
    goto error;
  }
  ...
  count[0] = 1;
  count[1] = 4;
  if ((ret = H5Sselect_hyperslab(fspace, H5S_SELECT_SET, start, NULL, count,
                                 NULL)) < 0)
    goto error;
  if ((ret = H5Sselect_all(rspace)) < 0)
    goto error;
  if (H5Dread(dset1, H5T_NATIVE_INT, rspace, fspace, H5P_DEFAULT, &r_values) <
      0)
    goto error;
  ...
  if ((ret = H5Sselect_hyperslab(fspace, H5S_SELECT_SET, start, NULL, count,
                                 NULL)) < 0)
    goto error;
  if (H5Dread(dset1, H5T_NATIVE_INT, rspace, fspace, H5P_DEFAULT, &f_values) <
      0)
    goto error;

  if (fill_time != H5D_FILL_TIME_NEVER) {
    /* check allocated chunk */
    if ((r_values[0] != w_values[0]) || (r_values[1] != fillval) ||
        (r_values[2] != fillval) || (r_values[3] != fillval)) {
      H5_FAILED();
      fprintf(stdout, "%u: Allocated chunk value read was not correct.\n",
              (unsigned)__LINE__);
      printf("    {%ld,%ld,%ld,%ld} should be {%ld,%ld,%ld,%ld}\n",
             (long)r_values[0], (long)r_values[1], (long)r_values[2],
             (long)r_values[3], (long)w_values[0], (long)fillval, (long)fillval,
             (long)fillval);
      goto error;
    }
    /* check unallocated chunk */
    if ((f_values[0] != fillval) || (f_values[1] != fillval) ||
        (f_values[2] != fillval) || (f_values[3] != fillval)) {
      H5_FAILED();
      fprintf(stdout, "%u: Unallocated chunk value read was not correct.\n",
              (unsigned)__LINE__);
      printf("    {%ld,%ld,%ld,%ld} should be {%ld,%ld,%ld,%ld}\n",
             (long)f_values[0], (long)f_values[1], (long)f_values[2],
             (long)f_values[3], (long)fillval, (long)fillval, (long)fillval,
             (long)fillval);
      goto error;
    }
...
static int test_partalloc(hid_t fapl, const char *base_name) {
  ...
  /* case for H5D_FILL_TIME_IFSET as fill write time and fill value to be
   * default */
  if (H5Pset_fill_time(dcpl, H5D_FILL_TIME_IFSET) < 0)
    goto error;
#ifdef DEBUG
