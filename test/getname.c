...
static const char *FILENAME[] = {"getname", "getname1", "getname2", "getname3",
                                 NULL};
...
static int check_name(hid_t id, const char *chk_name,
                      const char *chk_user_path) {
  ...
  *user_path = '\0';
  ...
  /* Check that if user path is hidden, the name from H5Iget_name() and the user
...
static int test_main(hid_t file_id, hid_t fapl) {
  ...
  if ((group_id = H5Gcreate2(file_id, "/g0", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g1", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create group "g2" in group "g1" using absolute name */
  if ((group2_id = H5Gcreate2(file_id, "/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((dataset_id = H5Dcreate2(file_id, "d1", H5T_NATIVE_INT, space_id,
  ...
  if ((dataset_id = H5Dcreate2(group_id, "d1", H5T_NATIVE_INT, space_id,
                               H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "g2", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "g2/bar", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "g2/bar/baz", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((space_id = H5Screate_simple(1, dims, NULL)) < 0)
    TEST_ERROR;
  if ((dataset_id = H5Dcreate2(group3_id, "d1", H5T_NATIVE_INT, space_id,
                               H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  if (H5Tcommit2(file_id, "t1", type_id, H5P_DEFAULT, H5P_DEFAULT,
                 H5P_DEFAULT) < 0)
    TEST_ERROR;
  ...
  /* Rename group */
  if (H5Lmove(file_id, "/g1", H5L_SAME_LOC, "/g1a", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Rename dataset */
  if (H5Lmove(file_id, "/d1", H5L_SAME_LOC, "/d1a", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Rename datatype */
  if (H5Lmove(file_id, "/t1", H5L_SAME_LOC, "/t1a", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "/g3" */
  if ((group_id = H5Gcreate2(file_id, "/g3", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create group "/g3/foo" using absolute name */
  if ((group2_id = H5Gcreate2(file_id, "/g3/foo1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Rename group */
  if (H5Lmove(group_id, "foo1", H5L_SAME_LOC, "foo2", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Rename group again */
  if (H5Lmove(file_id, "g3/foo2", H5L_SAME_LOC, "g3/foo1", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g4/A/B" */
  if ((group_id = H5Gcreate2(file_id, "g4", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "g4/A", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "g4/A/B", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create group "g5/C" */
  if ((group4_id = H5Gcreate2(file_id, "g5", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group5_id = H5Gcreate2(file_id, "g5/C", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Move group "B" to "D"*/
  if (H5Lmove(file_id, "/g4/A/B", H5L_SAME_LOC, "/g5/C/D", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "g6", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "g6/A", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "g6/A/B", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group4_id = H5Gcreate2(file_id, "g7", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Move group "A" to "C"*/
  if (H5Lmove(file_id, "/g6/A", H5L_SAME_LOC, "/g7/C", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create a new group. */
  if ((group_id = H5Gcreate2(file_id, "/g8", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g9/a/b" */
  if ((group_id = H5Gcreate2(file_id, "g9", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "g9/a", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "g9/a/b", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Recreate groups */
  if ((group2_id = H5Gcreate2(group_id, "a", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(group_id, "a/b", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "g10", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "g10/a", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "g10/a/b", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g11/g" */
  if ((group_id = H5Gcreate2(file_id, "g11", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "g11/g", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((space_id = H5Screate_simple(1, dims, NULL)) < 0)
    FAIL_STACK_ERROR;
  if ((dataset_id = H5Dcreate2(group_id, "d", H5T_NATIVE_INT, space_id,
                               H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((dataset2_id = H5Dcreate2(group2_id, "d", H5T_NATIVE_INT, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g12", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create the dataset */
  if ((dataset_id = H5Dcreate2(file1_id, "d", H5T_NATIVE_INT, space_id,
                               H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g13", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g13/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g13/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g14", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g14/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g14/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g15", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g15/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g15/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group4_id = H5Gcreate2(file_id, "/g15/g1/g2/g3", H5P_DEFAULT,
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g16", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g16/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g16/g4/g5", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g17" */
  if ((group_id = H5Gcreate2(file_id, "g17", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Save datatype for later */
  if (H5Tcommit2(group_id, "t", type_id, H5P_DEFAULT, H5P_DEFAULT,
                 H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create a new dataset */
  if ((dataset_id = H5Dcreate2(group_id, "d", type_id, space_id, H5P_DEFAULT,
                               H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lcreate_hard(dataset_id, ".", file_id, "/g17/link", H5P_DEFAULT,
                     H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create a new dataset */
  if ((dataset_id = H5Dcreate2(file2_id, "d", H5T_NATIVE_INT, space_id,
                               H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create a new dataset */
  if ((dataset2_id = H5Dcreate2(file3_id, "d", H5T_NATIVE_INT, space_id,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create a new dataset */
  if ((dataset_id = H5Dcreate2(file_id, "d2", type_id, space_id, H5P_DEFAULT,
                               H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g18", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g18/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((type_id = H5Tcopy(H5T_NATIVE_INT)) < 0)
    FAIL_STACK_ERROR;
  if ((dataset_id = H5Dcreate2(file_id, "g18/d2", type_id, space_id,
                               H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  if (H5Tcommit2(file_id, "g18/t2", type_id, H5P_DEFAULT, H5P_DEFAULT,
                 H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((file1_id = H5Fcreate(filename1, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group4_id = H5Gcreate2(file1_id, "/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group5_id = H5Gcreate2(file1_id, "/g3/g4/g5", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Get name for the datatype ID in the first file, should be "/g18/g2/t2"
   * still */
  ...
  if ((file1_id = H5Fcreate(filename1, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    FAIL_STACK_ERROR;
  if ((group_id = H5Gcreate2(file1_id, "/g1", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((file2_id = H5Fcreate(filename2, H5F_ACC_TRUNC, H5P_DEFAULT, fapl)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file2_id, "/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group4_id = H5Gcreate2(file2_id, "/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Rename group */
  if (H5Lmove(file2_id, "/g3/g4/g1/g2", H5L_SAME_LOC, "/g3/g4/g1/g5",
              H5P_DEFAULT, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Rename group */
  if (H5Lmove(file2_id, "/g3/g4/g1", H5L_SAME_LOC, "/g3/g4/g1a", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lmove(group3_id, "g4/g1a", H5L_SAME_LOC, "g4/g1", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lmove(group3_id, "g4/g1/g5", H5L_SAME_LOC, "g4/g1/g2", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Rename mount point */
  if (H5Lmove(file2_id, "/g3/g4", H5L_SAME_LOC, "/g3/g4a", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lmove(group3_id, "g4a", H5L_SAME_LOC, "g4", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g19/g1" */
  if ((group_id = H5Gcreate2(file_id, "/g19", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g19/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create hard link to "g19/g1/ group */
  if (H5Lcreate_hard(file_id, "/g19/g1", H5L_SAME_LOC, "/g19/g2", H5P_DEFAULT,
                     H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lmove(file_id, "/g19/g1", H5L_SAME_LOC, "/g19/g3", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lcreate_hard(file_id, "/g19/g1", H5L_SAME_LOC, "/g19/g3", H5P_DEFAULT,
                     H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g20/g1" */
  if ((group_id = H5Gcreate2(file_id, "/g20", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g20/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create symbolic link to "g20/g1/ group */
  if (H5Lcreate_soft("/g20/g1", file_id, "/g20/g2", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g21/g1" */
  if ((group_id = H5Gcreate2(file_id, "/g21", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g21/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create symbolic link to "g21/g1/ group */
  if (H5Lcreate_soft("/g21/g1", file_id, "/g21/g2", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Rename group */
  if (H5Lmove(file_id, "/g21/g1", H5L_SAME_LOC, "/g21/g3", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g22/g1" */
  if ((group_id = H5Gcreate2(file_id, "/g22", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g22/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create symbolic link to "g22/g1/ group */
  if (H5Lcreate_soft("/g22/g1", file_id, "/g22/g2", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Rename soft link */
  if (H5Lmove(file_id, "/g22/g2", H5L_SAME_LOC, "/g22/g3", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g23/g1" */
  if ((group_id = H5Gcreate2(file_id, "/g23", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g23/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create symbolic link to "g23/g1/ group */
  if (H5Lcreate_soft("/g23/g1", file_id, "/g23/g2", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  /* Create group "g24/g1" */
  if ((group_id = H5Gcreate2(file_id, "/g24", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g24/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create symbolic link to "g24/g1/ group */
  if (H5Lcreate_soft("/g24/g1", file_id, "/g24/g2", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g25", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g25/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g25/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g26", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g26/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g26/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file2_id, "/g27", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file2_id, "/g27/g5", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file2_id, "/g27/g5/g6", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file3_id, "/g28", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file3_id, "/g28/g7", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file3_id, "/g28/g7/g8", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group3_id = H5Gopen2(file_id, "/g25/g1/g26/g3/g27/g5/g6", H5P_DEFAULT)) <
      0)
    FAIL_STACK_ERROR;

  /* Verify */
  if (check_name(group3_id, "/g25/g1/g26/g3/g27/g5/g6",
                 "/g25/g1/g26/g3/g27/g5/g6") < 0)
    TEST_ERROR;
  ...
  if ((group4_id = H5Gopen2(file_id, "/g25/g1/g26/g3/g27/g5/g28/g7/g8",
                            H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Verify */
  if (check_name(group4_id, "/g25/g1/g26/g3/g27/g5/g28/g7/g8",
                 "/g25/g1/g26/g3/g27/g5/g28/g7/g8") < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g29", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g29/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g29/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group4_id = H5Gcreate2(file_id, "/g29/g1/g2/g1", H5P_DEFAULT,
                              H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group5_id = H5Gcreate2(file_id, "/g29/g1/g2/g1/g2", H5P_DEFAULT,
                              H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Rename group */
  if (H5Lmove(file_id, "/g29/g1/g2/g1/g2", H5L_SAME_LOC, "/g29/g1/g2/g1/g3",
              H5P_DEFAULT, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lmove(file_id, "/g29/g1/g2/g1", H5L_SAME_LOC, "/g29/g1/g2/g3",
              H5P_DEFAULT, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lmove(file_id, "/g29/g1/g2/g3", H5L_SAME_LOC, "/g29/g3", H5P_DEFAULT,
              H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g30", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g30/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g30/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g31", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g31/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g31/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file2_id, "/g32", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file2_id, "/g32/g5", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file2_id, "/g32/g5/g6", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file3_id, "/g33", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file3_id, "/g33/g7", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file3_id, "/g33/g7/g8", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group3_id = H5Gopen2(file_id, "/g30/g1/g31/g3/g32/g5/g6", H5P_DEFAULT)) <
      0)
    FAIL_STACK_ERROR;

  /* Verify */
  if (check_name(group3_id, "/g30/g1/g31/g3/g32/g5/g6",
                 "/g30/g1/g31/g3/g32/g5/g6") < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g35", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g35/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g35/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g34", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g34/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g34/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create hard link to "/g34/g1/g2 group */
  if (H5Lcreate_hard(file_id, "/g34/g1/g2", H5L_SAME_LOC, "/g34/g2a",
                     H5P_DEFAULT, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file_id, "/g36", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file_id, "/g36/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file_id, "/g36/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g37", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g37/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g37/g4/g5a", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group4_id = H5Gcreate2(file1_id, "/g37/g4/g5b", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g38", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g38/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g38/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file2_id, "/g39", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file2_id, "/g39/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file2_id, "/g39/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file3_id, "/g40", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file3_id, "/g40/g5", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file3_id, "/g40/g5/g6", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group2_id =
           H5Gopen2(file3_id, "/g40/g5/g38/g1/g39/g3/g4", H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Verify */
  if (check_name(group2_id, "/g40/g5/g38/g1/g39/g3/g4",
                 "/g40/g5/g38/g1/g39/g3/g4") < 0)
    TEST_ERROR;
  if (check_name(group_id, "/g38/g1/g39/g3/g4", "/g38/g1/g39/g3/g4") < 0)
    TEST_ERROR;
  ...
  if ((group_id = H5Gcreate2(file1_id, "/g41", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file1_id, "/g41/g1", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file1_id, "/g41/g1/g2", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group_id = H5Gcreate2(file2_id, "/g42", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group2_id = H5Gcreate2(file2_id, "/g42/g3", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((group3_id = H5Gcreate2(file2_id, "/g42/g3/g4", H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Test H5Iget_name with anonymously created datatype, should pass because
   * committed */
  if ((size = H5Iget_name(dtype, NULL, 0)) != 0)
    TEST_ERROR;
...
static int test_obj_ref(hid_t fapl) {
  ...
  /* Create a group */
  if ((group = H5Gcreate2(fid1, "Group1", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create a single dataset inside the second file, which will be mounted
   * and used to mask objects in the first file */
  if ((dataset = H5Dcreate2(fid2, "Dataset1", H5T_STD_U32LE, sid1, H5P_DEFAULT,
                            H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((dataset = H5Dcreate2(group, "Dataset1", H5T_STD_U32LE, sid1, H5P_DEFAULT,
                            H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Dwrite(dataset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, tu32) <
      0)
    FAIL_STACK_ERROR;
  ...
  if ((dataset = H5Dcreate2(group, "Dataset2", H5T_NATIVE_UCHAR, sid1,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Save datatype for later */
  if (H5Tcommit2(group, "Datatype1", tid1, H5P_DEFAULT, H5P_DEFAULT,
                 H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group2 = H5Gcreate2(group, "Group2", H5P_DEFAULT, H5P_DEFAULT,
                           H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;

  /* Create a hard link to group1 in group2 */
  if (H5Lcreate_hard(fid1, "/Group1", H5L_SAME_LOC, "/Group1/Group2/Link",
                     H5P_DEFAULT, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;

  /* Create dataset in that group */
  if ((dataset = H5Dcreate2(group2, "Dataset4", H5T_NATIVE_UCHAR, sid1,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((group = H5Gopen2(fid1, "/Group1/Group2/Link", H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  if ((dataset = H5Dcreate2(group, "Dataset5", H5T_NATIVE_UCHAR, sid1,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if ((dataset = H5Dcreate2(fid1, "Dataset3", H5T_STD_REF_OBJ, sid1,
                            H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Rcreate(&wbuf[4], fid1, "/Group1/Group2/Dataset4", H5R_OBJECT,
                (hid_t)-1) < 0)
    FAIL_STACK_ERROR;
  if (H5Rcreate(&wbuf[5], fid1, "/Group1/Group2", H5R_OBJECT, (hid_t)-1) < 0)
    FAIL_STACK_ERROR;
  if (H5Rcreate(&wbuf[6], fid1, "/Group1/Group2/Link/Dataset5", H5R_OBJECT,
                (hid_t)-1) < 0)
    FAIL_STACK_ERROR;
  ...
  /* Write selection to disk */
  if (H5Dwrite(dataset, H5T_STD_REF_OBJ, H5S_ALL, H5S_ALL, H5P_DEFAULT, wbuf) <
      0)
    FAIL_STACK_ERROR;

  TESTING("getting path to normal dataset in root group");
  if ((dataset2 = H5Rdereference2(dataset, H5P_DEFAULT, H5R_OBJECT, &wbuf[0])) <
      0)
    FAIL_STACK_ERROR;
  *buf = '\0';
  ...
  *buf = '\0';
  ...
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[0], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Dataset3") == 0) && (namelen == 9)))
    TEST_ERROR;
  PASSED();
  ...
  if ((dataset2 = H5Rdereference2(dataset, H5P_DEFAULT, H5R_OBJECT, &wbuf[1])) <
      0)
    FAIL_STACK_ERROR;
  *buf = '\0';
  namelen = H5Iget_name(dataset2, (char *)buf, sizeof(buf));
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[1], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Group1/Dataset2") == 0) && (namelen == 16)))
    TEST_ERROR;
  PASSED();
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[2], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Group1") == 0) && (namelen == 7)))
    TEST_ERROR;
  PASSED();
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[3], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Group1/Datatype1") == 0) && (namelen == 17)))
    TEST_ERROR;
  PASSED();
  ...
  if ((dataset2 = H5Rdereference2(dataset, H5P_DEFAULT, H5R_OBJECT, &wbuf[4])) <
      0)
    FAIL_STACK_ERROR;
  *buf = '\0';
  namelen = H5Iget_name(dataset2, (char *)buf, sizeof(buf));
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[4], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Group1/Group2/Dataset4") == 0) && (namelen == 23)))
    TEST_ERROR;
  PASSED();
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[5], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Group1/Group2") == 0) && (namelen == 14)))
    TEST_ERROR;
  PASSED();
  ...
  if ((dataset2 = H5Rdereference2(dataset, H5P_DEFAULT, H5R_OBJECT, &wbuf[6])) <
      0)
    FAIL_STACK_ERROR;
  *buf = '\0';
  namelen = H5Iget_name(dataset2, (char *)buf, sizeof(buf));
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[6], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/Group1/Dataset5") == 0) && (namelen == 16)))
    TEST_ERROR;
  PASSED();
  ...
  *buf = '\0';
  namelen =
      H5Rget_name(dataset, H5R_OBJECT, &wbuf[7], (char *)buf, sizeof(buf));
  if (!((HDstrcmp(buf, "/") == 0) && (namelen == 1)))
    TEST_ERROR;
  PASSED();
  ...
  *buf = '\0';
  ...
  /* Now we try unlinking dataset2 from the file and searching for it.  It
   * shouldn't be found */
  if ((dataset2 = H5Rdereference2(dataset, H5P_DEFAULT, H5R_OBJECT, &wbuf[1])) <
      0)
    FAIL_STACK_ERROR;
...
static int test_reg_ref(hid_t fapl) {
  ...
  if ((dsetv_id = H5Dcreate2(file_id, REFREG_DSETNAMEV, H5T_NATIVE_INT,
  ...
  if ((dsetr_id =
           H5Dcreate2(file_id, REFREG_DSETNAMER, H5T_STD_REF_DSETREG, spacer_id,
                      H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)
    TEST_ERROR;
  ...
  if (H5Sselect_hyperslab(space_id, H5S_SELECT_SET, start, NULL, count, NULL) <
      0)
    TEST_ERROR;
  if (H5Rcreate(&ref[0], file_id, REFREG_DSETNAMEV, H5R_DATASET_REGION,
                space_id) < 0)
    TEST_ERROR;
  ...
  if (H5Sselect_elements(space_id, H5S_SELECT_SET, num_points,
    ...
    TEST_ERROR;
  if (H5Rcreate(&ref[1], file_id, REFREG_DSETNAMEV, H5R_DATASET_REGION,
                space_id) < 0)
    TEST_ERROR;
  ...
  if (H5Dread(dsetr_id, H5T_STD_REF_DSETREG, H5S_ALL, H5S_ALL, H5P_DEFAULT,
              ref_out) < 0)
    TEST_ERROR;

  /* Get name of the dataset the first region reference points to using
   * H5Rget_name */
  ...
  *buf1 = '\0';
  ...
  name_size1 = H5Rget_name(dsetr_id, H5R_DATASET_REGION, &ref_out[0],
                           (char *)buf1, NAME_BUF_SIZE);
  ...
  dsetv_id =
      H5Rdereference2(dsetr_id, H5P_DEFAULT, H5R_DATASET_REGION, &ref_out[0]);
  ...
  *buf2 = '\0';
  ...
  /* Get name of the dataset the second region reference points to using
   * H5Rget_name */
  TESTING("H5Rget_name to get name from region reference(pnt selec)");
  *buf1 = '\0';
  name_size1 = H5Rget_name(dsetr_id, H5R_DATASET_REGION, &ref_out[1],
                           (char *)buf1, NAME_BUF_SIZE);
  if (!((HDstrcmp(buf1, "/MATRIX") == 0) && (name_size1 == 7)))
    TEST_ERROR;
  PASSED();
  ...
  if ((dsetv_id = H5Rdereference2(dsetr_id, H5P_DEFAULT, H5R_DATASET_REGION,
                                  &ref_out[1])) < 0)
    TEST_ERROR;
...
static int test_elinks(hid_t fapl) {
  ...
  if ((group2 = H5Gcreate2(fid2, "Group2", H5P_DEFAULT, H5P_DEFAULT,
                           H5P_DEFAULT)) < 0)
    FAIL_STACK_ERROR;
  ...
  if (H5Lcreate_external(filename2, "Group2", fid1, "Link_to_Group2",
                         H5P_DEFAULT, H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;

  /* Create an external link in second file to the external link in the first
   * file */
  if (H5Lcreate_external(filename1, "Link_to_Group2", fid2,
                         "Link_to_Link_to_Group2", H5P_DEFAULT,
                         H5P_DEFAULT) < 0)
    FAIL_STACK_ERROR;
  ...
  *name = '\0';
  ...
  /* Open the group in the second file through the external link to the external
   * link */
