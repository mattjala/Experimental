...
static void usage(void) {
  ...
  printf("\n");
  printf(
      "Usage: swmr_addrem_writer [-q] [-f <# of operations between flushing\n");
  ...
  printf("\n");
  printf(
      "Defaults to verbose (no '-q' given), flushing every 1000 operations\n");
...
int main(int argc, char *argv[]) {
  ...
  if (addrem_records(fid, verbose, (unsigned long)nops,
