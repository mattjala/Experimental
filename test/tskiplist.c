...
static void test_skiplist_remove_many(void) {
  ...
  /* Insert & remove again (in sorted order), to check that completely empty
   * skip lists can be added again
   */
  ...
  /* Insert & remove again (in reverse sorted order), to check that completely
   * empty skip lists can be added again */
...
static void test_skiplist_string(void) {
  ...
  string_node data[10] = {{10, "10"}, {20, "20"}, {15, "15"}, {5, "05"},
                          {50, "50"}, {30, "30"}, {31, "31"}, {32, "32"},
                          {80, "80"}, {90, "90"}};
  string_node hashed_data[10] = {{5, "05"},  {10, "10"}, {15, "15"}, {20, "20"},
...
static herr_t test_skiplist_iter(void *item, void H5_ATTR_UNUSED *key,
                                 void *op_data) {
...
static int test_skiplist_generic_cmp(const void *_key1, const void *_key2) {
  ...
  long long result = (long long)(key1->a) - (long long)(key1->b) -
                     (long long)(key2->a) + (long long)(key2->b);
...
static void test_skiplist_generic(void) {
  ...
  generic_t sorted_data[10] = {{30, 100}, {15, 32}, {31, 38}, {32, 34},
                               {5, 2},    {20, 13}, {10, 1},  {50, 37},
                               {80, 32},  {90, 0}};
...
static herr_t test_skiplist_destroy_free(void *item, void H5_ATTR_UNUSED *key,
                                         void *op_data) {
...
void test_skiplist(void) {
  ...
  test_skiplist_firstnext();   /* Test iteration over skip list nodes with
                                  first/next */
  ...
  test_skiplist_lastprev(); /* Test iteration over skip list nodes with
                               last/prev */
  ...
  test_skiplist_remove_first_many(); /* Test 'remove first' operation on large
                                        skip lists */
