...
static void test_genprop_basic_class(void) {
  ...
  cid1 = H5Pcreate_class(H5P_ROOT, CLASS1_NAME, NULL, NULL, NULL, NULL, NULL,
                         NULL);
  ...
  cid1 = H5Pcreate_class(H5P_FILE_CREATE, CLASS2_NAME, NULL, NULL, NULL, NULL,
                         NULL, NULL);
  CHECK_I(cid1, "H5Pcreate_class");
...
static void test_genprop_basic_class_prop(void) {
  ...
  MESSAGE(
      5,
      ("Testing Basic Generic Property List Class Properties Functionality\n"));
  ...
  ret = H5Pregister2(cid1, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");

  /* Try to insert the first property again (should fail) */
  H5E_BEGIN_TRY {
    ret = H5Pregister2(cid1, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL,
  ...
  ret = H5Pregister2(cid1, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");

  /* Try to insert the second property again (should fail) */
  H5E_BEGIN_TRY {
    ret = H5Pregister2(cid1, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL,
                       NULL, NULL, NULL, NULL, NULL, NULL);
  }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Pregister2");
  ...
  ret = H5Pregister2(cid1, PROP3_NAME, PROP3_SIZE, PROP3_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");
  ...
  H5E_BEGIN_TRY { ret = H5Pget_size(cid1, PROP1_NAME, &size); }
  H5E_END_TRY
...
**
****************************************************************/
static int test_genprop_iter1(hid_t H5_ATTR_UNUSED id, const char *name,
                              void *iter_data) {
...
static void test_genprop_class_iter(void) {
  ...
  /* Output message about test being performed */
  MESSAGE(5, ("Testing Basic Generic Property List Class Property Iteration "
              "Functionality\n"));
  ...
  /* Insert third property into class (with no callbacks) */
  ret = H5Pregister2(cid1, PROP4_NAME, PROP4_SIZE, PROP4_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");
...
/****************************************************************
**
**  test_genprop_cls_*_cb1(): Property List callbacks for
*test_genprop_class_callback
**
****************************************************************/
...
static herr_t test_genprop_cls_cpy_cb1(hid_t new_list_id,
                                       hid_t H5_ATTR_UNUSED old_list_id,
                                       void *copy_data) {
...
static herr_t test_genprop_cls_cls_cb1(hid_t list_id, void *create_data) {
  count_data_t *cdata = (count_data_t *)create_data;
...
static void test_genprop_class_callback(void) {
  ...
  MESSAGE(
      5,
      ("Testing Basic Generic Property List Class Callback Functionality\n"));

  /* Create a new generic class, derived from the root of the class hierarchy */
  cid1 =
      H5Pcreate_class(H5P_ROOT, CLASS1_NAME, test_genprop_cls_crt_cb1,
                      &crt_cb_struct, test_genprop_cls_cpy_cb1, &cpy_cb_struct,
                      test_genprop_cls_cls_cb1, &cls_cb_struct);
  CHECK_I(cid1, "H5Pcreate_class");
  ...
  cid2 =
      H5Pcreate_class(cid1, CLASS2_NAME, test_genprop_cls_crt_cb1,
                      &crt_cb_struct, test_genprop_cls_cpy_cb1, &cpy_cb_struct,
                      test_genprop_cls_cls_cb1, &cls_cb_struct);
  CHECK_I(cid2, "H5Pcreate_class");

  /* Insert fourth property into class (with no callbacks) */
  ret = H5Pregister2(cid2, PROP4_NAME, PROP4_SIZE, PROP4_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");
...
static void test_genprop_basic_list(void) {
  ...
  if (!H5_FLT_ABS_EQUAL(prop2_value, *PROP2_DEF_VALUE))
    printf("*** UNEXPECTED VALUE from %s should be %f, but is %f at line %4d "
           "in %s\n",
           "H5Pget", (double)*PROP2_DEF_VALUE, (double)prop2_value,
...
static void test_genprop_basic_list_prop(void) {
  ...
  ret = H5Pinsert2(lid1, PROP3_NAME, PROP3_SIZE, PROP3_DEF_VALUE, NULL, NULL,
                   NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pinsert2");

  /* Insert second temporary property into list (with no callbacks) */
  ret = H5Pinsert2(lid1, PROP4_NAME, PROP4_SIZE, PROP4_DEF_VALUE, NULL, NULL,
                   NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pinsert2");
...
**
****************************************************************/
static int test_genprop_iter2(hid_t H5_ATTR_UNUSED id, const char *name,
                              void *iter_data) {
  iter_data_t *idata = (iter_data_t *)iter_data;
...
/****************************************************************
**
**  test_genprop_cls_cpy_cb2(): Property Class callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_cls_cpy_cb2(hid_t new_list_id,
                                       hid_t H5_ATTR_UNUSED old_list_id,
                                       void *create_data) {
  count_data_t *cdata = (count_data_t *)create_data;
...
/****************************************************************
**
**  test_genprop_prop_crt_cb1(): Property creation callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_prop_crt_cb1(const char *name, size_t size,
                                        void *def_value) {
...
/****************************************************************
**
**  test_genprop_prop_set_cb1(): Property set callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_prop_set_cb1(hid_t plist_id, const char *name,
...
/****************************************************************
**
**  test_genprop_prop_get_cb1(): Property get callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_prop_get_cb1(hid_t plist_id, const char *name,
                                        size_t size, void *value) {
...
/****************************************************************
**
**  test_genprop_prop_cop_cb1(): Property copy callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_prop_cop_cb1(const char *name, size_t size,
                                        void *value) {
  /* Set the information from the get call */
...
/****************************************************************
**
**  test_genprop_prop_cmp_cb1(): Property comparison callback for
*test_genprop_list_callback
**
****************************************************************/
static int test_genprop_prop_cmp_cb1(const void *value1, const void *value2,
                                     size_t size) {
...
/****************************************************************
**
**  test_genprop_prop_cmp_cb3(): Property comparison callback for
*test_genprop_list_callback
**
****************************************************************/
static int test_genprop_prop_cmp_cb3(const void *value1, const void *value2,
                                     size_t size) {
  /* Set the information from the comparison call */
...
/****************************************************************
**
**  test_genprop_prop_cls_cb1(): Property close callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_prop_cls_cb1(const char *name, size_t size,
                                        void *value) {
...
/****************************************************************
**
**  test_genprop_prop_del_cb2(): Property delete callback for
*test_genprop_list_callback
**
****************************************************************/
static herr_t test_genprop_prop_del_cb2(hid_t plist_id, const char *name,
                                        size_t size, void *value) {
...
static void test_genprop_list_callback(void) {
  ...
  /* Output message about test being performed */
  MESSAGE(5, ("Testing Basic Generic Property List Property Callback "
              "Functionality\n"));

  /* Create a new generic class, derived from the root of the class hierarchy */
  cid1 = H5Pcreate_class(H5P_ROOT, CLASS1_NAME, NULL, NULL,
                         test_genprop_cls_cpy_cb2, &cop_cb_struct, NULL, NULL);
  CHECK_I(cid1, "H5Pcreate_class");

  /* Insert first property into class (with callbacks) */
  ret = H5Pregister2(cid1, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE,
                     test_genprop_prop_crt_cb1, test_genprop_prop_set_cb1,
                     test_genprop_prop_get_cb1, NULL, test_genprop_prop_cop_cb1,
                     test_genprop_prop_cmp_cb1, test_genprop_prop_cls_cb1);
  CHECK_I(ret, "H5Pregister2");

  /* Insert second property into class (with only delete callback) */
  ret = H5Pregister2(cid1, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL, NULL,
                     NULL, test_genprop_prop_del_cb2, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");

  /* Insert third property into class (with only compare callback) */
  ret = H5Pregister2(cid1, PROP3_NAME, PROP3_SIZE, PROP3_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, test_genprop_prop_cmp_cb3, NULL);
  CHECK_I(ret, "H5Pregister2");
...
static void test_genprop_list_addprop(void) {
  ...
  ret = H5Pinsert2(pid, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL, NULL,
                   NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pinsert2");
  ...
  /* Create a dataset */
  did = H5Dcreate2(fid, "Dataset1", H5T_NATIVE_INT, sid, H5P_DEFAULT, pid,
                   H5P_DEFAULT);
  ...
  /* Check values of property (set with default value) (after using property
   * list) */
  ret = H5Pget(pid, PROP1_NAME, &prop1_value);
  CHECK_I(ret, "H5Pget");
  VERIFY(prop1_value, *PROP1_DEF_VALUE, "H5Pget");
...
static void test_genprop_class_addprop(void) {
   ...
   */
  cid = H5Pcreate_class(H5P_DATASET_CREATE, CLASS1_NAME, NULL, NULL, NULL, NULL,
                        NULL, NULL);
  ...
  /* Insert first property into class (with no callbacks) */
  ret = H5Pregister2(cid, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");
  ...
  /* Insert second property into class (with no callbacks) */
  ret = H5Pregister2(cid, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");
  ...
  /* Check existence of second added property (in property list) (should not
   * exist) */
...
static void test_genprop_equal(void) {
  ...
  ret = H5Pinsert2(lid2, PROP3_NAME, PROP3_SIZE, PROP3_DEF_VALUE, NULL, NULL,
                   NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pinsert2");
  ...
  ret = H5Pinsert2(lid2, PROP4_NAME, PROP4_SIZE, PROP4_DEF_VALUE, NULL, NULL,
                   NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pinsert2");
...
static void test_genprop_path(void) {
  ...
  /* Insert second property into class (with no callbacks) */
  ret = H5Pregister2(cid2, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister2");
...
static void test_genprop_deprec_class(void) {
  ...
  /* Insert first property into class (with no callbacks) */
  ret = H5Pregister1(cid1, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister1");

  /* Try to insert the first property again (should fail) */
  H5E_BEGIN_TRY {
    ret = H5Pregister1(cid1, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL,
                       NULL, NULL, NULL, NULL, NULL);
  }
  H5E_END_TRY
  ...
  /* Insert second property into class (with no callbacks) */
  ret = H5Pregister1(cid1, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister1");

  /* Try to insert the second property again (should fail) */
  H5E_BEGIN_TRY {
    ret = H5Pregister1(cid1, PROP2_NAME, PROP2_SIZE, PROP2_DEF_VALUE, NULL,
                       NULL, NULL, NULL, NULL, NULL);
  }
  H5E_END_TRY
  VERIFY(ret, FAIL, "H5Pregister1");
  ...
  /* Insert third property into class (with no callbacks) */
  ret = H5Pregister1(cid1, PROP3_NAME, PROP3_SIZE, PROP3_DEF_VALUE, NULL, NULL,
                     NULL, NULL, NULL, NULL);
  CHECK_I(ret, "H5Pregister1");
...
static void test_genprop_deprec_list(void) {
  ...
  /* Insert temporary property into class (with no callbacks) */
  ret = H5Pinsert1(pid, PROP1_NAME, PROP1_SIZE, PROP1_DEF_VALUE, NULL, NULL,
                   NULL, NULL, NULL);
...
void test_genprop(void) {
  ...
  test_genprop_basic_class_prop(); /* Test basic code for adding properties to a
                                      generic class */
  test_genprop_class_iter();     /* Test code for iterating over properties in a
                                    generic class */
  test_genprop_class_callback(); /* Test code for property class callbacks */

  test_genprop_basic_list(); /* Test basic code for creating a generic property
                                list */
  test_genprop_basic_list_prop(); /* Test basic code for adding properties to a
                                     generic property list */
  test_genprop_list_iter(); /* Test basic code for iterating over properties in
                               a generic property list */
  ...
  test_genprop_list_add_remove_prop(); /* Test adding and removing the same
                                          property several times to HDF5
                                          property list */
