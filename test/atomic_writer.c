...
static void usage(void) {
  printf("\n");
  printf("Usage error!\n");
  printf("Usage: atomic_writer -n <number of integers to write> -i <number of "
         "iterations for writer>\n");
  printf(
 ...
 * Function:    main
 *
 * Purpose:     To write a series of integers to a file for the reader to verify
 *the data. A write is atomic if the whole amount written in one operation is
 *not interleaved with data from any other process. (1) Iterate with i
 *iterations (2) Write a series of integers (0 to n-1) to the file with this
 *pattern: offset 0:   0000000000000000000000000000000 offset 1:
 *111111111111111111111111111111 offset 2:   22222222222222222222222222222
...
int main(int argc, char *argv[]) {
  ...
  for (i = 1; i <= iterations; i++) {
    ...
    for (n = 0; n < num; n++) {
      ...
      /* Write the data */
      if ((bytes_wrote = write(fd, buf, ((num - n) * sizeof(unsigned int)))) <
          0) {
