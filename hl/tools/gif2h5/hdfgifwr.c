...
/*************************************************************/
int hdfWriteGIF(FILE *fp, byte *pic, int ptype, int w, int h, const byte *rmap,
                const byte *gmap, const byte *bmap, const byte *pc2ncmap,
...
/********************************/
static void cl_hash(count_int hashsize) /* reset code table */
{
