...
int Gif2Mem(GIFBYTE *MemGif, GIFTOMEM *GifMemoryStruct) {
  /*
  ...
  for (;;) {
    ...
    case 0x2C: /* Image Descriptor */
      ...
      if (!(gifImageDesc[ImageCount - 1] =
                (GIFIMAGEDESC *)malloc(sizeof(GIFIMAGEDESC)))) {
        printf("Out of memory!");
        exit(EXIT_FAILURE);
      }
      ...
      gifImageDesc[ImageCount - 1]->Image =
          Decompress(gifImageDesc[ImageCount - 1], gifHead);
    ...
    case 0x21: /* Extension Block */
      ...
      case 0x01: /* Plain Text Extension */
        ...
        if (!(gifPlainText = (GIFPLAINTEXT **)realloc(
                  gifPlainText, sizeof(GIFPLAINTEXT *) * PlainTextArray))) {
          printf("Out of memory!");
          exit(EXIT_FAILURE);
        }
      ...
      case 0xFE: /* Comment Extension */
        ...
        if (!(gifComment = (GIFCOMMENT **)realloc(
                  gifComment, sizeof(GIFCOMMENT *) * CommentArray))) {
          printf("Out of memory!");
          exit(EXIT_FAILURE);
        }

        if (!(gifComment[CommentCount - 1] =
                  (GIFCOMMENT *)malloc(sizeof(GIFCOMMENT)))) {
          printf("Out of memory!");
          exit(EXIT_FAILURE);
        }
      ...
      case 0xFF: /* Application Extension */
        ...
        if (!(gifApplication = (GIFAPPLICATION **)realloc(
                  gifApplication,
                  sizeof(GIFAPPLICATION *) * ApplicationArray))) {
          printf("Out of memory!");
          exit(EXIT_FAILURE);
        }
