...
/* The message sent by this process (extend_dset) to the test script to start
 * "h5watch" */
...
static herr_t extend_dset_two(const char *file, char *dname, int action1,
                              int action2);
...
int main(int argc, char *argv[]) {
  ...
  if (argc != 5) {
    fprintf(
        stderr,
        "Should have file name, dataset name, and the extended amount...\n");
    goto error;
  } /* end if */
