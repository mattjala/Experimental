...
int main(void) {
  ...
  size_t dst_offset1[NFIELDS] = {
      HOFFSET(Particle1, name), HOFFSET(Particle1, lati),
  ...
  file_id =
      H5Fcreate("ex_table_11.h5", H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT);

  /* Make the table */
  H5TBmake_table("Table Title", file_id, TABLE_NAME, NFIELDS, NRECORDS,
                 dst_size1, field_names, dst_offset1, field_type, chunk_size,
