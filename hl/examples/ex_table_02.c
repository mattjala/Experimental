...
int main(void) {
  ...
  size_t dst_sizes[NFIELDS] = {
      sizeof(p_data[0].name), sizeof(p_data[0].lati), sizeof(p_data[0].longi),
  ...
  file_id =
      H5Fcreate("ex_table_02.h5", H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT);
  ...
  /* append two records */
  H5TBappend_records(file_id, TABLE_NAME, NRECORDS_ADD, dst_size, dst_offset,
