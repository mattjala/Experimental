...
int main(void) {
  ...
  size_t dst_sizes[NFIELDS] = {sizeof(p.name), sizeof(p.lati), sizeof(p.longi),
                               sizeof(p.pressure), sizeof(p.temperature)};
  ...
  Particle particle_in[NRECORDS_WRITE] = {{"zero", 0, 0, 0.0F, 0.0},
                                          {"one", 10, 10, 1.0F, 10.0}};
