...
static int test_dsets(void) {
  ...
  /* Make dataset */
  if (H5LTmake_dataset(file_id, DSET0_NAME, rank, dims, H5T_NATIVE_INT,
                       data_int_in) < 0)
    goto out;
  ...
  /* Make dataset short */
  if (H5LTmake_dataset_short(file_id, DSET2_NAME, rank, dims, data_short_in) <
      0)
    goto out;

  /* Read dataset */
  if (H5LTread_dataset(file_id, DSET2_NAME, H5T_NATIVE_SHORT, data_short_out) <
      0)
    goto out;
  ...
  /* Make dataset float */
  if (H5LTmake_dataset_float(file_id, DSET5_NAME, rank, dims, data_float_in) <
      0)
    goto out;

  /* Read dataset */
  if (H5LTread_dataset(file_id, DSET5_NAME, H5T_NATIVE_FLOAT, data_float_out) <
      0)
    goto out;
  ...
  /* Make dataset double */
  if (H5LTmake_dataset_double(file_id, DSET6_NAME, rank, dims, data_double_in) <
      0)
    goto out;

  /* Read dataset */
  if (H5LTread_dataset(file_id, DSET6_NAME, H5T_NATIVE_DOUBLE,
                       data_double_out) < 0)
    goto out;
...
static int test_attr(void) {
  ...
  /* Create the dataset */
  if ((dataset_id = H5Dcreate2(file_id, "dset", H5T_NATIVE_INT, space_id,
  ...
  /* Create a group. */
  if ((group_id = H5Gcreate2(file_id, "grp", H5P_DEFAULT, H5P_DEFAULT,
                             H5P_DEFAULT)) < 0)
    goto out;
...
static herr_t make_attributes(hid_t loc_id, const char *obj_name) {
  ...
  /* Set the attribute */
  if (H5LTset_attribute_char(loc_id, obj_name, ATTR2_NAME, attr_char_in,
                             (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR2_NAME, H5T_NATIVE_CHAR,
                        attr_char_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_short(loc_id, obj_name, ATTR3_NAME, attr_short_in,
                              (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR3_NAME, H5T_NATIVE_SHORT,
                        attr_short_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_int(loc_id, obj_name, ATTR4_NAME, attr_int_in,
                            (size_t)5) < 0)
    return -1;

  /* Set the attribute which is a substring of an existing attribute */
  if (H5LTset_attribute_int(loc_id, obj_name, ATTR_NAME_SUB, attr_int_in,
                            (size_t)5) < 0)
    return -1;

  /* Set the attribute which is an extension of an existing attribute */
  if (H5LTset_attribute_int(loc_id, obj_name, ATTR_NAME_EXT, attr_int_in,
                            (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR4_NAME, H5T_NATIVE_INT,
                        attr_int_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_long(loc_id, obj_name, ATTR5_NAME, attr_long_in,
                             (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR5_NAME, H5T_NATIVE_LONG,
                        attr_long_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_uchar(loc_id, obj_name, ATTR6_NAME, attr_uchar_in,
                              (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR6_NAME, H5T_NATIVE_UCHAR,
                        attr_uchar_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_ushort(loc_id, obj_name, ATTR7_NAME, attr_ushort_in,
                               (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute_ushort(loc_id, obj_name, ATTR7_NAME, attr_ushort_out) <
      0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR7_NAME, H5T_NATIVE_USHORT,
                        attr_ushort_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_uint(loc_id, obj_name, ATTR8_NAME, attr_uint_in,
                             (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR8_NAME, H5T_NATIVE_UINT,
                        attr_uint_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_ulong(loc_id, obj_name, ATTR9_NAME, attr_ulong_in,
                              (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR9_NAME, H5T_NATIVE_ULONG,
                        attr_ulong_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_ullong(loc_id, obj_name, ATTR10_NAME, attr_ullong_in,
                               (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute_ullong(loc_id, obj_name, ATTR10_NAME, attr_ullong_out) <
      0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR10_NAME, H5T_NATIVE_ULLONG,
                        attr_ullong_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_float(loc_id, obj_name, ATTR11_NAME, attr_float_in,
                              (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute_float(loc_id, obj_name, ATTR11_NAME, attr_float_out) <
      0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR11_NAME, H5T_NATIVE_FLOAT,
                        attr_float_out) < 0)
    return -1;
  ...
  /* Set the attribute */
  if (H5LTset_attribute_double(loc_id, obj_name, ATTR12_NAME, attr_double_in,
                               (size_t)5) < 0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute_double(loc_id, obj_name, ATTR12_NAME, attr_double_out) <
      0)
    return -1;
  ...
  /* Get the attribute */
  if (H5LTget_attribute(loc_id, obj_name, ATTR12_NAME, H5T_NATIVE_DOUBLE,
                        attr_double_out) < 0)
    return -1;
  ...
  if (NULL ==
      (dims_out = (hsize_t *)malloc(sizeof(hsize_t) * (size_t)rank_out)))
    return -1;

  if (H5LTget_attribute_info(loc_id, obj_name, ATTR2_NAME, dims_out,
...
static int test_strings(void) {
  ...
  if ((dtype = H5LTtext_to_dtype(
           "H5T_STRING { STRSIZE 13; STRPAD H5T_STR_NULLTERM; CSET "
  ...
  if ((dtype = H5LTtext_to_dtype(
           "H5T_STRING { STRSIZE H5T_VARIABLE; STRPAD H5T_STR_NULLPAD; CSET "
           "H5T_CSET_ASCII; CTYPE H5T_C_S1; }",
           H5LT_DDL)) < 0)
    goto out;
...
static int test_opaques(void) {
  ...
  if ((dtype = H5LTtext_to_dtype("H5T_OPAQUE { OPQ_SIZE 19; OPQ_TAG \"This is "
                                 "a tag for opaque type\"; }",
                                 H5LT_DDL)) < 0)
    goto out;
...
static int test_enums(void) {
  ...
  if ((dtype = H5LTtext_to_dtype("H5T_ENUM { H5T_STD_I32LE; \"RED\" 5; "
                                 "\"GREEN\" 6; \"BLUE\" 7; \"WHITE\" 8; }",
                                 H5LT_DDL)) < 0)
    goto out;
  ...
  if (!H5Tequal(H5T_STD_I32LE, H5T_NATIVE_INT)) {
    if (H5Tconvert(H5T_NATIVE_INT, H5T_STD_I32LE, 1, &value1, NULL,
                   H5P_DEFAULT) < 0)
      goto out;
  }
  ...
  if (!H5Tequal(H5T_STD_I32LE, H5T_NATIVE_INT)) {
    if (H5Tconvert(H5T_NATIVE_INT, H5T_STD_I32LE, 1, &value2, NULL,
                   H5P_DEFAULT) < 0)
      goto out;
  }
...
static int test_arrays(void) {
  ...
  if ((dtype = H5LTtext_to_dtype(
           "H5T_ARRAY { [5][7][13] H5T_ARRAY { [17][19] H5T_COMPOUND { "
           "H5T_STD_I8BE "
...
static int test_compounds(void) {
  ...
  if ((dtype = H5LTtext_to_dtype("H5T_COMPOUND { H5T_STD_I16BE \"one_field\" : "
                                 "2; H5T_STD_U8LE \"two_field\" : 6; }",
                                 H5LT_DDL)) < 0)
    goto out;
  ...
  if ((dtype = H5LTtext_to_dtype(
           "H5T_COMPOUND { H5T_STD_I32BE \"i32_field\"; H5T_STD_I16BE "
           "\"i16_field\"; H5T_COMPOUND  { "
           "H5T_STD_I16BE \"sec_field\"; H5T_COMPOUND { H5T_STD_I32BE "
           "\"thd_field\"; } \"grandchild\"; } "
...
static int test_compound_bug(void) {
  ...
  char text[] =
      ...
      "__________________"
      "_____\"; H5T_VLEN { H5T_COMPOUND { H5T_ENUM { H5T_STD_I16LE; \"ZERO\" "
      "0; \"ONE\" 1; "
      "\"TWO\" 2;  \"THREE\" 3; } \"type____\"; H5T_STD_I32LE "
      "\"sub___________________________________________________________________"
      "__________________"
      "__________________________\"; H5T_STRING { STRSIZE H5T_VARIABLE; STRPAD "
      "H5T_STR_SPACEPAD; "
      "CSET H5T_CSET_ASCII; CTYPE H5T_C_S1; } \"sub_desc\"; H5T_STD_I32LE "
      "\"final_________________________________________________________________"
      "__________________"
  ...
  if ((memb_name = H5Tget_member_name(dtype, 1)) == NULL)
    goto out;
  if (strcmp(memb_name, "desc__________________________________________________"
...
static int test_valid_path(void) {
   ...
   */
  if (H5Lcreate_external("NonExistant_File.h5", "G8", file_id,
                         "DangledExternalLink", H5P_DEFAULT, H5P_DEFAULT) < 0)
    goto out;

  /*
   * Create a group named "G2" in the file.
   */
  if ((group = H5Gcreate2(file_id, "G2", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    goto out;
   ...
   * Create a soft link
   */
  if (H5Lcreate_soft("/G1/G20", file_id, "/G2/G7", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    goto out;
   ...
   */
  if ((group = H5Gcreate2(file_id, "G1", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    goto out;
   ...
   * Create a hard link
   */
  if (H5Lcreate_hard(file_id, "/G2/DS4", file_id, "/G1/DS3", H5P_DEFAULT,
                     H5P_DEFAULT) < 0)
    goto out;
  /*
   * Create a group named "/G1/G2" in the file.
   */
  if ((group = H5Gcreate2(file_id, "/G1/G2", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    goto out;
   ...
   */
  if (H5Lcreate_soft("/G1", file_id, "/G1/G2/Gcyc", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    goto out;
   ...
   */
  if ((group = H5Gcreate2(file_id, "/G1/G2/G6", H5P_DEFAULT, H5P_DEFAULT,
                          H5P_DEFAULT)) < 0)
    goto out;
   ...
   */
  if (H5Lcreate_external(FILE_NAME4, "G1", group, "ExternalLink", H5P_DEFAULT,
                         H5P_DEFAULT) < 0)
    goto out;
  ...
  if (H5Lcreate_soft("/G1/G2", file_id, "/G1/G20", H5P_DEFAULT, H5P_DEFAULT) <
      0)
    goto out;
  ...
  if ((path_valid = H5LTpath_valid(file_id, "/DangledExternalLink", FALSE)) !=
      TRUE)
    goto out;

  /* The file however does not exists, so the link dangles -> should return
   * false */
  if ((path_valid = H5LTpath_valid(file_id, "/DangledExternalLink", TRUE)) ==
      TRUE)
    goto out;

  if ((path_valid = H5LTpath_valid(file_id, "/G1/G2/G6/ExternalLink", FALSE)) !=
      TRUE)
    goto out;

  if ((path_valid = H5LTpath_valid(file_id, "/G1/G2/G6/ExternalLink", TRUE)) !=
      TRUE)
    goto out;

  if ((path_valid = H5LTpath_valid(
           file_id, "/G1/G2/Gcyc/G2/G6/ExternalLink/DS1", TRUE)) != TRUE)
    goto out;

  if ((path_valid = H5LTpath_valid(
           file_id, "/G1/G2/Gcyc/G2/G6/ExternalLink/G20", FALSE)) != TRUE)
    goto out;

  if ((path_valid =
           H5LTpath_valid(file_id, "/G1/G2/G6/ExternalLink/DS1", TRUE)) != TRUE)
    goto out;

  if ((path_valid = H5LTpath_valid(file_id, "/G1/G2/G6/ExternalLink/G20",
                                   FALSE)) != TRUE)
    goto out;

  /* Should fail, does not exist */
  if ((path_valid =
           H5LTpath_valid(file_id, "/G1/G2/G6/ExternalLink/G20", TRUE)) == TRUE)
    goto out;

  if ((path_valid = H5LTpath_valid(
           file_id, "/G1/G2/Gcyc/G2/G6/ExternalLink/G20", TRUE)) == TRUE)
    goto out;
